...
{
	public partial class Country : Allors.IObject , UserInterfaceable, Searchable
	{
		...
		{ 
			return new CountryOnPostBuild(this);
		}

		public ObjectApplySecurityOnPostBuild ApplySecurityOnPostBuild()
		{ 
			return new CountryApplySecurityOnPostBuild(this);
		}
	}
