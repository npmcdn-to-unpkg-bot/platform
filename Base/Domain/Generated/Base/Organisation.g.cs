...
{
	public partial class Organisation : Allors.IObject , Derivable, Searchable, UniquelyIdentifiable, UserInterfaceable, SearchResult
	{
		...
		{ 
			return new OrganisationOnPostBuild(this);
		}

		public ObjectApplySecurityOnPostBuild ApplySecurityOnPostBuild()
		{ 
			return new OrganisationApplySecurityOnPostBuild(this);
		}
	}
