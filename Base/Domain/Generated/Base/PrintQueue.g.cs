...
{
	public partial class PrintQueue : Allors.IObject , AccessControlledObject, UserInterfaceable, UniquelyIdentifiable
	{
		...
		{ 
			return new PrintQueueOnPostBuild(this);
		}

		public ObjectApplySecurityOnPostBuild ApplySecurityOnPostBuild()
		{ 
			return new PrintQueueApplySecurityOnPostBuild(this);
		}
	}
