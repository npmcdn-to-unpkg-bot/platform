namespace Allors.Bootstrap {
    ...
    export class SelectOneTemplate {
        ...
        static createDefaultView() {
            return `
<ui-select ng-if="$ctrl.options !== undefined" ng-model="$ctrl.model" append-to-body="$ctrl.appendToBody" close-on-select="$ctrl.closeOnSelect">
    <ui-select-match placeholder="Select a value" allow-clear="{{$ctrl.allowClear}}">{{$ctrl.displayValue}}</ui-select-match>
