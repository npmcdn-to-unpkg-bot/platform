...
(function (Tests) {
    var WorkspaceTests = (function (_super) {
        ...
        WorkspaceTests.prototype.unitGet = function () {
        ...
        WorkspaceTests.prototype.unitSet = function () {
            var database = new Allors.Database(Allors.Meta.population);
            database.load(Tests.Fixture.loadData);
        ...
        WorkspaceTests.prototype.unitSave = function () {
            var database = new Allors.Database(Allors.Meta.population);
            database.load(Tests.Fixture.loadData);
            var workspace = new Allors.Workspace(database);
            var koen = workspace.get("1");
        ...
        WorkspaceTests.prototype.oneGet = function () {
            var database = new Allors.Database(Allors.Meta.population);
            database.load(Tests.Fixture.loadData);
            var workspace = new Allors.Workspace(database);
            var koen = workspace.get("1");
        ...
        WorkspaceTests.prototype.oneSet = function () {
            var database = new Allors.Database(Allors.Meta.population);
            database.load(Tests.Fixture.loadData);
            var workspace1 = new Allors.Workspace(database);
            var workspace2 = new Allors.Workspace(database);
        ...
        WorkspaceTests.prototype.oneSave = function () {
            var database = new Allors.Database(Allors.Meta.population);
            database.load(Tests.Fixture.loadData);
            var workspace = new Allors.Workspace(database);
            var koen = workspace.get("1");
        ...
        WorkspaceTests.prototype.manyGet = function () {
            var database = new Allors.Database(Allors.Meta.population);
            database.load(Tests.Fixture.loadData);
            var workspace = new Allors.Workspace(database);
            var koen = workspace.get("1");
        ...
        WorkspaceTests.prototype.manySet = function () {
            var database = new Allors.Database(Allors.Meta.population);
            database.load(Tests.Fixture.loadData);
            var workspace1 = new Allors.Workspace(database);
            var workspace2 = new Allors.Workspace(database);
        ...
        WorkspaceTests.prototype.manySaveWithExistingObjects = function () {
            var database = new Allors.Database(Allors.Meta.population);
            database.load(Tests.Fixture.loadData);
            var workspace = new Allors.Workspace(database);
            var koen = workspace.get("1");
        ...
        WorkspaceTests.prototype.manySaveWithNewObjects = function () {
            var database = new Allors.Database(Allors.Meta.population);
            database.load(Tests.Fixture.loadData);
            var workspace = new Allors.Workspace(database);
            var martien = workspace.get("3");
        ...
        WorkspaceTests.prototype.methodCanExecute = function () {
            var database = new Allors.Database(Allors.Meta.population);
            database.load(Tests.Fixture.loadData);
            var workspace = new Allors.Workspace(database);
            var acme = workspace.get("101");
        ...
        WorkspaceTests.prototype.arrayEqual = function (array1, array2) {
