namespace Allors.Meta
{
    ...
    public partial class OrganisationClass : Class
    {
        ...
        internal override void TestExtend()
        {
            ...
            this.AngularEmployees = new Tree(organisation).Add(organisation.Employee);

            var person = PersonClass.Instance;
            this.AngularShareholders = new Tree(organisation).Add(
                organisation.Shareholder, 
                new Tree(person).Add(person.Photo));
        }
    }
}