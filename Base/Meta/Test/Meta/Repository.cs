...
namespace Allors.Meta
{
    ...
    public static partial class Repository
    {
        ...
        public static Domain Test(MetaPopulation meta)
        {
            ...
            new RelationTypeBuilder(domain, new Guid("81d9eb2f-55a7-4d1c-853d-4369eb691ba5"), new Guid("db4d3b11-77bd-408e-ad41-4a03272a88e1"), new Guid("bdcffe2b-ffa7-4eb1-be24-8d8ab0b4dce2")).WithObjectTypes(i2, allorsDate).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("7046c2b4-d458-4343-8446-d23d9c837c84"), new Guid("0671f523-a557-41e1-9d05-0e89d8d1ae2d"), new Guid("c84a6696-a1e9-4794-86c3-50e1f009c845")).WithObjectTypes(organisation, allorsDate).WithSingularName("IncorporationDate").WithPluralName("IncorporationDates").Build();
            ...
            // Unit
            new RelationTypeBuilder(domain, new Guid("0cbfa00c-e3e1-4dca-ad75-cd5c57a0df9f"), new Guid("4b9e7a79-4d7e-4029-8e58-d366f606b76f"), new Guid("80be7509-2fee-45b6-8359-553387d008f4")).WithObjectTypes(unit, allorsDate).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("37f696e4-88f1-4953-8d1b-000263cbf1ae"), new Guid("bd8333bc-c0b7-40c0-9527-212310aa1765"), new Guid("3ab8cd65-3e98-4ffe-b71f-5d9f2d1ea63a")).WithObjectTypes(c1, allorsDate).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("1afae917-7f62-4472-8a9c-22113b1af77f"), new Guid("edd17364-a075-49c6-ac29-841e8251f023"), new Guid("cf84a018-03c1-4f3e-b782-0b84a107d760")).WithObjectTypes(c2, allorsDate).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("ed4811bc-c1fc-453b-967f-bd5b6cb6f83f"), new Guid("55437bb6-719d-4884-92e9-c1cf58aeb231"), new Guid("75495ad4-ad58-4349-9558-94261284125d")).WithObjectTypes(i12, allorsDate).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("32fc21cc-4be7-4a0e-ac71-df135be95e68"), new Guid("e0006bdc-74e2-4067-871c-6f0b53eba5de"), new Guid("12824c37-d0d2-4cb9-9481-cad7f5f54976")).WithObjectTypes(i1, allorsDate).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("adf83a86-878d-4148-a9fc-152f56697136"), new Guid("b9da077d-bfc7-4b4e-be62-03aded6da22e"), new Guid("0ffd9c62-efc6-4438-aaa3-755e4c637c21")).WithObjectTypes(person, allorsDate).WithSingularName("BirthDate").WithPluralName("BirthDates").Build();
