...
namespace Allors.Meta
{
    ...
    public static partial class Repository
    {
        public static Domain Base(MetaPopulation meta)
        {
            ...
            // RelationTypes
            // Counter
            new RelationTypeBuilder(domain, new Guid("309d07d9-8dea-4e99-a3b8-53c0d360bc54"), new Guid("0c807020-5397-4cdb-8380-52899b7af6b7"), new Guid("ab60f6a7-d913-4377-ab47-97f0fb9d8f3b"))
            ...
            new RelationTypeBuilder(domain, new Guid("e1842d87-8157-40e7-b06e-4375f311f2c3"), new Guid("fe413e96-cfcf-4e8d-9f23-0fa4f457fdf1"), new Guid("d73fd9a4-13ee-4fa9-8925-d93eca328bf6"))
            ...
            // Singleton
            new RelationTypeBuilder(domain, new Guid("d9ea02e5-9aa1-4cbe-9318-06324529a923"), new Guid("6247e69d-4789-4ee0-a75b-c2de44a5fcce"), new Guid("c11f31e1-75a7-4b23-9d58-7dfec256b658"))
                ...
                .WithIsIndexed(true)
                .Build();
            new RelationTypeBuilder(domain, new Guid("f16652b0-b712-43d7-8d4e-34a22487514d"), new Guid("c92466b5-55ba-496a-8880-2821f32f8f8e"), new Guid("3a12d798-40c3-40e0-ba9f-9d01b1e39e89"))
                .WithObjectTypes(singleton, user)
                .WithSingularName("Guest")
                .WithPluralName("Guests")
                .Build();
            new RelationTypeBuilder(domain, new Guid("f579494b-e550-4be6-9d93-84618ac78704"), new Guid("33f17e75-99cc-417e-99f3-c29080f08f0a"), new Guid("ca9e3469-583c-4950-ba2c-1bc3a0fc3e96"))
                .WithObjectTypes(singleton, securityToken)
            ...
            new RelationTypeBuilder(domain, new Guid("585bb5cf-9ba4-4865-9027-3667185abc4f"), new Guid("1e2d1e31-ed80-4435-8850-7663d9c5f41d"), new Guid("c552f0b7-95ce-4d45-aaea-56bc8365eee4")).WithObjectTypes(userGroup, user).WithSingularName("Member").WithPluralName("Members").WithMultiplicity(Multiplicity.ManyToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("be9dc116-a7ea-4a4b-aaca-eb0f91fc3741"), new Guid("d8d8fdf7-f261-449b-b611-7c58dc43f6d3"), new Guid("6ec327af-86bc-4c79-8f00-bcb399686bf3")).WithObjectTypes(userGroup, userGroup).WithSingularName("Parent").WithPluralName("Parents").WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true).WithIsIndexed(true).Build();
            ...
            // Permission
            new RelationTypeBuilder(domain, new Guid("097bb620-f068-440e-8d02-ef9d8be1d0f0"), new Guid("3442728c-164a-477c-87be-19a789229585"), new Guid("3fd81194-2f6f-43e7-9c6b-91f5e3e118ac"))
                ...
                .WithIsRequired(true)
                .Build();
            new RelationTypeBuilder(domain, new Guid("29b80857-e51b-4dec-b859-887ed74b1626"), new Guid("8ffed1eb-b64e-4341-bbb6-348ed7f06e83"), new Guid("cadaca05-55ba-4a13-8758-786ff29c8e46"))
                .WithObjectTypes(permission, allorsUnique)
                ...
                .WithIsRequired(true)
                .Build();
            new RelationTypeBuilder(domain, new Guid("9d73d437-4918-4f20-b9a7-3ce23a04bd7b"), new Guid("891734d6-4855-4b33-8b3b-f46fd6103149"), new Guid("d29ce0ed-fba8-409d-8675-dc95e1566cfb"))
            ...
            new RelationTypeBuilder(domain, new Guid("dd19e7f8-83b7-4ff1-b475-02c4296b47e4"), new Guid("c88c9ab2-af38-45ca-9caa-fcb5715da129"), new Guid("c68eb959-1b2c-48a7-b15a-944a576944ef")).WithObjectTypes(transition, objectState).WithSingularName("ToState").WithPluralName("ToStates").WithMultiplicity(Multiplicity.ManyToOne).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("c2d950ad-39d3-40f1-8817-11a026e9890b"), new Guid("e8091111-9f92-41a9-b4b1-4e8f277ea575"), new Guid("150daf84-13ce-4b5f-83e6-64c7ef4f81c6")).WithObjectTypes(login, user).WithMultiplicity(Multiplicity.ManyToOne).WithIsIndexed(true).Build();

            // Role
            new RelationTypeBuilder(domain, new Guid("51e56ae1-72dc-443f-a2a3-f5aa3650f8d2"), new Guid("47af1a0f-497d-4a19-887b-79e5fb77c8bd"), new Guid("7e6a71b0-2194-47f8-b562-cb4a15e335b6")).WithObjectTypes(role, permission).WithMultiplicity(Multiplicity.ManyToMany).WithIsIndexed(true).Build();
            ...
            // AccessControl
            new RelationTypeBuilder(domain, new Guid("0dbbff5c-3dca-4257-b2da-442d263dcd86"), new Guid("92e8d639-9205-422b-b4ff-c7e8c2980abf"), new Guid("2d9b7157-5409-40d3-bd3e-6911df9aface")).WithObjectTypes(accessControl, userGroup).WithSingularName("SubjectGroup").WithPluralName("SubjectGroups").WithMultiplicity(Multiplicity.ManyToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("37dd1e27-ba75-404c-9410-c6399d28317c"), new Guid("3d74101d-97bc-46fb-9548-96cb7aa01b39"), new Guid("e0303a17-bf7a-4a7f-bb4b-0a447c56aaaf")).WithObjectTypes(accessControl, user).WithSingularName("Subject").WithPluralName("Subjects").WithMultiplicity(Multiplicity.ManyToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("6503574b-8bab-4da8-a19d-23a9bcffe01e"), new Guid("cae9e5c2-afa1-46f4-b930-69d4e810038f"), new Guid("ab2b4b9c-87dd-4712-b123-f5f9271c6193")).WithObjectTypes(accessControl, securityToken).WithSingularName("Object").WithPluralName("Objects").WithMultiplicity(Multiplicity.ManyToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("69a9dae8-678d-4c1c-a464-2e5aa5caf39e"), new Guid("ec79e57d-be81-430a-b12f-08ffd1e94af3"), new Guid("370d3d12-3164-4753-8a72-1c604bda1b64")).WithObjectTypes(accessControl, role).WithMultiplicity(Multiplicity.ManyToOne).Build();

            // AccessControlledObject
            new RelationTypeBuilder(domain, new Guid("5c70ca14-4601-4c65-9b0d-cb189f90be27"), new Guid("267053f0-43b4-4cc7-a0e2-103992b2d0c5"), new Guid("867765fa-49dc-462f-b430-3c0e264c5283")).WithObjectTypes(accessControlledObject, permission).WithSingularName("DeniedPermission").WithPluralName("DeniedPermissions").WithMultiplicity(Multiplicity.ManyToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("b816fccd-08e0-46e0-a49c-7213c3604416"), new Guid("1739db0d-fe6b-42e1-a6a5-286536ff4f56"), new Guid("9f722315-385a-42ab-b84e-83063b0e5b0d")).WithObjectTypes(accessControlledObject, securityToken).WithMultiplicity(Multiplicity.ManyToMany).WithIsIndexed(true).Build();
            ...
            // ObjectState
            new RelationTypeBuilder(domain, new Guid("59338f0b-40e7-49e8-ba1a-3ecebf96aebe"), new Guid("fca0f3f6-bdd6-4405-93b3-35dd769bff0e"), new Guid("c338f087-559c-4239-9c6a-1f691e58ed16")).WithObjectTypes(objectState, permission).WithSingularName("DeniedPermission").WithPluralName("DeniedPermissions").WithMultiplicity(Multiplicity.ManyToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("f091b264-e6b1-4a57-bbfb-8225cbe8190c"), new Guid("6650af3b-f537-4c2f-afff-6773552315cd"), new Guid("5e9fcced-727d-42a2-95e6-a0f9d8be4ec7")).WithObjectTypes(language, localisedText).WithSingularName("LocalisedName").WithPluralName("LocalisedNames").WithMultiplicity(Multiplicity.OneToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("a0c28d27-7be1-488d-85bf-2f84d4c61a55"), new Guid("5c229928-80b4-47f6-a182-1b2c34ed5d7b"), new Guid("594d3231-5d79-4c97-908f-558d0fa346c3")).WithObjectTypes(searchData, searchFragment).WithSingularName("SearchFragment").WithPluralName("SearchFragments").WithMultiplicity(Multiplicity.ManyToMany).WithIsIndexed(true).Build();
            ...
            // Localised
            new RelationTypeBuilder(domain, new Guid("8c005a4e-5ffe-45fd-b279-778e274f4d83"), new Guid("6684d98b-cd43-4612-bf9d-afefe02a0d43"), new Guid("d43b92ac-9e6f-4238-9625-1e889be054cf")).WithObjectTypes(localised, locale).WithSingularName("Locale").WithPluralName("Locales").WithMultiplicity(Multiplicity.ManyToOne).WithIsIndexed(true).Build();

            // Period
            new RelationTypeBuilder(domain, new Guid("5aeb31c7-03d4-4314-bbb2-fca5704b1eab"), new Guid("8cf0bd14-753d-4f34-99b3-7a6b0d90c3d4"), new Guid("0da8ef4e-53b7-4152-b219-7e0cebbca268")).WithObjectTypes(period, allorsString).WithSingularName("FromDate").WithPluralName("FromDates").Build();
            new RelationTypeBuilder(domain, new Guid("d7576ce2-da27-487a-86aa-b0912f745bc0"), new Guid("cb2fa6c1-f826-45f0-a03f-00e6cb268ebb"), new Guid("4e021875-5bae-4f01-8deb-641016cd2f8d")).WithObjectTypes(period, allorsString).WithSingularName("ThroughDate").WithPluralName("ThroughDates").Build();
            ...
            // PrintQueue
            new RelationTypeBuilder(domain, new Guid("679156a1-f683-4772-b724-54b318eb3cb3"), new Guid("9124aa32-3ed5-4a1a-8988-961eea280b86"), new Guid("432f8b01-0bb8-4bd2-8a41-107b6d043a40")).WithObjectTypes(printQueue, printable).WithSingularName("Printable").WithPluralName("Printables").WithMultiplicity(Multiplicity.ManyToMany).WithIsIndexed(true).Build();
            ...
            // Country
            new RelationTypeBuilder(domain, new Guid("62009cef-7424-4ec0-8953-e92b3cd6639d"), new Guid("323173ee-385c-4f74-8b78-ff05735460f8"), new Guid("4ca5a640-5d9e-4910-95ed-6872c7ea13d2")).WithObjectTypes(country, currency).WithSingularName("Currency").WithPluralName("Currencies").WithMultiplicity(Multiplicity.ManyToOne).WithIsIndexed(true).Build();
            ...
            // Image
            new RelationTypeBuilder(domain, new Guid("366410a7-7d51-4d7c-82fd-3444bdc0b3f7"), new Guid("9d45e17e-962b-4f9b-a029-c1c1562e5260"), new Guid("9ed94fa8-e01e-4f63-9932-d56134616474")).WithObjectTypes(image, media).WithSingularName("Original").WithPluralName("Originals").WithMultiplicity(Multiplicity.ManyToOne).WithIsIndexed(true).Build();
            ...
            // Media
            new RelationTypeBuilder(domain, new Guid("49481792-06f0-49a1-b32f-28d265815a24"), new Guid("7ca17a9e-0b68-445f-8080-84b08ca0eb2d"), new Guid("f1008c56-b375-4aa8-ac7e-c1f7ef9b2080")).WithObjectTypes(media, mediaType).WithSingularName("MediaType").WithPluralName("MediaTypes").WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("67082a51-1502-490b-b8db-537799e550bd"), new Guid("e8537dcf-1bd7-46c4-a37c-077bee6a78a1"), new Guid("02fe1ce8-c019-4a40-bd6f-b38d2f47a288")).WithObjectTypes(media, mediaContent).WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("9c1634ab-be99-4504-8690-ed4b39fec5bc"), new Guid("45a4205d-7c02-40d4-8d97-6d7d59e05def"), new Guid("1e051b37-cf30-43ed-a623-dd2928d6d0a3")).WithObjectTypes(singleton, locale).WithSingularName("DefaultLocale").WithPluralName("DefaultLocales").WithMultiplicity(Multiplicity.ManyToOne).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("9e5a3413-ed33-474f-adf2-149ad5a80719"), new Guid("33d5d8b9-3472-48d8-ab1a-83d00d9cb691"), new Guid("e75a8956-4d02-49ba-b0cf-747b7a9f350d")).WithObjectTypes(singleton, locale).WithSingularName("Locale").WithPluralName("Locales").WithMultiplicity(Multiplicity.OneToMany).WithIsIndexed(true).Build();
