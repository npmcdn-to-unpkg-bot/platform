        ...
        public ActionResult Populate()
        {
            ...
            try
            {
                ...
                using (var session = database.CreateSession())
                {
                    ...
                    var koen = new PersonBuilder(session).WithUserName("koen@allors.com").WithUserEmail("koen@allors.com").WithUserPasswordHash(passwordHasher.HashPassword("a")).Build();
