...
intellisense.annotate(jQuery.fn, {
  ...
  'id': function() {
    /// <signature>
    ///   <summary>Selects a single element with the given value attribute.</summary>
    ///   <param name="value" type="String">An ID to search for, specified via the value attribute of an element.</param>
    /// </signature>
  },
  'image': function() {
