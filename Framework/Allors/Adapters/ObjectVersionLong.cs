//------------------------------------------------------------------------------------------------- 
// <copyright file="ObjectVersionLong.cs" company="Allors bvba">
...
// </copyright>
// <summary>Defines the ObjectVersionLong type.</summary>
//-------------------------------------------------------------------------------------------------
namespace Allors
{
    using System;
    ...
    /// <summary>
    /// A 64 bit <see cref="ObjectVersion"/>.
    /// </summary>
    [Serializable]
    public sealed class ObjectVersionLong : ObjectVersion, IComparable<ObjectVersionLong>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectVersionLong"/> class.
        /// </summary>
        /// <param name="version">The object version.</param>
        public ObjectVersionLong(long version)
        {
        ...
        /// </summary>
        /// <param name="version">The object version.</param>
        public ObjectVersionLong(string version)
        {
            this.version = long.Parse(version);
        }

        public ObjectVersionLong()
        {
        ...
        public override ObjectVersion Next()
        {
            return new ObjectVersionLong(this.version+1);
        }
        ...
        {
            return this.CompareTo(obj as ObjectVersionLong);
        }
        ...
        public int CompareTo(ObjectVersionLong other)
        {
            return other == null ? -1 : this.version.CompareTo(other.version);
        }
        ...
        {
            return this.Equals(other as ObjectVersionLong);
        }
        ...
        /// </returns>
        /// <exception cref="T:System.NullReferenceException">The <paramref name="other"/> parameter is null.</exception>
        public bool Equals(ObjectVersionLong other)
        {
