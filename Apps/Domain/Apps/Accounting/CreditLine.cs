...
namespace Allors.Domain
{
    ...
    public partial class CreditLine
    {
        ...
        protected override void AppsDerive(IDerivation derivation)
        {
            ...
            derivation.Log.AssertExists(this, CreditLines.Meta.FromParty);
            derivation.Log.AssertExists(this, CreditLines.Meta.ToParty);
            derivation.Log.AssertExists(this, CreditLines.Meta.Description);
