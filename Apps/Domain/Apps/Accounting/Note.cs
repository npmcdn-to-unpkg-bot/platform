...
namespace Allors.Domain
{
    ...
    public partial class Note
    {
        ...
        protected override void AppsDerive(IDerivation derivation)
        {
            ...
            derivation.Log.AssertExists(this, Notes.Meta.EntryDate);
            derivation.Log.AssertExists(this, Notes.Meta.TransactionDate);
            derivation.Log.AssertExists(this, Notes.Meta.FromParty);
            derivation.Log.AssertExists(this, Notes.Meta.ToParty);
            derivation.Log.AssertExists(this, Notes.Meta.Description);
