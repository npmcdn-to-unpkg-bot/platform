...
namespace Allors.Domain
{
    ...
    public partial class InternalOrganisationRevenueHistories
    {
        public static void AppsDeriveHistory(ISession session)
        {
            ...
            {
                var months = ((DateTime.Now.Year - internalOrganisationRevenue.Year) * 12) + DateTime.Now.Month - internalOrganisationRevenue.Month;
                if (months <= 12)
                {
                    var date = new DateTime(internalOrganisationRevenue.Year, internalOrganisationRevenue.Month, 01);
            ...
            foreach (var keyValuePair in internalOrganisationRevenuesByPeriodByInternalOrganisation)
            {
                ...
                internalOrganisationRevenueHistory.Derive(derivation);
            }
        }
