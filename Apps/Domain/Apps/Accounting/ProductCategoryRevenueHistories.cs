...
namespace Allors.Domain
{
    ...
    public partial class ProductCategoryRevenueHistories
    {
        public static void AppsDeriveHistory(ISession session)
        {
            ...
            {
                var months = ((DateTime.Now.Year - productCategoryRevenue.Year) * 12) + DateTime.Now.Month - productCategoryRevenue.Month;
                if (months <= 12)
                {
                    var date = new DateTime(productCategoryRevenue.Year, productCategoryRevenue.Month, 01);
            ...
            foreach (var keyValuePair in productCategoryRevenuesByPeriodByProductCategoryByInternalOrganisation)
            {
                ...
                foreach (var valuePair in keyValuePair.Value)
                {
                    ...
                    productCategoryRevenueHistory.Derive(derivation);
                }
            }
        }
