// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SalesChannelRevenueHistory.cs" company="Allors bvba">
...
namespace Allors.Domain
{
    ...
    public partial class SalesChannelRevenueHistory
    {
        ...
        private void AppsDeriveMovingAverage()
        {
            ...
            var revenues = this.SalesChannel.SalesChannelRevenuesWhereSalesChannel;
