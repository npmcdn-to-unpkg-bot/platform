...
namespace Allors.Domain
{
    ...
    public partial class ManufacturingBom
    {
        protected override void AppsDerive(IDerivation derivation)
        {
            ...
            derivation.Log.AssertExists(this, ManufacturingBoms.Meta.QuantityUsed);
            derivation.Log.AssertExists(this, ManufacturingBoms.Meta.ComponentPart);
            derivation.Log.AssertExists(this, ManufacturingBoms.Meta.Part);
