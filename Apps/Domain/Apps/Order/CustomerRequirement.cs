// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CustomerRequirement.cs" company="Allors bvba">
...
namespace Allors.Domain
{
    public partial class CustomerRequirement
    {
        protected override void AppsOnPostBuild(IObjectBuilder objectBuilder)
        {
            ...
            {
                this.CurrentObjectState = new RequirementObjectStates(this.DatabaseSession).Active;
            }
        ...
        protected override void AppsDerive(IDerivation derivation)
        {
            ...
            derivation.Log.AssertExists(this, CustomerRequirements.Meta.Description);
