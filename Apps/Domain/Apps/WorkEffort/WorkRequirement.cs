...
namespace Allors.Domain
{
    public partial class WorkRequirement
    {
        protected override void AppsOnPostBuild(IObjectBuilder objectBuilder)
        {
            ...
            {
                this.CurrentObjectState = new Allors.Domain.RequirementObjectStates(this.DatabaseSession).Active;
            }
        ...
        protected override void AppsDerive(IDerivation derivation)
        {
            ...
            derivation.Log.AssertExists(this, WorkRequirements.Meta.Description);
