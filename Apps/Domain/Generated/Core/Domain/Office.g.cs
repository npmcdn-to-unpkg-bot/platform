...
{
	public partial class Office : Allors.ObjectBase , Facility
	{
		public static readonly OfficeMeta Meta = OfficeMeta.Instance;

		public Office(Allors.IStrategy allors) : base(allors) {}

		public static Office Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (Office) allorsSession.Instantiate(allorsObjectId);		
		}
	...
	{
		public static readonly OfficeMeta Instance = new OfficeMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.Office;
