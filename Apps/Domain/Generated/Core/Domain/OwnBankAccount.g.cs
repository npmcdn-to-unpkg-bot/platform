...
namespace Allors.Domain
{
	...
	public partial class OwnBankAccount : Allors.ObjectBase , PaymentMethod, FinancialAccount
	{
		public static readonly OwnBankAccountMeta Meta = OwnBankAccountMeta.Instance;

		public OwnBankAccount(Allors.IStrategy allors) : base(allors) {}

		public static OwnBankAccount Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (OwnBankAccount) allorsSession.Instantiate(allorsObjectId);		
		}
	...
	public class OwnBankAccountMeta
	{
		public static readonly OwnBankAccountMeta Instance = new OwnBankAccountMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.OwnBankAccount;

		public global::Allors.Meta.RoleType BankAccount 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.OwnBankAccountBankAccount;
			}
		} 
