...
namespace Allors.Domain
{
	...
	public partial class SubContractorRelationship : Allors.ObjectBase , PartyRelationship
	{
		public static readonly SubContractorRelationshipMeta Meta = SubContractorRelationshipMeta.Instance;

		public SubContractorRelationship(Allors.IStrategy allors) : base(allors) {}
		...
		{ 
			get
			{
				return (Party) Strategy.GetCompositeRole(Meta.Contractor);
			}
			set
			{
				Strategy.SetCompositeRole(Meta.Contractor ,value);
			}
		}
		...
		virtual public bool ExistContractor
		{
			get
			{
				return Strategy.ExistCompositeRole(Meta.Contractor);
			}
		}

		virtual public void RemoveContractor()
		{
			Strategy.RemoveCompositeRole(Meta.Contractor);
		}
		...
		{ 
			get
			{
				return (Party) Strategy.GetCompositeRole(Meta.SubContractor);
			}
			set
			{
				Strategy.SetCompositeRole(Meta.SubContractor ,value);
			}
		}
		...
		virtual public bool ExistSubContractor
		{
			get
			{
				return Strategy.ExistCompositeRole(Meta.SubContractor);
			}
		}

		virtual public void RemoveSubContractor()
		{
			Strategy.RemoveCompositeRole(Meta.SubContractor);
		}
	...
	public class SubContractorRelationshipMeta
	{
		public static readonly SubContractorRelationshipMeta Instance = new SubContractorRelationshipMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.SubContractorRelationship;

		public global::Allors.Meta.RoleType Contractor 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.SubContractorRelationshipContractor;
			}
		} 
		public global::Allors.Meta.RoleType SubContractor 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.SubContractorRelationshipSubContractor;
			}
		} 
