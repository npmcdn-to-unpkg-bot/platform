...
{
	public partial class OwnCreditCard : Allors.ObjectBase , PaymentMethod, FinancialAccount
	{
		public static readonly OwnCreditCardMeta Meta = OwnCreditCardMeta.Instance;

		public OwnCreditCard(Allors.IStrategy allors) : base(allors) {}
		...
		{ 
			get
			{
				return (CreditCard) Strategy.GetCompositeRole(Meta.CreditCard);
			}
			set
			{
				Strategy.SetCompositeRole(Meta.CreditCard ,value);
			}
		}
		...
		virtual public bool ExistCreditCard
		{
			get
			{
				return Strategy.ExistCompositeRole(Meta.CreditCard);
			}
		}

		virtual public void RemoveCreditCard()
		{
			Strategy.RemoveCompositeRole(Meta.CreditCard);
		}
	...
	public class OwnCreditCardMeta
	{
		public static readonly OwnCreditCardMeta Instance = new OwnCreditCardMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.OwnCreditCard;

		public global::Allors.Meta.RoleType Owner 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.OwnCreditCardOwner;
			}
		} 
		public global::Allors.Meta.RoleType CreditCard 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.OwnCreditCardCreditCard;
			}
		} 
