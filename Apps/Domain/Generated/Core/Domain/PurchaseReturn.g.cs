...
{
	public partial class PurchaseReturn : Allors.ObjectBase , Shipment
	{
		public static readonly PurchaseReturnMeta Meta = PurchaseReturnMeta.Instance;

		public PurchaseReturn(Allors.IStrategy allors) : base(allors) {}
		...
		virtual public PurchaseReturnStatus CurrentShipmentStatus
		{ 
			get
			{
				return (PurchaseReturnStatus) Strategy.GetCompositeRole(Meta.CurrentShipmentStatus);
			}
			set
			{
		...
		virtual public PurchaseReturnObjectState CurrentObjectState
		{ 
			get
			{
				return (PurchaseReturnObjectState) Strategy.GetCompositeRole(Meta.CurrentObjectState);
			}
			set
			{
		...
		virtual public global::Allors.Extent<PurchaseReturnStatus> ShipmentStatuses
		{ 
			get
			{
		...
		virtual public void AddShipmentStatus (PurchaseReturnStatus value)
		{
			Strategy.AddCompositeRole(Meta.ShipmentStatus, value);
		}

		virtual public void RemoveShipmentStatus (PurchaseReturnStatus value)
		{
		...
		virtual public PurchaseReturnObjectState PreviousObjectState
		{ 
			get
			{
				return (PurchaseReturnObjectState) Strategy.GetCompositeRole(Meta.PreviousObjectState);
			}
			set
			{
	...
	public class PurchaseReturnMeta
	{
		public static readonly PurchaseReturnMeta Instance = new PurchaseReturnMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.PurchaseReturn;

		public global::Allors.Meta.RoleType CurrentShipmentStatus 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.PurchaseReturnCurrentShipmentStatus;
			}
		} 
		public global::Allors.Meta.RoleType CurrentObjectState 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.PurchaseReturnCurrentObjectState;
			}
		} 
		public global::Allors.Meta.RoleType ShipmentStatus 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.PurchaseReturnShipmentStatus;
			}
		} 
		public global::Allors.Meta.RoleType PreviousObjectState 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.PurchaseReturnPreviousObjectState;
			}
		} 
