...
namespace Allors.Domain
{
	...
	public partial class Tolerance : Allors.ObjectBase , PartSpecification
	{
		public static readonly ToleranceMeta Meta = ToleranceMeta.Instance;

		public Tolerance(Allors.IStrategy allors) : base(allors) {}

		public static Tolerance Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (Tolerance) allorsSession.Instantiate(allorsObjectId);		
		}
	...
	public class ToleranceMeta
	{
		public static readonly ToleranceMeta Instance = new ToleranceMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.Tolerance;
