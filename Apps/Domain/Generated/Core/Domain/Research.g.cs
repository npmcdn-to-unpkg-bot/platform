...
{
	public partial class Research : Allors.ObjectBase , WorkEffort
	{
		public static readonly ResearchMeta Meta = ResearchMeta.Instance;

		public Research(Allors.IStrategy allors) : base(allors) {}

		public static Research Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (Research) allorsSession.Instantiate(allorsObjectId);		
		}
	...
	public class ResearchMeta
	{
		public static readonly ResearchMeta Instance = new ResearchMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.Research;
