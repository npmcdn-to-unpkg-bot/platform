...
{
	public partial class WebAddress : Allors.ObjectBase , ElectronicAddress
	{
		public static readonly WebAddressMeta Meta = WebAddressMeta.Instance;

		public WebAddress(Allors.IStrategy allors) : base(allors) {}
	...
	public class WebAddressMeta
	{
		public static readonly WebAddressMeta Instance = new WebAddressMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.WebAddress;
