...
namespace Allors.Domain
{
	...
	public partial class DeliverableOrderItem : Allors.ObjectBase , EngagementItem
	{
		public static readonly DeliverableOrderItemMeta Meta = DeliverableOrderItemMeta.Instance;

		public DeliverableOrderItem(Allors.IStrategy allors) : base(allors) {}

		public static DeliverableOrderItem Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (DeliverableOrderItem) allorsSession.Instantiate(allorsObjectId);		
		}
	...
	public class DeliverableOrderItemMeta
	{
		public static readonly DeliverableOrderItemMeta Instance = new DeliverableOrderItemMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.DeliverableOrderItem;

		public global::Allors.Meta.RoleType AgreedUponPrice 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.DeliverableOrderItemAgreedUponPrice;
			}
		} 
