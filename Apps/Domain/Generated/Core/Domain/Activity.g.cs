...
namespace Allors.Domain
{
	...
	public partial class Activity : Allors.ObjectBase , WorkEffort
	{
		public static readonly ActivityMeta Meta = ActivityMeta.Instance;

		public Activity(Allors.IStrategy allors) : base(allors) {}

		public static Activity Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (Activity) allorsSession.Instantiate(allorsObjectId);		
		}
	...
	{
		public static readonly ActivityMeta Instance = new ActivityMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.Activity;
