...
{
	public partial class Obligation : Allors.ObjectBase , ExternalAccountingTransaction
	{
		public static readonly ObligationMeta Meta = ObligationMeta.Instance;

		public Obligation(Allors.IStrategy allors) : base(allors) {}

		public static Obligation Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (Obligation) allorsSession.Instantiate(allorsObjectId);		
		}
	...
	public class ObligationMeta
	{
		public static readonly ObligationMeta Instance = new ObligationMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.Obligation;
