...
namespace Allors.Domain
{
	...
	public partial class Phase : Allors.ObjectBase , WorkEffort
	{
		public static readonly PhaseMeta Meta = PhaseMeta.Instance;

		public Phase(Allors.IStrategy allors) : base(allors) {}

		public static Phase Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (Phase) allorsSession.Instantiate(allorsObjectId);		
		}
	...
	{
		public static readonly PhaseMeta Instance = new PhaseMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.Phase;
