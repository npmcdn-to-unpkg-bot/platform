...
{
	public partial class ProfessionalServicesRelationship : Allors.ObjectBase , PartyRelationship
	{
		public static readonly ProfessionalServicesRelationshipMeta Meta = ProfessionalServicesRelationshipMeta.Instance;

		public ProfessionalServicesRelationship(Allors.IStrategy allors) : base(allors) {}
		...
		{ 
			get
			{
				return (Organisation) Strategy.GetCompositeRole(Meta.ProfessionalServicesProvider);
			}
			set
			{
				Strategy.SetCompositeRole(Meta.ProfessionalServicesProvider ,value);
			}
		}
		...
		virtual public bool ExistProfessionalServicesProvider
		{
			get
			{
				return Strategy.ExistCompositeRole(Meta.ProfessionalServicesProvider);
			}
		}

		virtual public void RemoveProfessionalServicesProvider()
		{
			Strategy.RemoveCompositeRole(Meta.ProfessionalServicesProvider);
		}
	...
	public class ProfessionalServicesRelationshipMeta
	{
		public static readonly ProfessionalServicesRelationshipMeta Instance = new ProfessionalServicesRelationshipMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.ProfessionalServicesRelationship;

		public global::Allors.Meta.RoleType Professional 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.ProfessionalServicesRelationshipProfessional;
			}
		} 
		public global::Allors.Meta.RoleType ProfessionalServicesProvider 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.ProfessionalServicesRelationshipProfessionalServicesProvider;
			}
		} 
