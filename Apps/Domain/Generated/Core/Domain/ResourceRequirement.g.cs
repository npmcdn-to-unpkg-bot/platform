...
namespace Allors.Domain
{
	...
	public partial class ResourceRequirement : Allors.ObjectBase , Requirement
	{
		public static readonly ResourceRequirementMeta Meta = ResourceRequirementMeta.Instance;

		public ResourceRequirement(Allors.IStrategy allors) : base(allors) {}

		public static ResourceRequirement Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (ResourceRequirement) allorsSession.Instantiate(allorsObjectId);		
		}




		virtual public global::System.String Duties 
		{
			get
			{
				return (global::System.String) Strategy.GetUnitRole(Meta.Duties);
			}
			set
			{
				Strategy.SetUnitRole(Meta.Duties, value);
			}
		}

		virtual public bool ExistDuties{
			get
			{
				return Strategy.ExistUnitRole(Meta.Duties);
			}
		}

		virtual public void RemoveDuties()
		{
			Strategy.RemoveUnitRole(Meta.Duties);
		}



		virtual public global::System.Decimal NumberOfPositions 
		{
			get
			{
				return (global::System.Decimal) Strategy.GetUnitRole(Meta.NumberOfPositions);
			}
			set
			{
				Strategy.SetUnitRole(Meta.NumberOfPositions, value);
			}
		}

		virtual public bool ExistNumberOfPositions{
			get
			{
				return Strategy.ExistUnitRole(Meta.NumberOfPositions);
			}
		}

		virtual public void RemoveNumberOfPositions()
		{
			Strategy.RemoveUnitRole(Meta.NumberOfPositions);
		}



		virtual public global::System.DateTime RequiredStartDate 
		{
			get
			{
				return (global::System.DateTime) Strategy.GetUnitRole(Meta.RequiredStartDate);
			}
			set
			{
				Strategy.SetUnitRole(Meta.RequiredStartDate, value);
			}
		}

		virtual public bool ExistRequiredStartDate{
			get
			{
				return Strategy.ExistUnitRole(Meta.RequiredStartDate);
			}
		}

		virtual public void RemoveRequiredStartDate()
		{
			Strategy.RemoveUnitRole(Meta.RequiredStartDate);
		}


		virtual public global::Allors.Extent<NeededSkill> NeededSkills
		{ 
			get
			{
				return Strategy.GetCompositeRoles(Meta.NeededSkill);
			}
			set
			{
				Strategy.SetCompositeRoles(Meta.NeededSkill, value);
			}
		}

		virtual public void AddNeededSkill (NeededSkill value)
		{
			Strategy.AddCompositeRole(Meta.NeededSkill, value);
		}

		virtual public void RemoveNeededSkill (NeededSkill value)
		{
			Strategy.RemoveCompositeRole(Meta.NeededSkill,value);
		}

		virtual public bool ExistNeededSkills
		{
			get
			{
				return Strategy.ExistCompositeRoles(Meta.NeededSkill);
			}
		}

		virtual public void RemoveNeededSkills()
		{
			Strategy.RemoveCompositeRoles(Meta.NeededSkill);
		}



		virtual public global::System.DateTime RequiredEndDate 
		{
			get
			{
				return (global::System.DateTime) Strategy.GetUnitRole(Meta.RequiredEndDate);
			}
			set
			{
				Strategy.SetUnitRole(Meta.RequiredEndDate, value);
			}
		}

		virtual public bool ExistRequiredEndDate{
			get
			{
				return Strategy.ExistUnitRole(Meta.RequiredEndDate);
			}
		}

		virtual public void RemoveRequiredEndDate()
		{
			Strategy.RemoveUnitRole(Meta.RequiredEndDate);
		}
	...
	public class ResourceRequirementMeta
	{
		public static readonly ResourceRequirementMeta Instance = new ResourceRequirementMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.ResourceRequirement;

		public global::Allors.Meta.RoleType Duties 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.ResourceRequirementDuties;
			}
		} 
		public global::Allors.Meta.RoleType NumberOfPositions 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.ResourceRequirementNumberOfPositions;
			}
		} 
		public global::Allors.Meta.RoleType RequiredStartDate 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.ResourceRequirementRequiredStartDate;
			}
		} 
		public global::Allors.Meta.RoleType NeededSkill 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.ResourceRequirementNeededSkill;
			}
		} 
		public global::Allors.Meta.RoleType RequiredEndDate 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.ResourceRequirementRequiredEndDate;
			}
		} 
