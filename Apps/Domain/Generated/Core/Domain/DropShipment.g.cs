...
namespace Allors.Domain
{
	...
	public partial class DropShipment : Allors.ObjectBase , Shipment
	{
		public static readonly DropShipmentMeta Meta = DropShipmentMeta.Instance;

		public DropShipment(Allors.IStrategy allors) : base(allors) {}

		public static DropShipment Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (DropShipment) allorsSession.Instantiate(allorsObjectId);		
		}



		virtual public global::Allors.Extent<DropShipmentStatus> ShipmentStatuses
		{ 
			get
			{
		...
		virtual public void AddShipmentStatus (DropShipmentStatus value)
		{
			Strategy.AddCompositeRole(Meta.ShipmentStatus, value);
		}

		virtual public void RemoveShipmentStatus (DropShipmentStatus value)
		{
		...
		virtual public DropShipmentStatus CurrentShipmentStatus
		{ 
			get
			{
				return (DropShipmentStatus) Strategy.GetCompositeRole(Meta.CurrentShipmentStatus);
			}
			set
			{
		...
		virtual public DropShipmentObjectState PreviousObjectState
		{ 
			get
			{
				return (DropShipmentObjectState) Strategy.GetCompositeRole(Meta.PreviousObjectState);
			}
			set
			{
		...
		virtual public DropShipmentObjectState CurrentObjectState
		{ 
			get
			{
				return (DropShipmentObjectState) Strategy.GetCompositeRole(Meta.CurrentObjectState);
			}
			set
			{
	...
	public class DropShipmentMeta
	{
		public static readonly DropShipmentMeta Instance = new DropShipmentMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.DropShipment;

		public global::Allors.Meta.RoleType ShipmentStatus 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.DropShipmentShipmentStatus;
			}
		} 
		public global::Allors.Meta.RoleType CurrentShipmentStatus 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.DropShipmentCurrentShipmentStatus;
			}
		} 
		public global::Allors.Meta.RoleType PreviousObjectState 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.DropShipmentPreviousObjectState;
			}
		} 
		public global::Allors.Meta.RoleType CurrentObjectState 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.DropShipmentCurrentObjectState;
			}
		} 
