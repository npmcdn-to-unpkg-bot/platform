...
{
	public partial class Equipment : Allors.ObjectBase , FixedAsset
	{
		public static readonly EquipmentMeta Meta = EquipmentMeta.Instance;

		public Equipment(Allors.IStrategy allors) : base(allors) {}

		public static Equipment Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (Equipment) allorsSession.Instantiate(allorsObjectId);		
		}
	...
	{
		public static readonly EquipmentMeta Instance = new EquipmentMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.Equipment;
