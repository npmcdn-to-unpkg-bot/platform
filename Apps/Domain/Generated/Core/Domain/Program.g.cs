...
namespace Allors.Domain
{
	...
	public partial class Program : Allors.ObjectBase , WorkEffort
	{
		public static readonly ProgramMeta Meta = ProgramMeta.Instance;

		public Program(Allors.IStrategy allors) : base(allors) {}

		public static Program Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (Program) allorsSession.Instantiate(allorsObjectId);		
		}
	...
	{
		public static readonly ProgramMeta Instance = new ProgramMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.Program;
