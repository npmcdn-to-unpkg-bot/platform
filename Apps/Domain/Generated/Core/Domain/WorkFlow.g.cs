...
namespace Allors.Domain
{
	...
	public partial class WorkFlow : Allors.ObjectBase , WorkEffort
	{
		public static readonly WorkFlowMeta Meta = WorkFlowMeta.Instance;

		public WorkFlow(Allors.IStrategy allors) : base(allors) {}

		public static WorkFlow Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (WorkFlow) allorsSession.Instantiate(allorsObjectId);		
		}
	...
	{
		public static readonly WorkFlowMeta Instance = new WorkFlowMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.WorkFlow;
