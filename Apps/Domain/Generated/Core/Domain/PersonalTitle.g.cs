...
{
	public partial class PersonalTitle : Allors.ObjectBase , Enumeration
	{
		public static readonly PersonalTitleMeta Meta = PersonalTitleMeta.Instance;

		public PersonalTitle(Allors.IStrategy allors) : base(allors) {}
		...
		virtual public global::Allors.Extent<Person> PersonsWhereTitle
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PersonsWhereTitle);
			}
		}

		virtual public bool ExistPersonsWhereTitle
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PersonsWhereTitle);
			}
		}

	}

	public class PersonalTitleMeta
	{
		public static readonly PersonalTitleMeta Instance = new PersonalTitleMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.PersonalTitle;
		...
		public global::Allors.Meta.AssociationType PersonsWhereTitle 
		{
			get
			{
				return global::Allors.Meta.AssociationTypes.PersonTitle;
			}
		} 
