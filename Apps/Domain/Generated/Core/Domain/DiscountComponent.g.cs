...
namespace Allors.Domain
{
	...
	public partial class DiscountComponent : Allors.ObjectBase , PriceComponent
	{
		public static readonly DiscountComponentMeta Meta = DiscountComponentMeta.Instance;

		public DiscountComponent(Allors.IStrategy allors) : base(allors) {}

		public static DiscountComponent Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (DiscountComponent) allorsSession.Instantiate(allorsObjectId);		
		}
	...
	public class DiscountComponentMeta
	{
		public static readonly DiscountComponentMeta Instance = new DiscountComponentMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.DiscountComponent;

		public global::Allors.Meta.RoleType Percentage 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.DiscountComponentPercentage;
			}
		} 
