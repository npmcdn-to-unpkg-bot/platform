...
namespace Allors.Domain
{
	...
	public partial class TaxDocument : Allors.ObjectBase , Document
	{
		public static readonly TaxDocumentMeta Meta = TaxDocumentMeta.Instance;

		public TaxDocument(Allors.IStrategy allors) : base(allors) {}

		public static TaxDocument Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (TaxDocument) allorsSession.Instantiate(allorsObjectId);		
		}
	...
	public class TaxDocumentMeta
	{
		public static readonly TaxDocumentMeta Instance = new TaxDocumentMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.TaxDocument;
