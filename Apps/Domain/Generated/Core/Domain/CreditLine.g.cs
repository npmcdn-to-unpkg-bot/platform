...
namespace Allors.Domain
{
	...
	public partial class CreditLine : Allors.ObjectBase , ExternalAccountingTransaction
	{
		public static readonly CreditLineMeta Meta = CreditLineMeta.Instance;

		public CreditLine(Allors.IStrategy allors) : base(allors) {}

		public static CreditLine Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (CreditLine) allorsSession.Instantiate(allorsObjectId);		
		}
	...
	public class CreditLineMeta
	{
		public static readonly CreditLineMeta Instance = new CreditLineMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.CreditLine;
