...
{
	public partial class Project : Allors.ObjectBase , WorkEffort
	{
		public static readonly ProjectMeta Meta = ProjectMeta.Instance;

		public Project(Allors.IStrategy allors) : base(allors) {}

		public static Project Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (Project) allorsSession.Instantiate(allorsObjectId);		
		}
	...
	{
		public static readonly ProjectMeta Instance = new ProjectMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.Project;
