...
namespace Allors.Domain
{
	...
	public partial class Note : Allors.ObjectBase , ExternalAccountingTransaction
	{
		public static readonly NoteMeta Meta = NoteMeta.Instance;

		public Note(Allors.IStrategy allors) : base(allors) {}

		public static Note Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (Note) allorsSession.Instantiate(allorsObjectId);		
		}
	...
	{
		public static readonly NoteMeta Instance = new NoteMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.Note;
