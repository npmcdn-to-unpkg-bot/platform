...
{
	public partial class Manifest : Allors.ObjectBase , Document
	{
		public static readonly ManifestMeta Meta = ManifestMeta.Instance;

		public Manifest(Allors.IStrategy allors) : base(allors) {}

		public static Manifest Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (Manifest) allorsSession.Instantiate(allorsObjectId);		
		}
	...
	{
		public static readonly ManifestMeta Instance = new ManifestMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.Manifest;
