...
namespace Allors.Domain
{
	public partial class Role : Allors.ObjectBase , UserInterfaceable, UniquelyIdentifiable
	{
		...
		virtual public global::Allors.Extent<InternalOrganisation> InternalOrganisationsWhereEmployeeRole
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.InternalOrganisationsWhereEmployeeRole);
			}
		}

		virtual public bool ExistInternalOrganisationsWhereEmployeeRole
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.InternalOrganisationsWhereEmployeeRole);
			}
		}
	...
	public class RoleMeta
	{
		...
		public global::Allors.Meta.AssociationType InternalOrganisationsWhereEmployeeRole 
		{
			get
			{
				return global::Allors.Meta.AssociationTypes.InternalOrganisationEmployeeRole;
			}
		} 
