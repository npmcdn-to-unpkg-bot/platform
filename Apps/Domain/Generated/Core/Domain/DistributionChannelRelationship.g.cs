...
namespace Allors.Domain
{
	...
	public partial class DistributionChannelRelationship : Allors.ObjectBase , PartyRelationship
	{
		public static readonly DistributionChannelRelationshipMeta Meta = DistributionChannelRelationshipMeta.Instance;

		public DistributionChannelRelationship(Allors.IStrategy allors) : base(allors) {}

		public static DistributionChannelRelationship Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (DistributionChannelRelationship) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public Organisation Distributor
		{ 
			get
			{
				return (Organisation) Strategy.GetCompositeRole(Meta.Distributor);
			}
			set
			{
				Strategy.SetCompositeRole(Meta.Distributor ,value);
			}
		}

		virtual public bool ExistDistributor
		{
			get
			{
				return Strategy.ExistCompositeRole(Meta.Distributor);
			}
		}

		virtual public void RemoveDistributor()
		{
			Strategy.RemoveCompositeRole(Meta.Distributor);
		}
	...
	public class DistributionChannelRelationshipMeta
	{
		public static readonly DistributionChannelRelationshipMeta Instance = new DistributionChannelRelationshipMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.DistributionChannelRelationship;

		public global::Allors.Meta.RoleType InternalOrganisation 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.DistributionChannelRelationshipInternalOrganisation;
			}
		} 
		public global::Allors.Meta.RoleType Distributor 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.DistributionChannelRelationshipDistributor;
			}
		} 
