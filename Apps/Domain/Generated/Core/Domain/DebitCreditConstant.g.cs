...
{
	public partial class DebitCreditConstant : Allors.ObjectBase , UniquelyIdentifiable, Enumeration
	{
		public static readonly DebitCreditConstantMeta Meta = DebitCreditConstantMeta.Instance;

		public DebitCreditConstant(Allors.IStrategy allors) : base(allors) {}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.GeneralLedgerAccountsWhereSide);
			}
		}
		...
		virtual public bool ExistGeneralLedgerAccountsWhereSide
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.GeneralLedgerAccountsWhereSide);
			}
		}


		virtual public global::Allors.Extent<AmountDue> AmountsDueWhereSide
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.AmountsDueWhereSide);
			}
		}

		virtual public bool ExistAmountsDueWhereSide
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.AmountsDueWhereSide);
			}
		}

	}

	public class DebitCreditConstantMeta
	{
		public static readonly DebitCreditConstantMeta Instance = new DebitCreditConstantMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.DebitCreditConstant;
		...
		public global::Allors.Meta.AssociationType GeneralLedgerAccountsWhereSide 
		{
			get
			{
				return global::Allors.Meta.AssociationTypes.GeneralLedgerAccountSide;
			}
		} 
		public global::Allors.Meta.AssociationType AmountsDueWhereSide 
		{
			get
			{
				return global::Allors.Meta.AssociationTypes.AmountDueSide;
			}
		} 
