...
{
	public partial class VatTariff : Allors.ObjectBase , Enumeration
	{
		public static readonly VatTariffMeta Meta = VatTariffMeta.Instance;

		public VatTariff(Allors.IStrategy allors) : base(allors) {}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.VatRatesWhereVatTariff);
			}
		}
		...
		virtual public bool ExistVatRatesWhereVatTariff
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.VatRatesWhereVatTariff);
			}
		}

	}

	public class VatTariffMeta
	{
		public static readonly VatTariffMeta Instance = new VatTariffMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.VatTariff;
		...
		public global::Allors.Meta.AssociationType VatRatesWhereVatTariff 
		{
			get
			{
				return global::Allors.Meta.AssociationTypes.VatRateVatTariff;
			}
		} 
