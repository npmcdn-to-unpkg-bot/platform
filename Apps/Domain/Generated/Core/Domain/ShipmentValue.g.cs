...
namespace Allors.Domain
{
	...
	public partial class ShipmentValue : Allors.ObjectBase , UserInterfaceable
	{
		public static readonly ShipmentValueMeta Meta = ShipmentValueMeta.Instance;

		public ShipmentValue(Allors.IStrategy allors) : base(allors) {}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.ShippingAndHandlingComponentsWhereShipmentValue);
			}
		}
		...
		virtual public bool ExistShippingAndHandlingComponentsWhereShipmentValue
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.ShippingAndHandlingComponentsWhereShipmentValue);
			}
		}

	}

	public class ShipmentValueMeta
	{
		public static readonly ShipmentValueMeta Instance = new ShipmentValueMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.ShipmentValue;

		public global::Allors.Meta.RoleType ThroughAmount 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.ShipmentValueThroughAmount;
			}
		} 
		public global::Allors.Meta.RoleType FromAmount 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.ShipmentValueFromAmount;
			}
		} 
		...
		public global::Allors.Meta.AssociationType ShippingAndHandlingComponentsWhereShipmentValue 
		{
			get
			{
				return global::Allors.Meta.AssociationTypes.ShippingAndHandlingComponentShipmentValue;
			}
		} 
