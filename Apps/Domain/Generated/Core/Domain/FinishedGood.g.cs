...
{
	public partial class FinishedGood : Allors.ObjectBase , Part
	{
		public static readonly FinishedGoodMeta Meta = FinishedGoodMeta.Instance;

		public FinishedGood(Allors.IStrategy allors) : base(allors) {}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.GoodsWhereFinishedGood);
			}
		}
		...
		virtual public bool ExistGoodsWhereFinishedGood
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.GoodsWhereFinishedGood);
			}
		}
	...
	public class FinishedGoodMeta
	{
		public static readonly FinishedGoodMeta Instance = new FinishedGoodMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.FinishedGood;
		...
		public global::Allors.Meta.AssociationType GoodsWhereFinishedGood 
		{
			get
			{
				return global::Allors.Meta.AssociationTypes.GoodFinishedGood;
			}
		} 
