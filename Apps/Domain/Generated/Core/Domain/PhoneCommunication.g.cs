...
namespace Allors.Domain
{
	...
	public partial class PhoneCommunication : Allors.ObjectBase , CommunicationEvent
	{
		public static readonly PhoneCommunicationMeta Meta = PhoneCommunicationMeta.Instance;

		public PhoneCommunication(Allors.IStrategy allors) : base(allors) {}
		...
		virtual public global::Allors.Extent<Person> Receivers
		{ 
			get
			{
		...
		virtual public void AddReceiver (Person value)
		{
			Strategy.AddCompositeRole(Meta.Receiver, value);
		}

		virtual public void RemoveReceiver (Person value)
		{
		...
		virtual public Person Caller
		{ 
			get
			{
				return (Person) Strategy.GetCompositeRole(Meta.Caller);
			}
			set
			{
				Strategy.SetCompositeRole(Meta.Caller ,value);
			}
		}

		virtual public bool ExistCaller
		{
			get
			{
				return Strategy.ExistCompositeRole(Meta.Caller);
			}
		}

		virtual public void RemoveCaller()
		{
			Strategy.RemoveCompositeRole(Meta.Caller);
		}
	...
	public class PhoneCommunicationMeta
	{
		public static readonly PhoneCommunicationMeta Instance = new PhoneCommunicationMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.PhoneCommunication;

		public global::Allors.Meta.RoleType Receiver 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.PhoneCommunicationReceiver;
			}
		} 
		public global::Allors.Meta.RoleType Caller 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.PhoneCommunicationCaller;
			}
		} 
