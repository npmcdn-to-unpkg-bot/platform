...
namespace Allors.Domain
{
	...
	public partial class Dimension : Allors.ObjectBase , ProductFeature
	{
		public static readonly DimensionMeta Meta = DimensionMeta.Instance;

		public Dimension(Allors.IStrategy allors) : base(allors) {}

		public static Dimension Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (Dimension) allorsSession.Instantiate(allorsObjectId);		
		}




		virtual public global::System.Decimal? Unit 
		{
			get
			{
				return (global::System.Decimal?) Strategy.GetUnitRole(Meta.Unit);
			}
			set
			{
				Strategy.SetUnitRole(Meta.Unit, value);
			}
		}

		virtual public bool ExistUnit{
			get
			{
				return Strategy.ExistUnitRole(Meta.Unit);
			}
		}

		virtual public void RemoveUnit()
		{
			Strategy.RemoveUnitRole(Meta.Unit);
		}
	...
	{
		public static readonly DimensionMeta Instance = new DimensionMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.Dimension;

		public global::Allors.Meta.RoleType Unit 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.DimensionUnit;
			}
		} 
		public global::Allors.Meta.RoleType UnitOfMeasure 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.DimensionUnitOfMeasure;
			}
		} 
