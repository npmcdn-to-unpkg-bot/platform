...
{
	public partial class ClientAgreement : Allors.ObjectBase , Agreement
	{
		public static readonly ClientAgreementMeta Meta = ClientAgreementMeta.Instance;

		public ClientAgreement(Allors.IStrategy allors) : base(allors) {}

		public static ClientAgreement Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (ClientAgreement) allorsSession.Instantiate(allorsObjectId);		
		}
	...
	public class ClientAgreementMeta
	{
		public static readonly ClientAgreementMeta Instance = new ClientAgreementMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.ClientAgreement;
