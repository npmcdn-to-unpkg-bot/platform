...
namespace Allors.Domain
{
	...
	public partial class AccountingPeriod : Allors.ObjectBase , Budget, UserInterfaceable
	{
		public static readonly AccountingPeriodMeta Meta = AccountingPeriodMeta.Instance;

		public AccountingPeriod(Allors.IStrategy allors) : base(allors) {}
		...
		{ 
			get
			{
				return (AccountingPeriod) Strategy.GetCompositeRole(Meta.Parent);
			}
			set
			{
		...
		virtual public global::System.Int32 PeriodNumber 
		{
			get
			{
				return (global::System.Int32) Strategy.GetUnitRole(Meta.PeriodNumber);
			}
			set
			{
				Strategy.SetUnitRole(Meta.PeriodNumber, value);
			}
		}
		...
		virtual public bool ExistPeriodNumber{
			get
			{
				return Strategy.ExistUnitRole(Meta.PeriodNumber);
			}
		}

		virtual public void RemovePeriodNumber()
		{
			Strategy.RemoveUnitRole(Meta.PeriodNumber);
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.OrganisationGlAccountBalancesWhereAccountingPeriod);
			}
		}
		...
		virtual public bool ExistOrganisationGlAccountBalancesWhereAccountingPeriod
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.OrganisationGlAccountBalancesWhereAccountingPeriod);
			}
		}
		...
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.AccountingPeriodsWhereParent);
			}
		}
		...
		virtual public bool ExistAccountingPeriodsWhereParent
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.AccountingPeriodsWhereParent);
			}
		}
		...
		{ 
			get
			{
				return (InternalOrganisation) Strategy.GetCompositeAssociation(Meta.InternalOrganisationWhereActualAccountingPeriod);
			}
		} 
		...
		virtual public bool ExistInternalOrganisationWhereActualAccountingPeriod
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.InternalOrganisationWhereActualAccountingPeriod);
			}
		}


		virtual public InternalOrganisation InternalOrganisationWhereAccountingPeriod
		{ 
			get
			{
				return (InternalOrganisation) Strategy.GetCompositeAssociation(Meta.InternalOrganisationWhereAccountingPeriod);
			}
		} 

		virtual public bool ExistInternalOrganisationWhereAccountingPeriod
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.InternalOrganisationWhereAccountingPeriod);
			}
		}

	}

	public class AccountingPeriodMeta
	{
		public static readonly AccountingPeriodMeta Instance = new AccountingPeriodMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.AccountingPeriod;

		public global::Allors.Meta.RoleType Parent 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.AccountingPeriodParent;
			}
		} 
		public global::Allors.Meta.RoleType Active 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.AccountingPeriodActive;
			}
		} 
		public global::Allors.Meta.RoleType PeriodNumber 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.AccountingPeriodPeriodNumber;
			}
		} 
		public global::Allors.Meta.RoleType TimeFrequency 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.AccountingPeriodTimeFrequency;
			}
		} 
		...
		public global::Allors.Meta.AssociationType OrganisationGlAccountBalancesWhereAccountingPeriod 
		{
			get
			{
				return global::Allors.Meta.AssociationTypes.OrganisationGlAccountBalanceAccountingPeriod;
			}
		} 
		public global::Allors.Meta.AssociationType AccountingPeriodsWhereParent 
		{
			get
			{
				return global::Allors.Meta.AssociationTypes.AccountingPeriodParent;
			}
		} 
		public global::Allors.Meta.AssociationType InternalOrganisationWhereActualAccountingPeriod 
		{
			get
			{
				return global::Allors.Meta.AssociationTypes.InternalOrganisationActualAccountingPeriod;
			}
		} 
		public global::Allors.Meta.AssociationType InternalOrganisationWhereAccountingPeriod 
		{
			get
			{
				return global::Allors.Meta.AssociationTypes.InternalOrganisationAccountingPeriod;
			}
		} 
