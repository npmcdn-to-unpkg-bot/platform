...
namespace Allors.Domain
{
	...
	public partial class CustomerReturn : Allors.ObjectBase , Shipment
	{
		public static readonly CustomerReturnMeta Meta = CustomerReturnMeta.Instance;

		public CustomerReturn(Allors.IStrategy allors) : base(allors) {}

		public static CustomerReturn Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (CustomerReturn) allorsSession.Instantiate(allorsObjectId);		
		}



		virtual public CustomerReturnStatus CurrentShipmentStatus
		{ 
			get
			{
				return (CustomerReturnStatus) Strategy.GetCompositeRole(Meta.CurrentShipmentStatus);
			}
			set
			{
		...
		virtual public CustomerReturnObjectState PreviousObjectState
		{ 
			get
			{
				return (CustomerReturnObjectState) Strategy.GetCompositeRole(Meta.PreviousObjectState);
			}
			set
			{
		...
		virtual public global::Allors.Extent<CustomerReturnStatus> ShipmentStatuses
		{ 
			get
			{
		...
		virtual public void AddShipmentStatus (CustomerReturnStatus value)
		{
			Strategy.AddCompositeRole(Meta.ShipmentStatus, value);
		}

		virtual public void RemoveShipmentStatus (CustomerReturnStatus value)
		{
		...
		virtual public CustomerReturnObjectState CurrentObjectState
		{ 
			get
			{
				return (CustomerReturnObjectState) Strategy.GetCompositeRole(Meta.CurrentObjectState);
			}
			set
			{
	...
	public class CustomerReturnMeta
	{
		public static readonly CustomerReturnMeta Instance = new CustomerReturnMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.CustomerReturn;

		public global::Allors.Meta.RoleType CurrentShipmentStatus 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.CustomerReturnCurrentShipmentStatus;
			}
		} 
		public global::Allors.Meta.RoleType PreviousObjectState 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.CustomerReturnPreviousObjectState;
			}
		} 
		public global::Allors.Meta.RoleType ShipmentStatus 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.CustomerReturnShipmentStatus;
			}
		} 
		public global::Allors.Meta.RoleType CurrentObjectState 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.CustomerReturnCurrentObjectState;
			}
		} 
