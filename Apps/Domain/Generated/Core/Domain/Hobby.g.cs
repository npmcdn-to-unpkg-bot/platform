...
{
	public partial class Hobby : Allors.ObjectBase , Enumeration
	{
		public static readonly HobbyMeta Meta = HobbyMeta.Instance;

		public Hobby(Allors.IStrategy allors) : base(allors) {}

		public static Hobby Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (Hobby) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public global::Allors.Extent<Person> PersonsWhereHobby
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.PersonsWhereHobby);
			}
		}

		virtual public bool ExistPersonsWhereHobby
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.PersonsWhereHobby);
			}
		}

	}

	public class HobbyMeta
	{
		public static readonly HobbyMeta Instance = new HobbyMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.Hobby;
		...
		public global::Allors.Meta.AssociationType PersonsWhereHobby 
		{
			get
			{
				return global::Allors.Meta.AssociationTypes.PersonHobby;
			}
		} 
