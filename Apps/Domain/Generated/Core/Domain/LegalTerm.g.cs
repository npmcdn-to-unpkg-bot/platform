...
{
	public partial class LegalTerm : Allors.ObjectBase , AgreementTerm
	{
		public static readonly LegalTermMeta Meta = LegalTermMeta.Instance;

		public LegalTerm(Allors.IStrategy allors) : base(allors) {}

		public static LegalTerm Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (LegalTerm) allorsSession.Instantiate(allorsObjectId);		
		}
	...
	public class LegalTermMeta
	{
		public static readonly LegalTermMeta Instance = new LegalTermMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.LegalTerm;
