...
namespace Allors.Domain
{
	...
	public partial class InvoiceTerm : Allors.ObjectBase , UserInterfaceable, AgreementTerm
	{
		public static readonly InvoiceTermMeta Meta = InvoiceTermMeta.Instance;

		public InvoiceTerm(Allors.IStrategy allors) : base(allors) {}
		...
		{ 
			get
			{
				return (Invoice) Strategy.GetCompositeAssociation(Meta.InvoiceWhereInvoiceTerm);
			}
		} 
		...
		virtual public bool ExistInvoiceWhereInvoiceTerm
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.InvoiceWhereInvoiceTerm);
			}
		}
	...
	public class InvoiceTermMeta
	{
		public static readonly InvoiceTermMeta Instance = new InvoiceTermMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.InvoiceTerm;
		...
		public global::Allors.Meta.AssociationType InvoiceWhereInvoiceTerm 
		{
			get
			{
				return global::Allors.Meta.AssociationTypes.InvoiceInvoiceTerm;
			}
		} 
