...
{
	public partial class Model : Allors.ObjectBase , ProductFeature, Enumeration
	{
		public static readonly ModelMeta Meta = ModelMeta.Instance;

		public Model(Allors.IStrategy allors) : base(allors) {}

		public static Model Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (Model) allorsSession.Instantiate(allorsObjectId);		
		}
	...
	{
		public static readonly ModelMeta Instance = new ModelMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.Model;
