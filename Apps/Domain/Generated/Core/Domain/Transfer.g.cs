...
namespace Allors.Domain
{
	...
	public partial class Transfer : Allors.ObjectBase , Shipment
	{
		public static readonly TransferMeta Meta = TransferMeta.Instance;

		public Transfer(Allors.IStrategy allors) : base(allors) {}

		public static Transfer Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (Transfer) allorsSession.Instantiate(allorsObjectId);		
		}



		virtual public TransferObjectState PreviousObjectState
		{ 
			get
			{
				return (TransferObjectState) Strategy.GetCompositeRole(Meta.PreviousObjectState);
			}
			set
			{
		...
		virtual public TransferObjectState CurrentObjectState
		{ 
			get
			{
				return (TransferObjectState) Strategy.GetCompositeRole(Meta.CurrentObjectState);
			}
			set
			{
		...
		virtual public TransferStatus CurrentShipmentStatus
		{ 
			get
			{
				return (TransferStatus) Strategy.GetCompositeRole(Meta.CurrentShipmentStatus);
			}
			set
			{
		...
		virtual public global::Allors.Extent<TransferStatus> ShipmentStatuses
		{ 
			get
			{
		...
		virtual public void AddShipmentStatus (TransferStatus value)
		{
			Strategy.AddCompositeRole(Meta.ShipmentStatus, value);
		}

		virtual public void RemoveShipmentStatus (TransferStatus value)
		{
	...
	{
		public static readonly TransferMeta Instance = new TransferMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.Transfer;

		public global::Allors.Meta.RoleType PreviousObjectState 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.TransferPreviousObjectState;
			}
		} 
		public global::Allors.Meta.RoleType CurrentObjectState 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.TransferCurrentObjectState;
			}
		} 
		public global::Allors.Meta.RoleType CurrentShipmentStatus 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.TransferCurrentShipmentStatus;
			}
		} 
		public global::Allors.Meta.RoleType ShipmentStatus 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.TransferShipmentStatus;
			}
		} 
