...
namespace Allors.Domain
{
	...
	public partial class ClientRelationship : Allors.ObjectBase , PartyRelationship
	{
		public static readonly ClientRelationshipMeta Meta = ClientRelationshipMeta.Instance;

		public ClientRelationship(Allors.IStrategy allors) : base(allors) {}

		public static ClientRelationship Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (ClientRelationship) allorsSession.Instantiate(allorsObjectId);		
		}



		virtual public Party Client
		{ 
			get
			{
				return (Party) Strategy.GetCompositeRole(Meta.Client);
			}
			set
			{
				Strategy.SetCompositeRole(Meta.Client ,value);
			}
		}

		virtual public bool ExistClient
		{
			get
			{
				return Strategy.ExistCompositeRole(Meta.Client);
			}
		}

		virtual public void RemoveClient()
		{
			Strategy.RemoveCompositeRole(Meta.Client);
		}
	...
	public class ClientRelationshipMeta
	{
		public static readonly ClientRelationshipMeta Instance = new ClientRelationshipMeta();

		public global::Allors.Meta.Class ObjectType = global::Allors.Meta.Classes.ClientRelationship;

		public global::Allors.Meta.RoleType Client 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.ClientRelationshipClient;
			}
		} 
		public global::Allors.Meta.RoleType InternalOrganisation 
		{
			get
			{
				return global::Allors.Meta.RoleTypes.ClientRelationshipInternalOrganisation;
			}
		} 
