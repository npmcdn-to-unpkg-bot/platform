...
namespace Allors.Domain
{
	...
	{		
		...
		{
			var builder = (WorkFlowBuilder)objectBuilder;
	...
	public partial class WorkFlowBuilder : Allors.ObjectBuilder<WorkFlow> , WorkEffortBuilder, global::System.IDisposable
	{		
		public WorkFlowBuilder(Allors.ISession session) : base(session)
	    {
	    }
				...
				/// <exclude/>
				public WorkFlowBuilder WithCurrentWorkEffortStatus(WorkEffortStatus value)
		        {
				...
				/// <exclude/>
				public WorkFlowBuilder WithPrecendency(WorkEffort value)
		        {
				...
				/// <exclude/>
				public WorkFlowBuilder WithFacility(Facility value)
		        {
				...
				/// <exclude/>
				public WorkFlowBuilder WithDeliverableProduced(Deliverable value)
		        {
				...
				/// <exclude/>
				public WorkFlowBuilder WithInventoryItemNeeded(WorkEffortInventoryAssignment value)
		        {
				...
				/// <exclude/>
				public WorkFlowBuilder WithChild(WorkEffort value)
		        {
				...
				/// <exclude/>
				public WorkFlowBuilder WithOrderItemFulfillment(OrderItem value)
		        {
				...
				/// <exclude/>
				public WorkFlowBuilder WithWorkEffortStatus(WorkEffortStatus value)
		        {
				...
				/// <exclude/>
				public WorkFlowBuilder WithWorkEffortType(WorkEffortType value)
		        {
				...
				/// <exclude/>
				public WorkFlowBuilder WithInventoryItemProduced(InventoryItem value)
		        {
				...
				/// <exclude/>
				public WorkFlowBuilder WithRequirementFulfillment(Requirement value)
		        {
				...
				/// <exclude/>
				public WorkFlowBuilder WithSpecialTerms(global::System.String value)
		        {
				...
				/// <exclude/>
				public WorkFlowBuilder WithConcurrency(WorkEffort value)
		        {
				...
				/// <exclude/>
				public WorkFlowBuilder WithActualHours(global::System.Decimal? value)
		        {
				...
				/// <exclude/>
				public WorkFlowBuilder WithDescription(global::System.String value)
		        {
				...
				/// <exclude/>
				public WorkFlowBuilder WithPreviousObjectState(WorkEffortObjectState value)
		        {
				...
				/// <exclude/>
				public WorkFlowBuilder WithCurrentObjectState(WorkEffortObjectState value)
		        {
				...
				/// <exclude/>
				public WorkFlowBuilder WithEstimatedHours(global::System.Decimal? value)
		        {
				...
				/// <exclude/>
				public WorkFlowBuilder WithSearchData(SearchData value)
		        {
				...
				/// <exclude/>
				public WorkFlowBuilder WithDisplayName(global::System.String value)
		        {
				...
				/// <exclude/>
				public WorkFlowBuilder WithDeniedPermission(Permission value)
		        {
				...
				/// <exclude/>
				public WorkFlowBuilder WithSecurityToken(SecurityToken value)
		        {
				...
				/// <exclude/>
				public WorkFlowBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class WorkFlows : global::Allors.ObjectsBase<WorkFlow>
	{
		public static readonly WorkFlowMeta Meta = WorkFlowMeta.Instance;

		public WorkFlows(Allors.ISession session) : base(session)
		{
		}
