...
namespace Allors.Domain
{
	...
	{		
		...
		{
			var builder = (PhaseBuilder)objectBuilder;
	...
	public partial class PhaseBuilder : Allors.ObjectBuilder<Phase> , WorkEffortBuilder, global::System.IDisposable
	{		
		public PhaseBuilder(Allors.ISession session) : base(session)
	    {
	    }
				...
				/// <exclude/>
				public PhaseBuilder WithCurrentWorkEffortStatus(WorkEffortStatus value)
		        {
				...
				/// <exclude/>
				public PhaseBuilder WithPrecendency(WorkEffort value)
		        {
				...
				/// <exclude/>
				public PhaseBuilder WithFacility(Facility value)
		        {
				...
				/// <exclude/>
				public PhaseBuilder WithDeliverableProduced(Deliverable value)
		        {
				...
				/// <exclude/>
				public PhaseBuilder WithInventoryItemNeeded(WorkEffortInventoryAssignment value)
		        {
				...
				/// <exclude/>
				public PhaseBuilder WithChild(WorkEffort value)
		        {
				...
				/// <exclude/>
				public PhaseBuilder WithOrderItemFulfillment(OrderItem value)
		        {
				...
				/// <exclude/>
				public PhaseBuilder WithWorkEffortStatus(WorkEffortStatus value)
		        {
				...
				/// <exclude/>
				public PhaseBuilder WithWorkEffortType(WorkEffortType value)
		        {
				...
				/// <exclude/>
				public PhaseBuilder WithInventoryItemProduced(InventoryItem value)
		        {
				...
				/// <exclude/>
				public PhaseBuilder WithRequirementFulfillment(Requirement value)
		        {
				...
				/// <exclude/>
				public PhaseBuilder WithSpecialTerms(global::System.String value)
		        {
				...
				/// <exclude/>
				public PhaseBuilder WithConcurrency(WorkEffort value)
		        {
				...
				/// <exclude/>
				public PhaseBuilder WithActualHours(global::System.Decimal? value)
		        {
				...
				/// <exclude/>
				public PhaseBuilder WithDescription(global::System.String value)
		        {
				...
				/// <exclude/>
				public PhaseBuilder WithPreviousObjectState(WorkEffortObjectState value)
		        {
				...
				/// <exclude/>
				public PhaseBuilder WithCurrentObjectState(WorkEffortObjectState value)
		        {
				...
				/// <exclude/>
				public PhaseBuilder WithEstimatedHours(global::System.Decimal? value)
		        {
				...
				/// <exclude/>
				public PhaseBuilder WithSearchData(SearchData value)
		        {
				...
				/// <exclude/>
				public PhaseBuilder WithDisplayName(global::System.String value)
		        {
				...
				/// <exclude/>
				public PhaseBuilder WithDeniedPermission(Permission value)
		        {
				...
				/// <exclude/>
				public PhaseBuilder WithSecurityToken(SecurityToken value)
		        {
				...
				/// <exclude/>
				public PhaseBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class Phases : global::Allors.ObjectsBase<Phase>
	{
		public static readonly PhaseMeta Meta = PhaseMeta.Instance;

		public Phases(Allors.ISession session) : base(session)
		{
		}
