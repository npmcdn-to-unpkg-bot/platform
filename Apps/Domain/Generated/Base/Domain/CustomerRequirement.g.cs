...
namespace Allors.Domain
{
	...
	{		
		...
		{
			var builder = (CustomerRequirementBuilder)objectBuilder;
	...
	public partial class CustomerRequirementBuilder : Allors.ObjectBuilder<CustomerRequirement> , RequirementBuilder, global::System.IDisposable
	{		
		public CustomerRequirementBuilder(Allors.ISession session) : base(session)
	    {
	    }
				...
				/// <exclude/>
				public CustomerRequirementBuilder WithRequiredByDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public CustomerRequirementBuilder WithPreviousObjectState(RequirementObjectState value)
		        {
				...
				/// <exclude/>
				public CustomerRequirementBuilder WithAuthorizer(Party value)
		        {
				...
				/// <exclude/>
				public CustomerRequirementBuilder WithRequirementStatus(RequirementStatus value)
		        {
				...
				/// <exclude/>
				public CustomerRequirementBuilder WithReason(global::System.String value)
		        {
				...
				/// <exclude/>
				public CustomerRequirementBuilder WithChild(Requirement value)
		        {
				...
				/// <exclude/>
				public CustomerRequirementBuilder WithNeededFor(Party value)
		        {
				...
				/// <exclude/>
				public CustomerRequirementBuilder WithOriginator(Party value)
		        {
				...
				/// <exclude/>
				public CustomerRequirementBuilder WithCurrentObjectState(RequirementObjectState value)
		        {
				...
				/// <exclude/>
				public CustomerRequirementBuilder WithCurrentRequirementStatus(RequirementStatus value)
		        {
				...
				/// <exclude/>
				public CustomerRequirementBuilder WithFacility(Facility value)
		        {
				...
				/// <exclude/>
				public CustomerRequirementBuilder WithServicedBy(Party value)
		        {
				...
				/// <exclude/>
				public CustomerRequirementBuilder WithEstimatedBudget(global::System.Decimal? value)
		        {
				...
				/// <exclude/>
				public CustomerRequirementBuilder WithDescription(global::System.String value)
		        {
				...
				/// <exclude/>
				public CustomerRequirementBuilder WithQuantity(global::System.Int32? value)
		        {
				...
				/// <exclude/>
				public CustomerRequirementBuilder WithDisplayName(global::System.String value)
		        {
				...
				/// <exclude/>
				public CustomerRequirementBuilder WithDeniedPermission(Permission value)
		        {
				...
				/// <exclude/>
				public CustomerRequirementBuilder WithSecurityToken(SecurityToken value)
		        {
				...
				/// <exclude/>
				public CustomerRequirementBuilder WithUniqueId(global::System.Guid? value)
		        {
				...
				/// <exclude/>
				public CustomerRequirementBuilder WithSearchData(SearchData value)
		        {
	...
	public partial class CustomerRequirements : global::Allors.ObjectsBase<CustomerRequirement>
	{
		public static readonly CustomerRequirementMeta Meta = CustomerRequirementMeta.Instance;

		public CustomerRequirements(Allors.ISession session) : base(session)
		{
		}
