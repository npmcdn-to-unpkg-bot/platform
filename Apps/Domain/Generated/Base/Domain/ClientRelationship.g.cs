...
namespace Allors.Domain
{
	...
	{		
		...
		{
			var builder = (ClientRelationshipBuilder)objectBuilder;
	...
	public partial class ClientRelationshipBuilder : Allors.ObjectBuilder<ClientRelationship> , PartyRelationshipBuilder, global::System.IDisposable
	{		
		public ClientRelationshipBuilder(Allors.ISession session) : base(session)
	    {
	    }
				...
				/// <exclude/>
				public ClientRelationshipBuilder WithClient(Party value)
		        {
		            if(this.Client!=null){throw new global::System.ArgumentException("One multicplicity");}
					this.Client = value;
		            return this;
		        }		
				...
				/// <exclude/>
				public ClientRelationshipBuilder WithInternalOrganisation(InternalOrganisation value)
		        {
				...
				/// <exclude/>
				public ClientRelationshipBuilder WithPartyRelationshipStatus(PartyRelationshipStatus value)
		        {
				...
				/// <exclude/>
				public ClientRelationshipBuilder WithAgreement(Agreement value)
		        {
				...
				/// <exclude/>
				public ClientRelationshipBuilder WithPartyRelationshipPriority(PartyRelationshipPriority value)
		        {
				...
				/// <exclude/>
				public ClientRelationshipBuilder WithSimpleMovingAverage(global::System.Decimal? value)
		        {
				...
				/// <exclude/>
				public ClientRelationshipBuilder WithCommunicationEvent(CommunicationEvent value)
		        {
				...
				/// <exclude/>
				public ClientRelationshipBuilder WithFromDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public ClientRelationshipBuilder WithThroughDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public ClientRelationshipBuilder WithComment(global::System.String value)
		        {
				...
				/// <exclude/>
				public ClientRelationshipBuilder WithDisplayName(global::System.String value)
		        {
				...
				/// <exclude/>
				public ClientRelationshipBuilder WithDeniedPermission(Permission value)
		        {
				...
				/// <exclude/>
				public ClientRelationshipBuilder WithSecurityToken(SecurityToken value)
		        {
	...
	public partial class ClientRelationships : global::Allors.ObjectsBase<ClientRelationship>
	{
		public static readonly ClientRelationshipMeta Meta = ClientRelationshipMeta.Instance;

		public ClientRelationships(Allors.ISession session) : base(session)
		{
		}
