...
namespace Allors.Domain
{
	...
	{		
		...
		{
			var builder = (ActivityBuilder)objectBuilder;
	...
	public partial class ActivityBuilder : Allors.ObjectBuilder<Activity> , WorkEffortBuilder, global::System.IDisposable
	{		
		public ActivityBuilder(Allors.ISession session) : base(session)
	    {
	    }
				...
				/// <exclude/>
				public ActivityBuilder WithCurrentWorkEffortStatus(WorkEffortStatus value)
		        {
				...
				/// <exclude/>
				public ActivityBuilder WithPrecendency(WorkEffort value)
		        {
				...
				/// <exclude/>
				public ActivityBuilder WithFacility(Facility value)
		        {
				...
				/// <exclude/>
				public ActivityBuilder WithDeliverableProduced(Deliverable value)
		        {
				...
				/// <exclude/>
				public ActivityBuilder WithInventoryItemNeeded(WorkEffortInventoryAssignment value)
		        {
				...
				/// <exclude/>
				public ActivityBuilder WithChild(WorkEffort value)
		        {
				...
				/// <exclude/>
				public ActivityBuilder WithOrderItemFulfillment(OrderItem value)
		        {
				...
				/// <exclude/>
				public ActivityBuilder WithWorkEffortStatus(WorkEffortStatus value)
		        {
				...
				/// <exclude/>
				public ActivityBuilder WithWorkEffortType(WorkEffortType value)
		        {
				...
				/// <exclude/>
				public ActivityBuilder WithInventoryItemProduced(InventoryItem value)
		        {
				...
				/// <exclude/>
				public ActivityBuilder WithRequirementFulfillment(Requirement value)
		        {
				...
				/// <exclude/>
				public ActivityBuilder WithSpecialTerms(global::System.String value)
		        {
				...
				/// <exclude/>
				public ActivityBuilder WithConcurrency(WorkEffort value)
		        {
				...
				/// <exclude/>
				public ActivityBuilder WithActualHours(global::System.Decimal? value)
		        {
				...
				/// <exclude/>
				public ActivityBuilder WithDescription(global::System.String value)
		        {
				...
				/// <exclude/>
				public ActivityBuilder WithPreviousObjectState(WorkEffortObjectState value)
		        {
				...
				/// <exclude/>
				public ActivityBuilder WithCurrentObjectState(WorkEffortObjectState value)
		        {
				...
				/// <exclude/>
				public ActivityBuilder WithEstimatedHours(global::System.Decimal? value)
		        {
				...
				/// <exclude/>
				public ActivityBuilder WithSearchData(SearchData value)
		        {
				...
				/// <exclude/>
				public ActivityBuilder WithDisplayName(global::System.String value)
		        {
				...
				/// <exclude/>
				public ActivityBuilder WithDeniedPermission(Permission value)
		        {
				...
				/// <exclude/>
				public ActivityBuilder WithSecurityToken(SecurityToken value)
		        {
				...
				/// <exclude/>
				public ActivityBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class Activities : global::Allors.ObjectsBase<Activity>
	{
		public static readonly ActivityMeta Meta = ActivityMeta.Instance;

		public Activities(Allors.ISession session) : base(session)
		{
		}
