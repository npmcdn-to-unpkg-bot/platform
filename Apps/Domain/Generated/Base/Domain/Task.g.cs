...
namespace Allors.Domain
{
	...
	{		
		...
		{
			var builder = (TaskBuilder)objectBuilder;
	...
	public partial class TaskBuilder : Allors.ObjectBuilder<Task> , WorkEffortBuilder, global::System.IDisposable
	{		
		public TaskBuilder(Allors.ISession session) : base(session)
	    {
	    }
				...
				/// <exclude/>
				public TaskBuilder WithCurrentWorkEffortStatus(WorkEffortStatus value)
		        {
				...
				/// <exclude/>
				public TaskBuilder WithPrecendency(WorkEffort value)
		        {
				...
				/// <exclude/>
				public TaskBuilder WithFacility(Facility value)
		        {
				...
				/// <exclude/>
				public TaskBuilder WithDeliverableProduced(Deliverable value)
		        {
				...
				/// <exclude/>
				public TaskBuilder WithInventoryItemNeeded(WorkEffortInventoryAssignment value)
		        {
				...
				/// <exclude/>
				public TaskBuilder WithChild(WorkEffort value)
		        {
				...
				/// <exclude/>
				public TaskBuilder WithOrderItemFulfillment(OrderItem value)
		        {
				...
				/// <exclude/>
				public TaskBuilder WithWorkEffortStatus(WorkEffortStatus value)
		        {
				...
				/// <exclude/>
				public TaskBuilder WithWorkEffortType(WorkEffortType value)
		        {
				...
				/// <exclude/>
				public TaskBuilder WithInventoryItemProduced(InventoryItem value)
		        {
				...
				/// <exclude/>
				public TaskBuilder WithRequirementFulfillment(Requirement value)
		        {
				...
				/// <exclude/>
				public TaskBuilder WithSpecialTerms(global::System.String value)
		        {
				...
				/// <exclude/>
				public TaskBuilder WithConcurrency(WorkEffort value)
		        {
				...
				/// <exclude/>
				public TaskBuilder WithActualHours(global::System.Decimal? value)
		        {
				...
				/// <exclude/>
				public TaskBuilder WithDescription(global::System.String value)
		        {
				...
				/// <exclude/>
				public TaskBuilder WithPreviousObjectState(WorkEffortObjectState value)
		        {
				...
				/// <exclude/>
				public TaskBuilder WithCurrentObjectState(WorkEffortObjectState value)
		        {
				...
				/// <exclude/>
				public TaskBuilder WithEstimatedHours(global::System.Decimal? value)
		        {
				...
				/// <exclude/>
				public TaskBuilder WithSearchData(SearchData value)
		        {
				...
				/// <exclude/>
				public TaskBuilder WithDisplayName(global::System.String value)
		        {
				...
				/// <exclude/>
				public TaskBuilder WithDeniedPermission(Permission value)
		        {
				...
				/// <exclude/>
				public TaskBuilder WithSecurityToken(SecurityToken value)
		        {
				...
				/// <exclude/>
				public TaskBuilder WithUniqueId(global::System.Guid? value)
		        {
