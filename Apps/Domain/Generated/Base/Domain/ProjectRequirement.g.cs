...
namespace Allors.Domain
{
	...
	{		
		...
		{
			var builder = (ProjectRequirementBuilder)objectBuilder;
			...
			if(builder.NeededDeliverables!=null)
			{
				this.NeededDeliverables = builder.NeededDeliverables.ToArray();
			}
	...
	public partial class ProjectRequirementBuilder : Allors.ObjectBuilder<ProjectRequirement> , RequirementBuilder, global::System.IDisposable
	{		
		public ProjectRequirementBuilder(Allors.ISession session) : base(session)
	    {
	    }

				public global::System.Collections.Generic.List<Deliverable> NeededDeliverables {get; set;}	

				/// <exclude/>
				public ProjectRequirementBuilder WithNeededDeliverable(Deliverable value)
		        {
					if(this.NeededDeliverables == null)
					{
						this.NeededDeliverables = new global::System.Collections.Generic.List<Deliverable>(); 
					}
		            this.NeededDeliverables.Add(value);
		            return this;
		        }		
				...
				/// <exclude/>
				public ProjectRequirementBuilder WithRequiredByDate(global::System.DateTime? value)
		        {
				...
				/// <exclude/>
				public ProjectRequirementBuilder WithPreviousObjectState(RequirementObjectState value)
		        {
				...
				/// <exclude/>
				public ProjectRequirementBuilder WithAuthorizer(Party value)
		        {
				...
				/// <exclude/>
				public ProjectRequirementBuilder WithRequirementStatus(RequirementStatus value)
		        {
				...
				/// <exclude/>
				public ProjectRequirementBuilder WithReason(global::System.String value)
		        {
				...
				/// <exclude/>
				public ProjectRequirementBuilder WithChild(Requirement value)
		        {
				...
				/// <exclude/>
				public ProjectRequirementBuilder WithNeededFor(Party value)
		        {
				...
				/// <exclude/>
				public ProjectRequirementBuilder WithOriginator(Party value)
		        {
				...
				/// <exclude/>
				public ProjectRequirementBuilder WithCurrentObjectState(RequirementObjectState value)
		        {
				...
				/// <exclude/>
				public ProjectRequirementBuilder WithCurrentRequirementStatus(RequirementStatus value)
		        {
				...
				/// <exclude/>
				public ProjectRequirementBuilder WithFacility(Facility value)
		        {
				...
				/// <exclude/>
				public ProjectRequirementBuilder WithServicedBy(Party value)
		        {
				...
				/// <exclude/>
				public ProjectRequirementBuilder WithEstimatedBudget(global::System.Decimal? value)
		        {
				...
				/// <exclude/>
				public ProjectRequirementBuilder WithDescription(global::System.String value)
		        {
				...
				/// <exclude/>
				public ProjectRequirementBuilder WithQuantity(global::System.Int32? value)
		        {
				...
				/// <exclude/>
				public ProjectRequirementBuilder WithDisplayName(global::System.String value)
		        {
				...
				/// <exclude/>
				public ProjectRequirementBuilder WithDeniedPermission(Permission value)
		        {
				...
				/// <exclude/>
				public ProjectRequirementBuilder WithSecurityToken(SecurityToken value)
		        {
				...
				/// <exclude/>
				public ProjectRequirementBuilder WithUniqueId(global::System.Guid? value)
		        {
				...
				/// <exclude/>
				public ProjectRequirementBuilder WithSearchData(SearchData value)
		        {
	...
	public partial class ProjectRequirements : global::Allors.ObjectsBase<ProjectRequirement>
	{
		public static readonly ProjectRequirementMeta Meta = ProjectRequirementMeta.Instance;

		public ProjectRequirements(Allors.ISession session) : base(session)
		{
		}
