...
namespace Allors.Domain
{
	...
	{		
		...
		{
			var builder = (ColourBuilder)objectBuilder;
	...
	public partial class ColourBuilder : Allors.ObjectBuilder<Colour> , EnumerationBuilder, ProductFeatureBuilder, global::System.IDisposable
	{		
		public ColourBuilder(Allors.ISession session) : base(session)
	    {
	    }
				...
				/// <exclude/>
				public ColourBuilder WithLocalisedName(LocalisedText value)
		        {
				...
				/// <exclude/>
				public ColourBuilder WithIsActive(global::System.Boolean? value)
		        {
				...
				/// <exclude/>
				public ColourBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public ColourBuilder WithDisplayName(global::System.String value)
		        {
				...
				/// <exclude/>
				public ColourBuilder WithDeniedPermission(Permission value)
		        {
				...
				/// <exclude/>
				public ColourBuilder WithSecurityToken(SecurityToken value)
		        {
				...
				/// <exclude/>
				public ColourBuilder WithUniqueId(global::System.Guid? value)
		        {
				...
				/// <exclude/>
				public ColourBuilder WithEstimatedProductCost(EstimatedProductCost value)
		        {
				...
				/// <exclude/>
				public ColourBuilder WithBasePrice(PriceComponent value)
		        {
				...
				/// <exclude/>
				public ColourBuilder WithDescription(global::System.String value)
		        {
				...
				/// <exclude/>
				public ColourBuilder WithDependentFeature(ProductFeature value)
		        {
				...
				/// <exclude/>
				public ColourBuilder WithIncompatibleFeature(ProductFeature value)
		        {
				...
				/// <exclude/>
				public ColourBuilder WithVatRate(VatRate value)
		        {
				...
				/// <exclude/>
				public ColourBuilder WithSearchData(SearchData value)
		        {
	...
	public partial class Colours : global::Allors.ObjectsBase<Colour>
	{
		public static readonly ColourMeta Meta = ColourMeta.Instance;

		public Colours(Allors.ISession session) : base(session)
		{
		}
