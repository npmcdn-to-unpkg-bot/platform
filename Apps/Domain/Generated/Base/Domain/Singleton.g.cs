...
namespace Allors.Domain
{
	...
	{		
		internal override void OnBuild(global::Allors.IObjectBuilder objectBuilder)
		{
			...
			this.DefaultInternalOrganisation = builder.DefaultInternalOrganisation;
	...
	{		
		public SingletonBuilder(Allors.ISession session) : base(session)
	    {
				...
				/// <exclude/>
				public SingletonBuilder WithDefaultCurrency(Currency value)
		        {
		            if(this.DefaultCurrency!=null){throw new global::System.ArgumentException("One multicplicity");}
				...
				/// <exclude/>
				public SingletonBuilder WithDefaultInternalOrganisation(InternalOrganisation value)
		        {
		            if(this.DefaultInternalOrganisation!=null){throw new global::System.ArgumentException("One multicplicity");}
					this.DefaultInternalOrganisation = value;
		            return this;
		        }		
