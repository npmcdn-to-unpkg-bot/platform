...
namespace Allors.Domain
{
	...
	{		
		internal override void OnBuild(global::Allors.IObjectBuilder objectBuilder)
		{
			...
			this.TemplatePurpose = builder.TemplatePurpose;
	...
	{		
		public StringTemplateBuilder(Allors.ISession session) : base(session)
	    {
				...
				/// <exclude/>
				public StringTemplateBuilder WithTemplatePurpose(TemplatePurpose value)
		        {
		            if(this.TemplatePurpose!=null){throw new global::System.ArgumentException("One multicplicity");}
