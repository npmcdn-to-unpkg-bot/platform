...
namespace Allors.Domain
{
	...
	{		
		...
		{
			var builder = (ProjectBuilder)objectBuilder;
	...
	public partial class ProjectBuilder : Allors.ObjectBuilder<Project> , WorkEffortBuilder, global::System.IDisposable
	{		
		public ProjectBuilder(Allors.ISession session) : base(session)
	    {
	    }
				...
				/// <exclude/>
				public ProjectBuilder WithCurrentWorkEffortStatus(WorkEffortStatus value)
		        {
				...
				/// <exclude/>
				public ProjectBuilder WithPrecendency(WorkEffort value)
		        {
				...
				/// <exclude/>
				public ProjectBuilder WithFacility(Facility value)
		        {
				...
				/// <exclude/>
				public ProjectBuilder WithDeliverableProduced(Deliverable value)
		        {
				...
				/// <exclude/>
				public ProjectBuilder WithInventoryItemNeeded(WorkEffortInventoryAssignment value)
		        {
				...
				/// <exclude/>
				public ProjectBuilder WithChild(WorkEffort value)
		        {
				...
				/// <exclude/>
				public ProjectBuilder WithOrderItemFulfillment(OrderItem value)
		        {
				...
				/// <exclude/>
				public ProjectBuilder WithWorkEffortStatus(WorkEffortStatus value)
		        {
				...
				/// <exclude/>
				public ProjectBuilder WithWorkEffortType(WorkEffortType value)
		        {
				...
				/// <exclude/>
				public ProjectBuilder WithInventoryItemProduced(InventoryItem value)
		        {
				...
				/// <exclude/>
				public ProjectBuilder WithRequirementFulfillment(Requirement value)
		        {
				...
				/// <exclude/>
				public ProjectBuilder WithSpecialTerms(global::System.String value)
		        {
				...
				/// <exclude/>
				public ProjectBuilder WithConcurrency(WorkEffort value)
		        {
				...
				/// <exclude/>
				public ProjectBuilder WithActualHours(global::System.Decimal? value)
		        {
				...
				/// <exclude/>
				public ProjectBuilder WithDescription(global::System.String value)
		        {
				...
				/// <exclude/>
				public ProjectBuilder WithPreviousObjectState(WorkEffortObjectState value)
		        {
				...
				/// <exclude/>
				public ProjectBuilder WithCurrentObjectState(WorkEffortObjectState value)
		        {
				...
				/// <exclude/>
				public ProjectBuilder WithEstimatedHours(global::System.Decimal? value)
		        {
				...
				/// <exclude/>
				public ProjectBuilder WithSearchData(SearchData value)
		        {
				...
				/// <exclude/>
				public ProjectBuilder WithDisplayName(global::System.String value)
		        {
				...
				/// <exclude/>
				public ProjectBuilder WithDeniedPermission(Permission value)
		        {
				...
				/// <exclude/>
				public ProjectBuilder WithSecurityToken(SecurityToken value)
		        {
				...
				/// <exclude/>
				public ProjectBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class Projects : global::Allors.ObjectsBase<Project>
	{
		public static readonly ProjectMeta Meta = ProjectMeta.Instance;

		public Projects(Allors.ISession session) : base(session)
		{
		}
