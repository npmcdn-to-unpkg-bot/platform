...
namespace Allors.Domain
{
	...
	{		
		...
		{
			var builder = (CustomerShipmentBuilder)objectBuilder;
			

			if(builder.ReleasedManually.HasValue)
			{
				this.ReleasedManually = builder.ReleasedManually.Value;
			}			
					

			if(builder.WithoutCharges.HasValue)
			{
				this.WithoutCharges = builder.WithoutCharges.Value;
			}			
					

			if(builder.HeldManually.HasValue)
			{
				this.HeldManually = builder.HeldManually.Value;
			}			
					

			if(builder.ShipmentValue.HasValue)
			{
				this.ShipmentValue = builder.ShipmentValue.Value;
			}			
	...
	public partial class CustomerShipmentBuilder : Allors.ObjectBuilder<CustomerShipment> , ShipmentBuilder, global::System.IDisposable
	{		
		public CustomerShipmentBuilder(Allors.ISession session) : base(session)
	    {
				...
				/// <exclude/>
				public CustomerShipmentBuilder WithCurrentShipmentStatus(CustomerShipmentStatus value)
		        {
				...
				public CustomerShipmentObjectState PreviousObjectState {get; set;}

				/// <exclude/>
				public CustomerShipmentBuilder WithPreviousObjectState(CustomerShipmentObjectState value)
		        {
				...
				/// <exclude/>
				public CustomerShipmentBuilder WithCurrentObjectState(CustomerShipmentObjectState value)
		        {
				...
				public global::System.Collections.Generic.List<CustomerShipmentStatus> ShipmentStatuses {get; set;}	

				/// <exclude/>
				public CustomerShipmentBuilder WithShipmentStatus(CustomerShipmentStatus value)
		        {
					if(this.ShipmentStatuses == null)
					{
						this.ShipmentStatuses = new global::System.Collections.Generic.List<CustomerShipmentStatus>(); 
					}
				...
				public global::System.Decimal? ShipmentValue {get; set;}

				/// <exclude/>
				public CustomerShipmentBuilder WithShipmentValue(global::System.Decimal? value)
		        {
				...
				/// <exclude/>
				public CustomerShipmentBuilder WithBillFromInternalOrganisation(InternalOrganisation value)
		        {
				...
				/// <exclude/>
				public CustomerShipmentBuilder WithBillFromContactMechanism(ContactMechanism value)
		        {
				...
				/// <exclude/>
				public CustomerShipmentBuilder WithDisplayName(global::System.String value)
		        {
				...
				/// <exclude/>
				public CustomerShipmentBuilder WithUniqueId(global::System.Guid? value)
		        {
				...
				/// <exclude/>
				public CustomerShipmentBuilder WithSearchData(SearchData value)
		        {
