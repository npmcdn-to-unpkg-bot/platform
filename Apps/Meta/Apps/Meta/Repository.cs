...
namespace Allors.Meta
{
    ...
    public static partial class Repository
    {
        public static Domain Apps(MetaPopulation meta)
        {
            ...
            new RelationTypeBuilder(domain, new Guid("b31753c5-6983-4753-8016-be389a71504b"), new Guid("702aad92-4bd9-461d-87c5-b438ecaa1387"), new Guid("f7307e39-1cce-4e70-a51a-d155a602526b")).WithObjectTypes(PartSpecification, PartSpecificationObjectState).WithSingularName("PreviousObjectState")  .WithPluralName("PreviousObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("d1f7f2cb-cbc8-42b4-a3f0-198ff35957de"), new Guid("0f429c19-5cb8-459a-b95a-9e3ec1e045f3"), new Guid("0750e77a-40bd-4a0b-89a6-6e6fbb797cc4")).WithObjectTypes(QuoteItem, QuoteTerm).WithSingularName("QuoteTerm")  .WithPluralName("QuoteTerms")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("dc00905b-bb4f-4a47-88d6-1ae6ce0855f7"), new Guid("f9a2cdde-485c-46a0-8f06-9f9687328737"), new Guid("e3308741-e48e-4b91-81ef-de38dcb5d80d")).WithObjectTypes(QuoteItem, RequestItem).WithSingularName("RequestItem")  .WithPluralName("RequestItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("785561cc-1c88-4ac2-811c-4fd304c1c0c1"), new Guid("5c235877-9214-45d6-956b-a7e0d2cdafa1"), new Guid("aec14320-5fa6-405b-b02d-dadef054e952")).WithObjectTypes(PartyProductCategoryRevenueHistory, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("9154e239-b23b-43f5-b77d-e5bb81c0bcc2"), new Guid("71b45408-43d1-457f-aba1-30c6641fe996"), new Guid("bdc40f4d-2bbe-485f-ae7e-1e8942a339cf")).WithObjectTypes(PartyProductCategoryRevenueHistory, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // Position
            new RelationTypeBuilder(domain, new Guid("137841cd-fa69-4704-a6e3-cd710c51af43"), new Guid("834d2485-8aac-4e7e-86ad-0b7c5c21b368"), new Guid("7f6522ca-1f5b-4c97-99b4-1f4ac6670d8e")).WithObjectTypes(Position, Organisation).WithSingularName("Organisation")  .WithPluralName("Organisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("39298cc2-0869-4dc9-b0ff-bea8269ba958"), new Guid("7ca00aff-ad0b-4195-902b-39b3d5cc2c25"), new Guid("949968c0-dc95-44d3-a8f0-65829a884c3b")).WithObjectTypes(Position, allorsDate).WithSingularName("EstimatedThroughDate")  .WithPluralName("EstimatedThroughDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("6ede43f7-87a5-429c-8fc0-6441ca8753f1"), new Guid("c2100e41-9586-485c-8110-693de5479a9e"), new Guid("5f2fa20d-f4c8-468e-b9bb-d9a3cd777b70")).WithObjectTypes(Position, allorsDate).WithSingularName("EstimatedFromDate")  .WithPluralName("EstimatedFromDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("8166d3b6-cc9d-486a-9321-5cd97ff49ddc"), new Guid("2c5ea5b2-9bea-4181-8c4e-ae903e93c8f8"), new Guid("03b86a68-6063-4299-aa94-ed3f1850f115")).WithObjectTypes(Position, PositionType).WithSingularName("PositionType")  .WithPluralName("PositionTypes")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("db94dd2c-5f39-4f64-ad6d-ce80bf7a4c22"), new Guid("1e391ccb-da94-4b69-8dc7-b0659eaaf201"), new Guid("c3123ffe-f6d2-4d46-87be-77e184ec8adb")).WithObjectTypes(Position, PositionStatus).WithSingularName("PositionStatus")  .WithPluralName("PositionStatuses")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("e1f8d2a3-83a7-4357-9451-858c314dbefc"), new Guid("5d53246b-9497-476e-b68a-e8e5bea2c851"), new Guid("a026d5da-a2dd-4443-956f-2c6d8c73a894")).WithObjectTypes(Position, BudgetItem).WithSingularName("ApprovedBudgetItem")  .WithPluralName("ApprovedBudgetItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("ec8beecc-9e28-4103-94d3-249aed76c934"), new Guid("c68b7794-0379-4542-8f1b-24311e2358a4"), new Guid("3a72f3f0-0476-4629-9831-ed43ebaa8cf5")).WithObjectTypes(Position, allorsDate).WithSingularName("ActualFromDate")  .WithPluralName("ActualFromDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("fc328a1a-4f62-42de-96b2-a61c612a1602"), new Guid("f815e446-05a5-4fa3-b3b4-4c7a94b7ca1f"), new Guid("c8cb5709-08d5-4b3b-9598-15289ba9d689")).WithObjectTypes(Position, allorsDate).WithSingularName("ActualThroughDate")  .WithPluralName("ActualThroughDates")      .Build();
			
            // LetterCorrespondence
            new RelationTypeBuilder(domain, new Guid("3e0f1be5-0685-48d6-922f-6e971110b414"), new Guid("d063c86e-bbee-41b9-9823-10e96c69c5a0"), new Guid("14ca37a9-7ce4-4d2a-b7ba-1a43bccc1664")).WithObjectTypes(LetterCorrespondence, PostalAddress).WithSingularName("PostalAddress")  .WithPluralName("PostalAddresses")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("e8fd2c39-bcb7-4914-8cd3-6dcc6a7a9997"), new Guid("d5ed6948-f657-4d47-89c8-d860e2971138"), new Guid("b65552b5-99c7-4b91-b9b6-a70ec35c3ae2")).WithObjectTypes(LetterCorrespondence, Party).WithSingularName("Originator")  .WithPluralName("Originators")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("ece02647-000a-4373-8f01-f4b7d1c75dd5"), new Guid("e580ed8f-a7a4-40c3-9c0a-4cdbe95354a6"), new Guid("dde368dc-c198-4744-b3b2-1a2e0d2976e4")).WithObjectTypes(LetterCorrespondence, Party).WithSingularName("Receiver")  .WithPluralName("Receivers")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("4830cfc5-0375-4996-8cd8-27e36c102b65"), new Guid("efa439f8-787e-43d7-bd1b-400cba7e3a62"), new Guid("583bfc51-0bb7-4ea5-914c-33a5c2d64196")).WithObjectTypes(PurchaseOrder, ContactMechanism).WithSingularName("TakenViaContactMechanism")  .WithPluralName("TakenViaContactMechanisms")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("6d0f4867-3237-4c3e-b00b-96f4ad456c55"), new Guid("ac51d7e6-abd1-4d07-9b25-34888b4f830d"), new Guid("e146ab05-15d4-4f29-a89c-c97b5a75d0cf")).WithObjectTypes(PurchaseOrder, PurchaseOrderStatus).WithSingularName("OrderStatus")  .WithPluralName("OrderStatuses")  .WithMultiplicity(Multiplicity.OneToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("7eceb1b6-1395-4655-a558-6d72ad4b380e"), new Guid("b6e1159c-fcb7-47f1-822b-4ab75e5dac14"), new Guid("ab3ee3c7-dc02-4acf-a34e-6b25783e11fc")).WithObjectTypes(PurchaseOrder, ContactMechanism).WithSingularName("BillToContactMechanism")  .WithPluralName("BillToContactMechanisms")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("87a2439e-83e1-4b51-97b8-9c21cc743e07"), new Guid("711e264a-74eb-4229-a4d1-82ddef1bb597"), new Guid("0316aafc-f5b2-41b2-bf39-7c2b7e4e0afc")).WithObjectTypes(PurchaseOrder, PurchaseOrderStatus).WithSingularName("ShipmentStatus")  .WithPluralName("ShipmentStatuses")  .WithMultiplicity(Multiplicity.OneToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("b390a733-e322-4ada-9ead-75a8c9976337"), new Guid("6082b0af-f5ed-493c-bb2b-ad4764053819"), new Guid("c725b348-df8f-4a64-adc2-c3d8b3b986b5")).WithObjectTypes(PurchaseOrder, InternalOrganisation).WithSingularName("ShipToBuyer")  .WithPluralName("ShipToBuyers")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("ccf88515-6441-4d0f-a2e7-8f5ed7c0533e"), new Guid("ce230886-53a7-4360-b545-a20d3cf47f1f"), new Guid("2f7e7d1b-6a61-41a6-a05f-375e8a5feeb2")).WithObjectTypes(PurchaseOrder, Facility).WithSingularName("Facility")  .WithPluralName("Facilities")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("d74bd1fd-f243-4b5d-8061-1eafe7c25beb"), new Guid("5465663b-6757-4b1d-9f91-233bfd86bc5d"), new Guid("35c28c9f-852a-4ebb-bc2b-1dce9e3812fa")).WithObjectTypes(PurchaseOrder, PostalAddress).WithSingularName("ShipToAddress")  .WithPluralName("ShipToAdresses")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("dd73dbd1-aa0e-4a19-a31d-5ebcdafccd45"), new Guid("f824cb43-7bc9-47f2-b754-36dc16c43076"), new Guid("8b52f909-abe4-4e77-85fa-6cf37198f179")).WithObjectTypes(PurchaseOrder, PurchaseOrderObjectState).WithSingularName("PreviousObjectState")  .WithPluralName("PreviousObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("f05e0ba5-4321-4d88-8f2c-8994de5b44b7"), new Guid("38d76559-6a9c-48c7-bde5-1a2e685b9a40"), new Guid("a0b2ec91-5b7e-4abb-91fb-91836cb88490")).WithObjectTypes(PurchaseOrder, InternalOrganisation).WithSingularName("BillToPurchaser")  .WithPluralName("BillToPurchasers")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // Quote
            new RelationTypeBuilder(domain, new Guid("033df6dd-fdf7-44e4-84ca-5c7e100cb3f5"), new Guid("4b19f443-0d27-447d-8186-e5361a094460"), new Guid("fa17ef86-c074-414e-b223-b62522d68280")).WithObjectTypes(Quote, allorsDate).WithSingularName("ValidFromDate")  .WithPluralName("ValidFromDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("05e3454a-0a7a-488d-b4b1-f0fd41392ddf"), new Guid("ca3f0d26-9ead-4691-8f7f-f79272065251"), new Guid("92e46228-ad44-4b9b-b727-23159a59bca3")).WithObjectTypes(Quote, QuoteTerm).WithSingularName("QuoteTerm")  .WithPluralName("QuoteTerms")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("20880670-0496-4d24-8c97-69b83867c09e"), new Guid("c2bfd7fd-7956-4c28-960e-539f8159e46a"), new Guid("3242cf4f-589c-457b-9ecd-59110041ab34")).WithObjectTypes(Quote, Party).WithSingularName("Issuer")  .WithPluralName("Issuers")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("2140e106-2ef3-427a-be94-458c2b8e154d"), new Guid("9d81ada4-a4f3-44bb-9098-bc1a3e61de19"), new Guid("60581583-2536-4b09-acae-f0f877169dae")).WithObjectTypes(Quote, allorsDate).WithSingularName("ValidThroughDate")  .WithPluralName("ValidThroughDates")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("d7dc81e8-76e7-4c68-9843-a2aaf8293510"), new Guid("6fbc80d1-e72b-4484-a9b1-e606f15d2435"), new Guid("219cb27f-20b5-48b3-9d89-4b119798b092")).WithObjectTypes(Quote, allorsDate).WithSingularName("IssueDate")  .WithPluralName("IssueDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("e250154a-77c5-4a0b-ae3d-28668a9037d1"), new Guid("b5ba8cfd-2b16-4a50-89cd-46927d59b97a"), new Guid("f5b6881b-c4d5-42e3-a024-0ae4564cb970")).WithObjectTypes(Quote, QuoteItem).WithSingularName("QuoteItem")  .WithPluralName("QuoteItems")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("dddccd24-864c-48bb-b1ac-35b8a201cd65"), new Guid("babbcdc0-7d4b-4679-a937-cbf6f5632c8b"), new Guid("2ee2162b-6936-4322-8d5b-1175d29f1308")).WithObjectTypes(GlBudgetAllocation, BudgetItem).WithSingularName("BudgetItem")  .WithPluralName("BudgetItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("f88ae79d-7605-4be9-972e-541489bdb72b"), new Guid("b527fed9-c720-45aa-b8c5-fe5336f43f5c"), new Guid("92716fbf-aae3-433f-85f1-9fcfeb68568c")).WithObjectTypes(WorkEffortPartyAssignment, Facility).WithSingularName("Facility")  .WithPluralName("Facilities")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("1b5f8acd-872d-498e-9c2d-ded4b7d31efe"), new Guid("9bb9541a-f0fc-4ed8-bc3f-13e1d7901395"), new Guid("0b9dd5eb-10a1-470b-a119-158c66c558f1")).WithObjectTypes(JournalEntry, allorsDate).WithSingularName("EntryDate")  .WithPluralName("EntryDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("4eca8284-cc27-4440-8b5f-adeffd3b078b"), new Guid("b7897efa-b2f5-4807-8385-3da4936998c7"), new Guid("f8bcd82b-5209-45d1-a6ee-5452ca9cf11b")).WithObjectTypes(JournalEntry, allorsDate).WithSingularName("JournalDate")  .WithPluralName("JournalDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("e81fe73b-1486-4a9d-ab2b-2d49dfcbb777"), new Guid("77a3f9d6-814b-438e-b424-e63763bb4213"), new Guid("9afbe2d8-116b-4e35-bbb5-e35085697b30")).WithObjectTypes(JournalEntry, JournalEntryDetail).WithSingularName("JournalEntryDetail")  .WithPluralName("JournalEntryDetails")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("46004f49-9d2e-49a6-870e-c81f44458c59"), new Guid("3b2a6ce5-a5c8-45c3-ba3b-3fa5326e4293"), new Guid("bd72c728-57ef-4e68-9bd1-2517bfe7e972")).WithObjectTypes(PurchaseReturnStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
			
            // PartyRevenueHistory
            new RelationTypeBuilder(domain, new Guid("00cc3ce5-d0d8-4082-a1af-8ee850bc76b3"), new Guid("dc4ec595-5121-4b69-bb2b-203d13ffdf75"), new Guid("b2bff84f-9e85-4b2d-bcb5-3860378aa6a0")).WithObjectTypes(PartyRevenueHistory, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("c4610b89-4e21-4e03-a1d5-7487dce9ad42"), new Guid("0ebd138c-0a0f-4a6e-b792-0cc8e88a614e"), new Guid("cacac289-9986-49a5-a0da-764af0dd5a9c")).WithObjectTypes(PartyRevenueHistory, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("c49a44b8-dff1-471c-8309-cf9c7e9188c2"), new Guid("7de3e158-9900-40c4-a015-c62947c0248a"), new Guid("651d72f5-61af-4800-af6a-704159998bfa")).WithObjectTypes(PositionTypeRate, RateType).WithSingularName("RateType")  .WithPluralName("RateTypes")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("f49e4e9e-2e8f-49f6-9c10-4aefb4bb61bf"), new Guid("6f36fb29-7820-45fa-9dca-888c11d8b0a3"), new Guid("135731d2-4120-45dd-b36c-36c8c93ea99e")).WithObjectTypes(PositionTypeRate, TimeFrequency).WithSingularName("TimeFrequency")  .WithPluralName("TimeFrequencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("01c49e6f-087a-494d-902d-12811442470e"), new Guid("839d77a1-7307-4aeb-921b-9aa8832ef853"), new Guid("6a616950-edba-4ed1-8419-7ed4ab3a8fcd")).WithObjectTypes(GeneralLedgerAccount, CostCenter).WithSingularName("DefaultCostCenter")  .WithPluralName("DefaultCostCenters")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("27ba2d5b-9e0b-4b20-9b34-f007a0f2e2f2"), new Guid("b05953d9-4d24-4fc6-8ee6-eeda14d519ca"), new Guid("c6cb1d95-1734-4d37-ad1c-d4cb19546b03")).WithObjectTypes(GeneralLedgerAccount, GeneralLedgerAccountType).WithSingularName("GeneralLedgerAccountType")  .WithPluralName("GeneralLedgerAccountTypes")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("4877e61b-443f-4bef-820f-5c93f8d42b8a"), new Guid("6f44b333-9270-4215-842e-12520d4fc5f6"), new Guid("e48f4a4a-bf66-49b2-b457-76b48e3cab21")).WithObjectTypes(GeneralLedgerAccount, DebitCreditConstant).WithSingularName("Side")  .WithPluralName("Sides")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("aa569c0a-597d-4b75-a527-25c6ef339547"), new Guid("73a33f92-462b-46c6-83d1-41d6f170aaee"), new Guid("b32aa8cb-b590-4302-8a30-66eacd2ec4f7")).WithObjectTypes(GeneralLedgerAccount, GeneralLedgerAccountGroup).WithSingularName("GeneralLedgerAccountGroup")  .WithPluralName("GeneralLedgerAccountGroups")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("beda5c75-e1a0-493a-85ec-a943214cec8d"), new Guid("319a12b6-4ee9-4bbd-9026-480b02e71255"), new Guid("be03ce0d-4023-4d62-8f2e-918e46d1f097")).WithObjectTypes(GeneralLedgerAccount, CostCenter).WithSingularName("CostCenterAllowed")  .WithPluralName("CostCentersAllowed")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("4dfb4bda-1add-45d5-92c7-6393186301f0"), new Guid("44088ee8-b84a-494c-a59c-3164c511176c"), new Guid("eac922da-3beb-41b2-a3ca-f91120f927bd")).WithObjectTypes(ShippingAndHandlingComponent, ShipmentMethod).WithSingularName("ShipmentMethod")  .WithPluralName("ShipmentMethods")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("a029fb4c-4f80-4216-8fc9-9d9b44997816"), new Guid("9e7b4c12-5168-4fe3-adaf-f8d14f7be01f"), new Guid("b0e26bbb-aef7-40ca-9a64-d78bc02affb9")).WithObjectTypes(ShippingAndHandlingComponent, Carrier).WithSingularName("Carrier")  .WithPluralName("Carriers")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("ab4377d4-69c6-4b0c-b9d4-e3a01c1a6a94"), new Guid("2ad57105-a5c4-4e7f-a6df-79af9cddf9ca"), new Guid("742dcf46-5fa5-44b4-bf02-582681b0f6aa")).WithObjectTypes(ShippingAndHandlingComponent, ShipmentValue).WithSingularName("ShipmentValue")  .WithPluralName("ShipmentValues")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("df4727ab-29a8-448c-97b4-c16033e03dcf"), new Guid("a57b1bd3-a060-41c1-91bd-ecc428dd9b55"), new Guid("a554ced2-84e0-41bb-97d9-d0b04ef56679")).WithObjectTypes(ShippingAndHandlingComponent, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("eb0b4419-e09c-43c6-a221-27e54872026e"), new Guid("699e4c3c-5cb2-44ab-8e8c-187d0006e4e9"), new Guid("6c6e0c2f-6475-415d-b916-c4489f7f4fc5")).WithObjectTypes(ShippingAndHandlingComponent, InternalOrganisation).WithSingularName("SpecifiedFor")  .WithPluralName("SpecifiedFors")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("f2bfd9d5-01b2-4bec-8dc2-018cc2187037"), new Guid("cf282301-2e6c-43ed-8447-cc09edcb9810"), new Guid("a3ee85b7-be6a-4e2b-a15d-57872bb57783")).WithObjectTypes(ShippingAndHandlingComponent, GeographicBoundary).WithSingularName("GeographicBoundary")  .WithPluralName("GeographicBoundaries")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // PackagingContent
            new RelationTypeBuilder(domain, new Guid("316a8ff4-1073-486e-ad62-5bee3d3504d2"), new Guid("c2970739-17c4-488a-8f12-9e35ad72d311"), new Guid("536e372d-5062-418a-b17e-752ebf32d430")).WithObjectTypes(PackagingContent, ShipmentItem).WithSingularName("ShipmentItem")  .WithPluralName("ShipmentItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("7ed819c8-78ef-4fe3-b499-b381c246711f"), new Guid("4a88ee23-2c4a-41d2-9891-77e5086db97d"), new Guid("ecb7eb99-dc8f-4ca0-9744-fb87a708430a")).WithObjectTypes(PartySkill, allorsDate).WithSingularName("StartedUsingDate")  .WithPluralName("StartedUsingDates")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("eb3e02dc-6ee5-4aca-9f35-68edafed6dd2"), new Guid("9223e489-7115-4765-88fd-b18f0d7e8c28"), new Guid("5d9c639a-7c94-4771-ad37-be6e4b68dd06")).WithObjectTypes(PartySkill, SkillLevel).WithSingularName("SkillLevel")  .WithPluralName("SkillLevels")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("fec11de5-a33c-4dd7-9af9-b32c3889c8a3"), new Guid("9c16c4b8-b80f-478f-96b0-a534f9de5663"), new Guid("9728a273-f8d7-4edd-94ff-7a91d178fe82")).WithObjectTypes(PartySkill, Skill).WithSingularName("Skill")  .WithPluralName("Skills")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // SerializedInventoryItemStatus
            new RelationTypeBuilder(domain, new Guid("aabb931a-38ee-4568-af8c-5f8ed98ed7b9"), new Guid("85598163-c71c-4bdc-942b-5ad461943e01"), new Guid("87e945cc-864b-42b6-ad9b-c3d447d96073")).WithObjectTypes(SerializedInventoryItemStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("65eebcc4-d5ef-4933-8640-973b67c65127"), new Guid("40703e06-25f8-425d-aa95-3c73fafbfa81"), new Guid("05f86785-08d8-4282-9734-6230e807181b")).WithObjectTypes(PurchaseInvoiceItem, Part).WithSingularName("Part")  .WithPluralName("Parts")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("c850d9db-682d-4a05-b62e-ab67eb19bd0d"), new Guid("b79e9e5b-f4a5-4bd0-bc46-ab55eea2f027"), new Guid("136970e5-2ec7-4036-9abc-c84747d59d54")).WithObjectTypes(PurchaseInvoiceItem, PurchaseInvoiceItemStatus).WithSingularName("InvoiceItemStatus")  .WithPluralName("InvoiceItemStatuses")  .WithMultiplicity(Multiplicity.OneToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            // OrderItemBilling
            new RelationTypeBuilder(domain, new Guid("214988fc-b5a2-4944-9c83-93a645a96853"), new Guid("2007bddd-e78c-40a8-9015-5d3f027586c0"), new Guid("624c3c0b-faac-4542-aeb2-466952cbf832")).WithObjectTypes(OrderItemBilling, OrderItem).WithSingularName("OrderItem")  .WithPluralName("OrderItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("23a0d52d-3ec7-4ddf-a300-c0ee46edf41a"), new Guid("03ac8386-6706-4e3f-9ad2-a64e67edf08f"), new Guid("61e3ad81-395e-46e9-837f-e48257141164")).WithObjectTypes(OrderItemBilling, SalesInvoiceItem).WithSingularName("SalesInvoiceItem")  .WithPluralName("SalesInvoiceItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("93447a57-a049-4eaa-98ec-6fec60bdb64c"), new Guid("68e37671-a29b-44fa-9f19-2efe76a409f3"), new Guid("f22eb146-8e3f-4ea6-85f5-3a2b0d08ecc5")).WithObjectTypes(BankAccount, ContactMechanism).WithSingularName("ContactMechanism")  .WithPluralName("ContactMechanisms")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("a7d242b4-4d39-4254-beb2-914eb556f7b7"), new Guid("2911fab2-a04f-4afc-961d-4fac26f01ae3"), new Guid("ab751b97-c9d9-46bc-9209-6a0b3c191ea0")).WithObjectTypes(BankAccount, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("ecaedf71-98a2-425d-8046-cc8865fdbe73"), new Guid("9174bacb-3955-462a-a53f-ec251466da1b"), new Guid("7d0da5fc-29a4-4a53-a834-9c58662145d0")).WithObjectTypes(BankAccount, Person).WithSingularName("ContactPerson")  .WithPluralName("ContactPersons")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
			
            // ServiceEntryHeader
            new RelationTypeBuilder(domain, new Guid("6b29a626-04f6-423f-8ae5-cb49e8f9211d"), new Guid("9f14e67f-328b-44e6-8c80-707441848265"), new Guid("21500c76-8a3e-4737-aa69-e348e06440e2")).WithObjectTypes(ServiceEntryHeader, ServiceEntry).WithSingularName("ServiceEntry")  .WithPluralName("ServiceEntries")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("7e160fbc-1339-433c-9dcb-9b3ad58ad400"), new Guid("a9d0cbd8-bb20-45e1-b109-6620b23fa1b7"), new Guid("ef8b435e-e354-45e2-89bc-3d452cc84f5a")).WithObjectTypes(ServiceEntryHeader, allorsDate).WithSingularName("SubmittedDate")  .WithPluralName("SubmittedDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("902235fe-a6c5-47bb-936b-8b6ce54b3d15"), new Guid("1f93dde3-a9bd-4e10-8ec6-38edaec6ffb5"), new Guid("3b27dd30-5452-480f-ae19-6937c422b541")).WithObjectTypes(ServiceEntryHeader, Person).WithSingularName("SubmittedBy")  .WithPluralName("SubmittedBys")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("84561abd-08bc-4d28-b25c-22787d8bd7f0"), new Guid("4f700281-794b-4250-8bbe-f4fbbbcf8243"), new Guid("8c408bc0-82f2-4343-93d2-87047c024ef9")).WithObjectTypes(PartRevision, Part).WithSingularName("SupersededByPart")  .WithPluralName("SupersededByParts")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("8a064340-def3-4d9f-89d6-3325b8a41f4d"), new Guid("6c674199-8f5f-469c-8f94-f35d64304968"), new Guid("190e180b-cf6f-485d-80b2-9042e0fe04a7")).WithObjectTypes(PartRevision, Part).WithSingularName("Part")  .WithPluralName("Parts")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // ProductConfiguration
            new RelationTypeBuilder(domain, new Guid("463f9523-62e0-4f33-a0fd-29b42f4af046"), new Guid("4c878c18-a3d4-4928-a675-4c0940f05c41"), new Guid("acf16223-8095-4133-89e9-841e11447a63")).WithObjectTypes(ProductConfiguration, Product).WithSingularName("ProductUsedIn")  .WithPluralName("ProductsUsedIn")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("528afcdf-09c2-4b3a-89b0-4da8fd732e83"), new Guid("774872d1-6b99-4e5e-8f00-f791a11ea337"), new Guid("b2fe3235-8886-4ed1-b8df-edb36e9c8e17")).WithObjectTypes(ProductConfiguration, Product).WithSingularName("Product")  .WithPluralName("Products")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("1176ffe1-efff-4c02-b4df-5bba9052f6da"), new Guid("dcb3602c-f60e-4798-b32d-2a69f9e1056b"), new Guid("920c6a7e-b8b8-4155-9209-4c8ed24a023a")).WithObjectTypes(PickList, allorsDate).WithSingularName("CreationDate")  .WithPluralName("CreationDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("3bb68c85-4e2b-42b8-b5fb-18a66c58c283"), new Guid("11fddfe2-9b04-4b53-a4ff-6f571e73c32a"), new Guid("a139b102-f8a9-43f1-9b14-d3c76f7be294")).WithObjectTypes(PickList, PickListItem).WithSingularName("PickListItem")  .WithPluralName("PickListItems")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("4231c38e-e54c-480d-9e0f-2fe8bd101da1"), new Guid("b4d28461-6b82-4843-90ee-a5c3c0cddfc0"), new Guid("11fa5c06-67ce-44e0-b205-e60be00e9922")).WithObjectTypes(PickList, PickListObjectState).WithSingularName("CurrentObjectState")  .WithPluralName("CurrentObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("4686c8fa-0637-4159-8cb6-ff738f686eb0"), new Guid("b1557f78-f07c-417b-b0b0-c4f26f08574e"), new Guid("3daa636c-e6bc-461d-9db7-7a890622e506")).WithObjectTypes(StoreRevenue, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("620bebb6-89b9-4c37-b9c6-a80605dab7dd"), new Guid("bcaa6464-f7b9-4cec-91c1-8a35b7f5889c"), new Guid("5bcdf844-f377-4439-84f3-191a79346fcb")).WithObjectTypes(StoreRevenue, Store).WithSingularName("Store")  .WithPluralName("Stores")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // ProductCategoryRevenueHistory
            new RelationTypeBuilder(domain, new Guid("19307e7c-c703-4d76-af03-53add0ad0dec"), new Guid("9e03ab90-cde9-439a-94ef-7807a1735248"), new Guid("b4027d52-49b4-4991-9294-110e914743ab")).WithObjectTypes(ProductCategoryRevenueHistory, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("51f81397-a0da-49f7-9f33-96d3aa85f000"), new Guid("fdee71e1-8c89-4042-ad5d-cab81c88f54d"), new Guid("0d668529-e9e7-4a2c-8451-f4e8b80ec4cc")).WithObjectTypes(ProductCategoryRevenueHistory, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // SupplierRelationship
            new RelationTypeBuilder(domain, new Guid("1546c9f0-84ce-4795-bcea-634d6a78e867"), new Guid("56c5ff64-f67b-4830-a1e4-11661b0ff898"), new Guid("a0e757a2-d780-43a1-8b21-ab2fc4d75e7e")).WithObjectTypes(SupplierRelationship, Organisation).WithSingularName("Supplier")  .WithPluralName("Suppliers")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("b12a68f6-0eaa-4a8a-a741-398a0be43f62"), new Guid("01adc720-91a4-47c6-9235-d21a3215ee6f"), new Guid("0363121b-d92e-4722-81dc-47032aae5440")).WithObjectTypes(SupplierRelationship, allorsDate).WithSingularName("LastReminderDate")  .WithPluralName("LastReminderDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("e96a79e7-c161-4ed9-a5cc-8de4f67bf954"), new Guid("1a406db2-268a-4669-a629-e0e15fdbd826"), new Guid("aa91e2ad-89c0-411e-9271-56fbf20489f6")).WithObjectTypes(SupplierRelationship, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("ee871786-8840-404d-9b41-932a9f59be13"), new Guid("5b98959d-5589-4958-a86f-4c9b465c1632"), new Guid("056ca61a-1ab4-4e53-8d5f-328ada5f3b11")).WithObjectTypes(SupplierRelationship, allorsDate).WithSingularName("BlockedForDunning")  .WithPluralName("BlockedsForDunning")      .Build();
			
            // EventRegistration
            new RelationTypeBuilder(domain, new Guid("af4b8828-bea1-43e5-b109-9934311cc2df"), new Guid("bd962b63-dff5-4b09-bd30-ef11755a381e"), new Guid("dcfcbf03-1cac-4533-a3b7-a235f167645c")).WithObjectTypes(EventRegistration, Person).WithSingularName("Person")  .WithPluralName("Persons")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("ed542026-7020-43e3-ab72-c3f4dd991a4b"), new Guid("cba93e20-e78d-4c86-8b5b-2daa930fde35"), new Guid("b2c0c98f-5ed7-4329-bfcb-ab0f3e6e169c")).WithObjectTypes(EventRegistration, Event).WithSingularName("Event")  .WithPluralName("Events")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("f9805362-2bd2-46d4-b9b2-d38cd0a76f78"), new Guid("e2dcb678-d8ba-45ed-9f25-5a87aae2d18f"), new Guid("19f9c2a6-5e2c-4bfb-bc63-b13d998e92e3")).WithObjectTypes(EventRegistration, allorsDate).WithSingularName("AllorsDateTime")  .WithPluralName("AllorsDateTimes")      .Build();
			
            // ServiceEntryBilling
            new RelationTypeBuilder(domain, new Guid("2fb9d650-0a28-4a39-8427-8c12bc4a20a1"), new Guid("c91e3796-6b23-4aa7-992b-ac15da334eae"), new Guid("7ca6affa-7d4f-45bd-88e2-a0fa1cad4ad7")).WithObjectTypes(ServiceEntryBilling, ServiceEntry).WithSingularName("ServiceEntry")  .WithPluralName("ServiceEntries")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("a8c707fb-98c1-43b1-99a3-9464cb25ea5f"), new Guid("284bf54c-8305-4892-ad00-f4975e155522"), new Guid("570acec5-b62e-4abc-bb1d-000fb70bc2fe")).WithObjectTypes(ServiceEntryBilling, InvoiceItem).WithSingularName("InvoiceItem")  .WithPluralName("InvoiceItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // PurchaseShipment
            new RelationTypeBuilder(domain, new Guid("400d42cd-bb10-406d-a448-9d9d53ccb5ca"), new Guid("9133d8c2-1988-42ef-a006-d02693e322e4"), new Guid("2f25f5a9-d1ef-45e3-8317-8bbcc65ff2ff")).WithObjectTypes(PurchaseShipment, PurchaseShipmentObjectState).WithSingularName("CurrentObjectState")  .WithPluralName("CurrentObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("40277d59-6ab8-40b0-acee-c95ba759e2c8"), new Guid("d7feb989-dd2d-4619-b079-8a059129f8ed"), new Guid("068d5263-18d7-40e4-80c1-4f9a8e88d10a")).WithObjectTypes(PurchaseShipment, Facility).WithSingularName("Facility")  .WithPluralName("Facilities")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("63363873-1dba-4044-8793-0196fc58f6ab"), new Guid("184515ec-10fc-49f9-8822-6a53eb899700"), new Guid("a3a49f0c-243b-4656-97f5-66fd012874eb")).WithObjectTypes(PurchaseShipment, PurchaseShipmentObjectState).WithSingularName("PreviousObjectState")  .WithPluralName("PreviousObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("8be328c9-0688-469b-901d-c9c290b30e88"), new Guid("df4fe9a9-3043-44a6-a4da-96465e63ba07"), new Guid("3726d5dd-a927-48ac-83a5-04d5c2e46b85")).WithObjectTypes(PurchaseShipment, PurchaseShipmentStatus).WithSingularName("ShipmentStatus")  .WithPluralName("ShipmentStatuses")  .WithMultiplicity(Multiplicity.OneToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("ef34543c-6194-4f27-87d7-a54285bc0a15"), new Guid("33b1069f-7be2-4f41-b502-8689256706d9"), new Guid("33dce90e-2a2a-482b-bee5-fcea55e59160")).WithObjectTypes(PurchaseShipment, PurchaseOrder).WithSingularName("PurchaseOrder")  .WithPluralName("PurchaseOrders")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // UnitOfMeasureConversion
            new RelationTypeBuilder(domain, new Guid("3ae94702-ee60-4057-a649-f655ff4e2865"), new Guid("1ab7d188-af19-4742-a0e6-11043b666bd4"), new Guid("5372ec1c-9b57-4ed5-b665-cdad8a13d933")).WithObjectTypes(UnitOfMeasureConversion, IUnitOfMeasure).WithSingularName("ToUnitOfMeasure")  .WithPluralName("ToUnitOfMeasures")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("5d7ed801-4a2e-4abc-a32d-d869210132af"), new Guid("a3467a5f-8c7d-453a-9a33-18d742f20d06"), new Guid("4b8a465d-9334-427f-b799-d08b7c84200a")).WithObjectTypes(UnitOfMeasureConversion, allorsDate).WithSingularName("StartDate")  .WithPluralName("StartDates")      .Build();
            ...
            // PaymentBudgetAllocation
            new RelationTypeBuilder(domain, new Guid("28f23032-b81c-4dbb-aa6c-24740ae3bb26"), new Guid("451ff770-7f33-4251-b78b-907ad95a9c38"), new Guid("1b82d64e-aeff-4150-b388-1144bef8b2ee")).WithObjectTypes(PaymentBudgetAllocation, Payment).WithSingularName("Payment")  .WithPluralName("Payments")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("3245613c-71d3-4a5e-a687-6f5ac306d9df"), new Guid("3cf6b4ce-56df-44c9-9348-3a419a226edc"), new Guid("e672774d-e11d-46df-9387-ef9f52315148")).WithObjectTypes(PaymentBudgetAllocation, BudgetItem).WithSingularName("BudgetItem")  .WithPluralName("BudgetItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("4301bb17-43b6-4bf3-a874-7441dd419dd0"), new Guid("5b6d83a4-a7f5-4097-bc9b-7ba91e3b96ee"), new Guid("269ea202-bffb-42ff-a497-4a2fa1afbaad")).WithObjectTypes(OrganisationRollUp, OrganisationUnit).WithSingularName("RollupKind")  .WithPluralName("RollupKinds")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("92ebf310-72ea-468b-a880-7268b48df41a"), new Guid("71b8ea7b-5316-42df-adc0-2aded71c9eaf"), new Guid("e005418e-9180-4146-b55a-81ff9fb06078")).WithObjectTypes(OrganisationRollUp, Organisation).WithSingularName("Child")  .WithPluralName("Children")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("208f711f-5d9d-4dc3-89ad-b1583ad06582"), new Guid("d91ef645-f5ef-4f09-9d6b-c023d02978f5"), new Guid("c1467dbc-9b64-49a0-8715-90ad277b02c9")).WithObjectTypes(Request, allorsDate).WithSingularName("RequiredResponseDate")  .WithPluralName("RequiredResponseDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("25332874-3ec6-41d8-ac6a-77dd4328e503"), new Guid("acae3045-3612-4cac-9994-ca81d350da74"), new Guid("576e5797-b3d3-41ab-a788-2b3eeba36f18")).WithObjectTypes(Request, RequestItem).WithSingularName("RequestItem")  .WithPluralName("RequestItems")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            // WorkEffortAssignment
            new RelationTypeBuilder(domain, new Guid("54bbdb5d-74b9-4ac7-b638-b1ef4a210b6e"), new Guid("91713efa-721d-43b7-99dd-ec7681456781"), new Guid("dafa5322-4905-40fa-ae14-ae5ee80f0f1c")).WithObjectTypes(WorkEffortAssignment, Person).WithSingularName("Professional")  .WithPluralName("Professionals")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("93cb0818-2599-4652-addd-4a1032d5dde9"), new Guid("2d5c955f-4bd5-43d2-a8f4-3df03ef6b78b"), new Guid("c42be8db-6e5a-459c-afbc-39bcac3e1eb2")).WithObjectTypes(WorkEffortAssignment, WorkEffort).WithSingularName("Assignment")  .WithPluralName("Assignments")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // SalesOrderStatus
            new RelationTypeBuilder(domain, new Guid("4c0986f4-c033-4646-b062-da9699bd8455"), new Guid("96c8b409-1ac9-4f31-a6a2-191bee4a1a82"), new Guid("99a005bb-6961-4a19-bedc-5bdce1829cb9")).WithObjectTypes(SalesOrderStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
            new RelationTypeBuilder(domain, new Guid("e61dabc2-729c-41cc-8d89-aea6e6557914"), new Guid("f3b9f2c8-18b5-4334-99e5-7f4f4eee7571"), new Guid("2e1c48fe-536b-4b2a-8e49-7320c961d42c")).WithObjectTypes(SalesOrderStatus, SalesOrderObjectState).WithSingularName("SalesOrderObjectState")  .WithPluralName("SalesOrderObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("a2ace411-df41-4191-b867-5f73ae5a1be7"), new Guid("1786e0dc-0483-4b80-942c-0c7d7ee8e913"), new Guid("44f58270-a4c7-49ca-838f-8a70a3ebe6d1")).WithObjectTypes(SalesChannelRevenue, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("f0fb8f34-e639-4c48-a1b7-66197520572d"), new Guid("9c2f6135-d7c7-400b-9450-b65abc402a8c"), new Guid("936d33cb-b303-4663-90cb-0bd64c864d21")).WithObjectTypes(SalesChannelRevenue, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("6f6af8ac-a4db-46e2-8bfd-a55161b12b66"), new Guid("345ec7c5-d2c5-489c-99eb-404659c7abba"), new Guid("119c0e16-d47a-46d4-bf57-4ece6cca2bf3")).WithObjectTypes(SalesChannelRevenueHistory, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("d1fe6003-0415-4826-ac5b-6fdaff587410"), new Guid("b87bb3d9-07d4-4178-99eb-77be7baba818"), new Guid("b392d765-f353-4c20-9410-f73f73978eae")).WithObjectTypes(SalesChannelRevenueHistory, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // PriceComponent
            new RelationTypeBuilder(domain, new Guid("18cda5a7-6720-4133-a71b-ce23e9ebc1bb"), new Guid("bfdd0a69-e69f-49e0-b756-e6b3307a2bd2"), new Guid("5934c3f4-3f64-4f5a-b455-70590ae02328")).WithObjectTypes(PriceComponent, GeographicBoundary).WithSingularName("GeographicBoundary")  .WithPluralName("GeographicBoundaries")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("52883992-8e1b-472a-9cc7-67d4824a2cd4"), new Guid("5a14b240-2eb3-4051-b9cb-8eefb0fd1722"), new Guid("ac8e7099-f0bd-492f-bbd9-5890060c56eb")).WithObjectTypes(PriceComponent, PackageQuantityBreak).WithSingularName("PackageQuantityBreak")  .WithPluralName("PackageQuantityBreaks")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("55c43896-ba79-4752-8fd4-7fd8501d64b6"), new Guid("38475cd5-ee15-4507-a810-f77ef0fb5cab"), new Guid("9e905572-d1bf-435b-8238-3a00da09f243")).WithObjectTypes(PriceComponent, Product).WithSingularName("Product")  .WithPluralName("Products")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("5b91ebce-6ebe-4d5f-a8bc-22cd7e7d688a"), new Guid("de72aa4b-17f1-4037-99e5-95f30c1f8f90"), new Guid("78d118ed-dcb7-4b8a-84ae-d1a9fdf11643")).WithObjectTypes(PriceComponent, RevenueQuantityBreak).WithSingularName("RevenueQuantityBreak")  .WithPluralName("RevenueQuantityBreaks")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("5cab507a-bf96-40c9-89cd-86d59ad07c33"), new Guid("bbeb2003-75ee-415e-a841-bab8af7153bc"), new Guid("6f1ba75a-c271-45d7-bebb-601889291784")).WithObjectTypes(PriceComponent, Party).WithSingularName("SpecifiedFor")  .WithPluralName("SpecifiedFors")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("6c0744ee-b730-490d-bb0c-b6be95211371"), new Guid("1eb6f686-586e-47cd-b23a-bcbc75430e7c"), new Guid("54726272-92ba-494c-9c08-d19e3248e2f3")).WithObjectTypes(PriceComponent, ProductFeature).WithSingularName("ProductFeature")  .WithPluralName("ProductFeatures")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("80379d5a-1831-4eed-abd3-a9574e3edd1d"), new Guid("d1a93eac-7143-43fc-897e-be6b198e69ec"), new Guid("cf38c778-74c9-4da2-8619-f3c87cee5f19")).WithObjectTypes(PriceComponent, AgreementPricingProgram).WithSingularName("AgreementPricingProgram")  .WithPluralName("AgreementPricingPrograms")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("c2b2b046-9e62-4065-8f2d-10624f7565aa"), new Guid("6e44c9e4-cf29-4303-8217-e01b5ce9dcb7"), new Guid("6fbee15a-bcba-46b6-9ea0-ff8c9a3256c4")).WithObjectTypes(PriceComponent, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("cb552b8b-f251-4c57-8cc7-8cc299631022"), new Guid("087b6d0d-399d-408e-af06-84bd70a0eff6"), new Guid("e968a3a1-7394-465a-829a-f8f33ea3fc4c")).WithObjectTypes(PriceComponent, OrderKind).WithSingularName("OrderKind")  .WithPluralName("OrderKinds")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("dc1cf3af-2f22-43e6-863d-346e91aa2240"), new Guid("7a5ec695-a56a-40dc-8898-667276078d3d"), new Guid("6dfffe42-670a-4076-b240-9e8ffb43f243")).WithObjectTypes(PriceComponent, OrderValue).WithSingularName("OrderValue")  .WithPluralName("OrderValues")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("98ad9944-62a5-4045-b4ba-0317240f5a61"), new Guid("297ff711-7ebd-45e0-87ed-2c68e8c71fce"), new Guid("8bb7005b-3d03-4ecd-b3d0-413a814f682a")).WithObjectTypes(PartyProductRevenue, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("bfca3b6f-a394-4f06-b04f-a29bcd4bade7"), new Guid("e048ce53-554c-4303-a13d-c27d8ea73c6d"), new Guid("f3ddc5c1-5281-4b42-bb2c-5f4ddbcea002")).WithObjectTypes(PartyProductRevenue, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("ff1b20d3-602b-4f43-92c7-d3f412950672"), new Guid("3bdf82fa-e7c4-4ab4-b766-af73c6a4ce27"), new Guid("a1587822-ec41-4bdc-8655-491f5012ac1b")).WithObjectTypes(PartyProductRevenue, Product).WithSingularName("Product")  .WithPluralName("Products")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // Organisation
            new RelationTypeBuilder(domain, new Guid("1c8bf2e3-6794-47c8-990c-f124d47653fb"), new Guid("d60f70d2-a17e-47d9-bccc-7971f5ef776d"), new Guid("d0f185d6-1ae2-40bf-a95e-6fde7ae10fa9")).WithObjectTypes(Organisation, LegalForm).WithSingularName("LegalForm")  .WithPluralName("LegalForms")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("59500ed1-2de5-45ff-bec7-275c1941d153"), new Guid("bd699a2c-e1dc-48dd-9d0a-c1aec3b18f44"), new Guid("9501b51f-92e1-4ab8-862b-c6b6fd469b68")).WithObjectTypes(Organisation, Person).WithSingularName("CurrentContact")  .WithPluralName("CurrentContacts")  .WithMultiplicity(Multiplicity.ManyToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("e90cb555-e6d9-4d7d-8d98-6f9c28c4bc14"), new Guid("739ac865-7c8c-45e3-b240-349e4092a56b"), new Guid("4087a04c-3f31-4c82-b7b1-bd5c7818981f")).WithObjectTypes(WorkEffortFixedAssetAssignment, FixedAsset).WithSingularName("FixedAsset")  .WithPluralName("FixedAssets")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // GeographicBoundaryComposite
            new RelationTypeBuilder(domain, new Guid("77d5f129-6096-45da-8b9f-39ef19276f1d"), new Guid("7484e00e-de39-4fbe-981a-aff3e693cf89"), new Guid("03ef822a-e2d3-43ba-9051-2c663593fb31")).WithObjectTypes(GeographicBoundaryComposite, GeographicBoundary).WithSingularName("Association")  .WithPluralName("Associations")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("35f92e67-aedd-4e62-aa1b-57f6489c0083"), new Guid("995ccfb4-f1ca-4894-9fd9-fbf19e2226eb"), new Guid("96eaeb9a-8047-4068-9185-765fc0e48342")).WithObjectTypes(CustomerRelationship, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("af50ade8-5964-4963-819d-c87689c6434e"), new Guid("a06dda1c-d91d-4e27-b293-05cb53de65ec"), new Guid("7f6da6ca-b069-47f6-983c-6e33d65ffd0e")).WithObjectTypes(CustomerRelationship, allorsDate).WithSingularName("LastReminderDate")  .WithPluralName("LastReminderDates")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("130d6e94-51e2-45f9-82d7-380ae7c8aa44"), new Guid("68c1c826-9915-4f7b-8a44-dc62e215b260"), new Guid("e47aa296-12fa-45f1-8deb-0f151aaaba60")).WithObjectTypes(Party, TelecommunicationsNumber).WithSingularName("BillingInquiriesFax")  .WithPluralName("BillingInquiriesFaxes")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("19c8a5a0-9567-4fc2-bfad-94a549cfa191"), new Guid("b8622d0f-ba18-4a76-b1d9-25115378c01c"), new Guid("6656341b-4b2a-41a3-abad-9aece1294b79")).WithObjectTypes(Party, Qualification).WithSingularName("Qualification")  .WithPluralName("Qualifications")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("1ad85fce-f2f8-45aa-bf1e-8f5ade34153c"), new Guid("20dd50d2-06c8-48e8-883d-5f894c973834"), new Guid("e3834580-66fc-4b4d-b0fa-58e19f660316")).WithObjectTypes(Party, ContactMechanism).WithSingularName("HomeAddress")  .WithPluralName("HomeAddresses")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("1d4e59a6-253f-470e-b9a7-c2c73b67cf2f"), new Guid("996ea544-3d27-410d-aa23-25457532e3b1"), new Guid("90f0a491-c7c7-4ff5-9910-77d430f6292a")).WithObjectTypes(Party, ContactMechanism).WithSingularName("SalesOffice")  .WithPluralName("SalesOffices")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("42ab0c4b-52b2-494e-b6a9-cacf55fb002e"), new Guid("32d52b42-f5cc-4fd0-959c-045ff0c02520"), new Guid("977a3626-85af-47a8-bfe8-ed2e8daa1d9e")).WithObjectTypes(Party, PartyContactMechanism).WithSingularName("PartyContactMechanism")  .WithPluralName("PartyContactMechanisms")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("70ada4aa-c51c-4f1d-a3d2-ea6de31cb988"), new Guid("9f1ea588-8dd9-4f48-a905-0271e694f1fe"), new Guid("f2455f15-83f5-4599-9b2e-c1b8d9b92995")).WithObjectTypes(Party, ContactMechanism).WithSingularName("BillingAddress")  .WithPluralName("BillingAddresses")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("79a5c25a-91e9-4a80-8649-c8abe86e47dd"), new Guid("39d03d8f-8fbc-4131-8e97-7f5fcf73871c"), new Guid("711fc18b-b5f8-4235-8a51-22f91e4c194e")).WithObjectTypes(Party, ShipmentMethod).WithSingularName("DefaultShipmentMethod")  .WithPluralName("DefaultShipmentMethods")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("7dc1e326-76ef-4bac-aae1-d6a26da9d40a"), new Guid("5b8c7f22-121d-473f-83e0-41f20740b912"), new Guid("468e863c-79f9-48a1-a28e-ad6159940b01")).WithObjectTypes(Party, Resume).WithSingularName("Resume")  .WithPluralName("Resumes")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("89971e75-61e5-4a0c-b7fc-6f4c15866175"), new Guid("ef2f1c0e-ecc2-4949-aec9-88460c0d5b0b"), new Guid("d80cc262-207a-462e-b8ed-ee58f04cf98b")).WithObjectTypes(Party, ContactMechanism).WithSingularName("HeadQuarter")  .WithPluralName("HeadQuarters")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("a7720655-a6c1-4f54-a093-b77da985ac5f"), new Guid("4f9183c0-bac1-4738-97e3-15c2906759e8"), new Guid("d1e7a633-f097-4030-b3c3-9167c022fe05")).WithObjectTypes(Party, ContactMechanism).WithSingularName("OrderAddress")  .WithPluralName("OrderAddresses")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("4584c4f9-12a5-4435-a6b8-2b2e6bb932b9"), new Guid("852fe55f-9f03-4542-90f4-ef4fceb560a3"), new Guid("013068f6-131a-4d0c-9847-d772ba9d3596")).WithObjectTypes(PartyProductCategoryRevenue, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("7f6972f9-16dc-4795-9e4b-7095738e80ed"), new Guid("20ecc315-ee8c-4bd2-9320-f16d258db9bc"), new Guid("9cf8972a-71d1-465e-bf08-6713c695a29a")).WithObjectTypes(PartyProductCategoryRevenue, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("70c7d06c-2086-4a60-b2b9-aba2c6f07669"), new Guid("23ec81db-27f0-4965-bf25-4f0150fd4281"), new Guid("02896b5c-8c38-40d3-89e3-9b3a0d209d3f")).WithObjectTypes(MarketingPackage, Product).WithSingularName("ProductUsedIn")  .WithPluralName("ProductsUsedIn")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("a687e8ff-624c-4794-866f-f4cc653d874c"), new Guid("7d1b384b-4730-4e61-8a80-8d18ea8e2ae4"), new Guid("ea685b4f-3063-47a9-ba82-980247e903af")).WithObjectTypes(MarketingPackage, Product).WithSingularName("Product")  .WithPluralName("Products")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // ItemIssuance
            new RelationTypeBuilder(domain, new Guid("60089b34-e9aa-4b09-9a5c-4523ce60152f"), new Guid("ddf8eba9-8821-490f-9d9d-adc6ebd32ddb"), new Guid("ee8e4f06-63e8-4281-a010-9f9212244cf1")).WithObjectTypes(ItemIssuance, allorsDate).WithSingularName("IssuanceDateTime")  .WithPluralName("IssuanceDateTimes")      .Build();
            new RelationTypeBuilder(domain, new Guid("6d0e1669-1583-4004-a0dd-6481faaa4803"), new Guid("2deb9c3e-6e3e-462c-88bf-df682a4af6e0"), new Guid("d8e7874c-a162-440a-8e99-4dd7b07216cd")).WithObjectTypes(ItemIssuance, InventoryItem).WithSingularName("InventoryItem")  .WithPluralName("InventoryItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("83de0bfa-98ca-4299-a529-f8ba8a02cb90"), new Guid("467ce53a-969b-4537-b51c-998ac64afbe9"), new Guid("1766b9c8-436d-427c-8c54-4f10a6accf02")).WithObjectTypes(ItemIssuance, ShipmentItem).WithSingularName("ShipmentItem")  .WithPluralName("ShipmentItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // ShipmentPackage
            new RelationTypeBuilder(domain, new Guid("293eb102-b098-4e5d-8cef-d5e0b4f1ca5d"), new Guid("24a2efe7-c10e-4cb0-807b-3c3ae7d4361f"), new Guid("82196a58-d9ba-4508-bdbf-84964f2d2590")).WithObjectTypes(ShipmentPackage, PackagingContent).WithSingularName("PackagingContent")  .WithPluralName("PackagingContents")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("7f009302-d4f4-4b06-9e18-fb1c35bd79e7"), new Guid("30cfc1be-1131-4914-888f-30f29e770332"), new Guid("7d4a4b20-3424-43b5-a7cf-7e9422c5870d")).WithObjectTypes(ShipmentPackage, Document).WithSingularName("Document")  .WithPluralName("Documents")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("afd7e182-d201-4eee-803c-9fb4dff0feed"), new Guid("5b2b0551-afcb-4cc3-863e-ba351492da45"), new Guid("d00256d2-fbc8-4935-bfe9-0b0843622936")).WithObjectTypes(ShipmentPackage, allorsDate).WithSingularName("CreationDate")  .WithPluralName("CreationDates")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("2f6ed687-4200-4a27-bfb2-922d9ce2e38f"), new Guid("5f2b047e-2cb0-4d2a-9cce-77846ad35f45"), new Guid("f21bbf2d-0780-4bbf-92e6-2c6676b4893d")).WithObjectTypes(PerformanceNote, allorsDate).WithSingularName("CommunicationDate")  .WithPluralName("CommunicationDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("5bf234d2-8486-47b2-a770-eca36b44bb67"), new Guid("cc9f9a6f-54fc-4786-9d83-2769d8d921ce"), new Guid("0467f9fa-17e9-4fdc-b74a-39d074e55b16")).WithObjectTypes(PerformanceNote, Person).WithSingularName("GivenByManager")  .WithPluralName("GivenByManagers")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("9a76f8ba-ae96-4040-81ce-59330392e77a"), new Guid("ca64ae22-fc6c-4747-a04b-ac77911c0c5e"), new Guid("1d77d632-e552-4745-a5d6-ebefc3f0ec06")).WithObjectTypes(ShipmentReceipt, OrderItem).WithSingularName("OrderItem")  .WithPluralName("OrderItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("ecdd6b27-3bcf-4f61-8e21-f829503aeeb0"), new Guid("b326cf9d-8770-4686-a7f5-2061d1683bb4"), new Guid("82ef73a5-8d4e-44a0-a551-b0c1dee958ca")).WithObjectTypes(ShipmentReceipt, allorsDate).WithSingularName("ReceivedDateTime")  .WithPluralName("ReceivedDateTimes")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("51133e4d-5135-4991-9f2f-8df9762fac78"), new Guid("fc2144b7-4a88-412d-9792-ba6f6c93c637"), new Guid("1cc0737e-a810-48d3-b048-7e3077d3db5c")).WithObjectTypes(FixedAsset, allorsDate).WithSingularName("LastServiceDate")  .WithPluralName("LastServiceDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("54cf9225-9204-43ee-9984-7fd8b2cbf8bc"), new Guid("efb718b5-7d70-4696-81c8-961582ed01f2"), new Guid("99c0a722-af34-4008-b7f5-dc4315c7fa1a")).WithObjectTypes(FixedAsset, allorsDate).WithSingularName("AcquiredDate")  .WithPluralName("AcquiredDates")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("ead0e86a-dfc7-45b0-9865-b973175c4567"), new Guid("6be614a2-0511-4ca0-9b1c-c8a3d0b0a998"), new Guid("47d9d93c-8ba3-4f28-a8a5-6a4cb02853e6")).WithObjectTypes(FixedAsset, allorsDate).WithSingularName("NextServiceDate")  .WithPluralName("NextServiceDates")      .Build();
			
            // ServiceEntry
            new RelationTypeBuilder(domain, new Guid("385eac5a-a588-4f30-b4df-a4b07be43d88"), new Guid("36477b8a-7c51-4fe6-bd6f-44e6205fb1bd"), new Guid("ed9b3483-c2a2-4572-9346-35ed621500b9")).WithObjectTypes(ServiceEntry, allorsDate).WithSingularName("ThroughDateTime")  .WithPluralName("ThroughDateTimes")      .Build();
            new RelationTypeBuilder(domain, new Guid("74fc8f9b-62f3-4921-bce1-ca10eed33204"), new Guid("987c6fb3-b512-4797-933d-28424500649e"), new Guid("1bbf98fb-fb84-45e7-b3f3-c6d5bb9b155c")).WithObjectTypes(ServiceEntry, EngagementItem).WithSingularName("EngagementItem")  .WithPluralName("EngagementItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("a4246c12-e77c-41e0-9f00-995fab17c13c"), new Guid("eef2f215-f262-4f7e-b87b-a8229b1d5d4b"), new Guid("f1ff8c32-0f88-49b9-83c1-b0754d65700e")).WithObjectTypes(ServiceEntry, allorsDate).WithSingularName("FromDateTime")  .WithPluralName("FromDateTimes")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("e0fe2033-85a9-428d-9918-f543fbcf3ed7"), new Guid("49e8ccb2-8a3f-4846-8067-9f68d005e44f"), new Guid("9d19f214-3ed9-4e2d-a924-2d513ca01934")).WithObjectTypes(SerializedInventoryItem, SerializedInventoryItemObjectState).WithSingularName("CurrentObjectState")  .WithPluralName("CurrentObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            // RespondingParty
            new RelationTypeBuilder(domain, new Guid("13f84c6c-d44a-4cc2-8898-bc2cbaed04f4"), new Guid("88a8016f-ecd7-4085-82d0-a9698d078184"), new Guid("72177a66-0459-4b6e-a8ea-2b5786e09f31")).WithObjectTypes(RespondingParty, allorsDate).WithSingularName("SendingDate")  .WithPluralName("SendingDates")      .Build();
            ...
            // BudgetStatus
            new RelationTypeBuilder(domain, new Guid("070418ab-f9aa-4286-9395-879b06cf832a"), new Guid("ee3be6af-f2b5-411a-a07b-24eb676bd923"), new Guid("ceee8ab2-a8da-45d8-be09-61e353e8b1a3")).WithObjectTypes(BudgetStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
            new RelationTypeBuilder(domain, new Guid("125c0c29-4f69-4e0b-b885-76c1e908737e"), new Guid("f5e1e19d-2c13-4163-b796-a8e0b7a80fcc"), new Guid("554bd320-adce-40ac-83b0-5710e69a0b25")).WithObjectTypes(BudgetStatus, BudgetObjectState).WithSingularName("BudgetObjectState")  .WithPluralName("BudgetObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("44d5c360-a82d-40ca-a56c-e377327a4858"), new Guid("0588e142-76ff-43a7-ae6e-63427fc18b43"), new Guid("6c00b475-38d9-4f2a-a53b-5a82434db39a")).WithObjectTypes(PositionType, Responsibility).WithSingularName("Responsibility")  .WithPluralName("Responsibilities")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("aa3886a5-a407-4598-900c-8fc3bcfc0604"), new Guid("bb552053-d6e7-470b-a8d9-81ed85950b19"), new Guid("827e2eda-b1bf-4040-9c3a-ff728a44f4c3")).WithObjectTypes(PositionType, PositionTypeRate).WithSingularName("PositionTypeRate")  .WithPluralName("PositionTypeRates")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // Agreement
            new RelationTypeBuilder(domain, new Guid("2ddce7b3-c763-45ea-8e1b-5ef8a0ea8e4a"), new Guid("d27ed7da-6a94-40ee-b790-8754282a2a1b"), new Guid("f199641e-5574-4733-b4e9-42f6ccb713a8")).WithObjectTypes(Agreement, allorsDate).WithSingularName("AgreementDate")  .WithPluralName("AgreementDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("34f0e272-7c56-4d92-a187-c40d9d907110"), new Guid("537bbe1f-ab09-4cbe-92d6-21e199dfcbf5"), new Guid("3fdf6e81-1581-40ca-a1ba-647f33ede850")).WithObjectTypes(Agreement, Addendum).WithSingularName("Addendum")  .WithPluralName("Addenda")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("d5c90527-cae6-4a4f-9fd7-96f93dad59c7"), new Guid("ceb36b51-89ef-4335-a29f-c3c0f0fc3c06"), new Guid("061d6861-26d9-4008-8612-b72e78bae14f")).WithObjectTypes(Agreement, AgreementItem).WithSingularName("AgreementItem")  .WithPluralName("AgreementItems")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            // Resume
            new RelationTypeBuilder(domain, new Guid("5ebf789b-f66a-40c9-99d6-bfaedc581c78"), new Guid("f90810ba-d62d-4e51-b9c7-5aac4e7d4d87"), new Guid("62592457-6263-4e92-b45d-b929245fa750")).WithObjectTypes(Resume, allorsDate).WithSingularName("ResumeDate")  .WithPluralName("ResumeDates")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("07b3745c-581c-476b-a4a9-beacaa3bd700"), new Guid("7878206b-b4f9-4ddd-b69e-a041402844dd"), new Guid("2e77d783-9cda-41e6-be8b-1bf96520a385")).WithObjectTypes(FinancialAccountTransaction, allorsDate).WithSingularName("EntryDate")  .WithPluralName("EntryDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("8f777804-597a-4604-a553-251e2e9d6502"), new Guid("f74151d5-ad2e-4418-b3a1-3772afbdaf52"), new Guid("3135d67e-7290-4eb2-aec8-e783d9325a02")).WithObjectTypes(FinancialAccountTransaction, allorsDate).WithSingularName("TransactionDate")  .WithPluralName("TransactionDates")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("092a296d-6f15-4fdd-aed6-25185e6e10b1"), new Guid("95a67913-5914-4705-b76d-6eed73704fab"), new Guid("ff1fade9-aa0b-4058-b8e0-8d993eb841cb")).WithObjectTypes(WorkEffort, WorkEffort).WithSingularName("Precendency")  .WithPluralName("Precendencies")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("0db9b217-c54f-4a7b-a1c0-9592eeabd51f"), new Guid("c918d8f5-77f0-4c0d-b02a-7695a7109cf2"), new Guid("ae8f325d-31e5-473a-8caf-d378ba571025")).WithObjectTypes(WorkEffort, Facility).WithSingularName("Facility")  .WithPluralName("Facilities")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("2efd427f-daeb-4b84-9f86-857ed1bdb1b7"), new Guid("0e92f113-f607-46bb-85c1-eb3cddb317ef"), new Guid("40e23b5c-8943-4e27-86a1-d0a0140068e6")).WithObjectTypes(WorkEffort, WorkEffort).WithSingularName("Child")  .WithPluralName("Children")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("3081fa56-272c-43d6-a54c-ad70cb233034"), new Guid("171d3338-5b58-4776-87de-a0b934e15a0a"), new Guid("3c24f9fa-1ada-42f8-8fe1-90c244189254")).WithObjectTypes(WorkEffort, OrderItem).WithSingularName("OrderItemFulfillment")  .WithPluralName("OrderItemFulfillments")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("39c8b84f-6925-41f7-aecf-2d73481746cc"), new Guid("736b0da0-facc-48ed-a2a2-2d67257c733b"), new Guid("05694786-18d6-4694-9e37-90f804bab984")).WithObjectTypes(WorkEffort, WorkEffortStatus).WithSingularName("WorkEffortStatus")  .WithPluralName("WorkEffortStatuses")  .WithMultiplicity(Multiplicity.OneToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("3bebd379-65a9-445e-898e-8913c26b94e6"), new Guid("d12425ed-2676-419e-bfae-674810fde5a8"), new Guid("f4b0fb7e-8e84-43ca-88b0-44242216ee7e")).WithObjectTypes(WorkEffort, WorkEffortType).WithSingularName("WorkEffortType")  .WithPluralName("WorkEffortTypes")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("62b84e6e-1b2f-46cb-825f-57f586e6cb92"), new Guid("81a938c3-1b27-4c24-993a-9bf616f06582"), new Guid("dc2dc942-1210-4fdd-ad95-fe5b4dbd674d")).WithObjectTypes(WorkEffort, InventoryItem).WithSingularName("InventoryItemProduced")  .WithPluralName("InventoryItemsProduced")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("a60c8797-320d-471f-9755-d3ef20a4feac"), new Guid("dd8b0f11-0443-4120-be2f-9a43125ccd62"), new Guid("7693cd03-9b2c-4f10-9826-0335371e893d")).WithObjectTypes(WorkEffort, Requirement).WithSingularName("RequirementFulfillment")  .WithPluralName("RequirementFulfillments")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("add2f3d5-d83a-4734-ad69-9f86eb116f06"), new Guid("d5f050e0-d662-4ac7-90d5-16625fd4afff"), new Guid("18fac5c8-2ba6-43cb-ad3b-d82facc17590")).WithObjectTypes(WorkEffort, WorkEffort).WithSingularName("Concurrency")  .WithPluralName("Concurrencies")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            ...
            // PickListStatus
            new RelationTypeBuilder(domain, new Guid("e1187cc2-9518-4387-986a-e989b303035f"), new Guid("b47b4537-e686-4f86-b45f-5366f05de7d3"), new Guid("67ffe9b3-3916-48e3-9c64-d1427f350737")).WithObjectTypes(PickListStatus, PickListObjectState).WithSingularName("PickListObjectState")  .WithPluralName("PickListObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("f87a3dcf-742c-4a3c-afbb-af1969164db9"), new Guid("153a2b44-da58-4db4-9b57-bfa9992c0353"), new Guid("52862edb-477c-4522-85c8-bcedb6affcdd")).WithObjectTypes(PickListStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("05a2e95a-e5f1-45bc-a8ca-4ebfad3290b5"), new Guid("1674a9e0-00de-45fa-bde4-63a716a31557"), new Guid("594503f3-c081-46b3-9695-92b921c15a6b")).WithObjectTypes(Product, allorsDate).WithSingularName("SupportDiscontinuationDate")  .WithPluralName("SupportDiscontinuationDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("0b283eb9-2972-47ae-80d8-1a7aa8f77673"), new Guid("aa3ccdc9-7286-4a82-912a-dd2e53c7410b"), new Guid("487e408f-d55b-4273-bbe9-b0291069ae42")).WithObjectTypes(Product, allorsDate).WithSingularName("SalesDiscontinuationDate")  .WithPluralName("SalesDiscontinuationDates")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("438f00fe-750a-414d-a498-a03095c086fb"), new Guid("62a5b5f3-0572-4f17-8f1b-10c9ee9048f4"), new Guid("e051a24d-f2de-439c-923a-39cf6c47a0e4")).WithObjectTypes(Product, ProductCategory).WithSingularName("ProductCategoryExpanded")  .WithPluralName("ProductCategoriesExpanded")  .WithMultiplicity(Multiplicity.ManyToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("4632101d-09d6-4a89-8bba-e02ac791f9ad"), new Guid("3aed43b7-3bad-44f9-a2d9-8f865de71156"), new Guid("de3785d8-0143-4339-bf49-310c13de385a")).WithObjectTypes(Product, Product).WithSingularName("ProductComplement")  .WithPluralName("ProductComplements")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("5735f671-6c52-474b-83a9-3dd8765af241"), new Guid("4abbf18f-1f97-4fec-8e85-805432e65e53"), new Guid("c485cfba-d3fe-46c2-8495-ddb63c8b4f56")).WithObjectTypes(Product, ProductFeature).WithSingularName("OptionalFeature")  .WithPluralName("OptionalFeatures")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("5f727bd9-9c3e-421e-93eb-646c4fdf73d3"), new Guid("210976bb-e440-44ee-b2b5-39bcee04965b"), new Guid("3165a365-a0db-4ce6-b194-7636cc9c015a")).WithObjectTypes(Product, Party).WithSingularName("ManufacturedBy")  .WithPluralName("ManufacturedBys")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("60bd113a-d6b9-4de9-bbff-2b5094ec4803"), new Guid("b5198a54-72bc-4972-aded-b8eaf0f304a0"), new Guid("1c2134b2-d7ce-469a-a6e4-7e2cc741e07c")).WithObjectTypes(Product, Product).WithSingularName("Variant")  .WithPluralName("Variants")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("74fc9be0-8677-463c-b3b6-f0e7bb7478ba"), new Guid("23a3e0bb-a2f9-48d5-b57b-40376e68b0ba"), new Guid("c977306e-8738-4e30-88c1-3c545fdb4e93")).WithObjectTypes(Product, allorsDate).WithSingularName("IntroductionDate")  .WithPluralName("IntroductionDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("7c41deee-b270-4810-abaa-6d00e6507b9b"), new Guid("72d6f463-2335-44bc-830f-816ee635101b"), new Guid("8926c093-d513-44dd-9324-3accc051cb06")).WithObjectTypes(Product, Document).WithSingularName("Document")  .WithPluralName("Documents")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("8645a62d-b230-4378-b4a2-f7ab64c99e58"), new Guid("f9d855e4-d16b-4d63-9654-a1b455aaa0db"), new Guid("63a361ba-030b-4c95-91a6-ce9131dede95")).WithObjectTypes(Product, ProductFeature).WithSingularName("StandardFeature")  .WithPluralName("StandardFeatures")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("9bff7f7d-c35c-426d-95f3-6a681d283914"), new Guid("c9fd9c9c-f57d-413a-ac69-7983f5d51dd6"), new Guid("c7596ec0-5e1d-4d8e-8707-f276c01d1e5f")).WithObjectTypes(PartBillOfMaterialSubstitute, Ordinal).WithSingularName("Preference")  .WithPluralName("Preferences")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("ef45301b-415a-417f-a952-fd71704a05e5"), new Guid("589cd7f5-a89e-48d2-adbe-8c6307ab3585"), new Guid("aa0e3719-cbc3-4cb0-b83a-3ff5489771f3")).WithObjectTypes(PartBillOfMaterialSubstitute, PartBillOfMaterial).WithSingularName("PartBillOfMaterial")  .WithPluralName("PartBillOfMaterials")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // RequirementBudgetAllocation
            new RelationTypeBuilder(domain, new Guid("4d5cfc89-068f-4cf5-ae51-0b3efe426499"), new Guid("cf5c7a91-3579-458b-8337-ed0ad9474fc4"), new Guid("26f1d7ab-cda3-4b47-a422-293aa6c1f57f")).WithObjectTypes(RequirementBudgetAllocation, BudgetItem).WithSingularName("BudgetItem")  .WithPluralName("BudgetItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // OrganisationGlAccount
            new RelationTypeBuilder(domain, new Guid("8e20ce74-a772-45c8-a76a-a8ca0d4d7ebd"), new Guid("948a2115-8780-46c6-83cf-dd4d27a1771b"), new Guid("a3d68e22-e492-4d1e-8386-ea45ad67ee3a")).WithObjectTypes(OrganisationGlAccount, Product).WithSingularName("Product")  .WithPluralName("Products")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("d5332edf-3cc4-4f26-b0d1-da7ce1182dbc"), new Guid("1fb5ddfd-930a-4c81-8e9e-ac9d94840864"), new Guid("30c0c848-5361-4bd3-9c0a-8b9aeaccdadc")).WithObjectTypes(OrganisationGlAccount, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // InternalAccountingTransaction
            new RelationTypeBuilder(domain, new Guid("96a1901c-a17a-43d7-8d84-76e1586787f2"), new Guid("5f58fb32-15d9-47e0-9ace-9eb4c1cd2eda"), new Guid("03f1ae5e-0644-47c7-b31e-345e92085a9c")).WithObjectTypes(InternalAccountingTransaction, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // NonSerializedInventoryItem
            new RelationTypeBuilder(domain, new Guid("0958b237-ba88-48d3-b662-90328801b197"), new Guid("72957576-5146-4578-8526-8b7a50025526"), new Guid("ebd546cd-7341-496d-86ca-27a1b8fc253e")).WithObjectTypes(NonSerializedInventoryItem, NonSerializedInventoryItemObjectState).WithSingularName("CurrentObjectState")  .WithPluralName("CurrentObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("41d804d4-588b-4bea-b013-665f1a6974b9"), new Guid("c82ea702-7035-4293-a8ef-32f0e70e4763"), new Guid("6e17e218-c04d-4c78-9a01-32d16eec6692")).WithObjectTypes(NonSerializedInventoryItem, NonSerializedInventoryItemObjectState).WithSingularName("PreviousObjectState")  .WithPluralName("PreviousObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            // NeededSkill
            new RelationTypeBuilder(domain, new Guid("079ef934-26e1-4dba-a69a-73fcc22d380e"), new Guid("f2afa9e5-239d-46c8-94c7-57dd23cb645a"), new Guid("90f27ec7-03b8-491b-862c-3c18a37d4dbc")).WithObjectTypes(NeededSkill, SkillLevel).WithSingularName("SkillLevel")  .WithPluralName("SkillLevels")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("590d749a-52d4-448a-8f95-8412c0115825"), new Guid("3e6cc798-dae0-4381-abfd-bcba0b449d03"), new Guid("09e6d6b8-8a89-46af-99fa-f332fea7ab6c")).WithObjectTypes(NeededSkill, Skill).WithSingularName("Skill")  .WithPluralName("Skills")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("27faaa2c-d4db-4cab-aa04-8ec4997d73d2"), new Guid("2e9fab52-2029-4ee3-8eba-ffd9764bcf67"), new Guid("9dd23ce4-d760-45af-94e4-c2ac94b0aea3")).WithObjectTypes(SalesInvoice, ContactMechanism).WithSingularName("BillToContactMechanism")  .WithPluralName("BillToContactMechanisms")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("2d0e924b-ff24-4630-9151-ac9bfc844c0c"), new Guid("0a159385-7570-494e-976d-4ee493235cb3"), new Guid("239e91ee-5606-4131-a351-ebbd5908d9be")).WithObjectTypes(SalesInvoice, Party).WithSingularName("PreviousBillToCustomer")  .WithPluralName("PreviousBillToCustomers")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("3eb16102-21cc-4b71-a8e2-4f016da4cfb0"), new Guid("d6e7328a-c306-4649-a7cc-d6b53535845a"), new Guid("35ae04c4-8a23-4531-8736-370ce29c970f")).WithObjectTypes(SalesInvoice, SalesInvoiceType).WithSingularName("SalesInvoiceType")  .WithPluralName("SalesInvoiceTypes")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("5c1f4c88-f67d-4f82-a7de-28868a5f030d"), new Guid("32125426-057d-441f-b9c9-2162d58fea83"), new Guid("801d63a0-31ae-4000-802a-b827e4122c62")).WithObjectTypes(SalesInvoice, SalesOrder).WithSingularName("SalesOrder")  .WithPluralName("SalesOrders")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("6cb5e21c-6344-46a9-bab5-355cdfbead81"), new Guid("8e8100ae-dbaa-425c-9dfe-4dccb1d2335a"), new Guid("9f01863e-afc8-47d6-adf1-7c861cd97229")).WithObjectTypes(SalesInvoice, Person).WithSingularName("SalesRep")  .WithPluralName("SalesReps")  .WithMultiplicity(Multiplicity.ManyToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("6e2b9a8a-9d59-4041-a9ea-f3f8286f110c"), new Guid("ee7aba21-39d6-4a4c-8b18-c7c141c8abdc"), new Guid("12db3958-c666-475e-85db-124c6549664d")).WithObjectTypes(SalesInvoice, Shipment).WithSingularName("Shipment")  .WithPluralName("Shipments")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("7eb3ee0e-43ff-4534-b6f0-c2dba20d4ed6"), new Guid("5a2b19b5-624a-4c2d-99a8-334502a1ca5e"), new Guid("f9e155ae-80e3-42a7-a9be-a3a76dc72545")).WithObjectTypes(SalesInvoice, SalesInvoiceStatus).WithSingularName("InvoiceStatus")  .WithPluralName("InvoiceStatuses")  .WithMultiplicity(Multiplicity.OneToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("7f833ad2-3146-4660-a9d4-8a70d3ce01db"), new Guid("b466881e-156a-488f-9f26-c2850b7dd7fc"), new Guid("aa621b67-049a-44e8-9f70-07e2a0c696b8")).WithObjectTypes(SalesInvoice, Party).WithSingularName("PreviousShipToCustomer")  .WithPluralName("PreviousShipToCustomers")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("816d66a7-7cab-4ce3-9912-c7cc9d6c294c"), new Guid("8b3c78de-7281-4f94-aeda-1dc6bd345df3"), new Guid("056822e6-4333-44ae-8479-d05c1b1b2974")).WithObjectTypes(SalesInvoice, Party).WithSingularName("BillToCustomer")  .WithPluralName("BillToCustomers")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("af0a72c8-003c-44a6-8c6f-086f26542e3d"), new Guid("d434a95b-9053-4471-864b-3d139b78915d"), new Guid("6c44f465-7d50-4a1b-bffa-9693f9afbde2")).WithObjectTypes(SalesInvoice, Party).WithSingularName("ShipToCustomer")  .WithPluralName("ShipToCustomers")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("ddd9b372-4687-4a6e-b62b-4e0521f8c4b7"), new Guid("3e5b5599-82bc-4bc3-8ef0-9b2301a1ad40"), new Guid("33265997-e42c-4955-839c-d2ce054b2d33")).WithObjectTypes(SalesInvoice, ContactMechanism).WithSingularName("BilledFromContactMechanism")  .WithPluralName("BilledFromContactMechanisms")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("f2f85b74-b28f-4627-9dca-94142789c0bc"), new Guid("e1bf6299-0009-44ad-84d3-725df91d5f63"), new Guid("e64f29b4-aa97-463f-acf1-fc9bd2a2bd8f")).WithObjectTypes(SalesInvoice, Party).WithSingularName("Customer")  .WithPluralName("Customers")  .WithMultiplicity(Multiplicity.ManyToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("f808aafb-3c7d-4a26-af5c-44b76ee45e86"), new Guid("d487d63e-8094-4085-bb73-d2f24e586c26"), new Guid("462acdc2-69e1-42e5-ba10-6f74f04da7a5")).WithObjectTypes(SalesInvoice, PostalAddress).WithSingularName("ShipToAddress")  .WithPluralName("ShipToAddresses")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("fd12507e-96b7-4b15-a43d-ab418d4795d6"), new Guid("b8044f1e-b8fa-42fc-995d-06ac47423b8e"), new Guid("8dd43185-e3a9-44d7-ab1e-2a1222a234cf")).WithObjectTypes(SalesInvoice, Store).WithSingularName("Store")  .WithPluralName("Stores")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            // InventoryItem
            ...
            new RelationTypeBuilder(domain, new Guid("374e9e57-e878-40ac-9021-d830dbf1efdc"), new Guid("fb58bcd8-d263-4563-b7d1-d62b6036e8bb"), new Guid("99a9dadc-ac9e-4662-91d0-41804e70101f")).WithObjectTypes(InventoryItem, Part).WithSingularName("Part")  .WithPluralName("Parts")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("39ee9493-b628-4cc6-a31c-239f306e8497"), new Guid("04da42d7-6e24-409e-b384-2283dc95ac35"), new Guid("b08500e2-feee-4115-90ec-c65d719d1d29")).WithObjectTypes(InventoryItem, Container).WithSingularName("Container")  .WithPluralName("Containers")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("5f8fa5ee-a638-4222-9865-518e220e7299"), new Guid("b6412daa-ac8d-4a73-8b87-cbc91981488c"), new Guid("eb553284-25ab-4cc0-ba20-5b5ef5c74313")).WithObjectTypes(InventoryItem, Lot).WithSingularName("Lot")  .WithPluralName("Lots")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("ab7b1a91-4756-4806-a5d3-ed8b392c6fe7"), new Guid("32ee6a64-bc23-4cb8-a839-2a83d4a68c46"), new Guid("8455bf8a-247f-41d9-b6fc-c30cda0f10f4")).WithObjectTypes(InventoryItem, ProductCategory).WithSingularName("DerivedProductCategory")  .WithPluralName("DerivedProductCategories")  .WithMultiplicity(Multiplicity.ManyToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("b4d944f5-7376-4096-a34a-4571f537c5fc"), new Guid("78fe1b1f-b4e9-4b75-b16f-6647ef8080ee"), new Guid("6cda2856-203d-409a-b9dd-3ae0c91d7443")).WithObjectTypes(InventoryItem, Good).WithSingularName("Good")  .WithPluralName("Goods")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("f99da732-7c31-4c67-a610-2147a2f29e44"), new Guid("300cc6b2-7f50-4399-a3f6-e492d3858524"), new Guid("e1f8b0ea-6b2f-44f1-bfe0-504b8e06f96d")).WithObjectTypes(InventoryItem, Facility).WithSingularName("Facility")  .WithPluralName("Facilities")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // PurchaseInvoiceStatus
            new RelationTypeBuilder(domain, new Guid("049dd047-7fa7-46e3-900b-84b87f960412"), new Guid("51ddc06d-aa92-49e1-b410-a7f69a474bdf"), new Guid("bf01b58a-465e-4dec-a451-de4601d28850")).WithObjectTypes(PurchaseInvoiceStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
            new RelationTypeBuilder(domain, new Guid("1f5b8db1-58bd-4006-8878-f1609055149c"), new Guid("f63d8052-8f2f-47b5-a5f8-585b0b2587ae"), new Guid("444ada74-4d76-4c78-a7c8-dc2c448dd7eb")).WithObjectTypes(PurchaseInvoiceStatus, PurchaseInvoiceObjectState).WithSingularName("PurchaseInvoiceObjectState")  .WithPluralName("PurchaseInvoiceObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("258a33cc-06ea-45a0-9b15-1b6d58385910"), new Guid("4909a04f-fd14-46ce-9c4c-bc7a2cc21914"), new Guid("cff49ef3-5b51-4501-a5c8-59b4d5714f4e")).WithObjectTypes(TimeEntry, QuoteTerm).WithSingularName("QuoteTerm")  .WithPluralName("QuoteTerms")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("5165e08b-97cc-457b-ba65-6592c31360e5"), new Guid("67272022-b5fb-4d33-aada-2df814418b64"), new Guid("f15e82a9-563c-4fda-bbb3-ba9c3d542d2c")).WithObjectTypes(StoreRevenueHistory, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("80a3da61-9df3-4100-b81b-323f293194a7"), new Guid("189a3f1e-1878-4e85-921d-9ae9d7ce520e"), new Guid("0f864ab4-599f-451f-9088-d7380981a46f")).WithObjectTypes(StoreRevenueHistory, Store).WithSingularName("Store")  .WithPluralName("Stores")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("f7325700-87e9-4753-8b0b-de459a6926e7"), new Guid("58379bfa-a272-4877-98ce-5e46063bc1c2"), new Guid("f7278113-6da8-49af-b205-615cf8df50fd")).WithObjectTypes(OrganisationGlAccountBalance, AccountingPeriod).WithSingularName("AccountingPeriod")  .WithPluralName("AccountingPeriods")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // InternalOrganisationRevenueHistory
            new RelationTypeBuilder(domain, new Guid("22b47e4a-5657-4bf6-acff-d923ef5ef8e2"), new Guid("4f48cd93-af57-4e7a-b54b-3aef374444e7"), new Guid("2aea8ef1-d353-43e4-8f1a-09b2052603e2")).WithObjectTypes(InternalOrganisationRevenueHistory, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("a8ab7445-38b2-4e1b-bee2-15d1a91fc239"), new Guid("cc5041b1-da31-472d-ab66-105561bcb2de"), new Guid("1d88f2e2-6a81-42f8-8e60-242918c82e21")).WithObjectTypes(InternalOrganisationRevenueHistory, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("dfd5fb95-50ee-48a5-942b-75752f78a615"), new Guid("fea5e2c3-b8fa-488d-aba6-641176652430"), new Guid("50499eba-a2b0-4ad2-8dc6-72eb2d1997a7")).WithObjectTypes(Deliverable, DeliverableType).WithSingularName("DeliverableType")  .WithPluralName("DeliverableTypes")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // EmploymentApplication
            new RelationTypeBuilder(domain, new Guid("528de310-3268-4b17-ab42-49dea27d5aee"), new Guid("ca9bf054-52cf-40f1-995f-0e504b5bee9b"), new Guid("9b07c065-678f-4d21-878f-4ac2029dddc5")).WithObjectTypes(EmploymentApplication, allorsDate).WithSingularName("ApplicationDate")  .WithPluralName("ApplicationDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("75cc1a7c-6bf7-4798-9ddc-fd1b283aed19"), new Guid("edffb19c-1b3d-45fc-bc52-d44bd51fc6e2"), new Guid("502bf1bc-596d-44e7-b9f3-148433028740")).WithObjectTypes(EmploymentApplication, Position).WithSingularName("Position")  .WithPluralName("Positions")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("7d3147e2-9709-42bc-a6cd-5b922bfc143d"), new Guid("e8ec31ed-ebd4-4a2c-8948-7170adf61572"), new Guid("af280063-af23-4afb-9dd6-8f44141c275e")).WithObjectTypes(EmploymentApplication, EmploymentApplicationStatus).WithSingularName("EmploymentApplicationStatus")  .WithPluralName("EmploymentApplicationStatuses")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("a4c14261-14a2-404c-814f-6475368d685a"), new Guid("f9cf5e5a-d262-4898-91f3-a69b3612f0a8"), new Guid("6d7984e5-d1c7-4a53-99a1-49e125db39b9")).WithObjectTypes(EmploymentApplication, Person).WithSingularName("Person")  .WithPluralName("Persons")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("b0799b22-bff3-49d7-8f9a-3ea41c540778"), new Guid("90dc458e-243e-42d6-950d-3994f7617981"), new Guid("4222311d-cb11-4cec-a547-eb45cfe94732")).WithObjectTypes(EmploymentApplication, EmploymentApplicationSource).WithSingularName("EmploymentApplicationSource")  .WithPluralName("EmploymentApplicationSources")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // VatRegime
            new RelationTypeBuilder(domain, new Guid("2071cc28-c8bf-43dc-a5e5-ec5735756dfa"), new Guid("fca4a435-bd82-496b-ab1d-c2b6cb10494f"), new Guid("baf416cf-3222-4c93-8fb7-f4257b2b9ef9")).WithObjectTypes(VatRegime, VatRate).WithSingularName("VatRate")  .WithPluralName("VatRates")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // PositionFulfillment
            new RelationTypeBuilder(domain, new Guid("30631f6e-3e70-4394-9540-0572230cd461"), new Guid("ebcfbd12-ea78-4dd1-b102-05110c7d4a95"), new Guid("3fc029a2-3465-4518-830a-348bd2235a71")).WithObjectTypes(PositionFulfillment, Position).WithSingularName("Position")  .WithPluralName("Positions")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("4de369bb-6fa3-4fd4-9056-0e70a72c9b9f"), new Guid("23fa9951-ceb1-44b2-af36-f3e4955018d1"), new Guid("76c3f430-bf53-4e6f-89af-ea91afbd6795")).WithObjectTypes(PositionFulfillment, Person).WithSingularName("Person")  .WithPluralName("Persons")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // Employment
            new RelationTypeBuilder(domain, new Guid("776e5cb7-6926-4455-89ed-c1f916018a25"), new Guid("9d997658-68ca-41a3-9551-9cc793811a4e"), new Guid("28191884-d18f-400b-96df-7da1a328d88e")).WithObjectTypes(Employment, InternalOrganisation).WithSingularName("Employer")  .WithPluralName("Employers")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("ba6d2658-9c07-4254-a664-21df0e2fcb6a"), new Guid("f512d8bd-5ea3-461c-9310-6ab93696763d"), new Guid("3c2fae70-49b5-407f-823c-db9b9052fb1e")).WithObjectTypes(Employment, PayrollPreference).WithSingularName("PayrollPreference")  .WithPluralName("PayrollPreferences")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("e79807d4-dcf8-47e2-b510-e8535f1ec436"), new Guid("6b4896d8-8bf6-4908-acb9-dc2438263fb7"), new Guid("96ff4ce3-5e0b-408e-9641-edf2e06dc508")).WithObjectTypes(Employment, EmploymentTermination).WithSingularName("EmploymentTermination")  .WithPluralName("EmploymentTerminations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // SalesRepRelationship
            new RelationTypeBuilder(domain, new Guid("24e8c07a-2fca-496a-8c21-165f29a6733d"), new Guid("5cd1d447-85b5-4d28-8296-05e356046f62"), new Guid("7d8a933f-1d36-4247-bf13-580aa24bd645")).WithObjectTypes(SalesRepRelationship, Person).WithSingularName("SalesRepresentative")  .WithPluralName("SalesRepresentatives")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("558ed9e0-81a0-4e6c-abd3-4e27e665deee"), new Guid("e1e94fa4-ac8f-44c2-9982-a05ad1eb3f8e"), new Guid("125f6b43-2204-43cb-819b-4b2b940630cc")).WithObjectTypes(ProductCategoryRevenue, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // PartyRevenue
            new RelationTypeBuilder(domain, new Guid("166cc4a8-4f7f-411e-9a43-9c3f44357691"), new Guid("2cfc0f11-a730-4992-9917-1f6830a534fc"), new Guid("7c8121e5-b9b9-4f4f-9b15-d47fdea0e661")).WithObjectTypes(PartyRevenue, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("d3a7f72d-e112-4da4-971f-69016bedf814"), new Guid("aa0ac3ab-3db4-4f5f-bd6a-8d50190bad8f"), new Guid("fcd1e476-6420-4e78-8da6-18c8a6e5f103")).WithObjectTypes(PartyRevenue, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("45a00bdb-cbe4-4170-88e2-20bb55dff33f"), new Guid("5db6dcfb-c4a9-49ea-84f3-f136a184a4fe"), new Guid("e6b78152-6511-4620-81a3-f31709434fc1")).WithObjectTypes(PurchaseInvoiceItemStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("d3300a5d-8e35-4106-9df9-d1bb25bb0352"), new Guid("14cc26ba-1c75-42dd-8a72-1f20f8692cb7"), new Guid("f83c9130-b540-4b25-b7cf-699333395a9d")).WithObjectTypes(InvoiceVatRateItem, VatRate).WithSingularName("VatRate")  .WithPluralName("VatRates")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            ...
            // SalaryStep
            new RelationTypeBuilder(domain, new Guid("162b31b7-78fd-4ec5-95f7-3913be0662e2"), new Guid("c00111ef-5eb8-4155-a621-fd09d0aa1a6c"), new Guid("2872381c-833b-4dce-83f4-a56bbbd416b3")).WithObjectTypes(SalaryStep, allorsDate).WithSingularName("ModifiedDate")  .WithPluralName("ModifiedDates")      .Build();
            ...
            // DropShipmentStatus
            new RelationTypeBuilder(domain, new Guid("2c667e0e-f489-470d-9f48-09a443588286"), new Guid("4f08a754-40ac-4806-bf34-fcc4b0d473af"), new Guid("bd4fb4a3-c2ba-4ed6-8f09-4d7e8e8e3a9a")).WithObjectTypes(DropShipmentStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
            new RelationTypeBuilder(domain, new Guid("3fe0bb83-1d87-4a7c-bda8-796cdaea9ac3"), new Guid("5098fab9-4d58-43e1-93b5-b95e090952e1"), new Guid("09b78c50-2eef-4f01-9277-8a14a657f6b9")).WithObjectTypes(DropShipmentStatus, DropShipmentObjectState).WithSingularName("DropShipmentObjectState")  .WithPluralName("DropShipmentObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("b5f00552-5976-4368-9f38-dc4734b1c4af"), new Guid("c51f9be5-aee5-43db-b986-78e076ded8bf"), new Guid("df69429e-b21d-4b28-83b3-17f365ac444d")).WithObjectTypes(PaymentApplication, InvoiceItem).WithSingularName("InvoiceItem")  .WithPluralName("InvoiceItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("deb07a2f-6344-4888-bd1a-97413e82700a"), new Guid("1c722ac2-b579-4707-8e27-0b0a23510293"), new Guid("345cb457-a401-4590-b21c-de3a213a5626")).WithObjectTypes(PaymentApplication, BillingAccount).WithSingularName("BillingAccount")  .WithPluralName("BillingAccounts")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // NonSerializedInventoryItemStatus
            new RelationTypeBuilder(domain, new Guid("590f1d9b-a805-4b0e-a2bd-8e274608fe3c"), new Guid("bcc05955-7c14-45f9-b2ea-ab36feca7287"), new Guid("30a81620-9871-414c-9b09-c2fad0358bb4")).WithObjectTypes(NonSerializedInventoryItemStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
            new RelationTypeBuilder(domain, new Guid("959aa0a9-a197-4eb4-bc9e-e40da8892dd0"), new Guid("d3b7eb35-52d2-48fc-a416-a2185ae347ee"), new Guid("78059f92-3345-4e5a-8d04-d30d15eee05a")).WithObjectTypes(NonSerializedInventoryItemStatus, NonSerializedInventoryItemObjectState).WithSingularName("NonSerializedInventoryItemObjectState")  .WithPluralName("NonSerializedInventoryItemObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // SalesOrder
            new RelationTypeBuilder(domain, new Guid("108a1136-feaa-45b8-a899-d455718090d1"), new Guid("a2df509a-6923-4121-9159-8d55b91fd407"), new Guid("7cf7c405-f20c-4416-84f5-a4ff05412162")).WithObjectTypes(SalesOrder, ContactMechanism).WithSingularName("TakenByContactMechanism")  .WithPluralName("TakenByContactMechanism")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("19b2f705-c5c7-4440-9b44-96783802ead0"), new Guid("9ce4d748-c7a2-445e-adf1-35ab41edbfe8"), new Guid("4a78e297-5ede-41a9-a487-43509450be2f")).WithObjectTypes(SalesOrder, SalesOrderStatus).WithSingularName("ShipmentStatus")  .WithPluralName("ShipmentStatuses")  .WithMultiplicity(Multiplicity.OneToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("2ee793c8-512e-4358-b28a-f364280db93f"), new Guid("fce2bfd3-8f68-4c9f-a1a3-dce309767458"), new Guid("d123ca45-1afb-4403-9b88-2a5a135d0e60")).WithObjectTypes(SalesOrder, ShipmentMethod).WithSingularName("ShipmentMethod")  .WithPluralName("ShipmentMethods")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("3a2be2f2-2608-46e0-b1f1-1da7e372b8f8"), new Guid("11b71189-8551-467d-9c50-07afe152bdc0"), new Guid("86ca98fe-6bc1-44ce-984e-23ed2f51e9b1")).WithObjectTypes(SalesOrder, PostalAddress).WithSingularName("ShipToAddress")  .WithPluralName("ShipToAddresses")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("3d01b9c9-5f37-40a8-9305-8ee9e98cc192"), new Guid("e93969bc-b73c-4fec-aec2-aa557c57e844"), new Guid("0100d1ae-c1a6-4b4d-b904-59a2f337e158")).WithObjectTypes(SalesOrder, Party).WithSingularName("PreviousShipToCustomer")  .WithPluralName("PreviousShipToCustomers")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("469084d5-acc5-4fc9-910b-ead4d8d4d021"), new Guid("0cc79ccb-af0e-4025-a4f1-3ec5d4f16b96"), new Guid("9640b6a4-f926-48d7-96a2-6c8a0e54cd6b")).WithObjectTypes(SalesOrder, ContactMechanism).WithSingularName("BillToContactMechanism")  .WithPluralName("BillToContactMechanisms")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("4958ae32-6bc0-451d-bacc-8b7244a9dc56"), new Guid("bf8525ec-1fdf-4bae-9fd9-85bb4aa54400"), new Guid("6281e7d9-d7b8-4611-83f4-e1bdb44cc5f9")).WithObjectTypes(SalesOrder, Person).WithSingularName("SalesRep")  .WithPluralName("SalesReps")  .WithMultiplicity(Multiplicity.ManyToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("6a34d3be-5b38-476e-8894-24db55d44ca6"), new Guid("d814f8bc-2650-4873-b32a-b17a42c3378a"), new Guid("3321bcfc-4de1-44be-9574-3a4b2130ff57")).WithObjectTypes(SalesOrder, SalesOrderObjectState).WithSingularName("PreviousObjectState")  .WithPluralName("PreviousObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("a012c48a-823a-4a4f-a251-33cfd3056ae2"), new Guid("0b2de73e-2fa1-4fa3-8df4-3c840c58babd"), new Guid("a5fab0ee-f955-4b36-a914-10479ee16b82")).WithObjectTypes(SalesOrder, SalesOrderStatus).WithSingularName("PaymentStatus")  .WithPluralName("PaymentStatuses")  .WithMultiplicity(Multiplicity.OneToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("a54ff0dc-5adb-4314-8081-66522431b11d"), new Guid("9af36608-dc4a-4197-a7a6-77a2cc3bdfd4"), new Guid("d40d841d-a4f0-4e14-b726-3a66f3628ead")).WithObjectTypes(SalesOrder, Store).WithSingularName("Store")  .WithPluralName("Stores")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("aa416d3e-0f75-4fa5-97e0-ef0bc4327ea9"), new Guid("6bd25de8-38a0-4005-baae-fe1339c24bbd"), new Guid("d99b70e4-1ad2-46a3-b362-26880a843ff8")).WithObjectTypes(SalesOrder, ContactMechanism).WithSingularName("BillFromContactMechanism")  .WithPluralName("BillFromContactMechanisms")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("ba592fc9-78bb-4102-b9b5-fa692210dc38"), new Guid("207a2983-64c8-41c1-a97f-eb1e8bb78919"), new Guid("0a0596d8-8717-466a-9321-02fc8f3410d3")).WithObjectTypes(SalesOrder, ContactMechanism).WithSingularName("PlacingContactMechanism")  .WithPluralName("PlacingContactMechanisms")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("eb5a3564-996d-4bbe-b592-6205adad93b8"), new Guid("37612ba0-d689-49ca-9005-3b3bf21cd272"), new Guid("bd5d13f3-c1e7-4eea-9c33-09f4b47289f3")).WithObjectTypes(SalesOrder, SalesOrderItem).WithSingularName("SalesOrderItem")  .WithPluralName("SalesOrderItems")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("f20ac339-0761-410b-bbb6-6fb393bcba8a"), new Guid("cf9fcfa0-a862-4cb2-88b4-c4dcd6d0034d"), new Guid("6ec955c9-6d25-45b3-a4d1-5e4270d28750")).WithObjectTypes(SalesOrder, SalesOrderObjectState).WithSingularName("CurrentObjectState")  .WithPluralName("CurrentObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("ff972b6c-ab12-4596-a1bc-18f93127ac31"), new Guid("556771a7-0f67-4061-8c88-c8401bf0b1c1"), new Guid("6d7ee57e-35b3-4a19-ad1f-4a1850c41568")).WithObjectTypes(SalesOrder, InternalOrganisation).WithSingularName("TakenByInternalOrganisation")  .WithPluralName("TakenByInternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("70b2fc04-ce4e-4af7-b287-02883fe660e9"), new Guid("48f05073-776f-4465-9763-ca71c785c058"), new Guid("d5009f5b-b990-465d-b868-0bf977b33a4c")).WithObjectTypes(SalesRepRevenue, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("730e4a76-6af4-441e-8d82-1f3e5807d5a5"), new Guid("6ad611d9-a2a1-46cc-9ac2-28832723f063"), new Guid("5a92ec5a-4128-46ba-9a75-112592f2662d")).WithObjectTypes(SalesRepRevenue, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("be530b0c-6ab9-43a2-a974-f06015ae3480"), new Guid("cd786202-3d96-4f6b-94af-27ffb92608e3"), new Guid("0bebaa7b-9332-44a6-abff-454175d2f2a5")).WithObjectTypes(SalesRepRevenue, Person).WithSingularName("SalesRep")  .WithPluralName("SalesReps")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // Engagement
            new RelationTypeBuilder(domain, new Guid("135792e4-42ad-4bf5-914b-ffc154330cd1"), new Guid("d0975157-1342-4a01-9fec-2a38f68a6080"), new Guid("3cd0c697-6767-429a-8f34-e648b4fda46c")).WithObjectTypes(Engagement, Agreement).WithSingularName("Agreement")  .WithPluralName("Agreements")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("1fb112f4-9628-40a8-9531-2d9ad24103ff"), new Guid("ad13c054-b721-4941-ad25-cc43936fed36"), new Guid("9c189e14-b734-41b5-9012-8651986039d7")).WithObjectTypes(Engagement, ContactMechanism).WithSingularName("PlacingContactMechanism")  .WithPluralName("PlacingContactMechanisms")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("4afffb12-3a70-4903-af99-ed814fd6a444"), new Guid("1bf53c71-0b09-4053-8bab-73d783fdfd62"), new Guid("dc2b8ab4-6eff-488c-955b-6329c1e1bfc3")).WithObjectTypes(Engagement, ContactMechanism).WithSingularName("BillToContactMechanism")  .WithPluralName("BillToContactMechanisms")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("d9df5d5e-e0cc-4c9e-9e0a-dc5423561774"), new Guid("4fec3a1a-28d4-4984-a82a-aee949ba79d5"), new Guid("abcb554b-44f8-424c-b991-1e56f15c5412")).WithObjectTypes(Engagement, allorsDate).WithSingularName("EndDate")  .WithPluralName("EndDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("e1081976-b7e4-4e8e-85de-bd6ff096b39b"), new Guid("947ccaf8-9264-4703-86a8-58818128ff84"), new Guid("5670bb8d-64a0-4492-9bb7-383b27144b31")).WithObjectTypes(Engagement, allorsDate).WithSingularName("ContractDate")  .WithPluralName("ContractDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("ec51db38-d0de-430d-82cc-1105f336977b"), new Guid("f1a3abd2-636b-441a-90fc-9ac4cd9d0936"), new Guid("237743f7-01c5-4762-b034-c43854f22157")).WithObjectTypes(Engagement, EngagementItem).WithSingularName("EngagementItem")  .WithPluralName("EngagementItems")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("a202a540-dc0d-4032-9963-d0aa1511c990"), new Guid("0dd915a3-d517-46c5-8664-e59c56623564"), new Guid("ab316ee2-bf84-4501-a798-94832c55e73f")).WithObjectTypes(Part, PriceComponent).WithSingularName("PriceComponent")  .WithPluralName("PriceComponents")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("f2c3407e-ab62-4f3e-94e5-7e9e65b89d6e"), new Guid("9bf78bcd-319c-4767-8053-4307577559ff"), new Guid("319781e8-c83c-41ea-a8e7-b7224e8240e0")).WithObjectTypes(Part, InventoryItemKind).WithSingularName("InventoryItemKind")  .WithPluralName("InventoryItemKinds")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("77910a3f-3547-4d6b-92e0-f1fc136e22da"), new Guid("97cc6287-9dc0-404a-ad92-bfd2c3927d30"), new Guid("83cfb29d-4311-4b16-9331-1c00d54b70c7")).WithObjectTypes(AccountingTransaction, allorsDate).WithSingularName("TransactionDate")  .WithPluralName("TransactionDates")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("be061dda-bb8f-4bc1-b386-dc0c05dc6eaf"), new Guid("8943c9e2-3c6f-49c4-aa87-397af24e8073"), new Guid("75b6517f-6e4a-4218-8ca1-de230c69a02e")).WithObjectTypes(AccountingTransaction, allorsDate).WithSingularName("EntryDate")  .WithPluralName("EntryDates")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("44124d06-9bbd-4c55-85f6-7036b49ffbcd"), new Guid("b7e31e2e-2e76-4049-870b-ff5848dc4ebc"), new Guid("37984d70-d086-461f-8879-710ecef10778")).WithObjectTypes(SalesRepPartyRevenue, Person).WithSingularName("SalesRep")  .WithPluralName("SalesReps")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("cab7ab56-2068-4090-bdae-b4e42a68ec36"), new Guid("e5f5eefd-0276-450b-815e-4bde07fee1d6"), new Guid("99d895a8-12c9-468c-9081-f600f64a9117")).WithObjectTypes(SalesRepPartyRevenue, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // PurchaseOrderItemStatus
            new RelationTypeBuilder(domain, new Guid("8d0f607b-221b-4f42-8ef8-242e3c35d9ba"), new Guid("2dbd22c3-b84d-4d65-a176-eecd61da3a89"), new Guid("26ed3c20-bad4-4651-9a6e-d6a27616503e")).WithObjectTypes(PurchaseOrderItemStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
            new RelationTypeBuilder(domain, new Guid("d2fad7ff-945e-4bed-b7a7-39238357eaf3"), new Guid("db25aff8-16fe-4277-afc2-843d81ace875"), new Guid("2f2af9c6-9ed4-475b-a9fd-c16c12454109")).WithObjectTypes(PurchaseOrderItemStatus, PurchaseOrderItemObjectState).WithSingularName("PurchaseOrderItemObjectState")  .WithPluralName("PurchaseOrderItemObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("30b99ed6-cb44-4401-b5bd-76c0099153d4"), new Guid("002ba83d-d60f-4365-90e0-4df952697ae7"), new Guid("cfa04c20-ecc5-4942-b898-2966bf5052aa")).WithObjectTypes(Addendum, allorsDate).WithSingularName("EffictiveDate")  .WithPluralName("EffictiveDates")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("74c60d54-b75f-4baa-b1d6-5a33e8ab3944"), new Guid("ea6bf951-414e-48e6-a579-a2ce8627f635"), new Guid("22405cc3-c402-4236-9517-bdb381d3285f")).WithObjectTypes(SalesInvoiceStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
			
            // PurchaseInvoice
            new RelationTypeBuilder(domain, new Guid("3e06d6c9-50b1-4cf6-95f9-0278b62c0c30"), new Guid("8e2f7243-738f-4e1c-9531-7160c627365a"), new Guid("f596e5ab-59e1-4b0a-9c56-0d22a23c4b0f")).WithObjectTypes(PurchaseInvoice, PurchaseInvoiceObjectState).WithSingularName("PreviousObjectState")  .WithPluralName("PreviousObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("4cf09eb7-820f-4677-bfc0-92a48d0a938b"), new Guid("5a71ca58-db28-4edc-9065-32396380bd80"), new Guid("fa280c8d-ac7b-4d99-80dd-fba155d4aef9")).WithObjectTypes(PurchaseInvoice, PurchaseInvoiceItem).WithSingularName("PurchaseInvoiceItem")  .WithPluralName("PurchaseInvoiceItems")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("bc059d0f-e9bd-41e8-82ff-9615a01ec24a"), new Guid("770c0376-8552-4d0c-b45f-b759018c3c85"), new Guid("5658422f-4097-49db-b97c-79bab6f337b4")).WithObjectTypes(PurchaseInvoice, PurchaseInvoiceObjectState).WithSingularName("CurrentObjectState")  .WithPluralName("CurrentObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("d4bbc5ed-08a4-4d89-ad53-7705ae71d029"), new Guid("8ce81b66-22e5-4195-a270-5e9f761ff51e"), new Guid("58245287-7a75-45c4-a000-d3944ec9319a")).WithObjectTypes(PurchaseInvoice, Party).WithSingularName("BilledFromParty")  .WithPluralName("BilledFromParties")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("e444b5e7-0128-49fc-86cb-a6fe39c280ae"), new Guid("d6240de5-9b99-4525-b7d0-ef28a3381821"), new Guid("6c911870-2737-4997-87a6-65ca55c17c55")).WithObjectTypes(PurchaseInvoice, PurchaseInvoiceType).WithSingularName("PurchaseInvoiceType")  .WithPluralName("PurchaseInvoiceTypes")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("ed3987d4-3dd1-4483-bcbb-8f1f0b18ff84"), new Guid("1c1d90ff-5910-4f39-b6ad-aa12a6e6c60e"), new Guid("d23c55ff-857b-40bc-b041-15f0ceb910a5")).WithObjectTypes(PurchaseInvoice, PurchaseInvoiceStatus).WithSingularName("InvoiceStatus")  .WithPluralName("InvoiceStatuses")  .WithMultiplicity(Multiplicity.OneToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("b28765aa-3529-449a-9ef1-539323b7f3b2"), new Guid("475243a3-8d87-4521-bbb6-b5388292268c"), new Guid("0084281a-3bcc-4de2-b581-037c3724259a")).WithObjectTypes(CustomerReturn, CustomerReturnObjectState).WithSingularName("PreviousObjectState")  .WithPluralName("PreviousObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("e7586be1-f751-4ac6-940b-a65b50834619"), new Guid("ca71aca7-fa06-44d1-830a-3eaf5e2355a2"), new Guid("3fb0c486-6e24-4f53-b7cf-f98596402d55")).WithObjectTypes(CustomerReturn, CustomerReturnStatus).WithSingularName("ShipmentStatus")  .WithPluralName("ShipmentStatuses")  .WithMultiplicity(Multiplicity.OneToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("fe3fd846-2d69-4d62-941b-dabc40a15e1f"), new Guid("82695003-f47f-4324-9a7c-d89949981354"), new Guid("b2d65c28-fbff-430b-a7ca-39201ce655ad")).WithObjectTypes(CustomerReturn, CustomerReturnObjectState).WithSingularName("CurrentObjectState")  .WithPluralName("CurrentObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("73521788-7e0e-4ea2-9961-1a58f68cde5c"), new Guid("8e7ad6ef-7a40-472f-b7b9-f53a77e51548"), new Guid("af64e731-adfb-414a-9520-51d4ea2c8f81")).WithObjectTypes(Order, OrderTerm).WithSingularName("OrderTerm")  .WithPluralName("OrderTerms")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("a5875c41-9f08-49d0-9961-19a656c7e0cc"), new Guid("c6604ee5-e9f2-4b5a-9f08-fbfa1d126402"), new Guid("6a783dbf-0f8d-4249-8e1e-6c0c2a61a97e")).WithObjectTypes(Order, allorsDate).WithSingularName("EntryDate")  .WithPluralName("EntryDates")  .WithIsDerived(true)    .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("e039e94d-db89-4a17-a692-e82fdb53bfea"), new Guid("f1eed6f2-fb70-4fd8-8e7a-0962759b00a7"), new Guid("e5e2710b-f662-4a50-8203-d0d7c0789e3e")).WithObjectTypes(Order, allorsDate).WithSingularName("OrderDate")  .WithPluralName("OrderDates")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("f38b3c7d-ac20-49be-a115-d7e83557f49a"), new Guid("f4ff4e74-0bff-4a2a-b4bd-3a08310c6ce2"), new Guid("6d52e55f-2adb-4ec6-8b13-e8611dfcd38a")).WithObjectTypes(Order, allorsDate).WithSingularName("DeliveryDate")  .WithPluralName("DeliveryDate")      .Build();
            ...
            // PartyPackageRevenueHistory
            new RelationTypeBuilder(domain, new Guid("06fdef2c-73f1-4365-9c74-4a994c3d8f97"), new Guid("901f16e6-2007-4da0-abb5-b8d36adceb16"), new Guid("2eca8cef-2790-42a7-8d28-8fb4024c9230")).WithObjectTypes(PartyPackageRevenueHistory, Package).WithSingularName("Package")  .WithPluralName("Packages")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("c503c916-7e4b-4a2f-98ca-e46141d6b63a"), new Guid("b9a80dee-d5bb-4a3f-9540-3b9b27cb47c6"), new Guid("e03d5835-0741-4710-a8d7-b1f317ed09a8")).WithObjectTypes(PartyPackageRevenueHistory, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("c8ed0a7f-62c9-44e4-a7c5-57a06f9aaedd"), new Guid("e9398597-8748-41dd-89b9-7f0cf7366d7a"), new Guid("188c541c-7d81-4dbf-8f89-17ce44744f8b")).WithObjectTypes(PartyPackageRevenueHistory, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("8a8ad2c2-e301-40be-8c7e-3c8291c3bbe9"), new Guid("1b28c7b7-f770-4e49-acbf-ade8e67ba939"), new Guid("eb4da206-6f39-4615-84e7-afb12f1cf486")).WithObjectTypes(PickListItem, InventoryItem).WithSingularName("InventoryItem")  .WithPluralName("InventoryItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("14d596e8-adec-46bc-b260-af37d24a1035"), new Guid("4f846efe-5546-4709-8f31-2470a3e3650e"), new Guid("ad606374-6b77-4ddc-b907-e190faf7da0e")).WithObjectTypes(SalesOrderItem, SalesOrderItemStatus).WithSingularName("CurrentPaymentStatus")  .WithPluralName("CurrentPaymentStatuses")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("1ea02a2c-280a-4a48-9ffb-1517789c56f1"), new Guid("851f33e4-6c43-468d-ab0d-0f5f83bdb179"), new Guid("213d2b36-dbfd-4e2d-a854-82ba271f0d94")).WithObjectTypes(SalesOrderItem, OrderItem).WithSingularName("OrderedWithFeature")  .WithPluralName("OrderedWithFeatures")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("3072d12f-e8de-43ba-a63c-f557744a1d5d"), new Guid("9b642b30-ec44-4877-a191-974704f6d8df"), new Guid("1eb0ad30-68f6-4d63-9e07-96f7e90005ee")).WithObjectTypes(SalesOrderItem, SalesOrderItemStatus).WithSingularName("OrderItemStatus")  .WithPluralName("OrderItemStatuses")  .WithMultiplicity(Multiplicity.OneToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("3dbd9a9b-8cda-4cf3-890d-2e6af4e47018"), new Guid("fba228cb-4b3f-4f50-8b6a-f16572ba3977"), new Guid("9d69d9af-7c23-4a1d-a4f2-09ef58881ce8")).WithObjectTypes(SalesOrderItem, SalesOrderItemStatus).WithSingularName("CurrentShipmentStatus")  .WithPluralName("CurrentShipmentStatuses")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("3e798309-d5d5-4860-87ec-ba3766e96c9e"), new Guid("4626b586-07e1-468c-877a-d1a8f1b196c5"), new Guid("b2aef5ac-45f7-41aa-8e1b-f2d79d3d9fad")).WithObjectTypes(SalesOrderItem, NonSerializedInventoryItem).WithSingularName("PreviousReservedFromInventoryItem")  .WithPluralName("PreviousReservedFromInventoryItems")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("6826e05e-eb9a-4dc4-a653-0230dec934a9"), new Guid("aa2b8b0a-672c-423b-9ca8-2fd40f8d1306"), new Guid("793f4946-ed12-49ca-9764-8df534941cca")).WithObjectTypes(SalesOrderItem, Product).WithSingularName("PreviousProduct")  .WithPluralName("PreviousProducts")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("710e0b05-01d1-4592-b652-f0fada3dfa45"), new Guid("9ab86597-c31b-46d7-b546-89ebfd1411cd"), new Guid("9533bbb6-359f-49a3-959b-98fcdd5cc2a7")).WithObjectTypes(SalesOrderItem, SalesOrderItemObjectState).WithSingularName("CurrentObjectState")  .WithPluralName("CurrentObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("911abda0-2eb0-477e-80be-e9e7d358205e"), new Guid("23af5657-ed05-43c2-aeed-d268204528d2"), new Guid("42a88fb9-84bc-4e35-83ff-6cb5c0cf3c96")).WithObjectTypes(SalesOrderItem, Person).WithSingularName("SalesRep")  .WithPluralName("SalesReps")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("ae30b852-d1d9-4966-a65a-6f16120652f6"), new Guid("c3a3e068-8683-44b7-a255-47e49a63c453"), new Guid("7a4a9d1b-2cff-4f9c-8b7c-94f08fb68c46")).WithObjectTypes(SalesOrderItem, SalesOrderItemStatus).WithSingularName("ShipmentStatus")  .WithPluralName("ShipmentStatuses")  .WithMultiplicity(Multiplicity.OneToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("b2d2645e-0d3f-473e-b277-6f890b9b911e"), new Guid("68281397-74f8-4356-b9fc-014f792ab914"), new Guid("1292e876-1c61-42cb-8f01-8b3eb6cf0fa0")).WithObjectTypes(SalesOrderItem, Party).WithSingularName("AssignedShipToParty")  .WithPluralName("AssignedShipToParties")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("c43d151f-3b6e-498e-b588-0a7cd6d746dd"), new Guid("916832a5-16d8-4705-9571-9631f6c1c0c0"), new Guid("094aafd5-7e41-41f4-b49f-7b8589414452")).WithObjectTypes(SalesOrderItem, SalesOrderItemObjectState).WithSingularName("PreviousObjectState")  .WithPluralName("PreviousObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("d7c25b48-d82f-4250-b09d-1e935eab665b"), new Guid("67e9a9d9-74ff-4b04-9aa1-dd08c5348a3e"), new Guid("4bfc1720-a2f6-4204-974b-42ca42c0d2e1")).WithObjectTypes(SalesOrderItem, NonSerializedInventoryItem).WithSingularName("ReservedFromInventoryItem")  .WithPluralName("ReservedFromInventoryItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("e8980105-2c4d-41de-bd67-802a8c0720f1"), new Guid("8b747457-bf7a-4274-b245-d04607b2a5ba"), new Guid("90d69cb4-d485-418f-9608-44063f116ff4")).WithObjectTypes(SalesOrderItem, Product).WithSingularName("Product")  .WithPluralName("Products")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("ed586b2f-c687-4d97-9416-52f7156b7b11"), new Guid("cb5c31c4-2daa-405b-8dc9-5ea6c87f66b3"), new Guid("c5b07ead-1a71-407e-91f8-4ec39853888a")).WithObjectTypes(SalesOrderItem, ProductFeature).WithSingularName("ProductFeature")  .WithPluralName("ProductFeatures")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("f2ccd5d6-95e3-4d72-938b-9f430f36ae59"), new Guid("77472c36-b500-4788-b1b3-22741adec0c0"), new Guid("748df737-edab-476d-a2f2-0f362828c0e7")).WithObjectTypes(SalesOrderItem, SalesOrderItemStatus).WithSingularName("PaymentStatus")  .WithPluralName("PaymentStatuses")  .WithMultiplicity(Multiplicity.OneToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
			
            // WorkEffortGoodStandard
            new RelationTypeBuilder(domain, new Guid("086907b1-97c2-47c1-ade4-f7749f615ae1"), new Guid("f3cf9c9b-2d69-4ef7-8240-44d1ca53bc6f"), new Guid("cd4b1f0a-425f-43d3-bc00-d64a0c4e84df")).WithObjectTypes(WorkEffortGoodStandard, Good).WithSingularName("Good")  .WithPluralName("Goods")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // Passport
            new RelationTypeBuilder(domain, new Guid("85036007-8e01-4d90-9cfe-7b9c25e43537"), new Guid("b1235d10-b895-40dc-bc99-680d08b4cef2"), new Guid("9a1e96ae-0a56-4812-ac52-1c142afd61c2")).WithObjectTypes(Passport, allorsDate).WithSingularName("IssueDate")  .WithPluralName("IssueDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("dd30acd3-2e7b-49e6-9fcd-04cfdafb62d0"), new Guid("cb5a7d75-b938-4451-9896-b661b1828fab"), new Guid("bc010471-bb69-4735-8a86-25d1a8528d34")).WithObjectTypes(Passport, allorsDate).WithSingularName("ExpiriationDate")  .WithPluralName("ExpiriationDates")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("39d2f4f2-0c16-40f5-990b-38bad15fae99"), new Guid("cada8a73-b732-4789-aa7b-a4caeaea20e2"), new Guid("341bd110-6126-476c-9d35-1069c207dc1b")).WithObjectTypes(AmountDue, allorsDate).WithSingularName("TransactionDate")  .WithPluralName("TransactionDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("3ca978b2-8c0a-4fec-8b98-88e9ea3b2966"), new Guid("90befe3a-0821-4ec9-bac1-f580ebdaab9e"), new Guid("6b0f0eed-a757-4668-97bb-9d82ed4ff983")).WithObjectTypes(AmountDue, allorsDate).WithSingularName("BlockedForDunning")  .WithPluralName("BlockedForDunnings")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("90b4eaea-21cd-4a04-a64b-3c3dce0718d9"), new Guid("87f05475-29aa-4cb7-a5d9-865a47995cd6"), new Guid("71271fdc-4a24-4650-a57a-9cbc2973cc04")).WithObjectTypes(AmountDue, allorsDate).WithSingularName("ReconciliationDate")  .WithPluralName("ReconciliationDates")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("def3c00e-f065-48e5-97a2-22497f1800b3"), new Guid("278bb3d9-da67-44ca-a78b-8c047da3b2d4"), new Guid("3b867d6f-f7e7-4223-99cf-052ac43e139b")).WithObjectTypes(AmountDue, allorsDate).WithSingularName("DateLastReminder")  .WithPluralName("DatesLastReminder")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("f18c665b-4f88-4e97-950c-08a38d9f0d93"), new Guid("8707951a-3285-44a9-b3d8-7c51cc9977ec"), new Guid("9caf74b7-48c5-4d1b-81fb-15bc22518156")).WithObjectTypes(AmountDue, allorsDate).WithSingularName("DueDate")  .WithPluralName("DueDates")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("a243d65e-81ac-49e7-af1b-1b97faa7360e"), new Guid("9d74270a-7197-43ee-92c9-8f06bd1b48db"), new Guid("fac16474-a909-4566-b55e-5849927aa431")).WithObjectTypes(PurchaseShipmentStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
			
            // Cash
            new RelationTypeBuilder(domain, new Guid("39c8beda-d284-442b-886a-6d6b2fb51cc8"), new Guid("f90e529a-8303-4a66-9622-144cfaed3bf3"), new Guid("90ee494e-2194-4972-bdde-7a3a30aff736")).WithObjectTypes(Cash, Person).WithSingularName("PersonResponsible")  .WithPluralName("PersonResponsible")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("49d6363c-6006-4850-8a96-d87b9336ae59"), new Guid("aab2420d-b105-4328-a71c-c2cdce2712a3"), new Guid("16e3ac4d-1641-417f-bb72-1167ae809ef9")).WithObjectTypes(AgreementItem, Addendum).WithSingularName("Addendum")  .WithPluralName("Addenda")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("4bd76d2c-383e-460f-a597-4283addcbef8"), new Guid("a8ea8f52-bbe2-4723-85c6-8277904c3d93"), new Guid("894d0335-40d3-4476-a87f-c3f11021862e")).WithObjectTypes(AgreementItem, AgreementItem).WithSingularName("Child")  .WithPluralName("Children")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("cfa9c54b-4e9f-4bd2-897d-baf8fb32fa9c"), new Guid("08518361-7f3d-4a44-9377-f407d6946668"), new Guid("d4becca2-e702-42f8-beb7-f652e086ce83")).WithObjectTypes(AgreementItem, AgreementTerm).WithSingularName("AgreementTerm")  .WithPluralName("AgreementTerms")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("b9acfd44-5228-4fcf-88c6-625110cb394e"), new Guid("0f7f8a0b-20b5-4fb8-abb4-cc727cab1337"), new Guid("e6aa2dbf-0d8a-41d2-94ef-2268c847e1b7")).WithObjectTypes(PackageRevenue, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("e6df8560-e85f-4e7a-a527-f7fb8f94cbb6"), new Guid("07b77c6b-09d0-4e4f-8cb4-69cbebc14e54"), new Guid("17b95dec-dc59-4abc-817e-26eb0e9d5ac0")).WithObjectTypes(PackageRevenue, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("e952d6d6-d388-4e80-ba6b-8a612973aca6"), new Guid("a1b71548-06f0-40cd-a619-8b9c080dfe99"), new Guid("c61b90e7-ea4d-4c7f-bfdb-ef87ba911c9d")).WithObjectTypes(PackageRevenue, Package).WithSingularName("Package")  .WithPluralName("Packages")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("2a697cc1-cdeb-4e40-a929-2a8df593877e"), new Guid("f2e40a37-c722-4608-9ed5-0b6f49819efc"), new Guid("54e17ef2-abae-4c76-9d93-87a6545cfa87")).WithObjectTypes(ShipmentRouteSegment, Facility).WithSingularName("FromFacility")  .WithPluralName("FromFacilities")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("4a30a93c-d50b-44cf-b0a2-c29c970e6290"), new Guid("9754042f-3f58-42dd-b160-9c4339a6169d"), new Guid("6be3b17d-03f1-4731-b17e-5956260d1d9a")).WithObjectTypes(ShipmentRouteSegment, ShipmentMethod).WithSingularName("ShipmentMethod")  .WithPluralName("ShipmentMethods")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("57f25750-a517-47a8-a6a0-feb160cd5f3e"), new Guid("0eb0c608-4d72-4aa2-b9c1-46d508a3ff32"), new Guid("44572277-5c54-4d92-8916-1ad2afd13da2")).WithObjectTypes(ShipmentRouteSegment, allorsDate).WithSingularName("EstimatedStartDateTime")  .WithPluralName("EstimatedStartDateTimes")      .Build();
            new RelationTypeBuilder(domain, new Guid("591427f6-b61c-4c19-9f82-e97570d9bead"), new Guid("352996f3-ffa9-4453-a602-938c7543a7c1"), new Guid("bd604c1a-3540-472a-90f5-69ed94a82f03")).WithObjectTypes(ShipmentRouteSegment, Facility).WithSingularName("ToFacility")  .WithPluralName("ToFacilities")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("6b3d4c25-823c-4197-8c05-80aeb887eb8b"), new Guid("f77e2ce0-97fb-4ccd-a6a3-dac8c09d5295"), new Guid("85fe4467-bfde-41ac-9a40-e482a2f800a0")).WithObjectTypes(ShipmentRouteSegment, allorsDate).WithSingularName("EstimatedArrivalDateTime")  .WithPluralName("EstimatedArrivalDateTimes")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("928b9d1e-903b-4d56-aa72-b7aeaf3ba340"), new Guid("ace8a50d-e396-4e47-b13c-f02fa018f652"), new Guid("2b85c556-8726-41d4-a236-197816b2824b")).WithObjectTypes(ShipmentRouteSegment, allorsDate).WithSingularName("ActualArrivalDateTime")  .WithPluralName("ActualArrivalDateTimes")      .Build();
            new RelationTypeBuilder(domain, new Guid("b080fe6b-382e-475d-be81-8632ddedb183"), new Guid("39dade5b-be0e-43ed-8368-00f24cfd3ce6"), new Guid("e749db0f-c95e-4c81-87d0-f5932a31816c")).WithObjectTypes(ShipmentRouteSegment, allorsDate).WithSingularName("ActualStartDateTime")  .WithPluralName("ActualStartDateTimes")      .Build();
            new RelationTypeBuilder(domain, new Guid("c04769b1-f8dc-40c7-87d2-1e55a4702e71"), new Guid("7d5a3fa4-50bb-45b6-b355-2bad4485b9d1"), new Guid("c8ad9159-10eb-4c38-8e5b-1339fa082406")).WithObjectTypes(ShipmentRouteSegment, Organisation).WithSingularName("Carrier")  .WithPluralName("Carriers")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // WorkEffortStatus
            new RelationTypeBuilder(domain, new Guid("5dd27f4b-032d-4b45-86ad-ba288c26fa7c"), new Guid("2743e797-731b-404f-866a-5b9249309f60"), new Guid("99022ef3-d4f2-4635-b27a-c02b554ad8ae")).WithObjectTypes(WorkEffortStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
            ...
            // PurchaseOrderStatus
            new RelationTypeBuilder(domain, new Guid("1f6f2902-0b17-4537-970d-a72454b91410"), new Guid("b3e0bc80-0b37-4946-a6c1-e84cb522e949"), new Guid("95d7759c-aa52-4b38-8337-0c59287441aa")).WithObjectTypes(PurchaseOrderStatus, PurchaseOrderObjectState).WithSingularName("PurchaseOrderObjectState")  .WithPluralName("PurchaseOrderObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("fe949e5f-b717-4cda-8f40-5b0db57d43dd"), new Guid("890b82dc-5a8b-463b-bcc4-cccee90b8dfb"), new Guid("e505854a-67de-4cdf-8404-a0495178ed74")).WithObjectTypes(PurchaseOrderStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("b576883f-0cfd-4973-aa49-479b6e712c75"), new Guid("f93aac27-8f9d-4b9e-a55d-5fad0efc6e86"), new Guid("162fccce-f98a-4b2b-b840-72368a87b043")).WithObjectTypes(PayrollPreference, TimeFrequency).WithSingularName("TimeFrequency")  .WithPluralName("TimeFrequencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("c71eb13a-8053-4d56-a3e3-dcd38a1e4f29"), new Guid("8955caa1-cfdb-4463-a6d2-80ce0f775470"), new Guid("4851823e-72f4-4531-b505-bae6d70688e8")).WithObjectTypes(PayrollPreference, DeductionType).WithSingularName("DeductionType")  .WithPluralName("DeductionTypes")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("8e250efc-f571-4567-a747-cefe30118ddc"), new Guid("48e4e136-0006-4c83-8616-246fb432346e"), new Guid("7e1086df-5289-48a5-8ee3-d8f14b39d4c7")).WithObjectTypes(InternalOrganisationRevenue, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("f1e4b78b-5166-46fc-8a9f-b009da84a3df"), new Guid("6e0495e8-cfac-49cb-89d4-7aae57b01aaa"), new Guid("105af49d-ba84-457a-8a73-d6fcab787d38")).WithObjectTypes(InternalOrganisationRevenue, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // EmailCommunication
            new RelationTypeBuilder(domain, new Guid("25b8aa5e-e7c5-4689-b1ed-d9a0ba47b8eb"), new Guid("11649936-a5fa-488e-8d17-e80619c4d634"), new Guid("6219fd3b-4f38-4f8f-8a5a-783f908ef55a")).WithObjectTypes(EmailCommunication, EmailAddress).WithSingularName("Originator")  .WithPluralName("Originators")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("4026fcf7-3fc2-494b-9c4a-3e19eed74134"), new Guid("f2febf7f-7917-4499-8546-cae1e53d6791"), new Guid("50439b5a-2251-469c-8512-f9dc65b0d9f6")).WithObjectTypes(EmailCommunication, EmailAddress).WithSingularName("Addressee")  .WithPluralName("Addressees")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("dd7506bb-4daa-4da7-8f20-3f607c944959"), new Guid("42fb79f1-c891-41bf-be4b-a2717bd94e69"), new Guid("6d75e51a-7994-43bb-9e99-cd0a88d9d8f2")).WithObjectTypes(EmailCommunication, EmailAddress).WithSingularName("BlindCopy")  .WithPluralName("BlindCopies")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("e12818ad-4ffd-4d91-8142-4ac9bfcbc146"), new Guid("a44a8d84-2510-45fd-add1-646f84be072d"), new Guid("ae354426-6273-4b09-aabf-3f6d25f86e56")).WithObjectTypes(EmailCommunication, EmailTemplate).WithSingularName("EmailTemplate")  .WithPluralName("EmailTemplates")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // OrganisationContactRelationship
            new RelationTypeBuilder(domain, new Guid("0ca367d2-0ce2-440d-a4e7-cbf089c1efed"), new Guid("738d9d62-4823-4045-9e2f-082b91127f3f"), new Guid("fa8ca2da-c75f-4ba9-9c22-6953008c3ba2")).WithObjectTypes(OrganisationContactRelationship, Person).WithSingularName("Contact")  .WithPluralName("Contacts")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("96f4c9af-eeff-477f-8a93-1168cc383b4c"), new Guid("a34e218b-26c0-4c88-a202-0353e693833a"), new Guid("3af5a227-4470-4a4e-a66c-245ac0d12be5")).WithObjectTypes(OrganisationContactRelationship, Organisation).WithSingularName("Organisation")  .WithPluralName("Organisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("af7e007e-c325-453a-923e-55299eda2a8c"), new Guid("337e305a-da68-42da-b508-d9f010138a09"), new Guid("2399e636-f267-4299-b2c7-747497487d63")).WithObjectTypes(OrganisationContactRelationship, OrganisationContactKind).WithSingularName("ContactKind")  .WithPluralName("ContactKinds")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // CustomerReturnStatus
            new RelationTypeBuilder(domain, new Guid("7f02b626-26e6-43c7-af6f-44db32a9748a"), new Guid("88941e26-55e1-400a-925c-8b40977e8141"), new Guid("6a362a6a-930f-4202-b9a7-07f6062c9dde")).WithObjectTypes(CustomerReturnStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
            ...
            // PerformanceReviewItem
            new RelationTypeBuilder(domain, new Guid("6d7bb4b2-885d-4f7b-9d31-d517c3d03ac2"), new Guid("4c8cd6fe-acea-43ae-90e9-41ae1b84f269"), new Guid("1a5977eb-1914-4b02-a0d3-feaad843465d")).WithObjectTypes(PerformanceReviewItem, RatingType).WithSingularName("RatingType")  .WithPluralName("RatingTypes")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("d62d7236-458f-4e30-8df4-27eb877d0931"), new Guid("7056f19c-c67e-4b54-a08c-c49155326a5e"), new Guid("cac7ce59-1969-43b8-99a9-a90af638558d")).WithObjectTypes(PerformanceReviewItem, PerformanceReviewItemType).WithSingularName("PerformanceReviewItemType")  .WithPluralName("PerformanceReviewItemTypes")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("646382fa-3794-46be-81a0-28a1609e65b0"), new Guid("0bb2b710-90c3-42c9-8eb4-5bffb06cb705"), new Guid("0ec8beac-06c9-4f7f-a39b-fb9d7bfcae0f")).WithObjectTypes(PartyPackageRevenue, Package).WithSingularName("Package")  .WithPluralName("Packages")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("e93042c4-1e6c-47c5-9004-f6ddcbfdbb33"), new Guid("39c71cdb-847a-474f-92b4-827e2eb95c22"), new Guid("d498a399-c183-433c-8260-396c4e2b997d")).WithObjectTypes(PartyPackageRevenue, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("ed2b5e8c-2c74-4ae2-b467-d41baf9f41db"), new Guid("1b51addf-6a5d-4611-b23c-1a16fa413259"), new Guid("2734ebff-1038-4945-98c5-d1da0a11265b")).WithObjectTypes(PartyPackageRevenue, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // BudgetRevision
            new RelationTypeBuilder(domain, new Guid("5124634a-dc8b-477a-8ae2-d4ad577a13bb"), new Guid("fa00944b-f6a3-4c61-9739-6a8a109d32d5"), new Guid("a1230395-837b-4021-8075-642fdf1d7d2c")).WithObjectTypes(BudgetRevision, allorsDate).WithSingularName("RevisionDate")  .WithPluralName("RevisionDates")      .Build();
            ...
            // Shipment
            new RelationTypeBuilder(domain, new Guid("05221b28-9c80-4d3b-933f-12a8a17bc261"), new Guid("c59ef057-da9a-433f-90d3-5ff657aa1e48"), new Guid("6fe551cd-0808-466b-9ec9-833098ebad79")).WithObjectTypes(Shipment, ShipmentMethod).WithSingularName("ShipmentMethod")  .WithPluralName("ShipmentMethods")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("05b0841b-d546-4fd6-9305-492b0ce20f8a"), new Guid("26be1e2b-ee3c-4c37-9ccc-07a916e6af29"), new Guid("313a2875-bafc-430a-b7c4-1aa45e825233")).WithObjectTypes(Shipment, ContactMechanism).WithSingularName("BillToContactMechanism")  .WithPluralName("BillToContactMechanisms")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("165b529f-df1c-45b6-bbed-d19ffcb375f2"), new Guid("c71e40be-1f55-483d-9bfa-0d2dfb26c7d9"), new Guid("18a5331e-120e-45e6-8ef4-35a1f48237e0")).WithObjectTypes(Shipment, ShipmentPackage).WithSingularName("ShipmentPackage")  .WithPluralName("ShipmentPackages")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("6a568bea-6718-414a-b822-d8304502be7b"), new Guid("499bb422-b2f0-48cf-bf09-0544e768b5de"), new Guid("b8724e90-9888-4f81-b70d-1eceb93af3d3")).WithObjectTypes(Shipment, ShipmentItem).WithSingularName("ShipmentItem")  .WithPluralName("ShipmentItems")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("6b90885f-9421-442a-b517-b85c6fe3c60d"), new Guid("b4df53d0-3970-45bf-bcfb-251dc18ebb46"), new Guid("215a7b54-93d9-455c-9979-759b116677cd")).WithObjectTypes(Shipment, InternalOrganisation).WithSingularName("BillFromInternalOrganisation")  .WithPluralName("BillFromInternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("78e7e7a5-2d8c-4184-b917-10095dc033b1"), new Guid("f924c450-6c83-4853-9449-b34efb52cc78"), new Guid("b9c80d27-7278-4883-b1f3-d01712463109")).WithObjectTypes(Shipment, ContactMechanism).WithSingularName("ReceiverContactMechanism")  .WithPluralName("ReceiverContactMechanisms")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("7e1325e0-a072-46da-adb5-b997dde9980a"), new Guid("f73c3f6d-cc9c-4bda-a4c6-ef4f406a491d"), new Guid("14f6385d-4e20-4ffe-89e7-f7a261eda78e")).WithObjectTypes(Shipment, PostalAddress).WithSingularName("ShipToAddress")  .WithPluralName("ShipToAddresses")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("97788e21-ec31-4fb2-9ef7-0b7b5a7367a1"), new Guid("227f8e47-58af-44be-bcaf-0da60e2c13d4"), new Guid("338e2be0-6eb5-42ad-b51c-83dd9b7f0194")).WithObjectTypes(Shipment, allorsDate).WithSingularName("EstimatedShipDate")  .WithPluralName("EstimatedShipDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("a74391e5-bd03-4247-93b8-e7081d939823"), new Guid("41060c75-fb34-4391-96f3-d0d267344ba3"), new Guid("eb3f084c-9d59-4fff-9fc3-186d7b9a19b3")).WithObjectTypes(Shipment, allorsDate).WithSingularName("LatestCancelDate")  .WithPluralName("LatestCancelDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("b37c7c90-0287-4f12-b000-025e2505499c"), new Guid("13e8d5af-43ff-431b-85d8-5e7706dc2f75"), new Guid("81367cbd-4713-46bd-8f4d-0df30c3daf96")).WithObjectTypes(Shipment, Carrier).WithSingularName("Carrier")  .WithPluralName("Carriers")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("b5dabbcc-508a-4998-a21a-6b86d7193688"), new Guid("43d9bbc8-319c-4971-a651-11f246fafa97"), new Guid("ebf2b41f-a922-4689-83d4-51569a3d85d3")).WithObjectTypes(Shipment, ContactMechanism).WithSingularName("InquireAboutContactMechanism")  .WithPluralName("InquireAboutContactMechanisms")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("b69c6812-bdc4-4a06-a782-fa8ff4a71aca"), new Guid("988cafce-2323-4c0d-b1cd-026045764ba4"), new Guid("cd02effa-d176-4f6e-8407-ec12d23b9f2a")).WithObjectTypes(Shipment, allorsDate).WithSingularName("EstimatedReadyDate")  .WithPluralName("EstimatedReadyDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("c8b0eff8-4dff-449c-9d44-a7235cd24928"), new Guid("556c0ae6-045e-4f35-8f63-ffb41f57dc44"), new Guid("5c34f5ee-5f25-42dd-97a8-7aa3aeb9973e")).WithObjectTypes(Shipment, PostalAddress).WithSingularName("ShipFromAddress")  .WithPluralName("ShipFromAddresses")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("ea57219b-217e-444d-9741-c1c4e7aee9f7"), new Guid("2d0935d0-cdb5-4c3e-9726-e27ea731c43b"), new Guid("d7184821-3b9c-4800-874f-32d7cd9b72e3")).WithObjectTypes(Shipment, ContactMechanism).WithSingularName("BillFromContactMechanism")  .WithPluralName("BillFromContactMechanisms")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("f1059139-6664-43d5-801f-79a4cc4288a6"), new Guid("92807e93-ed03-4dbc-9296-c508c879705b"), new Guid("3f2699b9-9652-4af4-98d7-2ff803677692")).WithObjectTypes(Shipment, Store).WithSingularName("Store")  .WithPluralName("Stores")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("f1e92d31-db63-419c-8ed7-49f5db66c63d"), new Guid("fffbc8b5-a541-402d-8df6-3134cc52b306"), new Guid("566b9c3a-3fec-455f-a40d-b23338d3508c")).WithObjectTypes(Shipment, Party).WithSingularName("ShipFromParty")  .WithPluralName("ShipFromParties")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("f403ab39-cc81-4e09-8794-a45db9ef178f"), new Guid("78c8d202-0277-4c3a-9e24-74041cc56872"), new Guid("8086c3d5-1577-4c32-bf73-abe72aac725c")).WithObjectTypes(Shipment, ShipmentRouteSegment).WithSingularName("ShipmentRouteSegment")  .WithPluralName("ShipmentRouteSegments")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("fdac3beb-edf8-4d1b-80d4-21b643ef43ce"), new Guid("63d8adfc-6afb-499f-bd27-2f1d3f78bee6"), new Guid("8f56ce24-500e-4db9-abce-c7a301c38fe6")).WithObjectTypes(Shipment, allorsDate).WithSingularName("EstimatedArrivalDate")  .WithPluralName("EstimatedArrivalDates")      .Build();
            ...
            // ProfessionalAssignment
            new RelationTypeBuilder(domain, new Guid("18af73aa-336f-4120-8508-a59a9acf17bc"), new Guid("31da78aa-5e06-48f8-90e4-018ef021a280"), new Guid("cf515b68-b198-4348-881c-fd9a0bcf22bf")).WithObjectTypes(ProfessionalAssignment, Person).WithSingularName("Professional")  .WithPluralName("Professionals")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("a75d3ec2-c4f8-4de6-a10c-fe5e3897e663"), new Guid("70e8f936-27c8-42cb-9459-9a823aaa6318"), new Guid("bb592768-a6f0-47fb-bc74-a15fc5867b34")).WithObjectTypes(ProfessionalAssignment, EngagementItem).WithSingularName("EngagementItem")  .WithPluralName("EngagementItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // Container
            new RelationTypeBuilder(domain, new Guid("a8279f40-4624-4aa9-9e61-fc01f880ca17"), new Guid("15f3df8c-c20e-4162-b5f8-1e031001f11f"), new Guid("33da1e6a-60bd-4c50-9fe6-30946254a5f7")).WithObjectTypes(Container, Facility).WithSingularName("Facility")  .WithPluralName("Facilities")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("7afc9649-43c9-4a60-a298-27361ba59765"), new Guid("41547bdb-9d10-42fb-a75f-b0c8d9b8d09e"), new Guid("6038fc56-abb9-41e6-965c-d71648d9f5ce")).WithObjectTypes(Payment, allorsDate).WithSingularName("EffectiveDate")  .WithPluralName("EffectiveDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("a80a1ed7-473b-493b-a9ab-23a682c6ae44"), new Guid("3e95c4c2-6164-486a-a483-e0552a142e13"), new Guid("495d6adc-8fff-4754-99cf-b4f2a65e6b44")).WithObjectTypes(Payment, Party).WithSingularName("SendingParty")  .WithPluralName("SendingParties")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("b0c79092-c5d0-426b-b06d-ccec574bb7d9"), new Guid("d85e6a8c-5fa9-455d-bc94-6d02b47e7cd8"), new Guid("967768b1-8ec5-4b58-8e8c-2513e5528bb2")).WithObjectTypes(Payment, PaymentApplication).WithSingularName("PaymentApplication")  .WithPluralName("PaymentApplications")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("faafa75e-496c-4220-ae3f-ab7d1e317484"), new Guid("c5800c84-707e-443c-a8ae-bc4e5598bc08"), new Guid("46c1c87e-c4af-4383-814d-5452b2faae94")).WithObjectTypes(Payment, Party).WithSingularName("ReceivingParty")  .WithPluralName("ReceivingParties")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // PackageRevenueHistory
            new RelationTypeBuilder(domain, new Guid("10487ca8-f973-4be7-b2ae-91857fe0486c"), new Guid("33beebef-7ccd-4ce3-a64b-262380d58728"), new Guid("6e01962d-36d5-4b16-8dc7-4290e3f8095e")).WithObjectTypes(PackageRevenueHistory, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("662d235e-1d36-48d1-a945-f0b60e579ca1"), new Guid("ffc5e375-a778-459e-978c-e542952cd0fa"), new Guid("771e3c35-cb1a-4fb7-8c0d-01f6bbb9f4e3")).WithObjectTypes(PackageRevenueHistory, Package).WithSingularName("Package")  .WithPluralName("Packages")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("7e7e4510-d1fb-4389-8a8c-d444f1c87daa"), new Guid("89879f07-2f9a-4c6c-bf3a-8d2ec8742d27"), new Guid("28f27ac4-af47-41a1-b264-1c58bb73a852")).WithObjectTypes(PackageRevenueHistory, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("51bfbe94-46a5-411f-ac10-8623bfc4472c"), new Guid("b8b5d65b-14c9-4ab0-89b9-4124d60cfeb7"), new Guid("b49c43fd-798c-4608-a055-af04d97aa72d")).WithObjectTypes(Case, CaseStatus).WithSingularName("CaseStatus")  .WithPluralName("CaseStatuses")  .WithMultiplicity(Multiplicity.OneToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("65e310b5-1358-450c-aec2-985dcc724cdd"), new Guid("d815e7c2-fe40-470c-9ab9-007f7bc0465b"), new Guid("fee6ebfb-3ce6-473b-9142-ea70ade93709")).WithObjectTypes(Case, allorsDate).WithSingularName("StartDate")  .WithPluralName("StartDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("6f68ff93-e70c-4581-b0c7-94b2f75e6860"), new Guid("8fb16366-5def-43eb-a68b-2bac5169564b"), new Guid("546330b8-f772-45f0-b2f0-66cf4a9ebffc")).WithObjectTypes(Case, CaseObjectState).WithSingularName("CurrentObjectState")  .WithPluralName("CurrentObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("be264aef-f259-494c-bfbf-20d20afde14c"), new Guid("d76227b9-0a0d-4f88-a169-99f5e681d374"), new Guid("b05ebe9f-e108-4dfe-b1e2-afb6dc9c3f55")).WithObjectTypes(Case, CaseObjectState).WithSingularName("PreviousObjectState")  .WithPluralName("PreviousObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            // WorkEffortPartStandard
            new RelationTypeBuilder(domain, new Guid("4d4913e2-649d-4589-86ee-93cfa6c426a7"), new Guid("9228803e-089c-4ee6-9a42-18503d12f663"), new Guid("abb46361-be39-4668-8bbb-26de268a654c")).WithObjectTypes(WorkEffortPartStandard, Part).WithSingularName("Part")  .WithPluralName("Parts")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // Bank
            new RelationTypeBuilder(domain, new Guid("28723704-3a61-445a-b14e-c757ebbf8d66"), new Guid("86b555ec-72f1-4ed6-b161-56d23508cf99"), new Guid("17dc868b-9a11-41c1-9366-b10f47d1fe3f")).WithObjectTypes(Bank, Media).WithSingularName("Logo")  .WithPluralName("Logos")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("5f87a322-6943-4b20-b667-11bdf2f29244"), new Guid("e4cc94a8-3282-4a52-9e7e-1291105c3269"), new Guid("4e6ed630-8d5d-4b1c-8934-4332d15426ad")).WithObjectTypes(ProductRevenue, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("c2570065-9bd8-403e-be43-884d31d4ccce"), new Guid("9d6ab03e-c52b-431b-aaee-f8116cf3a64c"), new Guid("d84acfc6-0df5-4d50-89bf-b36e2a0e5e9c")).WithObjectTypes(ProductRevenue, Product).WithSingularName("Product")  .WithPluralName("Products")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("e33476e4-a420-4fa5-a367-72ff75c4d5c4"), new Guid("e13c2b60-30b8-48d4-b0d7-443ac8e493e5"), new Guid("15aa589a-9169-4644-8256-b8a644a6b5cf")).WithObjectTypes(ProductRevenue, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("36b9d86d-4e2e-4ff5-b167-8ea6c81dd6cc"), new Guid("8e37c73a-5508-432f-94c9-77d0159b0cc2"), new Guid("955c2b54-1aab-4eb0-b71d-3b6e4664e3b3")).WithObjectTypes(VatRate, VatReturnBox).WithSingularName("VatReturnBox")  .WithPluralName("VatReturnBoxes")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("5418fdea-366c-4e0b-b2e0-d49cfb12cbe5"), new Guid("b63a4251-c297-46cb-a2a3-b0d619abe398"), new Guid("52fc90c1-2de7-4076-8cbf-44174ebd25a2")).WithObjectTypes(VatRate, Organisation).WithSingularName("TaxAuthority")  .WithPluralName("TaxAuthorities")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("5551f4ce-858f-4f29-9e92-3c2c893bb44b"), new Guid("bf0f6d49-1753-42f4-99e6-649e64bb0629"), new Guid("be2f8700-bd7d-4dd1-91ff-637ddc6a07a6")).WithObjectTypes(VatRate, VatRateUsage).WithSingularName("VatRateUsage")  .WithPluralName("VatRateUsages")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("821df580-26d4-415c-b2ea-3e96a08c2f62"), new Guid("5678eef7-6892-4c47-900d-85b5c5c08940"), new Guid("bb7c23b8-0a01-4afa-91a6-7816bbaa803c")).WithObjectTypes(VatRate, VatRatePurchaseKind).WithSingularName("VatRatePurchaseKind")  .WithPluralName("VatRatePurchaseKinds")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("8b37058f-49bd-4cc6-8c26-9a9e7c6700ad"), new Guid("71231b78-14e7-41c3-8691-745f4dd9c919"), new Guid("00945490-ff10-440b-be3b-de563caf892f")).WithObjectTypes(VatRate, VatTariff).WithSingularName("VatTariff")  .WithPluralName("VatTariffs")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("958c1fda-0126-4b0a-8967-5d9df3ba50dc"), new Guid("edcb9612-a4d4-4ddc-971c-48b7dfa6b03c"), new Guid("9e77b9ad-9031-4766-a2f3-33c875395a79")).WithObjectTypes(VatRate, TimeFrequency).WithSingularName("PaymentFrequency")  .WithPluralName("PaymentFrequencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("6ea961d5-89fc-4526-922a-80538ecb5654"), new Guid("66c5cfdd-6af4-4d75-b826-843be3b01bca"), new Guid("f560bb3d-f855-4ec3-a5e7-4bd6c4da2595")).WithObjectTypes(Invoice, BillingAccount).WithSingularName("BillingAccount")  .WithPluralName("BillingAccounts")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("82541f62-bf0e-4e33-9971-15a5a4fa4469"), new Guid("b3579af4-1c8e-46c5-bc1c-a9d7711a4a48"), new Guid("d54fdbf9-c580-4a49-b058-28aab77d81e0")).WithObjectTypes(Invoice, allorsDate).WithSingularName("InvoiceDate")  .WithPluralName("InvoiceDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("8798a760-de3d-4210-bd22-165582728f36"), new Guid("d0d6a00a-2d79-4798-b51f-7e6dfb8551d5"), new Guid("c1f88c71-2415-4928-ae3b-16c7f85af30c")).WithObjectTypes(Invoice, allorsDate).WithSingularName("EntryDate")  .WithPluralName("EntryDates")  .WithIsDerived(true)    .Build();
            ...
            // ProfessionalServicesRelationship
            new RelationTypeBuilder(domain, new Guid("62edaaeb-bcef-4c3c-955a-30d708bc4a3c"), new Guid("af3829d6-137c-4453-b705-60b7dfa8c045"), new Guid("29b1fec5-de9c-4fe2-bdfc-fc9d33ca90b5")).WithObjectTypes(ProfessionalServicesRelationship, Person).WithSingularName("Professional")  .WithPluralName("Professionals")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("a587695e-a9b3-4b5b-b211-a19096b88815"), new Guid("d3fc269c-debf-4ada-b1be-b2f48d2ae027"), new Guid("c6b955f2-20ed-4164-8f11-2c5d24fa0443")).WithObjectTypes(ProfessionalServicesRelationship, Organisation).WithSingularName("ProfessionalServicesProvider")  .WithPluralName("ProfessionalServicesProviders")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // RecurringCharge
            new RelationTypeBuilder(domain, new Guid("f95e774f-239e-4136-a964-c3d1841a43ba"), new Guid("46b2864f-5c9b-43b9-a6b0-0bcf907adbc8"), new Guid("97a9949b-6266-4fa2-a33a-3b13eaf21a93")).WithObjectTypes(RecurringCharge, TimeFrequency).WithSingularName("TimeFrequency")  .WithPluralName("TimeFrequencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // RequirementStatus
            new RelationTypeBuilder(domain, new Guid("03542f1b-23ac-4bfc-add5-bad028295b4e"), new Guid("9000b234-a6cf-4707-8a33-b90f6ee7b869"), new Guid("7baebeac-8013-4acc-bef7-508eed0eb1c3")).WithObjectTypes(RequirementStatus, RequirementObjectState).WithSingularName("RequirementObjectState")  .WithPluralName("RequirementObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("49e2a03a-aeba-4ae2-9f75-47639334bde6"), new Guid("a3ac3a93-90ed-4bfb-8a8c-e1fbd8fe743e"), new Guid("265a7954-c3be-420b-98b5-ff70076cefdf")).WithObjectTypes(RequirementStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
			
            // DropShipment
            new RelationTypeBuilder(domain, new Guid("0984f98c-fc64-4c86-aeb6-1d804d1506db"), new Guid("f7de3d8b-e404-4652-8eb1-dc58f8307e14"), new Guid("9ac05629-f7ae-422e-8131-78389ba7ecf9")).WithObjectTypes(DropShipment, DropShipmentStatus).WithSingularName("ShipmentStatus")  .WithPluralName("ShipmentStatuses")  .WithMultiplicity(Multiplicity.OneToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            // SalesInvoiceItem
            new RelationTypeBuilder(domain, new Guid("0854aece-6ca1-4b8d-99a9-6d424de8dfd4"), new Guid("cebb5430-809a-4d46-bc7b-563ee72f0848"), new Guid("f1f68b89-b95f-43c9-82d5-cb9eec635869")).WithObjectTypes(SalesInvoiceItem, ProductFeature).WithSingularName("ProductFeature")  .WithPluralName("ProductFeatures")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("0a93f639-a456-4318-a8fa-8d3c2a107379"), new Guid("f9476899-7bd7-472a-ae64-0a7f4610cb87"), new Guid("56ce0901-621f-407f-81be-9921ad6d19be")).WithObjectTypes(SalesInvoiceItem, SalesInvoiceItemObjectState).WithSingularName("CurrentObjectState")  .WithPluralName("CurrentObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("4daa5c18-85c6-49c0-8f23-8e419e44471c"), new Guid("061348dc-59a2-41d1-92bb-ccf16a1f31aa"), new Guid("a037ec30-f0f4-4dda-8eb5-80a042b26399")).WithObjectTypes(SalesInvoiceItem, Product).WithSingularName("Product")  .WithPluralName("Products")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("5a2c6c32-f7b6-40da-859f-a430edc27a43"), new Guid("31bd5084-75e8-4781-a7f0-d4a82f391066"), new Guid("c627c330-7381-4363-be05-3c80cac5b8af")).WithObjectTypes(SalesInvoiceItem, SalesInvoiceItemStatus).WithSingularName("InvoiceItemStatus")  .WithPluralName("InvoiceItemStatuses")  .WithMultiplicity(Multiplicity.OneToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("5bdae88b-856d-4746-8645-9bded2a4a3bd"), new Guid("2b93a791-124c-45ac-8f3c-bf33f2dcfc13"), new Guid("b303f168-96d8-478a-b42c-6b7594b8db42")).WithObjectTypes(SalesInvoiceItem, SalesOrderItem).WithSingularName("SalesOrderItem")  .WithPluralName("SalesOrderItems")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("6dd4e8ee-48ed-400d-a129-99a3a651586a"), new Guid("f99e5e01-943c-4de9-862c-c472d2d873f2"), new Guid("6cb182c2-b481-4e26-869e-609990ea68b3")).WithObjectTypes(SalesInvoiceItem, SalesInvoiceItemType).WithSingularName("SalesInvoiceItemType")  .WithPluralName("SalesInvoiceItemTypes")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("90866201-03a1-44b2-9318-5048639b58c8"), new Guid("0618fddc-dee4-4cd4-9d4d-b7356be9dc65"), new Guid("d61277d3-b916-4783-9de0-48f9eb6808c4")).WithObjectTypes(SalesInvoiceItem, Person).WithSingularName("SalesRep")  .WithPluralName("SalesReps")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("e8121ef7-e1f1-4245-a003-bae93e076a09"), new Guid("7986627b-3328-4d54-9064-052a81fec92d"), new Guid("dab55577-afea-4030-ad75-2c12873c2785")).WithObjectTypes(SalesInvoiceItem, SalesInvoiceItemObjectState).WithSingularName("PreviousObjectState")  .WithPluralName("PreviousObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
			
            // EngagementItem
            new RelationTypeBuilder(domain, new Guid("141333b6-2cc9-487e-acc1-86d314f2b30a"), new Guid("17fbbe0c-7d74-46ba-b5dd-a115536dd1a6"), new Guid("10b8af44-2efd-4549-981c-8471860dfb55")).WithObjectTypes(EngagementItem, QuoteItem).WithSingularName("QuoteItem")  .WithPluralName("QuoteItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("33fe3f86-8b73-4a70-b9c0-62ac27531ac3"), new Guid("24a3d499-1f30-4b0e-8a27-a42808c4b1a2"), new Guid("5e4915f7-955d-41a9-9c38-d8b6f7837ea4")).WithObjectTypes(EngagementItem, allorsDate).WithSingularName("ExpectedStartDate")  .WithPluralName("ExpectedStartDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("3635cb84-2d4f-4fa1-ac18-4c8a6cc129c5"), new Guid("b58461be-8138-42e1-9e4b-e095ae66fc90"), new Guid("afc29589-892c-41ca-94b3-92a775009a6e")).WithObjectTypes(EngagementItem, allorsDate).WithSingularName("ExpectedEndDate")  .WithPluralName("ExpectedEndDates")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("9133f59e-048d-4020-88e4-5a4bc36d663b"), new Guid("46ad58c7-3125-4307-93ae-58c386e98899"), new Guid("3065d420-15ec-47d3-9fa6-56a79d4c315b")).WithObjectTypes(EngagementItem, EngagementRate).WithSingularName("EngagementRate")  .WithPluralName("EngagementRates")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("9e1f4da4-41af-4030-b67f-79f1f49fa076"), new Guid("b5361ebf-2809-4fe7-8f24-bd68ec61c9b8"), new Guid("124043c0-dd7e-4d94-9c0c-a3804c343f11")).WithObjectTypes(EngagementItem, EngagementRate).WithSingularName("CurrentEngagementRate")  .WithPluralName("CurrentEngagementRates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("b445f2d6-55a6-4cb4-9550-5be8863eddb6"), new Guid("21509869-1643-402a-a5eb-9657f1f01af9"), new Guid("8844d711-33d6-4d19-ad21-edcd60851f1d")).WithObjectTypes(EngagementItem, EngagementItem).WithSingularName("OrderedWith")  .WithPluralName("OrderedWiths")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("c2ec3c6b-af56-4c6b-bdaf-76d3ea340bf7"), new Guid("d9a53328-0414-4403-bd54-37b48ec05823"), new Guid("a2dd5921-6ec7-4d7b-8aae-9a7e685688d1")).WithObjectTypes(EngagementItem, Person).WithSingularName("CurrentAssignedProfessional")  .WithPluralName("CurrentAssignedProfessionals")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("c7204c16-67b1-4e6d-b787-ce8ab9c6c111"), new Guid("d417f454-c1fa-41da-8b00-653b27d875a4"), new Guid("eaa02501-f6d8-4d12-b11e-523bf70805a4")).WithObjectTypes(EngagementItem, Product).WithSingularName("Product")  .WithPluralName("Products")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("dbb3d0c5-836d-477b-a42f-b260f3316458"), new Guid("888670c7-e42c-41eb-994f-91af9d2d93f3"), new Guid("ce43a83c-0289-42b5-9330-0341fa847809")).WithObjectTypes(EngagementItem, ProductFeature).WithSingularName("ProductFeature")  .WithPluralName("ProductFeatures")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("7a66f2bc-bfb1-420a-a383-acf3092ca48b"), new Guid("d3943099-a5ec-413b-9079-239c67bdc696"), new Guid("1c1aead6-f157-4d23-a9f0-0565e2b7ff82")).WithObjectTypes(Event, allorsDate).WithSingularName("From")  .WithPluralName("Froms")      .Build();
            new RelationTypeBuilder(domain, new Guid("7d73d60c-bcb2-4be6-bc60-e4420a8d0417"), new Guid("09cdba21-c34e-465e-847b-8062232c6d85"), new Guid("f80dabde-e6f0-4044-9468-f96641bdd49a")).WithObjectTypes(Event, Locale).WithSingularName("Locale")  .WithPluralName("Locales")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("cbc5a9f6-cd08-41aa-a4aa-dac9a8a802ac"), new Guid("ec42a541-030f-4fbe-9fba-145c8fbc8e87"), new Guid("ecc373d4-636f-4114-8635-55a97e629607")).WithObjectTypes(Event, Media).WithSingularName("Photo")  .WithPluralName("Photos")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("de61dd0d-1f8e-4a55-9fe4-f44cf35b6a31"), new Guid("90352035-7b90-414f-be38-7f3e4d5fbd95"), new Guid("b8c6fe1f-7c7e-41ae-8f03-32a18e4920e5")).WithObjectTypes(Event, allorsDate).WithSingularName("To")  .WithPluralName("Tos")      .Build();
			
            // ClientRelationship
            new RelationTypeBuilder(domain, new Guid("d611f21a-1045-40ea-b05b-0c29913d5f1c"), new Guid("115baf34-414a-4cfa-8d1f-dfbeb7264077"), new Guid("69161130-4a2e-430e-92a2-b8ab0e6ef8dc")).WithObjectTypes(ClientRelationship, Party).WithSingularName("Client")  .WithPluralName("Clients")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("e081884c-3db2-4be3-9c85-9167528d751b"), new Guid("32544879-3730-449a-9835-8decbfe9f4fc"), new Guid("2f9c92b5-7cf2-42ba-924d-4b5d0c73956c")).WithObjectTypes(ClientRelationship, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("adfe14e7-fbf6-465f-b6e5-1eb3e8583179"), new Guid("682538a3-d3e7-432b-9264-38197462cee1"), new Guid("fecc85a0-871b-4846-b8f1-c2a5728fbbd2")).WithObjectTypes(PurchaseOrderItem, Product).WithSingularName("Product")  .WithPluralName("Products")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("af9fa5bc-a392-473d-b077-7f06ee24390b"), new Guid("9a0f9ecd-9954-4c2f-bb0e-e94f9cc3c19a"), new Guid("5665d533-cd9c-4328-b422-66a94d77b19b")).WithObjectTypes(InventoryItemVariance, allorsDate).WithSingularName("InventoryDate")  .WithPluralName("InventoryDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("e422efc4-4d17-46d8-bba4-6e78e7761f93"), new Guid("468307f7-5033-4e77-9482-5df34ca9a4f1"), new Guid("7e0b8650-0d19-4ecc-b6e6-3c78dfe8c2aa")).WithObjectTypes(InventoryItemVariance, VarianceReason).WithSingularName("Reason")  .WithPluralName("Reasons")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("e2bd1f50-f891-4e3f-bac0-e9582b89e64c"), new Guid("9bb26e51-9acf-4fa1-8a24-3d0b1b2f7103"), new Guid("d85aba30-7aee-4bc4-9026-26ba4f355d70")).WithObjectTypes(ContactMechanism, ContactMechanism).WithSingularName("FollowTo")  .WithPluralName("FollowTo")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
			
            // CommunicationEvent
            new RelationTypeBuilder(domain, new Guid("01665c57-a343-441d-9760-53763badce51"), new Guid("82c1dad0-6d6d-440c-8bf0-f20d35ab0863"), new Guid("0dd9728e-0887-4029-af20-dd69371fbba0")).WithObjectTypes(CommunicationEvent, allorsDate).WithSingularName("ScheduledStart")  .WithPluralName("ScheduledStarts")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("28874ffe-f3b3-4aba-9f28-ba7c15b0cb65"), new Guid("544164cd-43e9-4e3c-a0b2-a33574accd7c"), new Guid("cbf3c355-cf99-4bd4-8f8b-e0dca835b9d2")).WithObjectTypes(CommunicationEvent, Party).WithSingularName("InvolvedParty")  .WithPluralName("InvolvedParties")  .WithMultiplicity(Multiplicity.ManyToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("2fa315f8-6208-495c-bcc4-2ccda734cc09"), new Guid("6b5d29f8-7016-4cdb-9af9-8320b1c7304d"), new Guid("8e7c8bab-063d-4f77-99ae-6e7979b63ce4")).WithObjectTypes(CommunicationEvent, allorsDate).WithSingularName("InitialScheduledStartDate")  .WithPluralName("InitialScheduledStartDates")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("9e52b6a3-3f94-43d6-9fda-879f57499c05"), new Guid("9dd6ccef-f816-40d6-9bb4-e1e88b2e0c06"), new Guid("7c309ce2-dd9a-4299-b462-b506b8ca54f4")).WithObjectTypes(CommunicationEvent, Case).WithSingularName("Case")  .WithPluralName("Cases")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("c43b6f6f-0fda-4794-9199-84b39373ecb3"), new Guid("f8f85fd4-3b97-4a67-8b42-12e17938c802"), new Guid("bc58b136-9b36-4065-babb-934ede99aefd")).WithObjectTypes(CommunicationEvent, Person).WithSingularName("Owner")  .WithPluralName("Owners")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("ecc20a6a-ef70-4a09-8a3b-c8dce88eaa27"), new Guid("abdb3a26-ae86-4500-a9d9-d9546fb6f856"), new Guid("406f48d7-a0be-48c9-81f5-7b506b41e114")).WithObjectTypes(CommunicationEvent, allorsDate).WithSingularName("ActualStart")  .WithPluralName("ActualStarts")      .Build();
			
            // PositionResponsibility
            new RelationTypeBuilder(domain, new Guid("493412a4-c29c-4e1c-9167-6c0c0dca831f"), new Guid("030fa5c5-e41f-4141-a91e-02b37a20e685"), new Guid("fe87742c-4238-4be0-9f58-70ae3f01c96b")).WithObjectTypes(PositionResponsibility, Position).WithSingularName("Position")  .WithPluralName("Positions")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("9c8794b9-2c7b-4afa-86a6-21fb48fc902f"), new Guid("7613dcb8-0c6f-4c65-96c0-75d2cc9db16e"), new Guid("70d2a311-d09b-406c-89d4-3adbbc0a8fe2")).WithObjectTypes(PositionResponsibility, Responsibility).WithSingularName("Responsibility")  .WithPluralName("Responsibilities")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("a0a42e5c-3106-4709-aa7b-c916a0ba8508"), new Guid("dc0b4ab7-19d1-4d15-938a-07ce77ba3b23"), new Guid("eeec43e2-dcb4-4ae1-aceb-afbb9da25f68")).WithObjectTypes(ResourceRequirement, allorsDate).WithSingularName("RequiredStartDate")  .WithPluralName("RequiredStartDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("d1c048c9-eb05-4cd2-a06c-a8dacf993ab2"), new Guid("88727cd2-46fd-44c0-a5bf-08698256592d"), new Guid("602edcd9-9446-4bbd-9133-1fbb45f423db")).WithObjectTypes(ResourceRequirement, NeededSkill).WithSingularName("NeededSkill")  .WithPluralName("NeededSkills")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("ffd07bff-38a2-4284-958d-18b1296f6112"), new Guid("ff6383a4-8502-4f12-8337-6a6ead2f3f0f"), new Guid("1aea6980-6914-4587-98ad-93d9164ebd63")).WithObjectTypes(ResourceRequirement, allorsDate).WithSingularName("RequiredEndDate")  .WithPluralName("RequiredEndDates")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("a4e584cc-7cf6-4590-83e4-a827a7a06624"), new Guid("76a35c5f-4f20-4520-ba02-f68a0dd61e0d"), new Guid("528620b6-e0a7-424a-8c8a-a9fa9c8ed84c")).WithObjectTypes(BudgetItem, BudgetItem).WithSingularName("Child")  .WithPluralName("Children")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("5fbc72bf-2153-4b91-83f9-6fd057e4b1d6"), new Guid("c06de12f-bf0e-4d91-b8f6-9f6b250b107c"), new Guid("26944bd3-762b-4436-ba19-5e5c34c1247f")).WithObjectTypes(PositionReportingStructure, Position).WithSingularName("ManagedByPosition")  .WithPluralName("ManagedByPositions")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("e2e60d09-ebfa-4bf3-94e9-759279b00919"), new Guid("1e94dba5-c7d3-41ca-ae79-80b0d2b2ce3c"), new Guid("7b375d54-2364-422c-a264-dd6438d53d33")).WithObjectTypes(PositionReportingStructure, Position).WithSingularName("Position")  .WithPluralName("Positions")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // Partnership
            new RelationTypeBuilder(domain, new Guid("c8eafc73-9fb3-4a7b-8349-1dd1e9f64520"), new Guid("4d6ee3e0-4c0c-4387-b140-e2296c8bcbd4"), new Guid("386770df-4089-482e-9b54-af375c37319f")).WithObjectTypes(Partnership, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("c9a60b88-e525-4bcd-94bd-3fca8989319f"), new Guid("309ffb3e-7cd3-4958-9177-e7f25a272579"), new Guid("f77b776b-b957-418b-acfb-a4aad51f7a8a")).WithObjectTypes(Partnership, Organisation).WithSingularName("Partner")  .WithPluralName("Partners")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("af3ad6bb-70a1-4682-945c-4cad1407ecf2"), new Guid("cf6d2b69-9646-46d2-a7a1-d02f8b8ec954"), new Guid("6361ff04-7d8e-45f3-b3a5-efe1f6c983be")).WithObjectTypes(SalesRepCommission, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("ea8de270-d03a-44cf-9b97-c233e1615d9e"), new Guid("7c2854ac-f4db-41e5-8b2f-7a9e9b376dff"), new Guid("bd39c031-3391-4b20-a57f-86c6e4c5b130")).WithObjectTypes(SalesRepCommission, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("f6d1ce52-7d8e-42e2-a76e-acc35e2b5dd8"), new Guid("743000d8-a71b-4638-9b3e-a5be4e45fd29"), new Guid("7e4d3cd9-4066-4186-a311-b1cd5155d632")).WithObjectTypes(SalesRepCommission, Person).WithSingularName("SalesRep")  .WithPluralName("SalesReps")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // CityBound
            new RelationTypeBuilder(domain, new Guid("7723a00d-8764-40e2-99a8-a790401689b5"), new Guid("bb222d51-4e32-4182-8c45-8ce6db2f2cea"), new Guid("4aa9efbb-fc9d-44f3-b713-3b1493637467")).WithObjectTypes(CityBound, City).WithSingularName("City")  .WithPluralName("Cities")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
			
            // Deduction
            new RelationTypeBuilder(domain, new Guid("0deb347e-22c7-4b48-b461-aa579e156398"), new Guid("aced036b-04ba-41da-a3fd-fb3d0782b8c6"), new Guid("b09c7a91-bcca-4f80-b68c-309fdf1e80b0")).WithObjectTypes(Deduction, DeductionType).WithSingularName("DeductionType")  .WithPluralName("DeductionTypes")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // CaseStatus
            new RelationTypeBuilder(domain, new Guid("28ef5fa2-7e2a-4ebb-b5a2-fe8cf7f18d04"), new Guid("9a1d40d3-0c58-4088-9a62-d7a35b787bf6"), new Guid("1acf2d5a-2631-48da-8e9a-222ff1293e83")).WithObjectTypes(CaseStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
            new RelationTypeBuilder(domain, new Guid("332b3322-ef2e-4457-8503-045aa99061c9"), new Guid("76b6d6d5-e406-43aa-be3f-90a685a3f8dc"), new Guid("8fbd70e2-fc8c-4584-ac6c-82bc432f9326")).WithObjectTypes(CaseStatus, CaseObjectState).WithSingularName("CaseObjectState")  .WithPluralName("CaseObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // PartSubstitute
            new RelationTypeBuilder(domain, new Guid("23f8fda9-9109-4826-988f-74e115a430f4"), new Guid("9f43aa6a-68d0-44f9-aecb-977b6f0d66ea"), new Guid("1a0b6784-dcbe-4f86-acb1-1a0408f00465")).WithObjectTypes(PartSubstitute, Part).WithSingularName("SubstitutionPart")  .WithPluralName("SubstitutionParts")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("510f8f4c-ff09-4d32-8c1c-e905dbbd684b"), new Guid("25d0c7ec-767e-4509-9164-67dbec0d66f4"), new Guid("d2c04285-03ab-4391-9338-d158630793b0")).WithObjectTypes(PartSubstitute, Ordinal).WithSingularName("Preference")  .WithPluralName("Preferences")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("9cd198eb-2c25-425e-a23b-c321938f2512"), new Guid("8f8c0254-8bb0-4e61-83b5-38b0b80d0b97"), new Guid("6939df10-1c96-4a64-aae4-201392e9fd59")).WithObjectTypes(PartSubstitute, allorsDate).WithSingularName("FromDate")  .WithPluralName("FromDates")      .Build();
            ...
            // TransferStatus
            new RelationTypeBuilder(domain, new Guid("05a4a5a6-cdaf-4ec8-9a34-cbd40753789b"), new Guid("a259de23-8d18-4d51-81e3-42796a144b5b"), new Guid("b3fd264c-91a5-425b-b9a0-48eb5cc765fd")).WithObjectTypes(TransferStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
            new RelationTypeBuilder(domain, new Guid("a08cde84-30e0-4f99-b6b5-35b45c3fa2b8"), new Guid("0fb9e813-bd7d-40c8-a1c2-10a569e873c8"), new Guid("63627877-78be-4ffc-aa0d-740049add137")).WithObjectTypes(TransferStatus, TransferObjectState).WithSingularName("TransferObjectState")  .WithPluralName("TransferObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("78d6de86-0f4d-4d8e-a9a6-4730668fa754"), new Guid("51d96df2-1e92-4ea2-8ec7-e918d5781ae7"), new Guid("933a70e0-0fa0-42cd-a4d5-b3eb10b57802")).WithObjectTypes(OrderAdjustment, VatRate).WithSingularName("VatRate")  .WithPluralName("VatRates")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // EngineeringChange
            new RelationTypeBuilder(domain, new Guid("1a5edba2-6fda-4eb1-9e37-7a0e368ccff0"), new Guid("1858c16c-47e0-4707-ba58-acd34378d25e"), new Guid("3cdaec27-9203-4ed3-8b9d-a4995db9210d")).WithObjectTypes(EngineeringChange, Person).WithSingularName("Requestor")  .WithPluralName("Requestors")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("1b65b18b-c930-49b4-85e4-bb4b07dfdca2"), new Guid("a34d8a88-50c9-4ece-920c-a1d95388b5ab"), new Guid("5aa1e795-726a-4459-9c1a-e4efb82e807f")).WithObjectTypes(EngineeringChange, Person).WithSingularName("Authorizer")  .WithPluralName("Authorizers")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("0994b73e-8d4c-4fa4-aca2-287449b22ca7"), new Guid("17a9138e-76c8-42e1-85b8-7af73b551a22"), new Guid("09fbb64d-c32e-4734-8df9-6e741a5070a5")).WithObjectTypes(InternalOrganisation, JournalEntryNumber).WithSingularName("JournalEntryNumber")  .WithPluralName("JournalEntryNumbers")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("293758d7-cc0a-4f1c-b122-84f609a828c2"), new Guid("afe9d80b-2984-4e46-b45c-e5a25af3bccd"), new Guid("97aa32a6-69c0-4cc5-9e42-98907ff6c45f")).WithObjectTypes(InternalOrganisation, PaymentMethod).WithSingularName("ActivePaymentMethod")  .WithPluralName("ActivePaymentMethods")  .WithMultiplicity(Multiplicity.OneToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("33a47048-277a-40e8-bfe0-c8090eb179b2"), new Guid("81bc7c99-b328-4b81-9391-fe7659146924"), new Guid("403008e6-8c8a-437e-8b09-02573198e319")).WithObjectTypes(InternalOrganisation, StringTemplate).WithSingularName("PurchaseShipmentTemplate")  .WithPluralName("PurchaseShipmentTemplates")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("3b32c442-9cbc-41d8-8eb2-2ae41beca2c4"), new Guid("eda352cd-00cc-4d04-99cf-f7ad667cb20a"), new Guid("b8211575-f4c9-44c8-89b2-bd122704f098")).WithObjectTypes(InternalOrganisation, CostCenterSplitMethod).WithSingularName("CostCenterSplitMethod")  .WithPluralName("CostCenterSplitMethods")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("496f6d33-2259-442e-924f-636d73cec52f"), new Guid("4ac05596-41d8-402a-8308-d9f458d604e0"), new Guid("0739dac1-6507-4306-95c9-78f10532a78e")).WithObjectTypes(InternalOrganisation, LegalForm).WithSingularName("LegalForm")  .WithPluralName("LegalForms")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("49b087e2-9f55-463e-8e77-2500149ad771"), new Guid("1da60a2b-5359-4688-b925-edee515a2427"), new Guid("a0e7966c-1096-4491-a712-1dc38b58b67c")).WithObjectTypes(InternalOrganisation, AccountingPeriod).WithSingularName("AccountingPeriod")  .WithPluralName("AccountingPeriods")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("5ca9eda8-278b-4466-99f3-8c61d0383ef4"), new Guid("5dd8f968-1ebf-4b94-be2d-11005d24aeb5"), new Guid("9e72477e-4729-4371-8f6b-80ff618705f7")).WithObjectTypes(InternalOrganisation, StringTemplate).WithSingularName("PurchaseOrderTemplate")  .WithPluralName("PurchaseOrderTemplates")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("63c9ceb1-d583-41e1-a9a9-0c2576e9adfc"), new Guid("fd1ac2ff-6869-44bd-9b4e-05a3b14fbad9"), new Guid("41058049-5c44-47b7-bbb9-34ab0bdcfbcb")).WithObjectTypes(InternalOrganisation, CostOfGoodsSoldMethod).WithSingularName("CostOfGoodsSoldMethod")  .WithPluralName("CostOfGoodsSoldMethods")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("76acc9c6-0aa1-4b30-8cca-4629fdd56b91"), new Guid("b9f585f4-a612-451a-ac0e-4a2584982385"), new Guid("e9e6013f-9458-4d27-89a2-bced57a2b15f")).WithObjectTypes(InternalOrganisation, Role).WithSingularName("EmployeeRole")  .WithPluralName("EmployeeRoles")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("89f4907d-4a10-428d-9e6b-ef9fb045c019"), new Guid("a0fd3167-5d4e-400f-b593-1497fce5d024"), new Guid("0ab03957-8140-4e1c-8a13-a9647f6c9e47")).WithObjectTypes(InternalOrganisation, GeneralLedgerAccount).WithSingularName("RetainedEarningsAccount")  .WithPluralName("RetainedEarningsAccounts")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("9306706d-c35c-4e7d-af31-60ff13c348bd"), new Guid("7299e411-7fd5-4500-8e25-a44f0339806a"), new Guid("1975353f-30b6-4c4a-ab41-94886c8f7f5a")).WithObjectTypes(InternalOrganisation, StringTemplate).WithSingularName("PackagingSlipTemplate")  .WithPluralName("PackagingSlipTemplates")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("9a2ab89e-c3bc-4b6b-a82d-417dc21c8f9e"), new Guid("fcc6e653-3787-44a0-8a3a-35e80e232a02"), new Guid("31549cf9-6418-4d19-96b0-5813cc964491")).WithObjectTypes(InternalOrganisation, Party).WithSingularName("Customer")  .WithPluralName("Customers")  .WithMultiplicity(Multiplicity.OneToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("a8d09b7d-5f55-4adb-897b-73b2c107932f"), new Guid("82e7ff09-f69c-4f22-97ad-80cae5730f19"), new Guid("9309b4cb-0552-4f9a-bf50-77bb686d8b8e")).WithObjectTypes(InternalOrganisation, StringTemplate).WithSingularName("PickListTemplate")  .WithPluralName("PickListTemplates")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("ab2004c1-fd91-4298-87cd-532a6fe5efb0"), new Guid("b53b80a4-92f5-4e08-a9fb-86bf2bd9572e"), new Guid("7fe218f4-975d-40f4-82b6-b43cb308aff4")).WithObjectTypes(InternalOrganisation, GeneralLedgerAccount).WithSingularName("SalesPaymentDiscountDifferencesAccount")  .WithPluralName("SalesPaymentDiscountDifferencesAccounts")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("b79d1af6-f14a-4466-aba2-893bf554dbc1"), new Guid("e24f08c4-a880-42f7-907d-d844d48fa152"), new Guid("78650a41-e592-4889-8c62-2f16a2e7fa01")).WithObjectTypes(InternalOrganisation, StringTemplate).WithSingularName("QuoteTemplate")  .WithPluralName("QuoteTemplates")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("bce0d7d9-cfc9-4092-99a1-93ff5c0b94dd"), new Guid("5c4cfec8-5bc0-48d2-ac92-132c0538e614"), new Guid("bece103b-dde6-4319-938b-e08d23d9f99e")).WithObjectTypes(InternalOrganisation, Currency).WithSingularName("PreviousCurrency")  .WithPluralName("PreviousCurrencies")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("d2ad57d5-de30-4bc0-90a7-9aea7a9da8c7"), new Guid("dbd28e59-d5d6-4d95-aef1-6881e0fe2d48"), new Guid("2e28606f-5708-4c0f-bdfa-04019a0e97d9")).WithObjectTypes(InternalOrganisation, GeneralLedgerAccount).WithSingularName("SuspenceAccount")  .WithPluralName("SuspenceAccounts")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("d48ef8bb-064b-4360-8162-a138fb601761"), new Guid("91252cf4-eca3-4b9d-b06d-5df795c3709c"), new Guid("3ef1f904-5b02-4f00-8486-2e452668be67")).WithObjectTypes(InternalOrganisation, GeneralLedgerAccount).WithSingularName("NetIncomeAccount")  .WithPluralName("NetIncomeAccounts")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("dcf24d2f-7bf2-43fd-82b4-bd30fd545022"), new Guid("b4b8b2e6-141c-416f-89a8-746c72c26e5c"), new Guid("dc7127c4-c4ca-49a3-95ae-970de554d4f3")).WithObjectTypes(InternalOrganisation, Facility).WithSingularName("DefaultFacility")  .WithPluralName("DefaultFacilities")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("dd008dfe-a219-42ab-bc08-d091da3f8ea4"), new Guid("77ce8418-a00b-46d0-ab7b-4a782b7387da"), new Guid("a5ac9bc1-5323-41ec-a791-d4ecc7d0eee8")).WithObjectTypes(InternalOrganisation, GeneralLedgerAccount).WithSingularName("PurchasePaymentDiscountDifferencesAccount")  .WithPluralName("PurchasePaymentDiscountDifferencesAccounts")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("e09976e8-dc99-4539-9b0b-0bbe98cc5404"), new Guid("0d828c12-82bd-4b37-96c8-68997a7c2f48"), new Guid("3d362cd1-d49c-422f-9722-7276a6ee07c4")).WithObjectTypes(InternalOrganisation, Party).WithSingularName("Supplier")  .WithPluralName("Suppliers")  .WithMultiplicity(Multiplicity.OneToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("f353e7ef-d24d-4a27-8ec9-e930ef936240"), new Guid("cf556dfd-4b43-48e4-8243-df2650d8ce97"), new Guid("6b7bda76-5fe7-4526-8c79-b42324fd4090")).WithObjectTypes(InternalOrganisation, GeneralLedgerAccount).WithSingularName("CalculationDifferencesAccount")  .WithPluralName("CalculationDifferencesAccounts")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("f7ad4cfe-fc31-412c-8df7-2a514783e2ed"), new Guid("4145ddcd-726a-405f-b4cb-2e85b0bd60a2"), new Guid("7940e9e6-e6f6-4eac-bfa4-e14f63315276")).WithObjectTypes(InternalOrganisation, PaymentMethod).WithSingularName("PaymentMethod")  .WithPluralName("PaymentMethods")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("78a7ee9c-4aeb-471d-ae17-5878737f1f67"), new Guid("d4e26be2-9adc-4ded-b373-e88c7ecd7e29"), new Guid("51bb9283-5e98-4a69-ae20-85460ee532d7")).WithObjectTypes(EstimatedProductCost, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("ce0f4392-cf76-49ba-a6bd-47b4e125ec61"), new Guid("acc9ae9a-8cb4-46cc-a507-db82759435d8"), new Guid("5ebf8530-9a22-43d0-a1db-d976dfcbeaea")).WithObjectTypes(EstimatedProductCost, Organisation).WithSingularName("Organisation")  .WithPluralName("Organisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // DeploymentUsage
            new RelationTypeBuilder(domain, new Guid("50c6bc05-83ff-4d40-b476-51418355eb0c"), new Guid("e8aa74ab-d70a-43f4-9cac-de0160e3f257"), new Guid("cc27af60-5ddd-4cce-bcc1-d68b3d5c6ab4")).WithObjectTypes(DeploymentUsage, TimeFrequency).WithSingularName("TimeFrequency")  .WithPluralName("TimeFrequencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("4b55ee38-64e9-4c11-a204-36e2f460c5f8"), new Guid("87db14ec-a82a-4107-bae1-8ea945a68bce"), new Guid("d576e2ee-dcf0-4f06-a496-42bceaf94399")).WithObjectTypes(Facility, ContactMechanism).WithSingularName("FacilityContactMechanism")  .WithPluralName("FacilityContactMechanisms")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            ...
            // FaceToFaceCommunication
            new RelationTypeBuilder(domain, new Guid("2dfb4cd7-ed48-4b79-ba26-b430058356ef"), new Guid("b935b150-4172-46fb-ab1a-b7197ea71f18"), new Guid("e6f4591e-ee9a-4fe8-b908-ee4e18084aa8")).WithObjectTypes(FaceToFaceCommunication, PostalAddress).WithSingularName("Location")  .WithPluralName("Location")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("52b8614b-799e-4aea-a012-ea8dbc23f8dd"), new Guid("ac424847-d426-4614-99a2-37c70841c454"), new Guid("bcf4a8df-8b57-4b3c-a6e5-f9b56c71a13b")).WithObjectTypes(FaceToFaceCommunication, Person).WithSingularName("Participant")  .WithPluralName("Participants")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
			
            // BudgetReview
            new RelationTypeBuilder(domain, new Guid("4396be4d-edb4-405d-a39a-ee6ff5c39ca5"), new Guid("9cbcaf98-22d1-41ed-b7d4-88a32e41de5f"), new Guid("61c422a4-cfb0-4e7a-b8ee-29ecf92589ee")).WithObjectTypes(BudgetReview, allorsDate).WithSingularName("ReviewDate")  .WithPluralName("ReviewDates")      .Build();
            ...
            // EngineeringChangeStatus
            new RelationTypeBuilder(domain, new Guid("0a6c34f7-b37b-4abc-b12e-05ef14a8d986"), new Guid("66d0b0a8-b39a-4654-9ce6-3b8a8e9bbf4a"), new Guid("765d186a-a5b5-4895-ae27-93bfe6ef98f2")).WithObjectTypes(EngineeringChangeStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
            new RelationTypeBuilder(domain, new Guid("6a7695dc-4343-4645-b4f1-78348d6873c3"), new Guid("7a1f031f-29ca-4b1c-95c0-1bdc35856412"), new Guid("09cf51ab-77a3-4188-97ad-590b6bca6a97")).WithObjectTypes(EngineeringChangeStatus, EngineeringChangeObjectState).WithSingularName("EngineeringChangeObjectState")  .WithPluralName("EngineeringChangeObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
			
            // PartBillOfMaterial
            new RelationTypeBuilder(domain, new Guid("06c3a64a-ef2c-44a0-81ee-1335842cf844"), new Guid("738ee8fd-307a-4d12-a0fc-238640386eee"), new Guid("e0145603-3f58-46f5-8348-77ad4d211543")).WithObjectTypes(PartBillOfMaterial, Part).WithSingularName("Part")  .WithPluralName("Parts")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("eb1b2313-df9b-407d-9cf9-617d58c6f4be"), new Guid("9d9c4b58-8144-4d64-92ca-b81abecc5f40"), new Guid("8f188307-b996-41eb-8811-462a3a4d436e")).WithObjectTypes(PartBillOfMaterial, Part).WithSingularName("ComponentPart")  .WithPluralName("ComponentParts")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("76e76063-ddce-4a8a-98fb-884cd6179c45"), new Guid("1395e70f-cd1c-457e-bfd8-c7f31a32c8f4"), new Guid("b6416161-0b77-4a30-b00e-59a0eaaa1e87")).WithObjectTypes(Journal, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("774f30df-26b4-41d5-9ecb-d1fd62244e1f"), new Guid("9a4078bb-350b-4fbb-8fc2-16e86928d32e"), new Guid("dfbac079-a8f6-4576-8d54-39bf76553e0c")).WithObjectTypes(Journal, JournalType).WithSingularName("PreviousJournalType")  .WithPluralName("PreviousJournalTypes")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("9b7c3687-b268-4c2b-8b04-c04a0c55d79f"), new Guid("47be858f-a462-4e23-acee-18aecdebc95e"), new Guid("f1907d6b-5015-4583-8d63-5c74f5954b97")).WithObjectTypes(Journal, JournalEntry).WithSingularName("JournalEntry")  .WithPluralName("JournalEntries")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("158f104b-fa5c-425e-8b55-ee4e866820ec"), new Guid("77f01592-48e6-486f-9217-7c9cfc477267"), new Guid("6dcd6646-e5fa-42c9-a54b-c95380e860a2")).WithObjectTypes(ShipmentItem, Part).WithSingularName("Part")  .WithPluralName("Parts")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("b5d35e87-f741-4600-9838-4419b127681d"), new Guid("797743d0-c0e9-4a75-9180-4e05eb55423f"), new Guid("d37d1290-af88-45c1-8e70-2774de0c58c2")).WithObjectTypes(ShipmentItem, ShipmentItem).WithSingularName("InResponseToShipmentItem")  .WithPluralName("InResponseToShipmentItems")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("b8ca6fae-0866-4806-9ffd-64d5d2b978f9"), new Guid("2a9e81f6-6009-4706-a0d0-cd180cb825e6"), new Guid("31227051-0164-40e7-9e37-d1b31719e483")).WithObjectTypes(ShipmentItem, InventoryItem).WithSingularName("InventoryItem")  .WithPluralName("InventoryItems")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("b9bfaea8-e5f0-4b0e-955f-df28ed63e8e3"), new Guid("7da8c058-92b7-4fd7-9eaf-7b7fb94f62cf"), new Guid("fb45aece-26e0-42ec-8dac-ddfcf11e61d9")).WithObjectTypes(ShipmentItem, ProductFeature).WithSingularName("ProductFeature")  .WithPluralName("ProductFeatures")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("bdd8041b-b1d1-4902-980a-f085c0af166d"), new Guid("150fd46f-8768-4210-a559-740386e7c03d"), new Guid("2fb644a8-bbd4-419e-8c30-ef10efeb07d7")).WithObjectTypes(ShipmentItem, InvoiceItem).WithSingularName("InvoiceItem")  .WithPluralName("InvoiceItems")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("f5c0279e-5ce4-4f09-bb93-ecaeb4825bcf"), new Guid("59b2bb80-3e60-4958-a3d8-9b5f7242d95c"), new Guid("fbac397f-52f2-4903-95bc-ee3f6ab3ae7b")).WithObjectTypes(ShipmentItem, Good).WithSingularName("Good")  .WithPluralName("Goods")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("badde93b-4691-435e-9ba3-e52435e9f574"), new Guid("c49ca161-d15b-4ba9-b42f-06144e8ca9f6"), new Guid("a3a58a70-3bab-4c8a-ac47-8beaca3b46d2")).WithObjectTypes(ProductFeature, ProductFeature).WithSingularName("DependentFeature")  .WithPluralName("DependentFeatures")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("ce228118-f5b2-49bb-b0cd-7e0ca8e10315"), new Guid("d90b3906-a48d-473c-85a7-baae359d58a7"), new Guid("0305f707-683e-4fcd-94a0-7c0b3a2b27e4")).WithObjectTypes(ProductFeature, ProductFeature).WithSingularName("IncompatibleFeature")  .WithPluralName("IncompatibleFeatures")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("efe16e22-edfb-40b1-83c0-110f874c285a"), new Guid("3c78c391-cf55-40ce-9d11-a0600787ed82"), new Guid("6c3e8238-f1dd-4461-a73b-0927cd26db29")).WithObjectTypes(ProductFeature, VatRate).WithSingularName("VatRate")  .WithPluralName("VatRates")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // Requirement
            new RelationTypeBuilder(domain, new Guid("0f2c9ca2-9f2a-403e-8110-311fc0622326"), new Guid("099c426c-7b3f-4c9a-9059-525851488030"), new Guid("178dfe82-99e2-4026-84f9-223e10e852c7")).WithObjectTypes(Requirement, allorsDate).WithSingularName("RequiredByDate")  .WithPluralName("RequiredByDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("289a217e-4705-4bf0-b3bb-e51a056e13ee"), new Guid("320a457b-8a35-487d-9ebb-eaa7f6443ebf"), new Guid("63cbc132-2108-4686-9cc6-811914524bcc")).WithObjectTypes(Requirement, RequirementObjectState).WithSingularName("PreviousObjectState")  .WithPluralName("PreviousObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("36511540-8c83-467c-9ed0-ff5dee38c378"), new Guid("047c0186-3878-4895-9946-4b5a32c5bae1"), new Guid("c80ac083-3b01-432c-81e1-56da054a5023")).WithObjectTypes(Requirement, RequirementStatus).WithSingularName("RequirementStatus")  .WithPluralName("RequirementStatuses")  .WithMultiplicity(Multiplicity.OneToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("ad98fd99-98b3-4876-b4af-b0c6aa7f41eb"), new Guid("d7a1af36-aea0-4e99-ab8b-b264c6bad301"), new Guid("5d88d9ac-6895-4a72-811b-2c02c9daed9b")).WithObjectTypes(Requirement, RequirementObjectState).WithSingularName("CurrentObjectState")  .WithPluralName("CurrentObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("a184408c-a1b0-47b2-821a-a2ab643b523e"), new Guid("213a7484-741a-4a2b-b765-3bc1b8427a64"), new Guid("55094ebe-bf49-44f4-bb0f-5722eca4ae90")).WithObjectTypes(NewsItem, allorsDate).WithSingularName("Date")  .WithPluralName("Date")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("9a8fcada-bf2c-450d-a941-e0c7ec414cf3"), new Guid("56813128-50b2-4fbf-ad0f-0385930a6805"), new Guid("95e9e94b-0fad-47e0-bfcf-f131e6962694")).WithObjectTypes(PartyBenefit, Benefit).WithSingularName("Benefit")  .WithPluralName("Benefits")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // PostalAddress
            new RelationTypeBuilder(domain, new Guid("24216a78-41d8-4ffc-958a-2411530eeb94"), new Guid("649eb363-210c-4567-be0a-bcd3e666294e"), new Guid("1e9fb472-c39d-4e46-a58c-3cbf2b99c2cd")).WithObjectTypes(PostalAddress, GeographicBoundary).WithSingularName("GeographicBoundary")  .WithPluralName("GeographicBoundaries")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("9801fa63-ac82-4774-bf84-d2752b95b8a3"), new Guid("6eb0ec18-2d30-4529-b741-785aad15842f"), new Guid("a477adeb-04b9-449c-b61c-4a1384fe10aa")).WithObjectTypes(PostalAddress, City).WithSingularName("City")  .WithPluralName("Cities")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("475d7a79-27a1-4d5a-90c1-3896fa2e892e"), new Guid("ad65733c-6d3d-4e90-97d5-ca91bc4505d9"), new Guid("651b29f8-644d-4588-ac56-0d51f2068ebd")).WithObjectTypes(InvoiceItem, InvoiceItem).WithSingularName("AdjustmentFor")  .WithPluralName("AdjustmentFors")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("6df95cf4-115f-4f43-aaea-52313c47d824"), new Guid("93ba1265-4050-41c1-aaf8-d09786889245"), new Guid("0abd9811-a8ac-42bf-9113-4f9760cfe9eb")).WithObjectTypes(InvoiceItem, SerializedInventoryItem).WithSingularName("SerializedInventoryItem")  .WithPluralName("SerializedInventoryItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("6dfc7def-6790-4841-90db-c37a431593ec"), new Guid("27f066ba-c894-4ced-9c3f-8af137d0ffb4"), new Guid("88d55469-1e0c-4dc8-83a7-ce0a48d9c9d9")).WithObjectTypes(InvoiceItem, PriceComponent).WithSingularName("CurrentPriceComponent")  .WithPluralName("CurrentPriceComponents")  .WithMultiplicity(Multiplicity.ManyToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("93e0e781-4755-4cd4-aeff-bff905d6e99b"), new Guid("6f45d5e3-ef25-45ea-9f31-11fc6a480c6c"), new Guid("0f3e4887-e43f-4b51-86ee-c4f474de2d7a")).WithObjectTypes(InvoiceItem, VatRate).WithSingularName("DerivedVatRate")  .WithPluralName("DerivedVatRates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("190d2363-affa-4a4b-8662-d8b566c506d6"), new Guid("76194162-1ef0-45f0-8804-2183f42e0e17"), new Guid("b4d8f605-9a66-468d-b9a0-f2157e8528b7")).WithObjectTypes(Store, StringTemplate).WithSingularName("SalesInvoiceTemplate")  .WithPluralName("SalesInvoiceTemplates")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("7c9cda07-5920-4037-b934-5b74355c4b85"), new Guid("0da06b1f-12ce-43d1-9e21-82e506ce7750"), new Guid("f1c26a78-d986-4fcc-ac55-3658783790ef")).WithObjectTypes(Store, ShipmentMethod).WithSingularName("DefaultShipmentMethod")  .WithPluralName("DefaultShipmentMethods")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("80670a7a-1be8-4407-917e-fa359e632519"), new Guid("dcd8b2e0-7490-40e4-ae4b-d1b0c0be0527"), new Guid("72993b04-4c10-4467-9d99-064e1b39f9e2")).WithObjectTypes(Store, Carrier).WithSingularName("DefaultCarrier")  .WithPluralName("DefaultCarriers")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("b64dd0b0-8f35-4c71-9e7c-f47ee7ea1097"), new Guid("6a3bac6d-f9c6-460e-9c02-29728c567109"), new Guid("aaa0ce97-c540-42d7-aed3-e6b3430b1f23")).WithObjectTypes(Store, InternalOrganisation).WithSingularName("Owner")  .WithPluralName("Owners")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("f024d205-2420-40bb-ab1d-71533fa25557"), new Guid("68800a34-f973-4339-b5d5-7c611b39a2b1"), new Guid("e858cc6c-2a6e-4c04-be7a-e019009bf3f7")).WithObjectTypes(Store, StringTemplate).WithSingularName("CustomerShipmentTemplate")  .WithPluralName("CustomerShipmentTemplates")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            ...
            // Lot
            new RelationTypeBuilder(domain, new Guid("4888a06a-fcf5-42a7-a1c3-721d3abaa755"), new Guid("0f922c04-b617-4b72-8c22-02f43ac2afb9"), new Guid("46b3ec4d-0463-48eb-8764-8dedf8c48b1a")).WithObjectTypes(Lot, allorsDate).WithSingularName("ExpirationDate")  .WithPluralName("ExpirationDates")      .Build();
            ...
            // WorkEffortSkillStandard
            new RelationTypeBuilder(domain, new Guid("13a68eeb-7ca1-4ecd-a82b-ecbd75da99b6"), new Guid("fe6ffe1f-a4eb-4478-922f-4c786e40709c"), new Guid("e0a9c761-26d1-48cd-bf13-bd6f66d863ba")).WithObjectTypes(WorkEffortSkillStandard, Skill).WithSingularName("Skill")  .WithPluralName("Skills")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("ff41a43c-997d-4158-984e-e669eb935148"), new Guid("b46ffa62-adcb-4928-bdb0-79d0eef9e676"), new Guid("7c4353a9-efd5-437e-8789-fae92a0be1ed")).WithObjectTypes(RequestItem, allorsDate).WithSingularName("RequiredByDate")  .WithPluralName("RequiredByDates")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("d09dbd42-5c59-4d78-b5d7-4dbee0406ead"), new Guid("4a611e8a-1bd5-42b3-b2ba-14403328696b"), new Guid("93f73ab2-af4a-47d1-822b-df576f5a5e86")).WithObjectTypes(DesiredProductFeature, ProductFeature).WithSingularName("ProductFeature")  .WithPluralName("ProductFeatures")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // SalesOrderItemStatus
            new RelationTypeBuilder(domain, new Guid("90dd5f56-af80-4f78-a0b6-c13f34c87193"), new Guid("05167075-7e33-42ba-a40a-ef2233af019a"), new Guid("3b0a60b9-b8f3-41f0-af4f-75598240bde1")).WithObjectTypes(SalesOrderItemStatus, SalesOrderItemObjectState).WithSingularName("SalesOrderItemObjectState")  .WithPluralName("SalesOrderItemObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("f31a9949-c0b3-45c5-854f-29884ce45c9b"), new Guid("73152227-ec98-4b5a-9fad-0e2d38cd7c61"), new Guid("47852a3a-f906-4757-87b9-29c6e8d560f9")).WithObjectTypes(SalesOrderItemStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
            ...
            // CommunicationEventStatus
            new RelationTypeBuilder(domain, new Guid("414fc983-3086-4362-806a-d77b09f04b24"), new Guid("0da368d4-31c3-45b3-b556-561b080a03a5"), new Guid("d0e76e79-e797-44dd-8256-f88c10b1d440")).WithObjectTypes(CommunicationEventStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
            new RelationTypeBuilder(domain, new Guid("5ad71d39-d9e2-4b08-a6ac-322c18f14be5"), new Guid("51e4f7d6-a511-493e-8207-b60343fccae6"), new Guid("4d04158e-c9a4-490c-9a35-c2205a01938a")).WithObjectTypes(CommunicationEventStatus, CommunicationEventObjectState).WithSingularName("CommunicationEventObjectState")  .WithPluralName("CommunicationEventObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("1e977b9c-8582-48be-ac1d-20a055598290"), new Guid("be920e49-abff-4ef0-80c2-02df6dfa55e3"), new Guid("67e83a0e-db03-439d-832a-b5685887eeaa")).WithObjectTypes(Good, Media).WithSingularName("Thumbnail")  .WithPluralName("Thumbnails")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("2ca90db1-8595-4de0-957e-dc4476be1654"), new Guid("637fa802-fc65-4b5e-aaf5-e49ac5218b9b"), new Guid("64036e01-6767-46d0-aca7-def5876db81f")).WithObjectTypes(Good, InventoryItemKind).WithSingularName("InventoryItemKind")  .WithPluralName("InventoryItemKinds")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("82295ab2-8488-4d7e-8703-9f7fbec55925"), new Guid("c1801b8f-013b-42ff-b02a-a6c9b0e361b8"), new Guid("cdc45553-9c60-4c40-8c82-56c488ee6aae")).WithObjectTypes(Good, FinishedGood).WithSingularName("FinishedGood")  .WithPluralName("FinishedGoods")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("acbe2dc6-63ad-4910-9752-4cab83e24afb"), new Guid("70d193cf-8985-4c25-84a5-31f4e2fd2a34"), new Guid("73361510-c5a2-4c4f-afe5-94d2b9eaeea3")).WithObjectTypes(Good, Product).WithSingularName("ProductSubstitution")  .WithPluralName("ProductSubstitutions")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            ...
            // ProductCategory
            new RelationTypeBuilder(domain, new Guid("049849d5-514b-418d-8397-29db6671b4fa"), new Guid("51631226-3c9e-46a5-9748-b9ab44e36173"), new Guid("11d9ba5c-1012-4442-893b-223d21ba7df7")).WithObjectTypes(ProductCategory, Package).WithSingularName("Package")  .WithPluralName("Packages")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("9f50cbbc-d0af-46e6-8e04-2bfb0bf1facf"), new Guid("4fe64d4c-747c-4e8f-a657-8174eb8e0b73"), new Guid("bdd11ee4-ade5-46f3-a2b1-2fbb0261ae14")).WithObjectTypes(ProductCategory, Media).WithSingularName("CategoryImage")  .WithPluralName("CategoryImages")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("b02c92d3-8b3a-4ce0-a49d-5c608a25b7d4"), new Guid("b01ed533-259c-429c-8827-c61222896b8f"), new Guid("7efeb782-6278-4482-8cbb-b46d2a146e96")).WithObjectTypes(ProductCategory, ProductCategory).WithSingularName("Ancestor")  .WithPluralName("Ancestors")  .WithMultiplicity(Multiplicity.ManyToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("f3683ece-e247-490f-be4f-4fe12e5cfd06"), new Guid("e8a9518b-d33b-4db5-ac01-6283028a7e1f"), new Guid("657b667e-cd15-4671-bc18-9f49c8aa04e6")).WithObjectTypes(VatForm, VatReturnBox).WithSingularName("VatReturnBox")  .WithPluralName("VatReturnBoxes")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
			
            // BudgetRevisionImpact
            new RelationTypeBuilder(domain, new Guid("16b0c91f-5746-4ebe-a071-7c42887cccb1"), new Guid("d8f69482-e661-4447-b055-7f3806cace95"), new Guid("ca98b59f-ac83-457f-a5fd-24b35347ea14")).WithObjectTypes(BudgetRevisionImpact, BudgetItem).WithSingularName("BudgetItem")  .WithPluralName("BudgetItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("b93df76d-439a-45cf-885d-4887afe5fd6f"), new Guid("ed0a9f21-20e3-4f26-a020-5b0afc8ec335"), new Guid("dd1b9041-cff6-4d03-9215-d963a1c2a992")).WithObjectTypes(BudgetRevisionImpact, BudgetRevision).WithSingularName("BudgetRevision")  .WithPluralName("BudgetRevisions")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("1c3dd3b4-b514-4a42-965f-d3200325d78c"), new Guid("dccc1ed1-0cac-4e25-a7ee-5848af5b390e"), new Guid("684c491e-c764-4d83-a11f-d3cf80d671ad")).WithObjectTypes(Budget, BudgetRevision).WithSingularName("BudgetRevision")  .WithPluralName("BudgetRevisions")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("2163a044-c967-4137-b1d0-dfd3fac80869"), new Guid("3ec284eb-944c-4ff0-8e24-9be0ceeda22a"), new Guid("f02d72a7-2547-44dc-bb8b-42e58afe186d")).WithObjectTypes(Budget, BudgetStatus).WithSingularName("BudgetStatus")  .WithPluralName("BudgetStatuses")  .WithMultiplicity(Multiplicity.OneToMany).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("59cbc253-e17d-4405-bea8-09ad420bf8bc"), new Guid("6f6d9d35-daf5-4a79-85ce-d662cd7ec2d4"), new Guid("a6ec675f-c28a-470e-9923-e623e0ca9c58")).WithObjectTypes(Budget, BudgetObjectState).WithSingularName("CurrentObjectState")  .WithPluralName("CurrentObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("5bb46810-419d-4b1e-be3a-a360e7e35ffd"), new Guid("c7e6b216-0292-4079-a0dc-5f87e86d4f95"), new Guid("d8fabb81-7e41-4efa-b008-2ace24694d36")).WithObjectTypes(Budget, BudgetObjectState).WithSingularName("PreviousObjectState")  .WithPluralName("PreviousObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("834432b1-65b2-4499-a83d-71f0db6e177b"), new Guid("b7f09631-6b4c-417d-ba12-115d07d9d6f5"), new Guid("b9ba1402-ce06-4bdd-9290-165ff8e555d2")).WithObjectTypes(Budget, BudgetReview).WithSingularName("BudgetReview")  .WithPluralName("BudgetReviews")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("f6078f5b-036f-45de-ab4f-fb26b6939d11"), new Guid("ba8edec9-a429-482d-bfbd-4f7fd419eaf7"), new Guid("9b9e4779-bb7d-4edb-b432-eab76472135a")).WithObjectTypes(Budget, BudgetItem).WithSingularName("BudgetItem")  .WithPluralName("BudgetItems")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            // Deployment
            new RelationTypeBuilder(domain, new Guid("212653db-1677-47bd-944c-b5468673ec63"), new Guid("7543cf10-97dd-4823-b386-f06379e398b2"), new Guid("685a54f0-4e66-4ce3-93a2-f6f45dcf8c8b")).WithObjectTypes(Deployment, Good).WithSingularName("ProductOffering")  .WithPluralName("ProductOfferings")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("d588ba7f-7b67-43fd-bb67-b9ff82fcffaf"), new Guid("bbee5696-6e53-4ea3-8f57-4e018e6bc61d"), new Guid("33c8e0e5-be98-44bb-a9eb-cfbabd8451b2")).WithObjectTypes(Deployment, SerializedInventoryItem).WithSingularName("SerializedInventoryItem")  .WithPluralName("SerializedInventoryItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // InventoryItemConfiguration
            new RelationTypeBuilder(domain, new Guid("92a85a6b-4f65-4ba4-bd5e-bf44d5a9ca56"), new Guid("e7e7fef5-a973-42b7-8c96-5ede712a353c"), new Guid("6beb2ac6-0319-4524-80a2-54393ba77e69")).WithObjectTypes(InventoryItemConfiguration, InventoryItem).WithSingularName("InventoryItem")  .WithPluralName("InventoryItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("f1d4ceeb-f859-4996-babc-dc55837489e0"), new Guid("a0cb4a4e-322e-4f8c-b7b8-b171b1b0aaa5"), new Guid("df3d337b-4998-4604-961c-3c074f91cd1b")).WithObjectTypes(InventoryItemConfiguration, InventoryItem).WithSingularName("ComponentInventoryItem")  .WithPluralName("ComponentInventoryItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // CustomerShipmentStatus
            new RelationTypeBuilder(domain, new Guid("591d3237-220b-4765-8001-4bc18ecd2d8c"), new Guid("2a2704d6-44f6-4e86-a8c9-407842b7eb83"), new Guid("fd56e773-b27b-4336-b1be-e262d1d26b41")).WithObjectTypes(CustomerShipmentStatus, CustomerShipmentObjectState).WithSingularName("CustomerShipmentObjectState")  .WithPluralName("CustomerShipmentObjectStates")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("74e826e5-75d0-4e7d-b2fe-73a7c58e30ef"), new Guid("261ca695-c146-493d-b059-3836913268c4"), new Guid("eb029966-6353-401b-b24b-190460f0c035")).WithObjectTypes(CustomerShipmentStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
            ...
            // PartSpecificationStatus
            new RelationTypeBuilder(domain, new Guid("14fdbce7-3494-48fb-a885-3b688b0c4e15"), new Guid("9b060799-5fca-4e1f-96c0-953444f4b6ac"), new Guid("53c22224-4741-4b2a-ac1f-2174c1bda312")).WithObjectTypes(PartSpecificationStatus, allorsDate).WithSingularName("StartDateTime")  .WithPluralName("StartDateTimes")      .Build();
            ...
            // DistributionChannelRelationship
            new RelationTypeBuilder(domain, new Guid("86a07419-5dfd-4618-a472-168ba5fdf3ff"), new Guid("2800f775-ce61-4684-b6a3-5ce28dcf140b"), new Guid("b61fdf73-2420-498c-af0b-49ecdeec359a")).WithObjectTypes(DistributionChannelRelationship, InternalOrganisation).WithSingularName("InternalOrganisation")  .WithPluralName("InternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("36559f29-1182-42d1-831d-587103456ce6"), new Guid("ce33ccae-be2c-4081-abd5-be803bdbc1a4"), new Guid("0c76bfba-2ef1-46fb-bb1f-b49b57f792c0")).WithObjectTypes(PaymentMethod, Journal).WithSingularName("Journal")  .WithPluralName("Journals")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("a937fc55-d737-444b-93b0-525994e09f6a"), new Guid("c33d3bc7-13ff-4d83-be7b-e9fbd7c21d55"), new Guid("2b00353d-bc87-4aa1-b260-3650f93320ff")).WithObjectTypes(PaymentMethod, SupplierRelationship).WithSingularName("Creditor")  .WithPluralName("Creditors")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("70f92965-d99a-4a6a-bc27-029eec7b5c2d"), new Guid("93ffaaa6-7401-4b7f-a297-081a98bee032"), new Guid("233fd990-758e-4f1d-87bd-ae3de8d9486b")).WithObjectTypes(OrderItem, PurchaseOrder).WithSingularName("CorrespondingPurchaseOrder")  .WithPluralName("CorrespondingPurchaseOrders")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("9674f349-3fcc-495c-b7eb-27b5b580597c"), new Guid("d7c3f753-9db0-4bb5-9b5d-4adbc695e320"), new Guid("34e4011b-c124-4d53-ab30-26734e8ba04c")).WithObjectTypes(OrderItem, QuoteItem).WithSingularName("QuoteItem")  .WithPluralName("QuoteItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("9dc87cdb-a35f-4a48-9f99-bf0fe07cad5c"), new Guid("b6f17e6b-f61a-4155-8e4c-79ebec1a01d4"), new Guid("9ec4f475-ecb7-4d57-a642-043b0a703094")).WithObjectTypes(OrderItem, allorsDate).WithSingularName("AssignedDeliveryDate")  .WithPluralName("AssignedDeliveryDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("a1769a74-d832-4ade-be59-a98b17033ca1"), new Guid("72f9c5a1-a66a-4181-b683-c0546f7cb95d"), new Guid("279735e0-974a-46b3-b460-2bd528895f5a")).WithObjectTypes(OrderItem, allorsDate).WithSingularName("DeliveryDate")  .WithPluralName("DeliveryDates")  .WithIsDerived(true)    .Build();
            ...
            // WorkEffortInventoryAssignment
            new RelationTypeBuilder(domain, new Guid("0bf425d4-7468-4e28-8fda-0b04278cb2cd"), new Guid("2c6841c6-c161-48e0-a257-d932d99ae7b4"), new Guid("1afed0f6-15fa-4fd2-91f5-648773933e3b")).WithObjectTypes(WorkEffortInventoryAssignment, WorkEffort).WithSingularName("Assignment")  .WithPluralName("Assignments")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("5fcdb553-4b8f-419b-9f12-b9cefa68d39f"), new Guid("dba27480-4d2f-4e69-af01-4e9afba2cc98"), new Guid("3f7a72a4-2727-4dd6-a602-60ef9b6896af")).WithObjectTypes(WorkEffortInventoryAssignment, InventoryItem).WithSingularName("InventoryItem")  .WithPluralName("InventoryItems")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("ef364ba6-62ed-40db-a580-cf7f6f473e27"), new Guid("beb281bd-199b-4416-bb38-7d21ec376398"), new Guid("8f541554-8bfa-404a-85e9-453f2809d4a4")).WithObjectTypes(WorkRequirement, Product).WithSingularName("Product")  .WithPluralName("Products")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // PhoneCommunication
            new RelationTypeBuilder(domain, new Guid("5e3c675b-b329-47a4-9d53-b0e95837a23b"), new Guid("16fa813c-15d6-4bfb-a7b3-c295efe47a1c"), new Guid("f9320b55-230d-4f10-9a1b-6960137326b7")).WithObjectTypes(PhoneCommunication, Person).WithSingularName("Receiver")  .WithPluralName("Receivers")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("7a37ab85-222a-4d13-b832-b222faefcf39"), new Guid("79c04646-6f62-4867-9f89-f2ce1876e981"), new Guid("507e6ff3-3baa-4c77-b41b-4d1893443dc2")).WithObjectTypes(PhoneCommunication, Person).WithSingularName("Caller")  .WithPluralName("Callers")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // ProductDeliverySkillRequirement
            new RelationTypeBuilder(domain, new Guid("12c6abaf-a080-45f3-820d-b462978d2539"), new Guid("4a6bd8f2-ea2a-4e07-a018-4b4b37b45a96"), new Guid("3e12bb69-b0bb-40ba-a987-89f5cc40c436")).WithObjectTypes(ProductDeliverySkillRequirement, allorsDate).WithSingularName("StartedUsingDate")  .WithPluralName("StartedUsingDates")      .Build();
            new RelationTypeBuilder(domain, new Guid("5a52b67e-23e4-45ac-a1d4-cb083bf897cc"), new Guid("7de9d895-a524-4fc2-a5f4-7b9e78921d6c"), new Guid("b44bf4b9-3aa8-4abb-b145-11d888bf55c5")).WithObjectTypes(ProductDeliverySkillRequirement, Service).WithSingularName("Service")  .WithPluralName("Services")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            new RelationTypeBuilder(domain, new Guid("6d4ec793-41a7-4044-9744-42d1bd44bbd4"), new Guid("fe73df0c-f46c-42e6-8274-a5de09de72d5"), new Guid("2c2f1476-48a5-45f4-86df-03a86a965af4")).WithObjectTypes(ProductDeliverySkillRequirement, Skill).WithSingularName("Skill")  .WithPluralName("Skills")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("92e8bbd9-fe5a-4053-aef3-593dbb13eac0"), new Guid("6e9761f4-fc3d-485a-9b45-32f60f993f3b"), new Guid("b57c833b-6083-4fc5-a6d5-1350caab9a22")).WithObjectTypes(SalesRepProductCategoryRevenue, Currency).WithSingularName("Currency")  .WithPluralName("Currencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("f978075e-05b8-4204-aa2f-97ab416fd3e8"), new Guid("0695bc15-2d76-4464-b61f-7627cf885ad3"), new Guid("52cfc399-8014-4b2e-94f0-bb67fec26e65")).WithObjectTypes(SalesRepProductCategoryRevenue, Person).WithSingularName("SalesRep")  .WithPluralName("SalesReps")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            // StringTemplate
            new RelationTypeBuilder(domain, new Guid("a09af300-8983-4211-af75-3e04efa8ec36"), new Guid("c8d26b39-96a6-4be4-9675-5a6fdb54bae5"), new Guid("e40af32d-abdd-4d7b-9b3d-92abf7fb129a")).WithObjectTypes(StringTemplate, TemplatePurpose).WithSingularName("TemplatePurpose")  .WithPluralName("TemplatePurposes")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
			
            // Country
            new RelationTypeBuilder(domain, new Guid("13010743-231f-43a8-9539-b95b83ab15da"), new Guid("de4d0d90-e41b-4b7c-bcdc-23269020ab4e"), new Guid("5e2328a6-5413-401f-8106-7b8b29907b06")).WithObjectTypes(Country, VatRate).WithSingularName("VatRate")  .WithPluralName("VatRates")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            // Person
            new RelationTypeBuilder(domain, new Guid("348dd7c2-c534-422c-90aa-d48b1e504df9"), new Guid("7516fdc6-10c1-4f61-8a9f-f1d84b1a9899"), new Guid("f0306c09-0b6f-4e73-b789-47c3b3c2b0d6")).WithObjectTypes(Person, Salutation).WithSingularName("Salutation")  .WithPluralName("Salutations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("5df11d30-c6e7-4778-890c-c24b162bd20a"), new Guid("da7d2f05-d84e-48c2-b2a8-b33c43f1345c"), new Guid("8db737e3-c93e-42b0-b5ac-0a7b64309b51")).WithObjectTypes(Person, Employment).WithSingularName("CurrentEmployment")  .WithPluralName("CurrentEmployment")  .WithMultiplicity(Multiplicity.ManyToOne).WithIsDerived(true)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("6d425613-b821-46f2-896a-a04dc4b377a3"), new Guid("18b225ef-df54-4fd1-9423-36d334d1d876"), new Guid("128f6659-8313-4c53-8ff5-eb1fcffd1b36")).WithObjectTypes(Person, PersonalTitle).WithSingularName("Title")  .WithPluralName("Titles")  .WithMultiplicity(Multiplicity.ManyToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("7bcba7fd-6419-4324-8a11-c56bd46581a1"), new Guid("78ccda0f-4b17-40f1-93ad-b86e1181cb80"), new Guid("1babd38a-8a52-4a92-bb99-7a289d41bb1e")).WithObjectTypes(Person, allorsDate).WithSingularName("BirthDate")  .WithPluralName("BirthDates")      .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("f0708d80-a9cf-47be-9bed-76201fe9f17d"), new Guid("bfce261c-2f85-4be2-97ee-de15d3158b1d"), new Guid("e55b5f5e-931f-40a5-b092-45cdc57fd0ec")).WithObjectTypes(Person, Passport).WithSingularName("Passport")  .WithPluralName("Passports")  .WithMultiplicity(Multiplicity.OneToMany)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("ffda06c0-7dff-42fa-abd5-1ed6fa8c43da"), new Guid("8dabd93a-badc-40f3-96af-f97c1b61d262"), new Guid("92041fa4-b675-4fd4-b6c4-d9143393878e")).WithObjectTypes(Person, allorsDate).WithSingularName("DeceasedDate")  .WithPluralName("DeceasedDates")      .Build();
			
            // Singleton
            new RelationTypeBuilder(domain, new Guid("9dee4a94-26d5-410f-a3e3-3fcde21c5c89"), new Guid("0322b71b-0389-4393-8b1f-1b3fb12bb7b1"), new Guid("68f80e6a-7ff4-4f07-b2c5-728459c376ae")).WithObjectTypes(Singleton, Currency).WithSingularName("DefaultCurrency")  .WithPluralName("DefaultCurrencies")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
            ...
            new RelationTypeBuilder(domain, new Guid("f154f01e-e8bb-49c0-be80-ef6c6c195ff3"), new Guid("2c42c9e4-72e3-4673-8653-aaf586ebb06a"), new Guid("979d1e59-7a9f-462a-9927-efb8ad2cada5")).WithObjectTypes(Singleton, InternalOrganisation).WithSingularName("DefaultInternalOrganisation")  .WithPluralName("DefaultInternalOrganisations")  .WithMultiplicity(Multiplicity.ManyToOne)  .WithIsIndexed(true)  .Build();
