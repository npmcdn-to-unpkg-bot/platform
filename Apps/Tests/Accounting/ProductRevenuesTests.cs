...
namespace Allors.Domain
{
    ...
    {
        [Test]
        public void GivenProductRevenue_WhenDeriving_ThenDisplayNameIsSet()
        {
            ...
            var revenue = new ProductRevenues(this.DatabaseSession).Extent().First;

            Assert.AreEqual(string.Format("{0}: {1}/{2} {3} at {4}", good.DisplayName, DateTime.Now.Year, DateTime.Now.Month, revenue.Revenue.AsCurrencyString(internalOrganisation.CurrencyFormat), internalOrganisation.DisplayName), revenue.DisplayName);
        }
