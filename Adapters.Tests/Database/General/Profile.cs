...
namespace Allors1.Adapters.General
{
    ...
    public abstract class Profile : IDisposable
    {
        ...
        private IDatabaseSession session2;
        ...
        public Allors1.Meta.Domain GetMetaDomain()
        {
            return this.GetPopulation().Domain;
        }

        public Allors1.Meta.Domain GetMetaDomain2()
        {
            return this.GetPopulation2().Domain;
        }
