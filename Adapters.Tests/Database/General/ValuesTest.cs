                    ...
                    for (int testTypeIndex = 0; testTypeIndex < this.GetTestTypes().Length; testTypeIndex++)
                    {
                        ...
                        for (int testRoleTypeIndex = 0; testRoleTypeIndex < testRoleTypes.Length; testRoleTypeIndex++)
                        {
                            ...
                            if (binarySize < testRoleType.Size)
                            {
                                ...
                                Assert.AreEqual(value, allorsObject.Strategy.GetUnitRole(testRoleType));
                                Assert.AreEqual(value, allorsObject.Strategy.GetUnitRole(testRoleType));
                            }
                        }
                    }
            ...
            for (int transactionFlagIndex = 0; transactionFlagIndex < transactionFlags.Length; transactionFlagIndex++)
            {
                ...
                for (int valueIndex = 0; valueIndex < values.Length; valueIndex++)
                {
                    ...
                    for (int testTypeIndex = 0; testTypeIndex < this.GetTestTypes().Length; testTypeIndex++)
                    {
                        ...
                        for (int testRoleTypeIndex = 0; testRoleTypeIndex < testRoleTypes.Length; testRoleTypeIndex++)
                        {
                            ...
                            Assert.AreEqual(value, (bool)allorsObject.Strategy.GetUnitRole(testRoleType));
                            Assert.AreEqual(value, (bool)allorsObject.Strategy.GetUnitRole(testRoleType));
                        }
                    }
                }
                ...
                for (int testTypeIndex = 0; testTypeIndex < this.GetTestTypes().Length; testTypeIndex++)
                {
                    ...
                    for (int testRoleTypeIndex = 0; testRoleTypeIndex < testRoleTypes.Length; testRoleTypeIndex++)
                    {
                        ...
                        Assert.IsFalse(allorsObject.Strategy.ExistRole(testRoleType));
                        Assert.IsFalse(allorsObject.Strategy.ExistRole(testRoleType));
                ...
                for (int valueIndex = 0; valueIndex < values.Length; valueIndex++)
                {
                    ...
                    for (int testTypeIndex = 0; testTypeIndex < this.GetTestTypes().Length; testTypeIndex++)
                    {
                        ...
                        for (int testRoleTypeIndex = 0; testRoleTypeIndex < testRoleTypes.Length; testRoleTypeIndex++)
                        {
                            ...
                            Assert.IsTrue(allorsObject.Strategy.ExistRole(testRoleType));
                            Assert.IsTrue(allorsObject.Strategy.ExistRole(testRoleType));
                ...
                for (int valueIndex = 0; valueIndex < values.Length; valueIndex++)
                {
                    ...
                    for (int testTypeIndex = 0; testTypeIndex < this.GetTestTypes().Length; testTypeIndex++)
                    {
                        ...
                        for (int testRoleTypeIndex = 0; testRoleTypeIndex < testRoleTypes.Length; testRoleTypeIndex++)
                        {
                            ...
                            Assert.AreEqual(value, (DateTime)allorsObject.Strategy.GetUnitRole(testRoleType));
                            Assert.AreEqual(value, (DateTime)allorsObject.Strategy.GetUnitRole(testRoleType));
                        }
                    }
                }
                ...
                for (int valueIndex = 0; valueIndex < values.Length; valueIndex++)
                {
                    ...
                    for (int testTypeIndex = 0; testTypeIndex < this.GetTestTypes().Length; testTypeIndex++)
                    {
                        ...
                        for (int testRoleTypeIndex = 0; testRoleTypeIndex < testRoleTypes.Length; testRoleTypeIndex++)
                        {
                            ...
                            Assert.AreEqual(value, (decimal)allorsObject.Strategy.GetUnitRole(testRoleType));
                            Assert.AreEqual(value, (decimal)allorsObject.Strategy.GetUnitRole(testRoleType));
                        }
                    }
                }
                ...
                for (int valueIndex = 0; valueIndex < values.Length; valueIndex++)
                {
                    ...
                    for (int testTypeIndex = 0; testTypeIndex < this.GetTestTypes().Length; testTypeIndex++)
                    {
                        ...
                        for (int testRoleTypeIndex = 0; testRoleTypeIndex < testRoleTypes.Length; testRoleTypeIndex++)
                        {
                            ...
                            Assert.AreEqual(value, (double)allorsObject.Strategy.GetUnitRole(testRoleType));
                            Assert.AreEqual(value, (double)allorsObject.Strategy.GetUnitRole(testRoleType));
                        }
                    }
                }
                ...
                for (int valueIndex = 0; valueIndex < values.Length; valueIndex++)
                {
                    ...
                    for (int testTypeIndex = 0; testTypeIndex < testTypes.Length; testTypeIndex++)
                    {
                        ...
                        for (int testRoleTypeIndex = 0; testRoleTypeIndex < testRoleTypes.Length; testRoleTypeIndex++)
                        {
                            ...
                            Assert.AreEqual(value, (int)allorsObject.Strategy.GetUnitRole(testRoleType));
                            Assert.AreEqual(value, (int)allorsObject.Strategy.GetUnitRole(testRoleType));
                        }
                    }
                }
                ...
                for (int valueIndex = 0; valueIndex < values.Length; valueIndex++)
                {
                    ...
                    for (int testTypeIndex = 0; testTypeIndex < testTypes.Length; testTypeIndex++)
                    {
                        ...
                        for (int testRoleTypeIndex = 0; testRoleTypeIndex < testRoleTypes.Length; testRoleTypeIndex++)
                        {
                            ...
                            Assert.AreEqual(value, (long)allorsObject.Strategy.GetUnitRole(testRoleType));
                            Assert.AreEqual(value, (long)allorsObject.Strategy.GetUnitRole(testRoleType));
                        }
                    }
                }
                ...
                for (int valueIndex = 0; valueIndex < values.Length; valueIndex++)
                {
                    ...
                    for (int testTypeIndex = 0; testTypeIndex < testTypes.Length; testTypeIndex++)
                    {
                        ...
                        for (int testRoleTypeIndex = 0; testRoleTypeIndex < testRoleTypes.Length; testRoleTypeIndex++)
                        {
                            ...
                            Assert.AreEqual(value, (Guid)allorsObject.Strategy.GetUnitRole(testRoleType));
                            Assert.AreEqual(value, (Guid)allorsObject.Strategy.GetUnitRole(testRoleType));
                        }
                    }
                }
