...
namespace Allors1.Adapters.General
{
    ...
    public abstract class ReferenceProxyTest : ReferenceTest
    {
        ...
        public override global::Allors1.Meta.Domain GetMetaDomain()
        {
            return this.subject.GetMetaDomain();
        }

        public override global::Allors1.Meta.Domain GetMetaDomain2()
        {
            return this.subject.GetMetaDomain2();
        }

        public override ObjectType GetMetaType(IObject allorsObject)
        {
