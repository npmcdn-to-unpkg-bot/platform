...
namespace Allors.Domain
{
    ...
    public partial class Person
    {
        ...
        private string BaseDeriveDisplayName()
        {
        ...
        private string BaseDeriveSearchDataCharacterBoundaryText()
        {
            return this.DeriveDisplayName();
        }

        private string BaseDeriveSearchDataWordBoundaryText()
        {
            return null;
        }
