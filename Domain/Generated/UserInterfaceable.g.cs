...
namespace Domain
{
	public partial interface UserInterfaceable :  global::Domain.AccessControlledObject, Allors.IObject
	{
	}

	public static class UserInterfaceableMeta
	{
		public static readonly global::Allors.Meta.Interface ObjectType = (Allors.Meta.Interface)global::Allors.Meta.Repository.MetaPopulation.Find( new System.Guid("eea17b39-8912-40b3-8403-293bd5a3316d") );
