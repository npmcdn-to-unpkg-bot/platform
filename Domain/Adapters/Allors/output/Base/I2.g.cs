...
namespace Domain
{
	public partial interface I2 :  global::Domain.S1234,global::Domain.S2, Allors.IObject
	{
		...
		Allors.Extent<global::Domain.I1> I1sWhereI2many2one
		{ 
			get;
		}
		...
		Allors.Extent<global::Domain.I1> I1sWhereI2many2many
		{ 
			get;
		}
		...
		Allors.Extent<global::Domain.C1> C1sWhereI2many2one
		{ 
			get;
		}
		...
		Allors.Extent<global::Domain.C1> C1sWhereI2many2many
		{ 
			get;
		}
