...
namespace Allors.Databases.Relation.SQLite
{
    ...
    internal abstract class AllorsExtentStatementSql
    {
        ...
        internal void AddJoins(string alias)
        {
            ...
            {
                this.Append(" LEFT OUTER JOIN " + this.Mapping.GetTableName(role) + " " + role.SingularFullName + "_R");
            ...
            {
                this.Append(" LEFT OUTER JOIN " + Mapping.TableNameForObjects + " " + this.GetJoinName(role));
            ...
            {
                this.Append(" LEFT OUTER JOIN " + this.Mapping.GetTableName(association) + " " + association.SingularFullName + "_A");
            ...
            {
                this.Append(" LEFT OUTER JOIN " + Mapping.TableNameForObjects + " " + this.GetJoinName(association));
