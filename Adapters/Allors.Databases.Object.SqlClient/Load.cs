...
namespace Allors.Databases.Object.SqlClient
{
    ...
    internal class Load
    {
        ...
        protected virtual void LoadObjects(Databases.Object.SqlClient.ManagementSession session)
        {
            while (this.reader.Read())
            {
                switch (this.reader.NodeType)
        ...
        protected virtual void LoadDatabaseIObjectTypes(Databases.Object.SqlClient.ManagementSession session)
        {
            while (this.reader.Read())
            {
                switch (this.reader.NodeType)
