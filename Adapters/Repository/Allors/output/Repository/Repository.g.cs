namespace Allors.Meta
{
	...
	public static partial class Repository
	{
		...
		public static RelationType S1234AllorsDouble;
		...
		public static RelationType C2AllorsDouble;
		...
		public static RelationType I12AllorsDouble;
		...
		public static RelationType C1IndexedMaxBinary;
		...
		public static RelationType C1IndexedMaxString;
		...
		public static RelationType S1AllorsDouble;
		...
		public static RelationType S2AllorsDouble;
		...
		public static RelationType I34AllorsDouble;
		...
		public static RelationType SandboxAllorsInteger;
		...
		public static RelationType S12AllorsDouble;
		...
		public static RelationType I1AllorsDouble;
		...
		public static RelationType C1AllorsDouble;
		...
		public static RelationType I2AllorsDouble;
		...
		static void Init(MetaPopulation meta)
		{
			...
			// RelationTypes
				...
				.WithObjectTypes(S1, AllorsDouble)
				...
				.WithObjectTypes(I2, AllorsDouble)
				...
				.WithObjectTypes(C1, AllorsDouble)
				...
				C1IndexedMaxBinary = new RelationTypeBuilder(Adapters, new Guid("65cff232-60fb-4ed9-9f36-2aebbdc3fc79"),new Guid("6c51970a-30b0-4881-b63b-ce51a7a64e03"),new Guid("80e71d74-6abc-4503-bddf-b86da1848ac3"))
				.WithObjectTypes(C1, AllorsBinary)
				.WithSingularName("IndexedMaxBinary")  
				.WithPluralName("IndexedMaxBinaries")  
				  
				.WithIsIndexed(true)  
				.WithSize(-1)
				.Build();

				C1IndexedMaxString = new RelationTypeBuilder(Adapters, new Guid("68fa3256-c5ba-42bb-b424-9349f1c6efa3"),new Guid("2984cad9-47c1-4606-9f5f-5fc2c0f40a3d"),new Guid("307ff3be-adf5-4914-9eaf-974161ff61f8"))
				.WithObjectTypes(C1, AllorsString)
				.WithSingularName("IndexedMaxString")  
				.WithPluralName("IndexedMaxStrings")  
				...
				.WithObjectTypes(C2, AllorsDouble)
				...
				SandboxAllorsInteger = new RelationTypeBuilder(Adapters, new Guid("a0dac9fc-2d19-429b-a522-46425a01ab78"),new Guid("62ea1fd2-c269-4145-8bfa-d4edffc7c17d"),new Guid("ab3b47b0-682e-4b0e-95af-30de1537e453"))
				.WithObjectTypes(Sandbox, AllorsInteger)
				...
				.WithObjectTypes(I12, AllorsDouble)
				...
				.WithObjectTypes(S1234, AllorsDouble)
				...
				.WithObjectTypes(S12, AllorsDouble)
				...
				.WithObjectTypes(I34, AllorsDouble)
				...
				.WithObjectTypes(S2, AllorsDouble)
				...
				.WithObjectTypes(I1, AllorsDouble)
				.WithSingularName("FloatLessThan")  
				.WithPluralName("FloatsLessThan")  
