// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ILoadCompositeRelations.cs" company="Allors bvba">
...
namespace Allors.Adapters.Database.Sql.Commands
{
    ...
    public interface ILoadCompositeRelations
    {
        void Execute(IList<CompositeRelation> associationId);
    }
