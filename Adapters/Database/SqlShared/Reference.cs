...
namespace Allors.Adapters.Database.Sql
{
    ...
    public class Reference
    {
        ...
        public Reference(DatabaseSession session, Class objectType, ObjectId objectId, bool isNew)
        {
        ...
        public Reference(DatabaseSession session, Class objectType, ObjectId objectId, int cacheId)
