...
namespace Allors.Adapters.Database.Sql
{
    ...
    public sealed class AssociationContainedInExtent : In
    {
        ...
        public AssociationContainedInExtent(ExtentFiltered extent, MetaAssociation association, Allors.Extent inExtent)
        {
        ...
        public override bool BuildWhere(ExtentStatement statement, string alias)
        {
            ...
            {
                statement.Append(" (" + this.association.RootName + "_A." + schema.RoleId + " IS NOT NULL AND ");
                statement.Append(" " + this.association.RootName + "_A." + schema.RoleId + " IN (\n");
            ...
            else
            {
                ...
                else
                {
                    ...
                    statement.Append(" " + this.association.RootName + "_A." + schema.ObjectId + " IN (\n");
                    this.inExtent.BuildSql(inStatement);
                    statement.Append(" ))\n");
                }
            }
