...
namespace Allors.Adapters.Database.Sql
{
    ...
    public sealed class AssociationContains : Predicate
    {
        ...
        public AssociationContains(ExtentFiltered extent, MetaAssociation association, IObject allorsObject)
        {
        ...
        public override bool BuildWhere(ExtentStatement statement, string alias)
        {
            ...
            if ((this.association.IsMany && this.association.RoleType.IsMany) || !this.association.RelationTypeWhereAssociationType.ExistExclusiveRootClasses)
            {
                statement.Append("\n");
