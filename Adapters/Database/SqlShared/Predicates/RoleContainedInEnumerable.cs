...
namespace Allors.Adapters.Database.Sql
{
    ...
    public sealed class RoleContainedInEnumerable : In
    {
        ...
        public RoleContainedInEnumerable(ExtentFiltered extent, MetaRole role, IEnumerable<IObject> enumerable)
        {
        ...
        public override bool BuildWhere(ExtentStatement statement, string alias)
        {
            ...
            else
            {
                if (this.role.IsMany)
                {
                    statement.Append(" (" + this.role.RootName + "_R." + schema.ObjectId + " IS NOT NULL AND ");
                    statement.Append(" " + this.role.RootName + "_R." + schema.ObjectId + " IN (");
                    statement.Append(inStatement.ToString());
                    statement.Append(" ))");
                }
                else
