...
namespace Allors.R1.Adapters.Database.Npgsql
{
    ...
    public class SchemaArrayParameter
    {
        ...
        public SchemaArrayParameter(Schema schema, string name, NpgsqlDbType elementType)
        {
            this.Name = string.Format(schema.ParamFormat, name);
            this.InvocationName = string.Format(schema.ParamInvocationFormat, name);
            this.ElementType = elementType;
            this.TypeName = schema.NpgsqlDatabase.GetSqlType(this.ElementType) + "[]";
        }
