...
namespace Allors.Adapters.Database.Sql
{
    ...
    public class SchemaValidationErrors
    {
        ...
        public void AddTableError(IObjectType objectType, RelationType relationType, RoleType roleType, string tableName, string columnName, SchemaValidationErrorKind kind, string message)
        {
