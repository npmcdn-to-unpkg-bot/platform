                       ...
                       foreach (var init in this.Inits)
            {
                ...
                foreach (var mark in this.Markers)
                {
                    for (var i = 0; i < NR_OF_RUNS; i++)
                    {
                        ...
                        // Get
                        mark();
                        Assert.AreEqual(0, to.C1sWhereC1many2one.Count);
                        Assert.AreEqual(0, to.C1sWhereC1many2one.Count);
                        ...
                        mark();
                        Assert.AreEqual(1, to.C1sWhereC1many2one.Count);
                        Assert.AreEqual(1, to.C1sWhereC1many2one.Count);
                        Assert.AreEqual(from1, to.C1sWhereC1many2one[0]);
                        Assert.AreEqual(from1, to.C1sWhereC1many2one[0]);
                        ...
                        mark();
                        Assert.AreEqual(2, to.C1sWhereC1many2one.Count);
                        Assert.AreEqual(2, to.C1sWhereC1many2one.Count);
                        Assert.IsTrue(to.C1sWhereC1many2one.Contains(from1));
                        Assert.IsTrue(to.C1sWhereC1many2one.Contains(from1));
                        Assert.IsTrue(to.C1sWhereC1many2one.Contains(from2));
                        Assert.IsTrue(to.C1sWhereC1many2one.Contains(from2));
                        Assert.AreEqual(to, from1.C1C1many2one);
                        Assert.AreEqual(to, from1.C1C1many2one);
                        ...
                        mark();
                        Assert.AreEqual(3, to.C1sWhereC1many2one.Count);
                        Assert.AreEqual(3, to.C1sWhereC1many2one.Count);
                        Assert.IsTrue(to.C1sWhereC1many2one.Contains(from1));
                        Assert.IsTrue(to.C1sWhereC1many2one.Contains(from1));
                        Assert.IsTrue(to.C1sWhereC1many2one.Contains(from2));
                        Assert.IsTrue(to.C1sWhereC1many2one.Contains(from2));
                        Assert.IsTrue(to.C1sWhereC1many2one.Contains(from3));
                        Assert.IsTrue(to.C1sWhereC1many2one.Contains(from3));
                        Assert.AreEqual(to, from1.C1C1many2one);
                        Assert.AreEqual(to, from1.C1C1many2one);
                        Assert.AreEqual(to, from2.C1C1many2one);
                        ...
                        mark();
                        Assert.AreEqual(4, to.C1sWhereC1many2one.Count);
                        Assert.AreEqual(4, to.C1sWhereC1many2one.Count);
                        Assert.IsTrue(to.C1sWhereC1many2one.Contains(from1));
                        Assert.IsTrue(to.C1sWhereC1many2one.Contains(from1));
                        Assert.IsTrue(to.C1sWhereC1many2one.Contains(from2));
                        ...
                        Assert.IsTrue(to.C1sWhereC1many2one.Contains(from3));
                        Assert.IsTrue(to.C1sWhereC1many2one.Contains(from3));
                        Assert.IsTrue(to.C1sWhereC1many2one.Contains(from4));
                        Assert.IsTrue(to.C1sWhereC1many2one.Contains(from4));
                        Assert.AreEqual(to, from1.C1C1many2one);
                        Assert.AreEqual(to, from1.C1C1many2one);
                        Assert.AreEqual(to, from2.C1C1many2one);
                        ...
                        // Exist
                        Assert.IsFalse(to.ExistC1sWhereC1many2one);
                        Assert.IsFalse(to.ExistC1sWhereC1many2one);
                        ...
                        from1.C1C1many2one = to; // Twice
                        mark();
                        Assert.IsTrue(to.ExistC1sWhereC1many2one);
                        Assert.IsTrue(to.ExistC1sWhereC1many2one);
                        ...
                        Assert.AreEqual(null, from1.C1C1many2one);
                        Assert.AreEqual(null, from1.C1C1many2one);
                        Assert.AreEqual(0, toAnother.C1sWhereC1many2one.Count);
                        Assert.AreEqual(0, toAnother.C1sWhereC1many2one.Count);
                        from1.C1C1many2one = to;
                        from1.C1C1many2one = to; // Twice
                        mark();
                        ...
                        Assert.AreEqual(toAnother, from1.C1C1many2one);
                        Assert.AreEqual(1, toAnother.C1sWhereC1many2one.Count);
                        Assert.AreEqual(1, toAnother.C1sWhereC1many2one.Count);
                        Assert.IsTrue(toAnother.C1sWhereC1many2one.Contains(from1));
                        Assert.IsTrue(toAnother.C1sWhereC1many2one.Contains(from1));
                        ...
                        Assert.IsFalse(from1.ExistC1C1many2one);
                        Assert.IsFalse(from1.ExistC1C1many2one);
                        Assert.IsFalse(toAnother.ExistC1sWhereC1many2one);
                        Assert.IsFalse(toAnother.ExistC1sWhereC1many2one);
                        from1.C1C1many2one = to;
                        from1.C1C1many2one = to; // Twice
                        mark();
                        ...
                        Assert.IsTrue(from1.ExistC1C1many2one);
                        Assert.IsTrue(from1.ExistC1C1many2one);
                        Assert.IsTrue(toAnother.ExistC1sWhereC1many2one);
                        Assert.IsTrue(toAnother.ExistC1sWhereC1many2one);
                        from1.C1C1many2one = null;
                        from1.C1C1many2one = null; // Twice
                        from1.C1C1many2one = null;
                        ...
                        Assert.AreEqual(1, toAnother.C1sWhereC1many2one.Count);
                        Assert.AreEqual(1, toAnother.C1sWhereC1many2one.Count);
                        Assert.IsTrue(toAnother.C1sWhereC1many2one.Contains(from2));
                        Assert.IsTrue(toAnother.C1sWhereC1many2one.Contains(from2));
                        from1.C1C1many2one = null;
                        from1.C1C1many2one = null; // Twice
                        ...
                        Assert.IsTrue(to.C1sWhereC1many2one.Contains(from1));
                        Assert.IsTrue(to.C1sWhereC1many2one.Contains(from1));
                        Assert.IsFalse(to.C1sWhereC1many2one.Contains(from2));
                        Assert.IsFalse(to.C1sWhereC1many2one.Contains(from2));
                        from2.C1C1many2one = to;
                        from2.C1C1many2one = to; // Twice
                        mark();
                       ...
                       foreach (var init in this.Inits)
            {
                ...
                foreach (var mark in this.Markers)
                {
                    for (var i = 0; i < NR_OF_RUNS; i++)
                    {
                        ...
                        // Get
                        mark();
                        Assert.AreEqual(0, to.C1sWhereC2many2one.Count);
                        Assert.AreEqual(0, to.C1sWhereC2many2one.Count);
                        ...
                        mark();
                        Assert.AreEqual(1, to.C1sWhereC2many2one.Count);
                        Assert.AreEqual(1, to.C1sWhereC2many2one.Count);
                        Assert.AreEqual(from1, to.C1sWhereC2many2one[0]);
                        Assert.AreEqual(from1, to.C1sWhereC2many2one[0]);
                        ...
                        mark();
                        Assert.AreEqual(2, to.C1sWhereC2many2one.Count);
                        Assert.AreEqual(2, to.C1sWhereC2many2one.Count);
                        Assert.IsTrue(to.C1sWhereC2many2one.Contains(from1));
                        Assert.IsTrue(to.C1sWhereC2many2one.Contains(from1));
                        Assert.IsTrue(to.C1sWhereC2many2one.Contains(from2));
                        Assert.IsTrue(to.C1sWhereC2many2one.Contains(from2));
                        Assert.AreEqual(to, from1.C1C2many2one);
                        Assert.AreEqual(to, from1.C1C2many2one);
                        ...
                        mark();
                        Assert.AreEqual(3, to.C1sWhereC2many2one.Count);
                        Assert.AreEqual(3, to.C1sWhereC2many2one.Count);
                        Assert.IsTrue(to.C1sWhereC2many2one.Contains(from1));
                        Assert.IsTrue(to.C1sWhereC2many2one.Contains(from1));
                        Assert.IsTrue(to.C1sWhereC2many2one.Contains(from2));
                        Assert.IsTrue(to.C1sWhereC2many2one.Contains(from2));
                        Assert.IsTrue(to.C1sWhereC2many2one.Contains(from3));
                        Assert.IsTrue(to.C1sWhereC2many2one.Contains(from3));
                        Assert.AreEqual(to, from1.C1C2many2one);
                        Assert.AreEqual(to, from1.C1C2many2one);
                        Assert.AreEqual(to, from2.C1C2many2one);
                        ...
                        mark();
                        Assert.AreEqual(4, to.C1sWhereC2many2one.Count);
                        Assert.AreEqual(4, to.C1sWhereC2many2one.Count);
                        Assert.IsTrue(to.C1sWhereC2many2one.Contains(from1));
                        Assert.IsTrue(to.C1sWhereC2many2one.Contains(from1));
                        Assert.IsTrue(to.C1sWhereC2many2one.Contains(from2));
                        ...
                        Assert.IsTrue(to.C1sWhereC2many2one.Contains(from3));
                        Assert.IsTrue(to.C1sWhereC2many2one.Contains(from3));
                        Assert.IsTrue(to.C1sWhereC2many2one.Contains(from4));
                        Assert.IsTrue(to.C1sWhereC2many2one.Contains(from4));
                        Assert.AreEqual(to, from1.C1C2many2one);
                        Assert.AreEqual(to, from1.C1C2many2one);
                        Assert.AreEqual(to, from2.C1C2many2one);
                        ...
                        // Exist
                        Assert.IsFalse(to.ExistC1sWhereC2many2one);
                        Assert.IsFalse(to.ExistC1sWhereC2many2one);
                        ...
                        from1.C1C2many2one = to; // Twice
                        mark();
                        Assert.IsTrue(to.ExistC1sWhereC2many2one);
                        Assert.IsTrue(to.ExistC1sWhereC2many2one);
                        ...
                        Assert.AreEqual(null, from1.C1C2many2one);
                        Assert.AreEqual(null, from1.C1C2many2one);
                        Assert.AreEqual(0, toAnother.C1sWhereC2many2one.Count);
                        Assert.AreEqual(0, toAnother.C1sWhereC2many2one.Count);
                        from1.C1C2many2one = to;
                        from1.C1C2many2one = to; // Twice
                        mark();
                        ...
                        Assert.AreEqual(toAnother, from1.C1C2many2one);
                        Assert.AreEqual(1, toAnother.C1sWhereC2many2one.Count);
                        Assert.AreEqual(1, toAnother.C1sWhereC2many2one.Count);
                        Assert.IsTrue(toAnother.C1sWhereC2many2one.Contains(from1));
                        Assert.IsTrue(toAnother.C1sWhereC2many2one.Contains(from1));
                        ...
                        Assert.IsFalse(from1.ExistC1C2many2one);
                        Assert.IsFalse(from1.ExistC1C2many2one);
                        Assert.IsFalse(toAnother.ExistC1sWhereC2many2one);
                        Assert.IsFalse(toAnother.ExistC1sWhereC2many2one);
                        from1.C1C2many2one = to;
                        from1.C1C2many2one = to; // Twice
                        mark();
                        ...
                        Assert.IsTrue(from1.ExistC1C2many2one);
                        Assert.IsTrue(from1.ExistC1C2many2one);
                        Assert.IsTrue(toAnother.ExistC1sWhereC2many2one);
                        Assert.IsTrue(toAnother.ExistC1sWhereC2many2one);
                        from1.C1C2many2one = null;
                        from1.C1C2many2one = null; // Twice
                        from1.C1C2many2one = null;
                        ...
                        Assert.AreEqual(1, toAnother.C1sWhereC2many2one.Count);
                        Assert.AreEqual(1, toAnother.C1sWhereC2many2one.Count);
                        Assert.IsTrue(toAnother.C1sWhereC2many2one.Contains(from2));
                        Assert.IsTrue(toAnother.C1sWhereC2many2one.Contains(from2));
                        from1.C1C2many2one = null;
                        from1.C1C2many2one = null; // Twice
                        ...
                        Assert.IsTrue(to.C1sWhereC2many2one.Contains(from1));
                        Assert.IsTrue(to.C1sWhereC2many2one.Contains(from1));
                        Assert.IsFalse(to.C1sWhereC2many2one.Contains(from2));
                        Assert.IsFalse(to.C1sWhereC2many2one.Contains(from2));
                        from2.C1C2many2one = to;
                        from2.C1C2many2one = to; // Twice
                        mark();
            ...
            foreach (var init in this.Inits)
            {
                ...
                foreach (var mark in this.Markers)
                {
                    for (var i = 0; i < NR_OF_RUNS; i++)
                    {
                        ...
                        // Get
                        mark();
                        Assert.AreEqual(0, to.C3sWhereC4many2one.Count);
                        Assert.AreEqual(0, to.C3sWhereC4many2one.Count);
                        ...
                        mark();
                        Assert.AreEqual(1, to.C3sWhereC4many2one.Count);
                        Assert.AreEqual(1, to.C3sWhereC4many2one.Count);
                        Assert.AreEqual(from1, to.C3sWhereC4many2one[0]);
                        Assert.AreEqual(from1, to.C3sWhereC4many2one[0]);
                        ...
                        mark();
                        Assert.AreEqual(2, to.C3sWhereC4many2one.Count);
                        Assert.AreEqual(2, to.C3sWhereC4many2one.Count);
                        Assert.IsTrue(to.C3sWhereC4many2one.Contains(from1));
                        Assert.IsTrue(to.C3sWhereC4many2one.Contains(from1));
                        Assert.IsTrue(to.C3sWhereC4many2one.Contains(from2));
                        Assert.IsTrue(to.C3sWhereC4many2one.Contains(from2));
                        Assert.AreEqual(to, from1.C3C4many2one);
                        Assert.AreEqual(to, from1.C3C4many2one);
                        ...
                        mark();
                        Assert.AreEqual(3, to.C3sWhereC4many2one.Count);
                        Assert.AreEqual(3, to.C3sWhereC4many2one.Count);
                        Assert.IsTrue(to.C3sWhereC4many2one.Contains(from1));
                        Assert.IsTrue(to.C3sWhereC4many2one.Contains(from1));
                        Assert.IsTrue(to.C3sWhereC4many2one.Contains(from2));
                        Assert.IsTrue(to.C3sWhereC4many2one.Contains(from2));
                        Assert.IsTrue(to.C3sWhereC4many2one.Contains(from3));
                        Assert.IsTrue(to.C3sWhereC4many2one.Contains(from3));
                        Assert.AreEqual(to, from1.C3C4many2one);
                        Assert.AreEqual(to, from1.C3C4many2one);
                        Assert.AreEqual(to, from2.C3C4many2one);
                        ...
                        mark();
                        Assert.AreEqual(4, to.C3sWhereC4many2one.Count);
                        Assert.AreEqual(4, to.C3sWhereC4many2one.Count);
                        Assert.IsTrue(to.C3sWhereC4many2one.Contains(from1));
                        Assert.IsTrue(to.C3sWhereC4many2one.Contains(from1));
                        Assert.IsTrue(to.C3sWhereC4many2one.Contains(from2));
                        ...
                        Assert.IsTrue(to.C3sWhereC4many2one.Contains(from3));
                        Assert.IsTrue(to.C3sWhereC4many2one.Contains(from3));
                        Assert.IsTrue(to.C3sWhereC4many2one.Contains(from4));
                        Assert.IsTrue(to.C3sWhereC4many2one.Contains(from4));
                        Assert.AreEqual(to, from1.C3C4many2one);
                        Assert.AreEqual(to, from1.C3C4many2one);
                        Assert.AreEqual(to, from2.C3C4many2one);
                        ...
                        // Exist
                        Assert.IsFalse(to.ExistC3sWhereC4many2one);
                        Assert.IsFalse(to.ExistC3sWhereC4many2one);
                        ...
                        from1.C3C4many2one = to; // Twice
                        mark();
                        Assert.IsTrue(to.ExistC3sWhereC4many2one);
                        Assert.IsTrue(to.ExistC3sWhereC4many2one);
                        ...
                        Assert.AreEqual(null, from1.C3C4many2one);
                        Assert.AreEqual(null, from1.C3C4many2one);
                        Assert.AreEqual(0, toAnother.C3sWhereC4many2one.Count);
                        Assert.AreEqual(0, toAnother.C3sWhereC4many2one.Count);
                        from1.C3C4many2one = to;
                        from1.C3C4many2one = to; // Twice
                        mark();
                        ...
                        Assert.AreEqual(toAnother, from1.C3C4many2one);
                        Assert.AreEqual(1, toAnother.C3sWhereC4many2one.Count);
                        Assert.AreEqual(1, toAnother.C3sWhereC4many2one.Count);
                        Assert.IsTrue(toAnother.C3sWhereC4many2one.Contains(from1));
                        Assert.IsTrue(toAnother.C3sWhereC4many2one.Contains(from1));
                        ...
                        Assert.IsFalse(from1.ExistC3C4many2one);
                        Assert.IsFalse(from1.ExistC3C4many2one);
                        Assert.IsFalse(toAnother.ExistC3sWhereC4many2one);
                        Assert.IsFalse(toAnother.ExistC3sWhereC4many2one);
                        from1.C3C4many2one = to;
                        from1.C3C4many2one = to; // Twice
                        mark();
                        ...
                        Assert.IsTrue(from1.ExistC3C4many2one);
                        Assert.IsTrue(from1.ExistC3C4many2one);
                        Assert.IsTrue(toAnother.ExistC3sWhereC4many2one);
                        Assert.IsTrue(toAnother.ExistC3sWhereC4many2one);
                        from1.C3C4many2one = null;
                        from1.C3C4many2one = null; // Twice
                        from1.C3C4many2one = null;
                        ...
                        Assert.AreEqual(1, toAnother.C3sWhereC4many2one.Count);
                        Assert.AreEqual(1, toAnother.C3sWhereC4many2one.Count);
                        Assert.IsTrue(toAnother.C3sWhereC4many2one.Contains(from2));
                        Assert.IsTrue(toAnother.C3sWhereC4many2one.Contains(from2));
                        from1.C3C4many2one = null;
                        from1.C3C4many2one = null; // Twice
                        ...
                        Assert.IsTrue(to.C3sWhereC4many2one.Contains(from1));
                        Assert.IsTrue(to.C3sWhereC4many2one.Contains(from1));
                        Assert.IsFalse(to.C3sWhereC4many2one.Contains(from2));
                        Assert.IsFalse(to.C3sWhereC4many2one.Contains(from2));
                        from2.C3C4many2one = to;
                        from2.C3C4many2one = to; // Twice
                        mark();
           ...
           foreach (var init in this.Inits)
            {
                ...
                foreach (var mark in this.Markers)
                {
                    for (var i = 0; i < NR_OF_RUNS; i++)
                    {
                        ...
                        // Get
                        mark();
                        Assert.AreEqual(0, to.I1sWhereI12many2one.Count);
                        Assert.AreEqual(0, to.I1sWhereI12many2one.Count);
                        ...
                        mark();
                        Assert.AreEqual(1, to.I1sWhereI12many2one.Count);
                        Assert.AreEqual(1, to.I1sWhereI12many2one.Count);
                        Assert.AreEqual(from1, to.I1sWhereI12many2one[0]);
                        Assert.AreEqual(from1, to.I1sWhereI12many2one[0]);
                        ...
                        mark();
                        Assert.AreEqual(2, to.I1sWhereI12many2one.Count);
                        Assert.AreEqual(2, to.I1sWhereI12many2one.Count);
                        Assert.IsTrue(to.I1sWhereI12many2one.Contains(from1));
                        Assert.IsTrue(to.I1sWhereI12many2one.Contains(from1));
                        Assert.IsTrue(to.I1sWhereI12many2one.Contains(from2));
                        Assert.IsTrue(to.I1sWhereI12many2one.Contains(from2));
                        Assert.AreEqual(to, from1.I1I12many2one);
                        Assert.AreEqual(to, from1.I1I12many2one);
                        ...
                        mark();
                        Assert.AreEqual(3, to.I1sWhereI12many2one.Count);
                        Assert.AreEqual(3, to.I1sWhereI12many2one.Count);
                        Assert.IsTrue(to.I1sWhereI12many2one.Contains(from1));
                        Assert.IsTrue(to.I1sWhereI12many2one.Contains(from1));
                        Assert.IsTrue(to.I1sWhereI12many2one.Contains(from2));
                        Assert.IsTrue(to.I1sWhereI12many2one.Contains(from2));
                        Assert.IsTrue(to.I1sWhereI12many2one.Contains(from3));
                        Assert.IsTrue(to.I1sWhereI12many2one.Contains(from3));
                        Assert.AreEqual(to, from1.I1I12many2one);
                        Assert.AreEqual(to, from1.I1I12many2one);
                        Assert.AreEqual(to, from2.I1I12many2one);
                        ...
                        mark();
                        Assert.AreEqual(4, to.I1sWhereI12many2one.Count);
                        Assert.AreEqual(4, to.I1sWhereI12many2one.Count);
                        Assert.IsTrue(to.I1sWhereI12many2one.Contains(from1));
                        Assert.IsTrue(to.I1sWhereI12many2one.Contains(from1));
                        Assert.IsTrue(to.I1sWhereI12many2one.Contains(from2));
                        ...
                        Assert.IsTrue(to.I1sWhereI12many2one.Contains(from3));
                        Assert.IsTrue(to.I1sWhereI12many2one.Contains(from3));
                        Assert.IsTrue(to.I1sWhereI12many2one.Contains(from4));
                        Assert.IsTrue(to.I1sWhereI12many2one.Contains(from4));
                        Assert.AreEqual(to, from1.I1I12many2one);
                        Assert.AreEqual(to, from1.I1I12many2one);
                        Assert.AreEqual(to, from2.I1I12many2one);
                        ...
                        // Exist
                        mark();
                        Assert.IsFalse(to.ExistI1sWhereI12many2one);
                        Assert.IsFalse(to.ExistI1sWhereI12many2one);
                        ...
                        from1.I1I12many2one = to; // Twice
                        mark();
                        Assert.IsTrue(to.ExistI1sWhereI12many2one);
                        Assert.IsTrue(to.ExistI1sWhereI12many2one);
                        ...
                        Assert.AreEqual(null, from1.I1I12many2one);
                        Assert.AreEqual(null, from1.I1I12many2one);
                        Assert.AreEqual(0, toAnother.I1sWhereI12many2one.Count);
                        Assert.AreEqual(0, toAnother.I1sWhereI12many2one.Count);
                        from1.I1I12many2one = to;
                        from1.I1I12many2one = to; // Twice
                        mark();
                        ...
                        Assert.AreEqual(toAnother, from1.I1I12many2one);
                        Assert.AreEqual(1, toAnother.I1sWhereI12many2one.Count);
                        Assert.AreEqual(1, toAnother.I1sWhereI12many2one.Count);
                        Assert.IsTrue(toAnother.I1sWhereI12many2one.Contains(from1));
                        Assert.IsTrue(toAnother.I1sWhereI12many2one.Contains(from1));
                        ...
                        Assert.IsFalse(from1.ExistI1I12many2one);
                        Assert.IsFalse(from1.ExistI1I12many2one);
                        Assert.IsFalse(toAnother.ExistI1sWhereI12many2one);
                        Assert.IsFalse(toAnother.ExistI1sWhereI12many2one);
                        from1.I1I12many2one = to;
                        from1.I1I12many2one = to; // Twice
                        mark();
                        ...
                        Assert.IsTrue(from1.ExistI1I12many2one);
                        Assert.IsTrue(from1.ExistI1I12many2one);
                        Assert.IsTrue(toAnother.ExistI1sWhereI12many2one);
                        Assert.IsTrue(toAnother.ExistI1sWhereI12many2one);
                        from1.I1I12many2one = null;
                        from1.I1I12many2one = null; // Twice
                        from1.I1I12many2one = null;
                        ...
                        Assert.AreEqual(1, toAnother.I1sWhereI12many2one.Count);
                        Assert.AreEqual(1, toAnother.I1sWhereI12many2one.Count);
                        Assert.IsTrue(toAnother.I1sWhereI12many2one.Contains(from2));
                        Assert.IsTrue(toAnother.I1sWhereI12many2one.Contains(from2));
                        from1.I1I12many2one = null;
                        from1.I1I12many2one = null; // Twice
                        ...
                        Assert.IsTrue(to.I1sWhereI12many2one.Contains(from1));
                        Assert.IsTrue(to.I1sWhereI12many2one.Contains(from1));
                        Assert.IsFalse(to.I1sWhereI12many2one.Contains(from2));
                        Assert.IsFalse(to.I1sWhereI12many2one.Contains(from2));
                        from2.I1I12many2one = to;
                        from2.I1I12many2one = to; // Twice
                        mark();
        ...
        public void RelationChecks()
        {
            foreach (var init in this.Inits)
            {
                ...
                foreach (var mark in this.Markers)
                {
                    ...
                    {
                        mark();
                        c1a.Strategy.SetCompositeRole(MetaC2.Instance.C2C2many2one, c2b);
                    }
                    catch
                    {
                        exceptionThrown = true;
                    ...
                    {
                        mark();
                        c1a.Strategy.SetCompositeRole(MetaC1.Instance.C1C2many2manies, c2b);
                    }
                    catch
                    {
                        exceptionThrown = true;
