    ...
    public abstract class ExtentTest
    {
        ...
        public void RoleLongBetweenValue()
        {
            foreach (var init in this.Inits)
            {
                ...
                // Between -10 and 0
                var extent = this.LocalExtent(Classes.C1);
                extent.Filter.AddBetween(RoleTypes.C1AllorsLong, -10, 0);
                ...
                // Between 0 and 1
                extent = this.LocalExtent(Classes.C1);
                extent.Filter.AddBetween(RoleTypes.C1AllorsLong, 0, 1);
                ...
                // Between 1 and 2
                extent = this.LocalExtent(Classes.C1);
                extent.Filter.AddBetween(RoleTypes.C1AllorsLong, 1, 2);
                ...
                // Between 3 and 10
                extent = this.LocalExtent(Classes.C1);
                extent.Filter.AddBetween(RoleTypes.C1AllorsLong, 3, 10);
                ...
                // Between -10 and 0
                extent = this.LocalExtent(Interfaces.I12);
                extent.Filter.AddBetween(RoleTypes.I12AllorsLong, -10, 0);
                ...
                // Between 0 and 1
                extent = this.LocalExtent(Interfaces.I12);
                extent.Filter.AddBetween(RoleTypes.I12AllorsLong, 0, 1);
                ...
                // Between 1 and 2
                extent = this.LocalExtent(Interfaces.I12);
                extent.Filter.AddBetween(RoleTypes.I12AllorsLong, 1, 2);
                ...
                // Between 3 and 10
                extent = this.LocalExtent(Interfaces.I12);
                extent.Filter.AddBetween(RoleTypes.I12AllorsLong, 3, 10);
                ...
                // Between -10 and 0
                extent = this.LocalExtent(Interfaces.S1234);
                extent.Filter.AddBetween(RoleTypes.S1234AllorsLong, -10, 0);
                ...
                // Between 0 and 1
                extent = this.LocalExtent(Interfaces.S1234);
                extent.Filter.AddBetween(RoleTypes.S1234AllorsLong, 0, 1);
                ...
                // Between 1 and 2
                extent = this.LocalExtent(Interfaces.S1234);
                extent.Filter.AddBetween(RoleTypes.S1234AllorsLong, 1, 2);
                ...
                // Between 3 and 10
                extent = this.LocalExtent(Interfaces.S1234);
                extent.Filter.AddBetween(RoleTypes.S1234AllorsLong, 3, 10);
                ...
                try
                {
                    extent.Filter.AddBetween(RoleTypes.C2AllorsLong, -10, 0);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddBetween(RoleTypes.C2AllorsLong, 0, 1);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddBetween(RoleTypes.C2AllorsLong, 1, 2);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddBetween(RoleTypes.C2AllorsLong, 3, 10);
                }
                catch
                {
                    exception = true;
        ...
        public void RoleLongLessThanValue()
        {
            foreach (var init in this.Inits)
            {
                ...
                // Less Than 1
                var extent = this.LocalExtent(Classes.C1);
                extent.Filter.AddLessThan(RoleTypes.C1AllorsLong, 1);
                ...
                // Less Than 2
                extent = this.LocalExtent(Classes.C1);
                extent.Filter.AddLessThan(RoleTypes.C1AllorsLong, 2);
                ...
                // Less Than 3
                extent = this.LocalExtent(Classes.C1);
                extent.Filter.AddLessThan(RoleTypes.C1AllorsLong, 3);
                ...
                // Less Than 1
                extent = this.LocalExtent(Interfaces.I12);
                extent.Filter.AddLessThan(RoleTypes.I12AllorsLong, 1);
                ...
                // Less Than 2
                extent = this.LocalExtent(Interfaces.I12);
                extent.Filter.AddLessThan(RoleTypes.I12AllorsLong, 2);
                ...
                // Less Than 3
                extent = this.LocalExtent(Interfaces.I12);
                extent.Filter.AddLessThan(RoleTypes.I12AllorsLong, 3);
                ...
                // Less Than 1
                extent = this.LocalExtent(Interfaces.S1234);
                extent.Filter.AddLessThan(RoleTypes.S1234AllorsLong, 1);
                ...
                // Less Than 2
                extent = this.LocalExtent(Interfaces.S1234);
                extent.Filter.AddLessThan(RoleTypes.S1234AllorsLong, 2);
                ...
                // Less Than 3
                extent = this.LocalExtent(Interfaces.S1234);
                extent.Filter.AddLessThan(RoleTypes.S1234AllorsLong, 3);
                ...
                try
                {
                    extent.Filter.AddLessThan(RoleTypes.C2AllorsLong, 1);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddLessThan(RoleTypes.C2AllorsLong, 2);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddLessThan(RoleTypes.C2AllorsLong, 3);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddLessThan(RoleTypes.I2AllorsLong, 1);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddLessThan(RoleTypes.I2AllorsLong, 2);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddLessThan(RoleTypes.I2AllorsLong, 3);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddLessThan(RoleTypes.S2AllorsLong, 1);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddLessThan(RoleTypes.S2AllorsLong, 2);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddLessThan(RoleTypes.S2AllorsLong, 3);
                }
                catch
                {
                    exception = true;
        ...
        public void RoleLongGreaterThanValue()
        {
            foreach (var init in this.Inits)
            {
                ...
                // Greater Than 0
                var extent = this.LocalExtent(Classes.C1);
                extent.Filter.AddGreaterThan(RoleTypes.C1AllorsLong, 0);
                ...
                // Greater Than 1
                extent = this.LocalExtent(Classes.C1);
                extent.Filter.AddGreaterThan(RoleTypes.C1AllorsLong, 1);
                ...
                // Greater Than 2
                extent = this.LocalExtent(Classes.C1);
                extent.Filter.AddGreaterThan(RoleTypes.C1AllorsLong, 2);
                ...
                // Greater Than 0
                extent = this.LocalExtent(Interfaces.I12);
                extent.Filter.AddGreaterThan(RoleTypes.I12AllorsLong, 0);
                ...
                // Greater Than 1
                extent = this.LocalExtent(Interfaces.I12);
                extent.Filter.AddGreaterThan(RoleTypes.I12AllorsLong, 1);
                ...
                // Greater Than 2
                extent = this.LocalExtent(Interfaces.I12);
                extent.Filter.AddGreaterThan(RoleTypes.I12AllorsLong, 2);
                ...
                // Greater Than 0
                extent = this.LocalExtent(Interfaces.S1234);
                extent.Filter.AddGreaterThan(RoleTypes.S1234AllorsLong, 0);
                ...
                // Greater Than 1
                extent = this.LocalExtent(Interfaces.S1234);
                extent.Filter.AddGreaterThan(RoleTypes.S1234AllorsLong, 1);
                ...
                // Greater Than 2
                extent = this.LocalExtent(Interfaces.S1234);
                extent.Filter.AddGreaterThan(RoleTypes.S1234AllorsLong, 2);
                ...
                try
                {
                    extent.Filter.AddGreaterThan(RoleTypes.C2AllorsLong, 0);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddGreaterThan(RoleTypes.C2AllorsLong, 1);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddGreaterThan(RoleTypes.C2AllorsLong, 2);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddGreaterThan(RoleTypes.I2AllorsLong, 0);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddGreaterThan(RoleTypes.I2AllorsLong, 1);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddGreaterThan(RoleTypes.I2AllorsLong, 2);
                }
                catch
                {
                    exception = true;
        ...
        public void RoleLongEquals()
        {
            foreach (var init in this.Inits)
            {
                ...
                // Equal 0
                var extent = this.LocalExtent(Classes.C1);
                extent.Filter.AddEquals(RoleTypes.C1AllorsLong, 0);
                ...
                // Equal 2
                extent = this.LocalExtent(Classes.C1);
                extent.Filter.AddEquals(RoleTypes.C1AllorsLong, 2);
                ...
                // Equal 0
                extent = this.LocalExtent(Interfaces.I12);
                extent.Filter.AddEquals(RoleTypes.I12AllorsLong, 0);
                ...
                // Equal 1
                extent = this.LocalExtent(Interfaces.I12);
                extent.Filter.AddEquals(RoleTypes.I12AllorsLong, 1);
                ...
                // Equal 2
                extent = this.LocalExtent(Interfaces.I12);
                extent.Filter.AddEquals(RoleTypes.I12AllorsLong, 2);
                ...
                // Equal 0
                extent = this.LocalExtent(Interfaces.S1234);
                extent.Filter.AddEquals(RoleTypes.S1234AllorsLong, 0);
                ...
                // Equal 1
                extent = this.LocalExtent(Interfaces.S1234);
                extent.Filter.AddEquals(RoleTypes.S1234AllorsLong, 1);
                ...
                // Equal 2
                extent = this.LocalExtent(Interfaces.S1234);
                extent.Filter.AddEquals(RoleTypes.S1234AllorsLong, 2);
                ...
                try
                {
                    extent.Filter.AddEquals(RoleTypes.C2AllorsLong, 0);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddEquals(RoleTypes.C2AllorsLong, 1);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddEquals(RoleTypes.C2AllorsLong, 2);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddEquals(RoleTypes.I2AllorsLong, 0);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddEquals(RoleTypes.I2AllorsLong, 1);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddEquals(RoleTypes.I2AllorsLong, 2);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddEquals(RoleTypes.S2AllorsLong, 0);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddEquals(RoleTypes.S2AllorsLong, 1);
                }
                catch
                {
                    exception = true;
                ...
                try
                {
                    extent.Filter.AddEquals(RoleTypes.S2AllorsLong, 2);
                }
                catch
                {
                    exception = true;
        ...
        public void RoleEnumerationEquals()
        {
            foreach (var init in this.Inits)
            {
                ...
                try
                {
                    extent.Filter.AddEquals(RoleTypes.C1AllorsLong, Zero2Four.Zero);
