// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OldLoad.cs" company="Allors bvba">
...
namespace Allors.Adapters.Object.SqlClient
{
    ...
    internal class OldLoad
    {
        ...
        internal OldLoad(Database database, ObjectNotLoadedEventHandler objectNotLoaded, RelationNotLoadedEventHandler relationNotLoaded, XmlReader reader)
        {
