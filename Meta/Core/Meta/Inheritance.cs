...
namespace Allors.Meta
{
    ...
    public sealed partial class Inheritance : MetaObject
    {
        ...
        public Inheritance(Part part, Guid inheritanceId)
        {
            this.Whole = part.Whole;
            this.Id = inheritanceId;

            part.OnInheritanceCreated(this);
        }
        ...
        protected internal override void Validate(ValidationLog validationLog)
        {
            ...
            if (this.Subtype != null && this.Supertype != null)
            {
                ...
                if (this.Whole.Inheritances.Count(inheritance => this.Subtype.Equals(inheritance.Subtype) && this.Supertype.Equals(inheritance.Supertype)) != 1)
                {
        ...
        private bool HasCycle(Composite startSubType)
        {
            ...
            return this.Supertype != null && this.Whole.Inheritances
