...
namespace Allors.Meta
{
    ...
    public static partial class Repository
    {
        public static Domain Adapters(Environment env)
        {
            ...
            var interfaceWithoutConcreteClass = new Interface(domain, new Guid("2f4bc713-47c9-4e07-9f2b-1d22a0cb4fad"))
                                                    {
                                                        SingularName = "InterfaceWithoutConcreteClass",
                                                        PluralName = "InterfacesWithoutConcreteClass",
                                                    };
            var classWithoutUnitRoles = new Class(domain, new Guid("071d291d-fcc6-4511-8aa2-2d30fdeede8f"))
                                            {
                                                SingularName = "ClassWithoutUnitRoles",
                                                PluralName = "ClassesWithoutUnitRoles"
                                            };
            var classWithoutRoles = new Class(domain, new Guid("e1008840-6d7c-4d44-b2ad-1545d23f90d8")) { SingularName = "ClassWithoutRoles", PluralName = "ClassesWithoutRoles" };
            var singleUnit = new Class(domain, new Guid("c3e82ab0-f586-4913-acb0-838ffd6701f8")) { SingularName = "SingleUnit", PluralName = "SingleUnits" };

            var lt32 = new Class(domain, new Guid("67c8d19f-1947-487c-8884-dbd76033aab0")) { SingularName = "LT32", PluralName = "LT32s" };
            var lt32UnitGT32Composite = new Class(domain, new Guid("15ea889f-21d6-4682-aca2-c2987f592f0e"))
                                            {
                                                SingularName = "LT32UnitGT32Composite",
                                                PluralName = "LT32UnitGT32Composites"
                                            };
            var ilt32Composite = new Interface(domain, new Guid("4f53e1e7-e88a-4161-969c-1fed0b3a24a2")) { SingularName = "ILT32Composite", PluralName = "ILT32Composites" };
            var ilt32Unit = new Interface(domain, new Guid("228fa79f-afa7-418c-968e-8c0d38fb3ad2")) { SingularName = "ILT32Unit", PluralName = "ILT32Units" };
            var gt32 = new Class(domain, new Guid("4f6301b3-6f0a-40c2-8267-4f8631bae706")) { SingularName = "GT32", PluralName = "GT32s" };
            var gt32UnitLT32Composite = new Class(domain, new Guid("7683eb7f-cbac-4947-ac29-4ef15ae47597"))
                                            {
                                                SingularName = "GT32UnitLT32Composite",
                                                PluralName = "GT32UnitLT32Composites"
                                            };
            var igt32Unit = new Interface(domain, new Guid("584681af-90f0-45b1-a80e-6a73c3592600")) { SingularName = "IGT32Unit", PluralName = "IGT32Units" };
            var igt32Composite = new Interface(domain, new Guid("ee84609f-e165-4037-b8ce-f7c8b826e603")) { SingularName = "IGT32Composite", PluralName = "IGT32Composites" };

            var sandbox = new Class(domain, new Guid("73970b0f-1ff4-4d39-aad8-fdbfbaae472f")) { SingularName = "Sandbox", PluralName = "Sandboxes" };
            var isandbox = new Interface(domain, new Guid("7ba2ab26-491b-49eb-944c-26f6bb66e50f")) { SingularName = "ISandbox", PluralName = "ISandboxes" };

            var named = new Interface(domain, new Guid("fcaa52e3-4a90-4981-b45d-d158e2589506")) { SingularName = "Named", PluralName = "Nameds" };
            var user = new Class(domain, new Guid("0d6bc154-112b-4a58-aa96-3b2a96f82523")) { SingularName = "User", PluralName = "Users" };
            var person = new Class(domain, new Guid("6a082a25-a8f2-4acd-a1a3-ba4461b729f1")) { SingularName = "Person", PluralName = "Persons" };
            var company = new Class(domain, new Guid("b1b6361e-5ee5-434c-9c92-46c6166195c4")) { SingularName = "Company", PluralName = "Companies" };

            // Inheritances
            new Inheritance(domain, new Guid("7ba9043d-2307-4d81-b56d-b1ddbd3070e4")) { Subtype = c1, Supertype = i1 };
            new Inheritance(domain, new Guid("941aa988-3890-420d-bd6a-515f2bc3a7f8")) { Subtype = c1, Supertype = i12 };
            new Inheritance(domain, new Guid("1fa71df5-71a2-49f9-98eb-813f3992c4d5")) { Subtype = c2, Supertype = i2 };
            new Inheritance(domain, new Guid("ad06478b-1756-46a4-a0a2-14f0f237eb4f")) { Subtype = c2, Supertype = i12 };
            new Inheritance(domain, new Guid("8007d524-40f1-4a2d-9299-6fd8d53692c1")) { Subtype = c2, Supertype = i23 };
            new Inheritance(domain, new Guid("44af67b9-26ae-43c1-ba80-3e8298e4bed8")) { Subtype = c3, Supertype = i3 };
            new Inheritance(domain, new Guid("71862815-beba-495c-9d30-47b5d248da34")) { Subtype = c3, Supertype = i23 };
            new Inheritance(domain, new Guid("f90bfd4b-d610-46ab-a02d-5f4f2590bbcb")) { Subtype = c3, Supertype = i34 };
            new Inheritance(domain, new Guid("51509eb9-02f4-494b-ab30-04acd4286b42")) { Subtype = c4, Supertype = i4 };
            new Inheritance(domain, new Guid("782b5d64-91f9-4e27-ad92-6a1f0a8c7e07")) { Subtype = c4, Supertype = i34 };
            new Inheritance(domain, new Guid("280e235b-f17a-4505-917e-e51647ca6928")) { Subtype = i1, Supertype = s1 };
            new Inheritance(domain, new Guid("a1c0ac5b-cffa-4a5d-8812-9383a3e1cadc")) { Subtype = i1, Supertype = s1234 };
            new Inheritance(domain, new Guid("c53f1f14-2a22-4b6d-8e3c-3c50c07e5299")) { Subtype = i2, Supertype = s2 };
            new Inheritance(domain, new Guid("10d59b2a-9b59-43e3-a63d-2a5dda8f2921")) { Subtype = i2, Supertype = s1234 };
            new Inheritance(domain, new Guid("c78ab091-6fd4-4ca1-a245-525f84bff02b")) { Subtype = i3, Supertype = s3 };
            new Inheritance(domain, new Guid("614c5332-4836-44fe-80c0-3196fcdbad51")) { Subtype = i3, Supertype = s1234 };
            new Inheritance(domain, new Guid("2dea90ce-fa75-45db-bba2-4713fafd061c")) { Subtype = i4, Supertype = s4 };
            new Inheritance(domain, new Guid("ecd3bb16-7221-440b-8ab5-01880fdd4dee")) { Subtype = i4, Supertype = s1234 };
            new Inheritance(domain, new Guid("cef6e9fb-c5a9-473a-a25e-23bc60115012")) { Subtype = i12, Supertype = s12 };
            new Inheritance(domain, new Guid("c54b5dd3-1228-4ad5-9dda-8827f2d93df0")) { Subtype = s1, Supertype = s1234 };

            new Inheritance(domain, new Guid("3fea8f15-6a9e-425b-9064-3efd9b7b809a")) { Subtype = person, Supertype = named };
            new Inheritance(domain, new Guid("a7b5f53e-1e73-48ff-a313-16c9ebc0609d")) { Subtype = company, Supertype = named };
