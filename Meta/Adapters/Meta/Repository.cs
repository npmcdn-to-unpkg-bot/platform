...
namespace Allors.Meta
{
    ...
    public static partial class Repository
    {
        private static void Adapters()
        {
            ...
            var c2 = new Class(adapters, new Guid("72c07e8a-03f5-4da8-ab37-236333d4f74e")) { SingularName = "C2", PluralName = "C2s" };
            var c3 = new Class(adapters, new Guid("2a9b5a77-6065-4f2a-bbc3-655426f0f97b")) { SingularName = "C3", PluralName = "C3s" };
            var c4 = new Class(adapters, new Guid("20049a79-20c7-478b-a5ba-c54b1e615168")) { SingularName = "C4", PluralName = "C4s" };
            var i1 = new Interface(adapters, new Guid("fefcf1b6-ac8f-47b0-bed5-939207a2833e")) { SingularName = "I1", PluralName = "I1s" };
            var i2 = new Interface(adapters, new Guid("19bb2bc3-d53a-4d15-86d0-b250fdbcb0a0")) { SingularName = "I2", PluralName = "I2s" };
            var i3 = new Interface(adapters, new Guid("2d86277f-3993-4831-a7de-3640166d3d50")) { SingularName = "I3", PluralName = "I3s" };
            var i4 = new Interface(adapters, new Guid("7a49be0e-cb91-4e1e-b113-ac67ec969935")) { SingularName = "I4", PluralName = "I4s" };
            var i12 = new Interface(adapters, new Guid("97755724-b934-4cc5-beb4-3d49a7a4b27e")) { SingularName = "I12", PluralName = "I12s" };
            var i23 = new Interface(adapters, new Guid("29cb9717-2452-4da0-9a29-8bd5d815307a")) { SingularName = "I23", PluralName = "I23s" };
            var i34 = new Interface(adapters, new Guid("ebc22540-54c8-4601-a43d-2ed6da9f3e79")) { SingularName = "I34", PluralName = "I34s" };
            var s1 = new Interface(adapters, new Guid("15c3bb71-075d-48ad-8a00-250c2f627092")) { SingularName = "S1", PluralName = "S1s" };
            var s2 = new Interface(adapters, new Guid("feeb7027-7c6c-4cb5-8718-93e6e8a4afd8")) { SingularName = "S2", PluralName = "S2s" };
            var s3 = new Interface(adapters, new Guid("5b24107d-f5e8-499b-94f7-2bf712493546")) { SingularName = "S3", PluralName = "S3s" };
            var s4 = new Interface(adapters, new Guid("5b348bcb-823d-4cbe-b3ac-a18b1cd96581")) { SingularName = "S4", PluralName = "S4s" };
            var s12 = new Interface(adapters, new Guid("c5747a64-f468-4d0d-80f3-6463bd32b0ca")) { SingularName = "S12", PluralName = "S12s" };
            var s1234 = new Interface(adapters, new Guid("c3c0ecf3-9f8d-4701-854f-8ddea1bd69fd")) { SingularName = "S1234", PluralName = "S1234s" };

            var interfaceWithoutConcreteClass = new Interface(adapters, new Guid("2f4bc713-47c9-4e07-9f2b-1d22a0cb4fad"))
                                                    {
                                                        SingularName = "InterfaceWithoutConcreteClass",
                                                        PluralName = "InterfacesWithoutConcreteClass",
                                                    };
            var classWithoutUnitRoles = new Class(adapters, new Guid("071d291d-fcc6-4511-8aa2-2d30fdeede8f"))
                                            {
                                                SingularName = "ClassWithoutUnitRoles",
                                                PluralName = "ClassesWithoutUnitRoles"
                                            };
            var classWithoutRoles = new Class(adapters, new Guid("e1008840-6d7c-4d44-b2ad-1545d23f90d8")) { SingularName = "ClassWithoutRoles", PluralName = "ClassesWithoutRoles" };
            var singleUnit = new Class(adapters, new Guid("c3e82ab0-f586-4913-acb0-838ffd6701f8")) { SingularName = "SingleUnit", PluralName = "SingleUnits" };

            var lt32 = new Class(adapters, new Guid("67c8d19f-1947-487c-8884-dbd76033aab0")) { SingularName = "LT32", PluralName = "LT32s" };
            var lt32UnitGT32Composite = new Class(adapters, new Guid("15ea889f-21d6-4682-aca2-c2987f592f0e"))
                                            {
                                                SingularName = "LT32UnitGT32Composite",
                                                PluralName = "LT32UnitGT32Composites"
                                            };
            var ilt32Composite = new Interface(adapters, new Guid("4f53e1e7-e88a-4161-969c-1fed0b3a24a2")) { SingularName = "ILT32Composite", PluralName = "ILT32Composites" };
            var ilt32Unit = new Interface(adapters, new Guid("228fa79f-afa7-418c-968e-8c0d38fb3ad2")) { SingularName = "ILT32Unit", PluralName = "ILT32Units" };
            var gt32 = new Class(adapters, new Guid("4f6301b3-6f0a-40c2-8267-4f8631bae706")) { SingularName = "GT32", PluralName = "GT32s" };
            var gt32UnitLT32Composite = new Class(adapters, new Guid("7683eb7f-cbac-4947-ac29-4ef15ae47597"))
                                            {
                                                SingularName = "GT32UnitLT32Composite",
                                                PluralName = "GT32UnitLT32Composites"
                                            };
            var igt32Unit = new Interface(adapters, new Guid("584681af-90f0-45b1-a80e-6a73c3592600")) { SingularName = "IGT32Unit", PluralName = "IGT32Units" };
            var igt32Composite = new Interface(adapters, new Guid("ee84609f-e165-4037-b8ce-f7c8b826e603")) { SingularName = "IGT32Composite", PluralName = "IGT32Composites" };

            var sandbox = new Class(adapters, new Guid("73970b0f-1ff4-4d39-aad8-fdbfbaae472f")) { SingularName = "Sandbox", PluralName = "Sandboxes" };
            var isandbox = new Interface(adapters, new Guid("7ba2ab26-491b-49eb-944c-26f6bb66e50f")) { SingularName = "ISandbox", PluralName = "ISandboxes" };

            var named = new Interface(adapters, new Guid("fcaa52e3-4a90-4981-b45d-d158e2589506")) { SingularName = "Named", PluralName = "Nameds" };
            var user = new Class(adapters, new Guid("0d6bc154-112b-4a58-aa96-3b2a96f82523")) { SingularName = "User", PluralName = "Users" };
            var person = new Class(adapters, new Guid("6a082a25-a8f2-4acd-a1a3-ba4461b729f1")) { SingularName = "Person", PluralName = "Persons" };
            var company = new Class(adapters, new Guid("b1b6361e-5ee5-434c-9c92-46c6166195c4")) { SingularName = "Company", PluralName = "Companies" };

            // Inheritances
            new Inheritance(adapters, new Guid("7ba9043d-2307-4d81-b56d-b1ddbd3070e4")) { Subtype = c1, Supertype = i1 };
            new Inheritance(adapters, new Guid("941aa988-3890-420d-bd6a-515f2bc3a7f8")) { Subtype = c1, Supertype = i12 };
            new Inheritance(adapters, new Guid("1fa71df5-71a2-49f9-98eb-813f3992c4d5")) { Subtype = c2, Supertype = i2 };
            new Inheritance(adapters, new Guid("ad06478b-1756-46a4-a0a2-14f0f237eb4f")) { Subtype = c2, Supertype = i12 };
            new Inheritance(adapters, new Guid("8007d524-40f1-4a2d-9299-6fd8d53692c1")) { Subtype = c2, Supertype = i23 };
            new Inheritance(adapters, new Guid("44af67b9-26ae-43c1-ba80-3e8298e4bed8")) { Subtype = c3, Supertype = i3 };
            new Inheritance(adapters, new Guid("71862815-beba-495c-9d30-47b5d248da34")) { Subtype = c3, Supertype = i23 };
            new Inheritance(adapters, new Guid("f90bfd4b-d610-46ab-a02d-5f4f2590bbcb")) { Subtype = c3, Supertype = i34 };
            new Inheritance(adapters, new Guid("51509eb9-02f4-494b-ab30-04acd4286b42")) { Subtype = c4, Supertype = i4 };
            new Inheritance(adapters, new Guid("782b5d64-91f9-4e27-ad92-6a1f0a8c7e07")) { Subtype = c4, Supertype = i34 };
            new Inheritance(adapters, new Guid("280e235b-f17a-4505-917e-e51647ca6928")) { Subtype = i1, Supertype = s1 };
            new Inheritance(adapters, new Guid("a1c0ac5b-cffa-4a5d-8812-9383a3e1cadc")) { Subtype = i1, Supertype = s1234 };
            new Inheritance(adapters, new Guid("c53f1f14-2a22-4b6d-8e3c-3c50c07e5299")) { Subtype = i2, Supertype = s2 };
            new Inheritance(adapters, new Guid("10d59b2a-9b59-43e3-a63d-2a5dda8f2921")) { Subtype = i2, Supertype = s1234 };
            new Inheritance(adapters, new Guid("c78ab091-6fd4-4ca1-a245-525f84bff02b")) { Subtype = i3, Supertype = s3 };
            new Inheritance(adapters, new Guid("614c5332-4836-44fe-80c0-3196fcdbad51")) { Subtype = i3, Supertype = s1234 };
            new Inheritance(adapters, new Guid("2dea90ce-fa75-45db-bba2-4713fafd061c")) { Subtype = i4, Supertype = s4 };
            new Inheritance(adapters, new Guid("ecd3bb16-7221-440b-8ab5-01880fdd4dee")) { Subtype = i4, Supertype = s1234 };
            new Inheritance(adapters, new Guid("cef6e9fb-c5a9-473a-a25e-23bc60115012")) { Subtype = i12, Supertype = s12 };
            new Inheritance(adapters, new Guid("c54b5dd3-1228-4ad5-9dda-8827f2d93df0")) { Subtype = s1, Supertype = s1234 };

            new Inheritance(adapters, new Guid("3fea8f15-6a9e-425b-9064-3efd9b7b809a")) { Subtype = person, Supertype = named };
            new Inheritance(adapters, new Guid("a7b5f53e-1e73-48ff-a313-16c9ebc0609d")) { Subtype = company, Supertype = named };
            ...
            new RelationType(
                ...
                new Guid("e77d108f-e8db-4e8c-89ae-574c7362a159")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s1234 
                                                                                        }, RoleType = {
            ...
            new RelationType(
                ...
                new Guid("f7e26d33-558d-4e5e-8b12-3116c110cf1f")) 
                {
            ...
            new RelationType(
                ...
                new Guid("1c1d8356-9240-4582-a3ab-a8a1a2553869")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i23 
                                                                                        }, RoleType = {
            ...
            new RelationType(
                ...
                new Guid("cb10aafe-0330-482c-8782-4c50fc56b00e")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s12 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsString, Size = 256 
            ...
            new RelationType(
                ...
                new Guid("54370233-2451-4ba1-bbd6-e573cc885b84")) {
                                                                      AssociationType = {
                                                                                            ObjectType = c2 
                                                                                        }, RoleType = {
            ...
            new RelationType(
                ...
                new Guid("cf993b81-671e-44f9-b7fc-96a4f0ac8522")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i12 
                                                                                        }, RoleType = {
            ...
            new RelationType(
                ...
                new Guid("8fedfe1b-10d0-4be8-ae87-177b77b8d36f")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s2 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsString, Size = 256 
            ...
            new RelationType(
                ...
                new Guid("a4da55d6-e7ac-4889-8479-0bd1a41c6817")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s2 
                                                                                        }, RoleType = {
            ...
            new RelationType(
                ...
                new Guid("73131747-7ce6-4801-a6ad-1a6f65b00ebe")) {
                                                                      AssociationType = {
                                                                                            ObjectType = c1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsString, Size = 256 
            ...
            new RelationType(
                ...
                new Guid("d42bc583-ec2c-4154-9697-132e96e38030")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i12 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsInteger 
            ...
            new RelationType(
                ...
                new Guid("f0ee9b2a-f757-40bf-a300-3d307cdfe671")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i3 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsString, Size = 256 
            ...
            new RelationType(
                ...
                new Guid("8aaedaa7-bea2-43cf-b0be-1401ef1b92d4")) {
                                                                      AssociationType = {
                                                                                            ObjectType = c2 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDouble 
            ...
            new RelationType(
                ...
                new Guid("ba8195d0-5c26-4402-97d7-54024f9f547c")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsString, Size = 256 
            ...
            new RelationType(
                ...
                new Guid("eeb24332-c825-4e1b-9d65-4e7f93062aae")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDecimal, Scale = 2, Precision = 19 
            ...
            new RelationType(
                ...
                new Guid("54eac29a-4aee-4fd2-b6e5-4f70e9d04c2f")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s1234 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDecimal, Scale = 2, Precision = 19 
            ...
            new RelationType(
                ...
                new Guid("d4003255-3083-428a-b2af-9456313cd765")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s12 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDateTime 
            ...
            new RelationType(
                ...
                new Guid("6131d63e-e7fa-4859-bbd0-be684f203a3e")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDateTime 
            ...
            new RelationType(
                ...
                new Guid("c39a79f1-3b54-45bb-ad24-3cec889691fc")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i2 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsBoolean 
            ...
            new RelationType(
                ...
                new Guid("d079cba2-c2af-4dc5-abf3-46abeb8b4928")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i34 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDecimal, Scale = 2, Precision = 19 
            ...
            new RelationType(
                ...
                new Guid("a2585517-50e0-4168-9158-12cdd466b14a")) {
                                                                      AssociationType = {
                                                                                            ObjectType = c2 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsLong 
            ...
            new RelationType(
                ...
                new Guid("15d1699c-3c37-4f75-8b91-6082288053ec")) {
                                                                      AssociationType = {
                                                                                            ObjectType = c2 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsInteger 
            ...
            new RelationType(
                ...
                new Guid("e7793a66-e307-420e-9fb6-6a057fcf8094")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s1234 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsInteger 
            ...
            new RelationType(
                ...
                new Guid("77f678c6-93ee-465a-b252-7e0530ed19ea")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i34 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsBoolean 
            ...
            new RelationType(
                ...
                new Guid("ee7dfee2-bc14-498e-b9e5-6d25bb5fafb1")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i12 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDouble 
            ...
            new RelationType(
                ...
                new Guid("592c39ed-47f8-4f42-8ab4-26279627c5d4")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsInteger 
            ...
            new RelationType(
                ...
                new Guid("c7cb9a8b-7df5-4677-902f-b6f4b9aec802")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i2 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDecimal, Scale = 2, Precision = 19 
            ...
            new RelationType(
                ...
                new Guid("e6b89bb6-dfd9-4605-afff-21f1360bc5cb")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s1 
                                                                                        }, RoleType = {
            ...
            new RelationType(
                ...
                new Guid("aaf7057e-faa9-43d6-8364-08e381155719")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsInteger 
            ...
            new RelationType(
                ...
                new Guid("261c56b2-6096-44dd-bf1d-4750ef29b9d6")) {
                                                                      AssociationType = {
                                                                                            ObjectType = c2 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsBoolean 
            ...
            new RelationType(
                ...
                new Guid("7121814d-81c8-4224-a77c-f873cae73b74")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s1 
                                                                                        }, RoleType = {
            ...
            new RelationType(
                ...
                new Guid("1ed86e48-fa9c-4590-ba1b-f2a6345ff572")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsBoolean 
            ...
            new RelationType(
                ...
                new Guid("0c610a6d-839f-4578-9ede-23afa29c3205")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDouble 
            ...
            new RelationType(
                ...
                new Guid("c5bc1216-fcfb-4e84-bd7c-5ad9f64de637")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsString, Size = 256 
            ...
            new RelationType(
                ...
                new Guid("9d0f4a5c-a8c7-41a7-9d92-0a9b4ff788ce")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s2 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDouble 
            ...
            new RelationType(
                ...
                new Guid("e234f895-42b2-42e4-a051-323534b1f23e")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsLong 
            ...
            new RelationType(
                ...
                new Guid("680be670-2b68-4a46-b34c-2056f9e0f31a")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i1 
                                                                                        }, RoleType = {
            ...
            new RelationType(
                ...
                new Guid("f4c841cb-821e-4e9c-ab2a-dc56aa3234ab")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i2 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDateTime 
            ...
            new RelationType(
                ...
                new Guid("5568fb11-4cda-4528-82e3-9ebc8d2c4d2c")) {
                                                                      AssociationType = {
                                                                                            ObjectType = c1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDecimal, Scale = 2, Precision = 10 
            ...
            new RelationType(
                ...
                new Guid("dd7ec053-d621-44c4-9975-18bcc487bda0")) {
                                                                      AssociationType = {
                                                                                            ObjectType = c1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsLong 
            ...
            new RelationType(
                ...
                new Guid("33f6448e-1aef-4fea-be23-aa1cb16c8908")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i12 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsLong 
            ...
            new RelationType(
                ...
                new Guid("850808bb-fac8-4a90-af6c-321e4722f92f")) {
                                                                      AssociationType = {
                                                                                            ObjectType = c1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsBinary, Size = -1 
            ...
            new RelationType(
                ...
                new Guid("bd759535-1681-455f-b140-2dcfea268b0a")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s2 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsBoolean 
            ...
            new RelationType(
                ...
                new Guid("e5b452ba-b29f-47f4-be48-029289e91345")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i34 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDouble 
            ...
            new RelationType(
                ...
                new Guid("757e03f2-be92-4af7-ba0b-fa0ce9f5bda2")) {
                                                                      AssociationType = {
                                                                                            ObjectType = c2 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsString, Size = 256 
            ...
            new RelationType(
                ...
                new Guid("f155d4f3-bcda-47a2-8be2-ba24ba6648e5")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s2 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDecimal, Scale = 2, Precision = 19 
            ...
            new RelationType(
                ...
                new Guid("6e74ef8d-d748-4142-8073-afbf5534c43f")) {
                                                                      AssociationType = {
                                                                                            ObjectType = c4 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsString, Size = 256 
            ...
            new RelationType(
                ...
                new Guid("15ba5c39-5269-4f61-b595-7b8b6fcefe9a")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i2 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsString, Size = 256 
            ...
            new RelationType(
                ...
                new Guid("5495d54b-111e-43a4-8fcf-0b3af218340c")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i12 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDecimal, Scale = 2, Precision = 19 
            ...
            new RelationType(
                ...
                new Guid("75f3149d-52c9-4aca-bee7-1d24a2a5751b")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsBoolean 
            ...
            new RelationType(
                ...
                new Guid("51f99d5f-bccf-4252-9475-dcf724e775d9")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s2 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDateTime 
            ...
            new RelationType(
                ...
                new Guid("e86db1ff-d072-42eb-9493-bc01984b7d8d")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s12 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsBoolean 
            ...
            new RelationType(
                ...
                new Guid("64d27877-edf1-4136-a810-19a5d5356110")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s12 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDouble 
            ...
            new RelationType(
                ...
                new Guid("8e0df573-0931-4bf0-a3bb-1cf88a530d98")) {
                                                                      AssociationType = {
            ...
            new RelationType(
                ...
                new Guid("fb2e5e27-790c-4a1e-bb31-1d2a80e9f785")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s1234 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsLong 
            ...
            new RelationType(
                ...
                new Guid("e7edc290-a280-40dc-acc6-a6b7ebbb09b0")) {
                                                                      AssociationType = {
            ...
            new RelationType(
                ...
                new Guid("1cb9182b-4cf7-4050-a4d2-4eea351712ab")) {
                                                                      AssociationType = {
                                                                                            ObjectType = c1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsBoolean 
            ...
            new RelationType(
                ...
                new Guid("a19db58e-703d-408a-92d1-f2b7191b0b61")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsBinary, Size = -1 
            ...
            new RelationType(
                ...
                new Guid("6a019bf8-39fa-4a20-98e7-616021add661")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s2 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsLong 
            ...
            new RelationType(
                ...
                new Guid("29672f22-7d09-4bca-b8a2-4170a8a8a8b1")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s1234 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDateTime 
            ...
            new RelationType(
                ...
                new Guid("48afb12e-a36e-43f1-b1f1-c8b4e36de8b8")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i12 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDateTime 
            ...
            new RelationType(
                ...
                new Guid("d11ad34e-9079-4005-b803-90511894d73f")) {
                                                                      AssociationType = {
                                                                                            ObjectType = sandbox 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsString, Size = 256 
            ...
            new RelationType(
                ...
                new Guid("0649567c-2942-4d6e-9fa5-3672f8eb77a3")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i34 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsInteger 
            ...
            new RelationType(
                ...
                new Guid("cde919c6-3192-4337-8b53-6cc03b364368")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDouble 
            ...
            new RelationType(
                ...
                new Guid("0443f179-b2dd-49da-9e15-d0b348aa2dd9")) {
                                                                      AssociationType = {
                                                                                            ObjectType = c2 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDateTime 
            ...
            new RelationType(
                ...
                new Guid("6ff183b3-1859-4489-b459-8bddc8f50c8c")) {
                                                                      AssociationType = {
                                                                                            ObjectType = c1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsUnique 
            ...
            new RelationType(
                ...
                new Guid("a4163284-3b87-46c0-9495-acf5e3240513")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s12 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsInteger 
            ...
            new RelationType(
                ...
                new Guid("6d96ffff-b781-43eb-9152-57caf15f09aa")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i2 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsLong 
            ...
            new RelationType(
                ...
                new Guid("25cb17ec-01e2-4658-a06b-2a620f152923")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i2 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsInteger 
            ...
            new RelationType(
                ...
                new Guid("ad8c99c8-7628-4f82-8188-287b2dbfbf42")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i34 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsString, Size = 256 
            ...
            new RelationType(
                ...
                new Guid("d2cfa173-6724-4b78-81e7-8dca0857819f")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsLong 
            ...
            new RelationType(
                ...
                new Guid("692c22ff-7c88-463b-9399-966ea41228a6")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i12 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsString, Size = 256 
            ...
            new RelationType(
                ...
                new Guid("919db239-03a7-488f-81fd-4930a41fa42b")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDateTime 
            ...
            new RelationType(
                ...
                new Guid("986c626f-1bcb-480c-9e2d-0da297340fc9")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s1234 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsString, Size = 256 
            ...
            new RelationType(
                ...
                new Guid("ace6cdc5-e66f-40dd-bd37-45db231cc9e8")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s1234 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsBoolean 
            ...
            new RelationType(
                ...
                new Guid("d6e19a7c-23a8-4450-a0b7-c882111fb087")) {
                                                                      AssociationType = {
                                                                                            ObjectType = c1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDateTime 
            ...
            new RelationType(
                ...
                new Guid("3492623a-7fe3-48ec-a95e-2690ced58f88")) {
                                                                      AssociationType = {
                                                                                            ObjectType = c1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDouble 
            ...
            new RelationType(
                ...
                new Guid("b6c919ad-97c9-4d08-a3ba-179d3c8a313c")) {
            ...
            new RelationType(
                ...
                new Guid("68937f6c-9561-49e8-abb3-24e0eeabfcb1")) {
                                                                      AssociationType = {
                                                                                            ObjectType = s12 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDecimal, Scale = 2, Precision = 19 
            ...
            new RelationType(
                ...
                new Guid("9570a106-ceab-41d1-bcb5-b073e2ad82cf")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i1 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsUnique 
            ...
            new RelationType(
                ...
                new Guid("81acc49f-16c9-4677-80f4-c3e768a7b9e3")) {
                                                                      AssociationType = {
                                                                                            ObjectType = i2 
                                                                                        }, RoleType = {
                                                                                                          ObjectType = allorsDouble 
