...
namespace Domain
{
    ...
    public static class M
    {
        ...
        static M()
        {
            ...
            ClassWithoutUnitRoles = new Class(part, new Guid("071d291d-fcc6-4511-8aa2-2d30fdeede8f"))
                                        {
                                            SingularName = "ClassWithoutUnitRoles",
                                            PluralName = "ClassesWithoutUnitRoles"
                                        };

            User = new Class(part, new Guid("0d6bc154-112b-4a58-aa96-3b2a96f82523")) { SingularName = "User", PluralName = "Users" };

            S1 = new Interface(part, new Guid("15c3bb71-075d-48ad-8a00-250c2f627092")) { SingularName = "S1", PluralName = "S1s" };

            LT32UnitGT32Composite = new Class(part, new Guid("15ea889f-21d6-4682-aca2-c2987f592f0e")) { SingularName = "LT32UnitGT32Composite", PluralName = "LT32UnitGT32Composites" };

            I2 = new Interface(part, new Guid("19bb2bc3-d53a-4d15-86d0-b250fdbcb0a0")) { SingularName = "I2", PluralName = "I2s" };

            C4 = new Class(part, new Guid("20049a79-20c7-478b-a5ba-c54b1e615168")) { SingularName = "C4", PluralName = "C4s" };

            ILT32Unit = new Interface(part, new Guid("228fa79f-afa7-418c-968e-8c0d38fb3ad2")) { SingularName = "ILT32Unit", PluralName = "ILT32Units"};

            I23 = new Interface(part, new Guid("29cb9717-2452-4da0-9a29-8bd5d815307a")) { SingularName = "I23", PluralName = "I23s" };

            C3 = new Class(part, new Guid("2a9b5a77-6065-4f2a-bbc3-655426f0f97b")) { SingularName = "C3", PluralName = "C3s" };

            I3 = new Interface(part, new Guid("2d86277f-3993-4831-a7de-3640166d3d50")) { SingularName = "I3", PluralName = "I3s" };

            InterfaceWithoutConcreteClass = new Interface(part, new Guid("2f4bc713-47c9-4e07-9f2b-1d22a0cb4fad"))
                                                {
                                                    SingularName = "InterfaceWithoutConcreteClass",
                                                    PluralName = "InterfacesWithoutConcreteClass",
                                                };

            ILT32Composite = new Interface(part, new Guid("4f53e1e7-e88a-4161-969c-1fed0b3a24a2"))
                                 {
                                     SingularName = "ILT32Composite",
                                     PluralName = "ILT32Composites",
                                 };

            GT32 = new Class(part, new Guid("4f6301b3-6f0a-40c2-8267-4f8631bae706")) { SingularName = "GT32", PluralName = "GT32s" };

            IGT32Unit = new Interface(part, new Guid("584681af-90f0-45b1-a80e-6a73c3592600")) { SingularName = "IGT32Unit", PluralName = "IGT32Units" };

            S3 = new Interface(part, new Guid("5b24107d-f5e8-499b-94f7-2bf712493546")) { SingularName = "S3", PluralName = "S3s" };

            S4 = new Interface(part, new Guid("5b348bcb-823d-4cbe-b3ac-a18b1cd96581")) { SingularName = "S4", PluralName = "S4s" };

            LT32 = new Class(part, new Guid("67c8d19f-1947-487c-8884-dbd76033aab0")) { SingularName = "LT32", PluralName = "LT32s" };

            Person = new Class(part, new Guid("6a082a25-a8f2-4acd-a1a3-ba4461b729f1")) { SingularName = "Person", PluralName = "Persons" };

            C1 = new Class(part, new Guid("7041c691-d896-4628-8f50-1c24f5d03414")) { SingularName = "C1", PluralName = "C1s" };

            C2 = new Class(part, new Guid("72c07e8a-03f5-4da8-ab37-236333d4f74e")) { SingularName = "C2", PluralName = "C2s" };

            Sandbox = new Class(part, new Guid("73970b0f-1ff4-4d39-aad8-fdbfbaae472f")) { SingularName = "Sandbox", PluralName = "Sandboxes" };

            GT32UnitLT32Composite = new Class(part, new Guid("7683eb7f-cbac-4947-ac29-4ef15ae47597")) { SingularName = "GT32UnitLT32Composite", PluralName = "GT32UnitLT32Composites" };

            I4 = new Interface(part, new Guid("7a49be0e-cb91-4e1e-b113-ac67ec969935")) { SingularName = "I4", PluralName = "I4s" };

            ISandbox = new Interface(part, new Guid("7ba2ab26-491b-49eb-944c-26f6bb66e50f")) { SingularName = "ISandbox", PluralName = "ISandboxes" };

            I12 = new Interface(part, new Guid("97755724-b934-4cc5-beb4-3d49a7a4b27e")) { SingularName = "I12", PluralName = "I12s" };

            Company = new Class(part, new Guid("b1b6361e-5ee5-434c-9c92-46c6166195c4")) { SingularName = "Company", PluralName = "Companies" };

            S1234 = new Interface(part, new Guid("c3c0ecf3-9f8d-4701-854f-8ddea1bd69fd")) { SingularName = "S1234", PluralName = "S1234s" };

            SingleUnit = new Class(part, new Guid("c3e82ab0-f586-4913-acb0-838ffd6701f8")) { SingularName = "SingleUnit", PluralName = "SingleUnits" };

            S12 = new Interface(part, new Guid("c5747a64-f468-4d0d-80f3-6463bd32b0ca")) { SingularName = "S12", PluralName = "S12s" };

            ClassWithoutRoles = new Class(part, new Guid("e1008840-6d7c-4d44-b2ad-1545d23f90d8")) { SingularName = "ClassWithoutRoles", PluralName = "ClassesWithoutRoles" };

            I34 = new Interface(part, new Guid("ebc22540-54c8-4601-a43d-2ed6da9f3e79")) { SingularName = "I34", PluralName = "I34s" };

            IGT32Composite = new Interface(part, new Guid("ee84609f-e165-4037-b8ce-f7c8b826e603"))
                                 {
                                     SingularName = "IGT32Composite",
                                     PluralName = "IGT32Composites",
                                 };

            Named = new Interface(part, new Guid("fcaa52e3-4a90-4981-b45d-d158e2589506")) { SingularName = "Named", PluralName = "Nameds" };

            S2 = new Interface(part, new Guid("feeb7027-7c6c-4cb5-8718-93e6e8a4afd8")) { SingularName = "S2", PluralName = "S2s" };

            I1 = new Interface(part, new Guid("fefcf1b6-ac8f-47b0-bed5-939207a2833e")) { SingularName = "I1", PluralName = "I1s" };

            new Inheritance(part, new Guid("10d59b2a-9b59-43e3-a63d-2a5dda8f2921")) { Subtype = I2, Supertype = S1234 };

            new Inheritance(part, new Guid("1fa71df5-71a2-49f9-98eb-813f3992c4d5")) { Subtype = C2, Supertype = I2 };

            new Inheritance(part, new Guid("280e235b-f17a-4505-917e-e51647ca6928")) { Subtype = I1, Supertype = S1 };

            new Inheritance(part, new Guid("2dea90ce-fa75-45db-bba2-4713fafd061c")) { Subtype = I4, Supertype = S4 };

            new Inheritance(part, new Guid("3fea8f15-6a9e-425b-9064-3efd9b7b809a")) { Subtype = Person, Supertype = Named };

            new Inheritance(part, new Guid("44af67b9-26ae-43c1-ba80-3e8298e4bed8")) { Subtype = C3, Supertype = I3 };

            new Inheritance(part, new Guid("51509eb9-02f4-494b-ab30-04acd4286b42")) { Subtype = C4, Supertype = I4 };

            new Inheritance(part, new Guid("614c5332-4836-44fe-80c0-3196fcdbad51")) { Subtype = I3, Supertype = S1234 };

            new Inheritance(part, new Guid("71862815-beba-495c-9d30-47b5d248da34")) { Subtype = C3, Supertype = I23 };

            new Inheritance(part, new Guid("782b5d64-91f9-4e27-ad92-6a1f0a8c7e07")) { Subtype = C4, Supertype = I34 };

            new Inheritance(part, new Guid("7ba9043d-2307-4d81-b56d-b1ddbd3070e4")) { Subtype = C1, Supertype = I1 };

            new Inheritance(part, new Guid("8007d524-40f1-4a2d-9299-6fd8d53692c1")) { Subtype = C2, Supertype = I23 };

            new Inheritance(part, new Guid("941aa988-3890-420d-bd6a-515f2bc3a7f8")) { Subtype = C1, Supertype = I12 };

            new Inheritance(part, new Guid("a1c0ac5b-cffa-4a5d-8812-9383a3e1cadc")) { Subtype = I1, Supertype = S1234 };

            new Inheritance(part, new Guid("a7b5f53e-1e73-48ff-a313-16c9ebc0609d")) { Subtype = Company, Supertype = Named };

            new Inheritance(part, new Guid("ad06478b-1756-46a4-a0a2-14f0f237eb4f")) { Subtype = C2, Supertype = I12 };

            new Inheritance(part, new Guid("c53f1f14-2a22-4b6d-8e3c-3c50c07e5299")) { Subtype = I2, Supertype = S2 };

            new Inheritance(part, new Guid("c54b5dd3-1228-4ad5-9dda-8827f2d93df0")) { Subtype = S1, Supertype = S1234 };

            new Inheritance(part, new Guid("c78ab091-6fd4-4ca1-a245-525f84bff02b")) { Subtype = I3, Supertype = S3 };

            new Inheritance(part, new Guid("cef6e9fb-c5a9-473a-a25e-23bc60115012")) { Subtype = I12, Supertype = S12 };

            new Inheritance(part, new Guid("ecd3bb16-7221-440b-8ab5-01880fdd4dee")) { Subtype = I4, Supertype = S1234 };

            new Inheritance(part, new Guid("f90bfd4b-d610-46ab-a02d-5f4f2590bbcb")) { Subtype = C3, Supertype = I34 };
