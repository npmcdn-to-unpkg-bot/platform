namespace Domain
{
	...
	public static class M
	{
		...
		public static readonly ObjectType AbstractClassWithoutConcreteClass;
		...
		public static readonly ObjectType AI34;
		public static readonly ObjectType A4;
		public static readonly ObjectType I3;
		public static readonly ObjectType InterfaceWithoutConcreteClass;
		public static readonly ObjectType A1;
		public static readonly ObjectType AI4;
		public static readonly ObjectType A2;
		public static readonly ObjectType A34;
		public static readonly ObjectType ILT32Composite;
		public static readonly ObjectType GT32;
		public static readonly ObjectType AS2;
		...
		public static readonly ObjectType A3;
		public static readonly ObjectType I12;
		public static readonly ObjectType AS3;
		public static readonly ObjectType AI1;
		...
		public static readonly ObjectType AI3;
		public static readonly ObjectType AI2;
		public static readonly ObjectType AS4;
		public static readonly ObjectType ClassWithoutRoles;
		public static readonly ObjectType AS1;
		...
		public static readonly RelationType AI1AllorsDouble;
		...
		public static readonly RelationType AI1AllorsString;
		public static readonly RelationType S2AllorsInteger;
		public static readonly RelationType UserSelect;
		public static readonly RelationType AI1AllorsBoolean;
		...
		public static readonly RelationType AI1AllorsDateTime;
		public static readonly RelationType AS1AllorsDouble;
		public static readonly RelationType AI1AllorsInteger;
		public static readonly RelationType A1AllorsInteger;
		...
		public static readonly RelationType A1AllorsDecimal;
		...
		public static readonly RelationType A3AllorsString;
		...
		public static readonly RelationType A1A2Many2Many;
		...
		public static readonly RelationType A34AllorsString;
		public static readonly RelationType I1I2many2many;
		public static readonly RelationType I34AllorsBoolean;
		public static readonly RelationType A1AllorsBoolean;
		...
		public static readonly RelationType AS1AllorsBoolean;
		...
		public static readonly RelationType A3C4many2many;
		...
		public static readonly RelationType AS1AllorsDecimal;
		...
		public static readonly RelationType A2AllorsString;
		...
		public static readonly RelationType A1AllorsLong;
		...
		public static readonly RelationType A1AllorsBinary;
		...
		public static readonly RelationType A1AllorsDateTime;
		...
		public static readonly RelationType A1A2One2One;
		...
		public static readonly RelationType A1AllorsDouble;
		...
		public static readonly RelationType AS1AllorsDateTime;
		...
		public static readonly RelationType A1AllorsString;
		...
		public static readonly RelationType A4AllorsString;
		public static readonly RelationType A1A2Many2One;
		...
		public static readonly RelationType A1AllorsUnique;
		...
		public static readonly RelationType A1A2One2Many;
		...
		public static readonly RelationType AbstractClassWithoutConcreteClassAllorsBoolean;
		...
		public static readonly RelationType AS1AllorsString;
  ...
  AbstractClassWithoutConcreteClass = D.AddDeclaredObjectType(new Guid("0a72cec5-002f-481b-9e84-c86ca7d5a737"));
  				AbstractClassWithoutConcreteClass.SingularName = "AbstractClassWithoutConcreteClass";
  				AbstractClassWithoutConcreteClass.PluralName = "AbstractClassesWithoutConcreteClass";
  				AbstractClassWithoutConcreteClass.IsAbstract = true;  
  ...
  AI34 = D.AddDeclaredObjectType(new Guid("2ad98592-075f-486c-9c10-852a36d9069e"));
  				AI34.SingularName = "AI34";
  				AI34.PluralName = "AI34s";
  
  				AI34.IsInterface = true;  A4 = D.AddDeclaredObjectType(new Guid("2c8e7fa1-aab6-40c4-a247-8236f0551ae3"));
  				A4.SingularName = "A4";
  				A4.PluralName = "A4s";
  				A4.IsAbstract = true;  
  I3 = D.AddDeclaredObjectType(new Guid("2d86277f-3993-4831-a7de-3640166d3d50"));
  				...
  				InterfaceWithoutConcreteClass.IsInterface = true;  A1 = D.AddDeclaredObjectType(new Guid("305b6231-355e-4af0-a101-9afda44c3e55"));
  				A1.SingularName = "A1";
  				A1.PluralName = "A1s";
  				A1.IsAbstract = true;  
  AI4 = D.AddDeclaredObjectType(new Guid("377b1a29-fb6b-4989-aa25-c28b4209f577"));
  				AI4.SingularName = "AI4";
  				AI4.PluralName = "AI4s";
  
  				AI4.IsInterface = true;  A2 = D.AddDeclaredObjectType(new Guid("460d0222-0a23-4610-853c-fddaa7fd2bee"));
  				A2.SingularName = "A2";
  				A2.PluralName = "A2s";
  				A2.IsAbstract = true;  
  A34 = D.AddDeclaredObjectType(new Guid("48955e6b-9664-40dc-8796-c8f9fe649f18"));
  				A34.SingularName = "A34";
  				A34.PluralName = "A34s";
  				A34.IsAbstract = true;  
  ILT32Composite = D.AddDeclaredObjectType(new Guid("4f53e1e7-e88a-4161-969c-1fed0b3a24a2"));
  ...
  AS2 = D.AddDeclaredObjectType(new Guid("51794eec-57d2-48f4-ad8a-ce403be4e79c"));
  				AS2.SingularName = "AS2";
  				AS2.PluralName = "AS2s";
  
  				AS2.IsInterface = true;  IGT32Unit = D.AddDeclaredObjectType(new Guid("584681af-90f0-45b1-a80e-6a73c3592600"));
  ...
  I4 = D.AddDeclaredObjectType(new Guid("7a49be0e-cb91-4e1e-b113-ac67ec969935"));
  				...
  				ISandbox.IsInterface = true;  A3 = D.AddDeclaredObjectType(new Guid("90e2e630-ce01-48ab-84d4-a93ea7a58e6a"));
  				A3.SingularName = "A3";
  				A3.PluralName = "A3s";
  				A3.IsAbstract = true;  
  I12 = D.AddDeclaredObjectType(new Guid("97755724-b934-4cc5-beb4-3d49a7a4b27e"));
  				I12.SingularName = "I12";
  				I12.PluralName = "I12s";
  
  				I12.IsInterface = true;  AS3 = D.AddDeclaredObjectType(new Guid("a3714e97-4f47-432f-9de6-e16209d99a16"));
  				AS3.SingularName = "AS3";
  				AS3.PluralName = "AS3s";
  
  				AS3.IsInterface = true;  AI1 = D.AddDeclaredObjectType(new Guid("b125c472-475f-4ecf-9390-8fe42df8cc27"));
  				AI1.SingularName = "AI1";
  				AI1.PluralName = "AI1s";
  
  				AI1.IsInterface = true;  Company = D.AddDeclaredObjectType(new Guid("b1b6361e-5ee5-434c-9c92-46c6166195c4"));
  ...
  S12 = D.AddDeclaredObjectType(new Guid("c5747a64-f468-4d0d-80f3-6463bd32b0ca"));
  				...
  				S12.IsInterface = true;  AI3 = D.AddDeclaredObjectType(new Guid("d12caf94-88e2-4f82-b911-13ff36b5e5cb"));
  				AI3.SingularName = "AI3";
  				AI3.PluralName = "AI3s";
  
  				AI3.IsInterface = true;  AI2 = D.AddDeclaredObjectType(new Guid("dd78b3a9-a5da-4149-9848-e21a9ce8f0fd"));
  				AI2.SingularName = "AI2";
  				AI2.PluralName = "AI2s";
  
  				AI2.IsInterface = true;  AS4 = D.AddDeclaredObjectType(new Guid("dd85a5d5-453c-4e0f-80f0-1c303ac3d35f"));
  				AS4.SingularName = "AS4";
  				AS4.PluralName = "AS4s";
  
  				AS4.IsInterface = true;  ClassWithoutRoles = D.AddDeclaredObjectType(new Guid("e1008840-6d7c-4d44-b2ad-1545d23f90d8"));
  				ClassWithoutRoles.SingularName = "ClassWithoutRoles";
  				ClassWithoutRoles.PluralName = "ClassesWithoutRoles";
  
  AS1 = D.AddDeclaredObjectType(new Guid("e189620f-8491-43e4-831a-a2b90ea23864"));
  				AS1.SingularName = "AS1";
  				AS1.PluralName = "AS1s";
  
  				AS1.IsInterface = true;  I34 = D.AddDeclaredObjectType(new Guid("ebc22540-54c8-4601-a43d-2ed6da9f3e79"));
				...
				var inheritance_07e2e957cf414daab45edca3c578ad8d = D.AddDeclaredInheritance(new Guid("07e2e957-cf41-4daa-b45e-dca3c578ad8d"));
				inheritance_07e2e957cf414daab45edca3c578ad8d.Subtype = C4;
				inheritance_07e2e957cf414daab45edca3c578ad8d.Supertype = A4;
				...
				var inheritance_19282faf049247659ec615948d58c6c9 = D.AddDeclaredInheritance(new Guid("19282faf-0492-4765-9ec6-15948d58c6c9"));
				inheritance_19282faf049247659ec615948d58c6c9.Subtype = A3;
				inheritance_19282faf049247659ec615948d58c6c9.Supertype = A34;
				...
				var inheritance_25d1744e15654c59907d517fd9e2978a = D.AddDeclaredInheritance(new Guid("25d1744e-1565-4c59-907d-517fd9e2978a"));
				inheritance_25d1744e15654c59907d517fd9e2978a.Subtype = AI4;
				inheritance_25d1744e15654c59907d517fd9e2978a.Supertype = AS4;
				...
				var inheritance_3bb5b5f9f0ed49dc9fe3d3c9e2de1e59 = D.AddDeclaredInheritance(new Guid("3bb5b5f9-f0ed-49dc-9fe3-d3c9e2de1e59"));
				inheritance_3bb5b5f9f0ed49dc9fe3d3c9e2de1e59.Subtype = AI2;
				inheritance_3bb5b5f9f0ed49dc9fe3d3c9e2de1e59.Supertype = AS2;
				...
				var inheritance_97ec7de6c94e4b90b1595acdefe24763 = D.AddDeclaredInheritance(new Guid("97ec7de6-c94e-4b90-b159-5acdefe24763"));
				inheritance_97ec7de6c94e4b90b1595acdefe24763.Subtype = A2;
				inheritance_97ec7de6c94e4b90b1595acdefe24763.Supertype = AI2;

				var inheritance_9afdcbde09a24e8d8b650f8b5ae1e15d = D.AddDeclaredInheritance(new Guid("9afdcbde-09a2-4e8d-8b65-0f8b5ae1e15d"));
				inheritance_9afdcbde09a24e8d8b650f8b5ae1e15d.Subtype = C3;
				inheritance_9afdcbde09a24e8d8b650f8b5ae1e15d.Supertype = A3;

				var inheritance_9e6135f8efd64a509a40806bc9dcac00 = D.AddDeclaredInheritance(new Guid("9e6135f8-efd6-4a50-9a40-806bc9dcac00"));
				inheritance_9e6135f8efd64a509a40806bc9dcac00.Subtype = A4;
				inheritance_9e6135f8efd64a509a40806bc9dcac00.Supertype = AI4;

				var inheritance_a095b3e8ca66450bbc1a087e6f5b87c9 = D.AddDeclaredInheritance(new Guid("a095b3e8-ca66-450b-bc1a-087e6f5b87c9"));
				inheritance_a095b3e8ca66450bbc1a087e6f5b87c9.Subtype = A4;
				inheritance_a095b3e8ca66450bbc1a087e6f5b87c9.Supertype = AI34;
				...
				var inheritance_a896d8e1588e4ebaa98c13c6e29309e8 = D.AddDeclaredInheritance(new Guid("a896d8e1-588e-4eba-a98c-13c6e29309e8"));
				inheritance_a896d8e1588e4ebaa98c13c6e29309e8.Subtype = AI3;
				inheritance_a896d8e1588e4ebaa98c13c6e29309e8.Supertype = AS3;

				var inheritance_a91097187e7f40ba882e214b0069dc08 = D.AddDeclaredInheritance(new Guid("a9109718-7e7f-40ba-882e-214b0069dc08"));
				inheritance_a91097187e7f40ba882e214b0069dc08.Subtype = A1;
				inheritance_a91097187e7f40ba882e214b0069dc08.Supertype = AI1;
				...
				var inheritance_baedae8d48544305a9921ab1641a75e5 = D.AddDeclaredInheritance(new Guid("baedae8d-4854-4305-a992-1ab1641a75e5"));
				inheritance_baedae8d48544305a9921ab1641a75e5.Subtype = A3;
				inheritance_baedae8d48544305a9921ab1641a75e5.Supertype = AI34;

				var inheritance_c34dd948744c4bb88868e59bacae1318 = D.AddDeclaredInheritance(new Guid("c34dd948-744c-4bb8-8868-e59bacae1318"));
				inheritance_c34dd948744c4bb88868e59bacae1318.Subtype = A3;
				inheritance_c34dd948744c4bb88868e59bacae1318.Supertype = AI3;
				...
				var inheritance_d72466227cb74fa6981078afb2b8e1bf = D.AddDeclaredInheritance(new Guid("d7246622-7cb7-4fa6-9810-78afb2b8e1bf"));
				inheritance_d72466227cb74fa6981078afb2b8e1bf.Subtype = C1;
				inheritance_d72466227cb74fa6981078afb2b8e1bf.Supertype = A1;

				var inheritance_e99481bfb3724f1982f9b482e6880bbe = D.AddDeclaredInheritance(new Guid("e99481bf-b372-4f19-82f9-b482e6880bbe"));
				inheritance_e99481bfb3724f1982f9b482e6880bbe.Subtype = AI1;
				inheritance_e99481bfb3724f1982f9b482e6880bbe.Supertype = AS1;
				...
				var inheritance_f0e9f814ee3a4dd2be7f4c3b8d3c0e45 = D.AddDeclaredInheritance(new Guid("f0e9f814-ee3a-4dd2-be7f-4c3b8d3c0e45"));
				inheritance_f0e9f814ee3a4dd2be7f4c3b8d3c0e45.Subtype = A4;
				inheritance_f0e9f814ee3a4dd2be7f4c3b8d3c0e45.Supertype = A34;

				var inheritance_f8a6ce23430240308a240f69e91561d5 = D.AddDeclaredInheritance(new Guid("f8a6ce23-4302-4030-8a24-0f69e91561d5"));
				inheritance_f8a6ce23430240308a240f69e91561d5.Subtype = C2;
				inheritance_f8a6ce23430240308a240f69e91561d5.Supertype = A2;
			...
			AI1AllorsDouble = D.AddDeclaredRelationType(new Guid("0c0fc765-fd59-49a6-9d7e-4e5c6c946f06"), new Guid("f080cc32-b375-421a-bdaa-c19bb8036bdc"), new Guid("9a27c2ae-2100-46b5-8a22-d75ac7437ff6"));
  
  
			AI1AllorsDouble.AssociationType.ObjectType = AI1;  
  
  
  
			AI1AllorsDouble.RoleType.ObjectType = AllorsDouble;  
			...
			AI1AllorsString = D.AddDeclaredRelationType(new Guid("1ef56f2e-38c6-4c18-8f30-ef37bd92c022"), new Guid("edf3ea18-0c43-4464-8575-f8938794b142"), new Guid("9d1dbfbc-3d30-4660-8e2a-ff014ee739c5"));
  
  
			AI1AllorsString.AssociationType.ObjectType = AI1;  
  
  
  
			AI1AllorsString.RoleType.ObjectType = AllorsString;  
  
  
			AI1AllorsString.RoleType.Size = 256;
			...
			AI1AllorsBoolean = D.AddDeclaredRelationType(new Guid("202eeed9-5d42-4139-b1a8-b600933c8dca"), new Guid("08327843-62bf-4440-8e3b-2fa8f962a7d4"), new Guid("831abf61-f0df-416a-b0d2-7879c09211a5"));
  
  
			AI1AllorsBoolean.AssociationType.ObjectType = AI1;  
  
  
  
			AI1AllorsBoolean.RoleType.ObjectType = AllorsBoolean;  
			...
			AI1AllorsDateTime = D.AddDeclaredRelationType(new Guid("22ed6ebd-7344-4e9f-b034-4332be69bff2"), new Guid("bb74e7da-610e-4850-8a28-c9ff3e000504"), new Guid("00aac84d-4971-4c7d-be13-31c5f17dcb4d"));
  
  
			AI1AllorsDateTime.AssociationType.ObjectType = AI1;  
  
  
  
			AI1AllorsDateTime.RoleType.ObjectType = AllorsDateTime;  
  
  

			AS1AllorsDouble = D.AddDeclaredRelationType(new Guid("2322ebb9-3a49-45bd-8212-f512cab1c082"), new Guid("31a79393-c079-451c-b736-cd643b7d0efe"), new Guid("2b4a0deb-0e0f-4861-9eb5-bc29d6cb486e"));
  
  
			AS1AllorsDouble.AssociationType.ObjectType = AS1;  
  
  
  
			AS1AllorsDouble.RoleType.ObjectType = AllorsDouble;  
  
  

			AI1AllorsInteger = D.AddDeclaredRelationType(new Guid("23a7f385-14e8-43ed-8455-a98d7ca8a4c4"), new Guid("8fb824cb-4a76-4a7f-8898-7a99f7632601"), new Guid("d1e4f973-4011-4540-8a60-223be8a1949a"));
  
  
			AI1AllorsInteger.AssociationType.ObjectType = AI1;  
  
  
  
			AI1AllorsInteger.RoleType.ObjectType = AllorsInteger;  
  
  

			A1AllorsInteger = D.AddDeclaredRelationType(new Guid("23cbeb00-8a6c-4dd8-8b89-a38110539bf5"), new Guid("35291e78-eadd-439e-97c5-aa6d2bf6adab"), new Guid("8902df1b-4c37-4b36-8742-b162d92406ad"));
  
  
			A1AllorsInteger.AssociationType.ObjectType = A1;  
  
  
  
			A1AllorsInteger.RoleType.ObjectType = AllorsInteger;  
			...
			A1AllorsDecimal = D.AddDeclaredRelationType(new Guid("2ac60fb1-e121-4581-b071-2a44fcef441f"), new Guid("6281ef47-28a2-4e57-b63f-1924f76c7eaf"), new Guid("4acb6174-ab06-4b15-be73-c9788c418ae6"));
  
  
			A1AllorsDecimal.AssociationType.ObjectType = A1;  
  
  
  
			A1AllorsDecimal.RoleType.ObjectType = AllorsDecimal;  
  
  
			A1AllorsDecimal.RoleType.Scale = 2;
			A1AllorsDecimal.RoleType.Precision = 19;
			...
			A3AllorsString = D.AddDeclaredRelationType(new Guid("3661e621-63d0-41b3-8e3d-57419b65004c"), new Guid("d85b3373-9863-41f3-821e-99ec00a0bf65"), new Guid("8b701b37-4572-4fd3-baf7-7098865c966e"));
  
  
			A3AllorsString.AssociationType.ObjectType = A3;  
  
  
  
			A3AllorsString.RoleType.ObjectType = AllorsString;  
  
  
			A3AllorsString.RoleType.Size = 256;
			...
			A1A2Many2Many = D.AddDeclaredRelationType(new Guid("39bb9b08-ff8c-4dd1-bf6a-87dde81998c5"), new Guid("01c1cf8f-088c-421d-a0aa-ecdab546d537"), new Guid("be0688d4-7668-47b9-ba38-6d59f40f3fba"));
  
  
			A1A2Many2Many.AssociationType.ObjectType = A1;  
  
  
			A1A2Many2Many.AssociationType.IsMany = true;  
			A1A2Many2Many.RoleType.ObjectType = A2;  
			A1A2Many2Many.RoleType.AssignedSingularName = "A2Many2Many";  
			A1A2Many2Many.RoleType.AssignedPluralName = "A2Many2Manies";  
			A1A2Many2Many.RoleType.IsMany = true;
			...
			A34AllorsString = D.AddDeclaredRelationType(new Guid("4a0acddf-3949-4223-8ea9-b23fb46054c3"), new Guid("3e88c3d8-e56b-4176-88ec-82ba5fdf5edb"), new Guid("6914efb8-6e2c-4c9f-bb3c-93dd8291eca8"));
  
  
			A34AllorsString.AssociationType.ObjectType = A34;  
  
  
  
			A34AllorsString.RoleType.ObjectType = AllorsString;  
  
  
			A34AllorsString.RoleType.Size = 256;
			...
			A1AllorsBoolean = D.AddDeclaredRelationType(new Guid("4b2d9f8b-091e-4d21-8bf7-afbc07730985"), new Guid("3d96dcd8-3a08-42bd-a12f-66bec7d31f51"), new Guid("c6fea75c-6efc-406e-b150-d36dfbcccd9f"));
  
  
			A1AllorsBoolean.AssociationType.ObjectType = A1;  
  
  
  
			A1AllorsBoolean.RoleType.ObjectType = AllorsBoolean;  
			...
			AS1AllorsBoolean = D.AddDeclaredRelationType(new Guid("545265eb-901f-4e2c-b2f7-4342bdc1d98e"), new Guid("7d6662d9-7b52-4b4f-891c-4c68230d33d2"), new Guid("5cf6aba1-8c28-4a84-bd25-6822777a88e1"));
  
  
			AS1AllorsBoolean.AssociationType.ObjectType = AS1;  
  
  
  
			AS1AllorsBoolean.RoleType.ObjectType = AllorsBoolean;  
			...
			A3C4many2many = D.AddDeclaredRelationType(new Guid("5e0bf3d5-2585-4945-b68e-8a66fe24695e"), new Guid("fb42104e-a6ee-4e40-8bcf-ad3e28638857"), new Guid("4987d935-b7a2-46c6-9d87-954f84be1a86"));
			A3C4many2many.IsIndexed = true;  
  
			A3C4many2many.AssociationType.ObjectType = A3;  
  
  
			A3C4many2many.AssociationType.IsMany = true;  
			A3C4many2many.RoleType.ObjectType = C4;  
			A3C4many2many.RoleType.AssignedSingularName = "C4many2many";  
			A3C4many2many.RoleType.AssignedPluralName = "C4many2manies";  
			A3C4many2many.RoleType.IsMany = true;
			...
			AS1AllorsDecimal = D.AddDeclaredRelationType(new Guid("636fa380-3826-430c-a5c7-85c831d29763"), new Guid("2afcedb8-2783-4d26-9cf3-71b21bb852fd"), new Guid("f5aa8ce3-9fdf-4697-92c3-2c763ab1b9f9"));
  
  
			AS1AllorsDecimal.AssociationType.ObjectType = AS1;  
  
  
  
			AS1AllorsDecimal.RoleType.ObjectType = AllorsDecimal;  
  
  
			AS1AllorsDecimal.RoleType.Scale = 2;
			AS1AllorsDecimal.RoleType.Precision = 19;
			...
			A2AllorsString = D.AddDeclaredRelationType(new Guid("74cc2ab0-19c4-48b4-890d-e14a2ff78765"), new Guid("4c3b6529-007b-4e90-95ce-fbc1d527cc2d"), new Guid("fe283f9b-dcb9-4351-baf1-7bfbe3bb0e2d"));
  
  
			A2AllorsString.AssociationType.ObjectType = A2;  
  
  
  
			A2AllorsString.RoleType.ObjectType = AllorsString;  
  
  
			A2AllorsString.RoleType.Size = 256;
			...
			A1AllorsLong = D.AddDeclaredRelationType(new Guid("9abcdafc-b7b0-4c5c-91c4-307e52f04158"), new Guid("86523f9c-d103-4dcf-a6df-91d531763e5c"), new Guid("5dfc2848-497f-4570-9e0e-4731aa8ed372"));
  
  
			A1AllorsLong.AssociationType.ObjectType = A1;  
  
  
  
			A1AllorsLong.RoleType.ObjectType = AllorsLong;  
			...
			A1AllorsBinary = D.AddDeclaredRelationType(new Guid("a5d88a76-dee5-4ee2-a9f5-d26f66bb8873"), new Guid("6fc17d9e-f4cf-4787-a635-117d2bba39a5"), new Guid("498000bf-ca0a-410c-a879-7d31e2851b5b"));
  
  
			A1AllorsBinary.AssociationType.ObjectType = A1;  
  
  
  
			A1AllorsBinary.RoleType.ObjectType = AllorsBinary;  
  
  
			A1AllorsBinary.RoleType.Size = -1;
			...
			A1AllorsDateTime = D.AddDeclaredRelationType(new Guid("aa84f116-fef2-4770-8635-3501648171e4"), new Guid("0375beff-b38b-4067-badc-c7b5cb4c60a9"), new Guid("ff155571-94d5-4215-9544-5071a3b4c71f"));
  
  
			A1AllorsDateTime.AssociationType.ObjectType = A1;  
  
  
  
			A1AllorsDateTime.RoleType.ObjectType = AllorsDateTime;  
			...
			A1A2One2One = D.AddDeclaredRelationType(new Guid("b9edde7c-979a-4902-9cc6-332182eaef3e"), new Guid("94076b49-0a6c-4dcd-a439-78e48d061377"), new Guid("68d28087-4e17-463d-b09a-1338f0b62d88"));
  
  
			A1A2One2One.AssociationType.ObjectType = A1;  
  
  
  
			A1A2One2One.RoleType.ObjectType = A2;  
			A1A2One2One.RoleType.AssignedSingularName = "A2One2One";  
			A1A2One2One.RoleType.AssignedPluralName = "A2One2Ones";  
			...
			A1AllorsDouble = D.AddDeclaredRelationType(new Guid("bfbe3b6d-972a-4095-83b8-429eab6867ac"), new Guid("60b813ad-cd08-414f-8c01-4f872ba9cc24"), new Guid("e5682c94-15f8-4629-a3c5-cd1bed986118"));
  
  
			A1AllorsDouble.AssociationType.ObjectType = A1;  
  
  
  
			A1AllorsDouble.RoleType.ObjectType = AllorsDouble;  
			...
			AS1AllorsDateTime = D.AddDeclaredRelationType(new Guid("c11929aa-0719-4577-85a0-1027b4943262"), new Guid("e24249af-78ea-4480-a62e-5eec8129aa23"), new Guid("1ebce217-55d3-4bf0-9573-62f259fe8c84"));
  
  
			AS1AllorsDateTime.AssociationType.ObjectType = AS1;  
  
  
  
			AS1AllorsDateTime.RoleType.ObjectType = AllorsDateTime;  
			...
			A1AllorsString = D.AddDeclaredRelationType(new Guid("c63bfe3b-3533-4753-8e21-9ac164db866b"), new Guid("f409c25a-f0e5-49a7-bf77-7752e4633c0e"), new Guid("30b554bb-5e50-463b-a9f2-b962d9e5c98d"));
  
  
			A1AllorsString.AssociationType.ObjectType = A1;  
  
  
  
			A1AllorsString.RoleType.ObjectType = AllorsString;  
  
  
			A1AllorsString.RoleType.Size = 256;
			...
			AI1AllorsDecimal = D.AddDeclaredRelationType(new Guid("c804a7a1-b973-47ef-b701-7861cf73fa7f"), new Guid("a2b82757-35ad-4e9d-87d6-90fc2b09c39b"), new Guid("3ac7fa7e-4113-4eda-9516-7fdd17ee3e44"));
  
  
			AI1AllorsDecimal.AssociationType.ObjectType = AI1;  
  
  
  
			AI1AllorsDecimal.RoleType.ObjectType = AllorsDecimal;  
  
  
			AI1AllorsDecimal.RoleType.Scale = 2;
			AI1AllorsDecimal.RoleType.Precision = 19;
			...
			C3A1 = D.AddDeclaredRelationType(new Guid("c8dd96b5-cb0b-4539-979f-f559c33c90ee"), new Guid("2fde3634-8a5b-4189-abd9-b778afb6abd2"), new Guid("19839f91-5da0-467a-8671-1814b86409c6"));
  
  
			C3A1.AssociationType.ObjectType = C3;  
  
  
			C3A1.AssociationType.IsMany = true;  
			C3A1.RoleType.ObjectType = A1;  
			...
			A4AllorsString = D.AddDeclaredRelationType(new Guid("cbf14f55-dc38-4cc1-9c7e-088234f7d285"), new Guid("b0b0632c-560a-4e16-8f30-ea10e96a4511"), new Guid("38769e61-4123-4dc3-866a-688843b1c937"));
  
  
			A4AllorsString.AssociationType.ObjectType = A4;  
  
  
  
			A4AllorsString.RoleType.ObjectType = AllorsString;  
  
  
			A4AllorsString.RoleType.Size = 256;

			A1A2Many2One = D.AddDeclaredRelationType(new Guid("cc0fe732-70e4-46ea-92b7-9cf218ae956c"), new Guid("606e77fc-e76f-4c32-beb1-a1472ef3eb35"), new Guid("f273d8be-04ba-4fe6-b2f9-65940dee6065"));
  
  
			A1A2Many2One.AssociationType.ObjectType = A1;  
  
  
			A1A2Many2One.AssociationType.IsMany = true;  
			A1A2Many2One.RoleType.ObjectType = A2;  
			A1A2Many2One.RoleType.AssignedSingularName = "A2Many2One";  
			A1A2Many2One.RoleType.AssignedPluralName = "A2Many2ones";  
			...
			A1AllorsUnique = D.AddDeclaredRelationType(new Guid("d01a993b-3003-4738-8c64-634e98ca0ad4"), new Guid("b056ec87-0784-4055-9fa1-cf4a1cd4c217"), new Guid("803fefaf-7283-47cf-aaab-e71d1e9e4aae"));
  
  
			A1AllorsUnique.AssociationType.ObjectType = A1;  
  
  
  
			A1AllorsUnique.RoleType.ObjectType = AllorsUnique;  
			...
			A1A2One2Many = D.AddDeclaredRelationType(new Guid("d69cd491-de29-4bae-aeb2-5254cb4f37d8"), new Guid("05866a61-9308-463a-983d-209eda3de2f8"), new Guid("7c68d6a2-a477-4dab-947e-54d1da1da4ba"));
  
  
			A1A2One2Many.AssociationType.ObjectType = A1;  
  
  
  
			A1A2One2Many.RoleType.ObjectType = A2;  
			A1A2One2Many.RoleType.AssignedSingularName = "A2One2Many";  
			A1A2One2Many.RoleType.AssignedPluralName = "A2One2Manies";  
			A1A2One2Many.RoleType.IsMany = true;
			...
			AbstractClassWithoutConcreteClassAllorsBoolean = D.AddDeclaredRelationType(new Guid("e21f9385-90a9-44f8-91d8-de67a8682bba"), new Guid("bed41b28-5dbb-41ba-b332-995bbdfb69bf"), new Guid("98201ce3-6ae7-40a8-a846-248e582f07c7"));
  
  
			AbstractClassWithoutConcreteClassAllorsBoolean.AssociationType.ObjectType = AbstractClassWithoutConcreteClass;  
  
  
  
			AbstractClassWithoutConcreteClassAllorsBoolean.RoleType.ObjectType = AllorsBoolean;  
			...
			AS1AllorsInteger = D.AddDeclaredRelationType(new Guid("e444a256-616a-4c49-b781-1871dfdd10a9"), new Guid("358cc1f6-a0f5-4a5d-8200-b7cc4194db1d"), new Guid("3273e561-37ad-49bf-a0a8-6c4d7f76064e"));
  
  
			AS1AllorsInteger.AssociationType.ObjectType = AS1;  
  
  
  
			AS1AllorsInteger.RoleType.ObjectType = AllorsInteger;  
			...
			C1A1 = D.AddDeclaredRelationType(new Guid("e590e01f-98ca-4575-94ba-3cff040f2b29"), new Guid("634dca4c-015d-429d-8920-1189e6c8a5c6"), new Guid("5f0c7628-93b7-4503-9f2e-6b11d530191f"));
  
  
			C1A1.AssociationType.ObjectType = C1;  
  
  
  
			C1A1.RoleType.ObjectType = A1;  
			...
			AS1AllorsString = D.AddDeclaredRelationType(new Guid("f984016c-209c-4230-93eb-b82d703b00ce"), new Guid("c24f51fd-3d81-4a96-923a-bd9a72e04a57"), new Guid("0597baa0-d804-40ff-9cba-1f89f03ae279"));
  
  
			AS1AllorsString.AssociationType.ObjectType = AS1;  
  
  
  
			AS1AllorsString.RoleType.ObjectType = AllorsString;  
  
  
			AS1AllorsString.RoleType.Size = 256;
