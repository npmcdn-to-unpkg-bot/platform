...
namespace Allors.Meta
{
    ...
    public static partial class Repository
    {
        public static Domain BaseTest(MetaPopulation meta)
        {
            ...
            // Base
            var @base = (Domain)meta.Find(new Guid("CA802192-8186-4C2A-8315-A8DEFAA74A12"));
            ...
            // Address
            new RelationTypeBuilder(domain, new Guid("36e7d935-a9c7-484d-8551-9bdc5bdeab68"), new Guid("113a8abd-e587-45a3-b118-92e60182c94b"), new Guid("4f7016f6-1b87-4ac4-8363-7f8210108928")).WithObjectTypes(address, place).WithSingularName("Place").WithPluralName("Places").WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("1f763206-c575-4e34-9e6b-997d434d3f42"), new Guid("923f6373-cbf8-46b1-9b4b-185015ff59ac"), new Guid("9edd1eb9-2b9a-4375-a669-68c1859eace2")).WithObjectTypes(i2, c1).WithSingularName("C1Many2One").WithPluralName("C1Many2Ones").WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("40b8edb3-e8c4-46c0-855b-4b18e0e8d7f3"), new Guid("078e1b17-f239-44b2-87d6-6350dd37ac1d"), new Guid("805d7871-bc51-4572-be01-e47ac8fef22a")).WithObjectTypes(i2, c1).WithSingularName("C1One2Many").WithPluralName("C1One2Manies").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("5ebbc734-23dd-494f-af2d-8e75caaa3e26"), new Guid("4d6c09d6-5644-47bb-a50a-464350053833"), new Guid("3aab87f3-2eab-4f81-9c1b-fd2e162a93b8")).WithObjectTypes(i2, i2).WithSingularName("I2Many2any").WithPluralName("I2Many2Manies").WithCardinality(Cardinalities.ManyToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("81d9eb2f-55a7-4d1c-853d-4369eb691ba5"), new Guid("db4d3b11-77bd-408e-ad41-4a03272a88e1"), new Guid("bdcffe2b-ffa7-4eb1-be24-8d8ab0b4dce2")).WithObjectTypes(i2, allorsDateTime).Build();
            new RelationTypeBuilder(domain, new Guid("83dc0581-e04a-4f51-a44e-4fef63d44356"), new Guid("b1c5cbb7-3d5f-48b8-b182-aa8a0cc3e72a"), new Guid("9598153e-9c1c-438a-a8a8-9822092a6a07")).WithObjectTypes(i2, i12).WithSingularName("I12One2Many").WithPluralName("I12One2Manies").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("92fdb313-0b90-48f6-b054-a4ab38f880ba"), new Guid("a45ffec8-5e4e-4b21-9d68-9b0050472ed2"), new Guid("17e159a2-f5a6-4828-9fef-796fcc9085e8")).WithObjectTypes(i2, c2).WithSingularName("C2Many2Many").WithPluralName("C2Many2Manies").WithCardinality(Cardinalities.ManyToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("9bed0518-1946-4e23-9d4b-e4cda439984c"), new Guid("7b4a8937-258c-4129-a282-89d5ab924d68"), new Guid("2e78a543-949f-4130-b659-80a9a60ad6ab")).WithObjectTypes(i2, i1).WithSingularName("I1Many2Many").WithPluralName("I1Many2Manies").WithCardinality(Cardinalities.ManyToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("9f361b97-0b04-496d-ac60-718760c2a4e2"), new Guid("c51f6fd4-c290-41b6-b594-19e9bcbbee6a"), new Guid("f60f8fa4-4e73-472d-b0b0-67f202c1e969")).WithObjectTypes(i2, c2).WithSingularName("C2Many2One").WithPluralName("C2Many2Ones").WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("b39fdd23-d7dd-473f-9705-df2f29be5ffe"), new Guid("8ddc9cbf-8e5c-4166-a2b0-6127c142da78"), new Guid("7cdd2b76-6c35-4e81-a1da-f5d0a300014b")).WithObjectTypes(i2, c2).WithSingularName("C2One2Many").WithPluralName("C2One2Manies").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("b6d44d67-3a51-482c-88d1-a4917ca2a065"), new Guid("3d3ba4c1-ef61-4ee4-9b80-64ba6a3ce85c"), new Guid("7cc0404f-f972-4027-bf9e-84bb0088b4f4")).WithObjectTypes(i2, allorsDateTime).Build();
            new RelationTypeBuilder(domain, new Guid("bbb01166-2671-4ca1-8b1e-12e6ae8aeb03"), new Guid("ee0766c7-0ef6-4ca0-b4a1-c399bc8df823"), new Guid("d8f011c4-3057-4384-9045-9c34b13db5c3")).WithObjectTypes(i2, i1).WithSingularName("I1One2Many").WithPluralName("I1One2Manies").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("cb9f21e0-a841-45de-8ba4-991b4ceca616"), new Guid("1127ff1b-1657-4e18-bdc9-bc90cd8a3c15"), new Guid("d838e921-ff63-4e4f-afd8-42dc29d23555")).WithObjectTypes(i2, i12).WithSingularName("I12Many2Many").WithPluralName("I12Many2Manies").WithCardinality(Cardinalities.ManyToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("d0c49b92-a108-48b5-bc95-72d2e6109ad2"), new Guid("418c17a6-b740-4170-be3b-01fea56a7988"), new Guid("2f357d51-6053-4cf7-9646-12ed4226fffb")).WithObjectTypes(i2, allorsLong).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("deb9cbd3-386f-4599-802c-be50945b9f1d"), new Guid("3fcc8e73-5f3c-4ce0-8f45-daa813278d7e"), new Guid("c7d68f0d-24b1-40c9-9431-78763b776bee")).WithObjectTypes(i2, i2).WithSingularName("I2One2Many").WithPluralName("I2One2Manies").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("f364c9fe-ad36-4305-80fd-4921451c70a5"), new Guid("db6935b0-684c-48ce-97d0-6b7183a73adb"), new Guid("6ed084f6-8809-46d9-a3ec-4b086ddafb0a")).WithObjectTypes(i2, c1).WithSingularName("C1Many2Many").WithPluralName("C1Many2Manies").WithCardinality(Cardinalities.ManyToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("fbad33e7-ede1-41fc-97e9-ddf33a0f6459"), new Guid("c138d77b-e8bf-4945-962e-f74e338caad4"), new Guid("12ea1f33-0eed-4476-9cab-1fd62ed146a3")).WithObjectTypes(i2, allorsDouble).Build();
            ...
            // Place
            new RelationTypeBuilder(domain, new Guid("1bf1cc1e-75bf-4a3f-87bd-a2fae2697855"), new Guid("dce03fde-fbb1-45e7-b78d-9484fa6487ff"), new Guid("d88eaaa2-2622-48ef-960a-1b506d95f238")).WithObjectTypes(place, country).WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("7046c2b4-d458-4343-8446-d23d9c837c84"), new Guid("0671f523-a557-41e1-9d05-0e89d8d1ae2d"), new Guid("c84a6696-a1e9-4794-86c3-50e1f009c845")).WithObjectTypes(organisation, allorsDateTime).WithSingularName("IncorporationDate").WithPluralName("IncorporationDates").Build();
            new RelationTypeBuilder(domain, new Guid("73f23588-1444-416d-b43c-b3384ca87bfc"), new Guid("d1a098bf-a3d8-4b71-948f-a77ae82f02db"), new Guid("a365f0ee-a94f-4435-a7b1-c92ac804a845")).WithObjectTypes(organisation, address).WithSingularName("Address").WithPluralName("Addresses").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("b201d2a0-2335-47a1-aa8d-8416e89a9fec"), new Guid("e332003a-0287-4aab-9d95-257146ee4f1c"), new Guid("b1f5b479-e4d0-46de-8ad4-347076d9f180")).WithObjectTypes(organisation, media).WithSingularName("Logo").WithPluralName("Logos").WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
            ...
            // Unit
            new RelationTypeBuilder(domain, new Guid("09bfade2-1739-4a7b-80ec-982fe43428ce"), new Guid("519b3064-54df-45c2-9b6a-cec8f0245f7d"), new Guid("92795240-3cb6-4ae7-854a-869cfa52e9c6")).WithObjectTypes(unit, allorsLong).Build();
            new RelationTypeBuilder(domain, new Guid("0cbfa00c-e3e1-4dca-ad75-cd5c57a0df9f"), new Guid("4b9e7a79-4d7e-4029-8e58-d366f606b76f"), new Guid("80be7509-2fee-45b6-8359-553387d008f4")).WithObjectTypes(unit, allorsDateTime).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("4d6a80f5-0fa7-4867-91f8-37aa92b6707b"), new Guid("13f88cf7-aaec-48a1-a896-401df84da34b"), new Guid("a462ce40-5885-48c6-b327-7e4c096a99fa")).WithObjectTypes(unit, allorsDateTime).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("74a35820-ef8c-4373-9447-6215ee8279c0"), new Guid("e5f7a565-372a-42ed-8da5-ffe6dd599f70"), new Guid("4a95fb0d-6849-499e-a140-6c942fb06f4d")).WithObjectTypes(unit, allorsDouble).Build();
            ...
            // Shared
            // One
            new RelationTypeBuilder(domain, new Guid("448878af-c992-4256-baa7-239335a26bc6"), new Guid("2c9236ed-892e-4005-9730-5a14f03f71e1"), new Guid("355b2e85-e597-4f88-9dca-45cbfbde527f")).WithObjectTypes(one, two).WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();

            // From
            new RelationTypeBuilder(domain, new Guid("d9a9896d-e175-410a-9916-9261d83aa229"), new Guid("a963f593-cad0-4fa9-96a3-3853f0f7d7c6"), new Guid("775a29b8-6e21-4545-9881-d52f6eb7db8b")).WithObjectTypes(@from, to).WithSingularName("To").WithPluralName("Tos").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("37f696e4-88f1-4953-8d1b-000263cbf1ae"), new Guid("bd8333bc-c0b7-40c0-9527-212310aa1765"), new Guid("3ab8cd65-3e98-4ffe-b71f-5d9f2d1ea63a")).WithObjectTypes(c1, allorsDateTime).Build();
            new RelationTypeBuilder(domain, new Guid("5490dc63-a8f6-4a86-91ef-fef97a86f119"), new Guid("3f307d57-1f39-4aba-822d-9881cef7223c"), new Guid("66a06e06-95e4-43ad-9b45-56687f8a2051")).WithObjectTypes(c1, c2).WithSingularName("C2Many2One").WithPluralName("C2Many2Ones").WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("815878f6-16f2-42f2-9b24-f394ddf789c2"), new Guid("eca51eab-3815-410f-b4c5-f7e2a1318791"), new Guid("39f62f9e-52d3-47c5-8fd4-44e91d9b78be")).WithObjectTypes(c1, i1).WithSingularName("I1Many2Many").WithPluralName("I1Many2Manies").WithCardinality(Cardinalities.ManyToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("82f5fb26-c260-41bc-a784-a2d5e35243bd"), new Guid("f5329d84-1301-44ea-85b4-dc7d98554694"), new Guid("ca30ba2a-627f-43d1-b467-fe0d7cd015cc")).WithObjectTypes(c1, i2).WithSingularName("I2One2Many").WithPluralName("I2One2Manies").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("8c198447-e943-4f5a-b749-9534b181c664"), new Guid("154222cb-0eb8-459d-839c-9c8857bd1c7e"), new Guid("c403f160-6486-4207-b32c-aa9ade27a28c")).WithObjectTypes(c1, c1).WithSingularName("C1Many2Many").WithPluralName("C1Many2Manies").WithCardinality(Cardinalities.ManyToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("91e8b23b-48fb-4d20-8a71-89c5630f1c78"), new Guid("8c8cfed1-7634-472a-9055-a33e62af9cfa"), new Guid("a7145647-45b2-458c-b2c9-7e20eb43e35e")).WithObjectTypes(c1, allorsLong).Build();
            new RelationTypeBuilder(domain, new Guid("94a2b37d-9431-4496-b992-630cda5b9851"), new Guid("a4a31323-7193-4709-828e-88b2c0f3f8aa"), new Guid("f225d708-c98f-44ff-9ed8-847cb1ddaacb")).WithObjectTypes(c1, i12).WithSingularName("I12Many2Many").WithPluralName("I12Many2Manies").WithCardinality(Cardinalities.ManyToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("9f6538c2-e6dd-4c27-80ed-2748f645cb95"), new Guid("3ddac067-46f1-4302-bb1b-aa0e05dd55ae"), new Guid("c749e58c-0f1d-4946-b35d-878221aac72f")).WithObjectTypes(c1, c2).WithSingularName("C2One2Many").WithPluralName("C2One2Manies").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("a0ac5a65-2cbd-4c51-9417-b10150bc5699"), new Guid("d595765b-5e67-46f2-b19c-c58563dd1ae0"), new Guid("3d121ffa-0ff5-4627-9ec3-879c2830ff04")).WithObjectTypes(c1, c1).WithSingularName("C1One2Many").WithPluralName("C1One2Manies").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("a8e18ea7-cbf2-4ea7-ae14-9f4bcfdb55de"), new Guid("8a546f48-fc09-48ae-997d-4a6de0cd458a"), new Guid("e6b21250-194b-4424-8b92-221c6d0e6228")).WithObjectTypes(c1, c1).WithSingularName("C1Many2One").WithPluralName("C1Many2Ones").WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("e0656d9a-75a6-4e59-aaa1-3ff03d440059"), new Guid("637c5967-fb6c-45d4-81c4-de5559df785f"), new Guid("89e4802f-7c61-4deb-a243-f78e79578082")).WithObjectTypes(c1, i1).WithSingularName("I1One2Many").WithPluralName("I1One2Manies").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("ef75cc4e-8787-4f1c-ae5c-73577d721467"), new Guid("8c8baa81-0c59-485c-b416-c7e6ec972595"), new Guid("610129f7-0c35-4649-9f4b-14698d0d1c77")).WithObjectTypes(c1, allorsDateTime).Build();
            new RelationTypeBuilder(domain, new Guid("f268783d-42ed-41c1-b0b0-b8a60e30a601"), new Guid("6ed0694c-a74f-44c3-835b-897f56343576"), new Guid("459d20d8-dadd-44e1-aa8a-396e6eab7538")).WithObjectTypes(c1, allorsDouble).Build();
            new RelationTypeBuilder(domain, new Guid("f29d4a52-9ba5-40f6-ba99-050cbd03e554"), new Guid("122dc72f-cc92-440c-84e5-fe8340020c43"), new Guid("608db13d-1778-44a8-94f0-b86fc0f6992d")).WithObjectTypes(c1, c2).WithSingularName("C2Many2Many").WithPluralName("C2Many2Manies").WithCardinality(Cardinalities.ManyToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("12896fc2-c9e9-4a89-b875-0aeb92e298e5"), new Guid("781b282e-b86f-4747-9d5e-d0f7c08b0899"), new Guid("f41ddb05-4a96-40fa-859b-8b3d6dfcd86b")).WithObjectTypes(c2, c2).WithSingularName("C2Many2One").WithPluralName("C2Many2Ones").WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("1afae917-7f62-4472-8a9c-22113b1af77f"), new Guid("edd17364-a075-49c6-ac29-841e8251f023"), new Guid("cf84a018-03c1-4f3e-b782-0b84a107d760")).WithObjectTypes(c2, allorsDateTime).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("1d98eda7-6dba-43f1-a5ce-44f7ed104cf9"), new Guid("cae17f3c-a605-4dce-b38d-01c23eea29df"), new Guid("d3e84546-02fc-40be-b550-dbd54cd8a139")).WithObjectTypes(c2, i1).WithSingularName("I1Many2Many").WithPluralName("I1Many2Manies").WithCardinality(Cardinalities.ManyToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("262ad367-a52c-4d8b-94e2-b477bb098423"), new Guid("31be0ad7-0886-406a-a69f-7e38b4526199"), new Guid("c52984df-80f8-4622-84e0-0e9f97cfaff3")).WithObjectTypes(c2, allorsDouble).Build();
            new RelationTypeBuilder(domain, new Guid("2ac55066-c748-4f90-9d0f-1090fe02cc76"), new Guid("02a5ac2c-d0ac-482d-abee-117ed7eaa5ba"), new Guid("28f373c6-62b6-4f5c-b794-c10138043a63")).WithObjectTypes(c2, i1).WithSingularName("I1One2Many").WithPluralName("I1One2Manies").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("41cd7805-0f93-460f-8572-9c479f3db206"), new Guid("5cfc7f5e-48d7-4215-be18-2dfc0b1bc641"), new Guid("a6a15ccc-5db3-43a7-ba94-cb305f503feb")).WithObjectTypes(c2, allorsLong).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("50300577-b5fb-4c16-9ac5-41151543f958"), new Guid("1f16f92e-ba99-4553-bd1d-b95ba360468a"), new Guid("6210478c-86e3-4d8c-8e3c-3b29da3175ca")).WithObjectTypes(c2, i12).WithSingularName("I12Many2Many").WithPluralName("I12Many2Manies").WithCardinality(Cardinalities.ManyToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("60680366-4790-4443-a941-b30cd4bd3848"), new Guid("8fa68cfd-8e0c-40c6-881b-4ebe88487ae7"), new Guid("bfa632a3-f334-4c92-a1b1-21cfa726ab90")).WithObjectTypes(c2, c2).WithSingularName("C2One2Many").WithPluralName("C2One2Manies").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("7a9129c9-7b6d-4bdd-a630-cfd1392549b7"), new Guid("87f7a34c-476f-4670-a670-30451c05842d"), new Guid("19f3caa1-c8d1-4257-b4ad-2f8ccb809524")).WithObjectTypes(c2, i2).WithSingularName("I2One2Many").WithPluralName("I2One2Manies").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("a5315151-aa0f-42a3-9d5b-2c7f2cb92560"), new Guid("f2bf51b6-0375-4d77-8881-d4d313d682ef"), new Guid("54dce296-9454-440e-9cf3-1327ea439f0e")).WithObjectTypes(c2, c1).WithSingularName("C1Many2One").WithPluralName("C1Many2Ones").WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("bc6c7fe0-6501-428c-a929-da87a9f4b885"), new Guid("794d2637-293c-49cc-a052-246a779825e9"), new Guid("73d243be-d8d0-42c7-b354-fd9786b4eaaa")).WithObjectTypes(c2, c2).WithSingularName("C2Many2Many").WithPluralName("C2Many2Manies").WithCardinality(Cardinalities.ManyToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("ce23482d-3a22-4202-98e7-5934fd9abd2d"), new Guid("6d752249-af37-4f22-9e59-bfae9e6537ee"), new Guid("6e9490f2-740f-498c-9c0f-d601c76f28ad")).WithObjectTypes(c2, allorsDateTime).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("f748949e-de5a-4f2e-85e2-e15516d9bf24"), new Guid("92c02837-9e6c-45ad-8772-b97a17afad8c"), new Guid("2c172bc6-a87b-4945-b02f-e00a38eb866d")).WithObjectTypes(c2, c1).WithSingularName("C1One2Many").WithPluralName("C1One2Manies").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            ...
            // Two
            new RelationTypeBuilder(domain, new Guid("8930c13c-ad5a-4b0e-b3bf-d7cdf6f5b867"), new Guid("fd97db6d-d946-47ba-a2a0-88b732457b96"), new Guid("39eda296-4e8d-492b-b0c1-756ffcf9a493")).WithObjectTypes(two, shared).WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("1611cb5d-4676-4e85-bfc5-5572e8ff1138"), new Guid("4af20cc8-a610-4493-9420-7cd110cc6755"), new Guid("5f2eff86-71bf-480d-a6ad-1c93fc68b08d")).WithObjectTypes(i12, allorsDouble).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("1bf2abe0-9273-4fb9-b491-020320f1f8db"), new Guid("732fc964-194e-4ece-bd39-bb3c47b83ff9"), new Guid("b311c57d-9565-48c1-80d8-1d3cf5a498ea")).WithObjectTypes(i12, i12).WithSingularName("I12Many2Many").WithPluralName("I12Many2Manies").WithCardinality(Cardinalities.ManyToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("51ebb024-c847-4165-b216-b3b6e8883961"), new Guid("04bca123-7c45-43f4-a5ed-8691b0cbb0e3"), new Guid("f5928b47-5a57-4be8-a0a9-a729e8e467bb")).WithObjectTypes(i12, c2).WithSingularName("C2Many2Many").WithPluralName("C2Many2Manies").WithCardinality(Cardinalities.ManyToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("59ae05e3-573c-4ea4-9181-2c545236ed1e"), new Guid("064f5e1b-b5c8-45ee-baf1-094f6a723ede"), new Guid("397b339e-0277-4700-a5d1-d9d0ac23c362")).WithObjectTypes(i12, i1).WithSingularName("I1Many2Many").WithPluralName("I1Many2Manies").WithCardinality(Cardinalities.ManyToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("7827af95-147f-4803-865a-b418d567da68"), new Guid("7e707f89-6dd2-44a4-8f85-e00666af4d00"), new Guid("a4c1f678-a3ae-4707-81e9-b3f3411a5d93")).WithObjectTypes(i12, c1).WithSingularName("C1Many2Many").WithPluralName("C1Many2Manies").WithCardinality(Cardinalities.ManyToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("95c77a0f-7f4c-4142-a93f-f688cfd554af"), new Guid("870af1ab-075f-4e19-a283-6e6875d362bb"), new Guid("29f38fb4-8e6a-4f70-9ee9-f6819b9d759e")).WithObjectTypes(i12, i1).WithSingularName("I1One2Many").WithPluralName("I1One2Manies").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("9bcbb810-fe3e-4829-8b1c-40219d16b60b"), new Guid("048c6629-9bb0-4e19-b1bb-1ebbb7c4c4ae"), new Guid("e041bbb5-4fb0-449f-9bc1-922b8df2b45d")).WithObjectTypes(i12, allorsLong).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("b2f568a1-51ba-4b6b-a1f1-b82bdec382b5"), new Guid("6f37656a-21d0-4574-8eac-5342f7c6850d"), new Guid("09a2a7a1-4713-4c5c-828d-8be40f33d1ae")).WithObjectTypes(i12, i2).WithSingularName("I2One2Many").WithPluralName("I2One2Manies").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("c018face-b292-455c-a2c0-8f71377fb6cb"), new Guid("3239eb17-dc55-465f-854c-1d2d024bca94"), new Guid("2ff52878-3ade-4afe-9961-8f79336bb0a2")).WithObjectTypes(i12, c2).WithSingularName("C2Many2One").WithPluralName("C2Many2Ones").WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("ed4811bc-c1fc-453b-967f-bd5b6cb6f83f"), new Guid("55437bb6-719d-4884-92e9-c1cf58aeb231"), new Guid("75495ad4-ad58-4349-9558-94261284125d")).WithObjectTypes(i12, allorsDateTime).Build();
            new RelationTypeBuilder(domain, new Guid("f302dd07-1abc-409e-aa71-ec9f7ac439aa"), new Guid("99b3bf26-3437-4b5b-a786-28c095975a48"), new Guid("ee291df6-6a3e-4d92-a779-879679e1b688")).WithObjectTypes(i12, c1).WithSingularName("C1One2Many").WithPluralName("C1One2Manies").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("f6436bc9-e307-4001-8f1f-5b37553ab3c6"), new Guid("63297178-60c1-4cbc-a68d-2842385ba266"), new Guid("6e5b98b0-1af3-4e99-8781-37ea97792a24")).WithObjectTypes(i12, c1).WithSingularName("C1Many2One").WithPluralName("C1Many2Ones").WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("fa6656dc-3a7a-4701-bc6b-3cd06aaa4483"), new Guid("6e4d05f3-52e3-4937-b8d2-8d9d52e7c8bf"), new Guid("823e8329-0a90-49ed-9b2c-4bfb9db2ee02")).WithObjectTypes(i12, allorsDateTime).Build();

            // BadUI
            new RelationTypeBuilder(domain, new Guid("8a999086-ca90-40a1-90ae-475d231bb1eb"), new Guid("0ce20e7c-7be0-4c07-a179-e8d0e77f3de1"), new Guid("4ab20876-f8fc-4d39-87d7-8758f044587b")).WithObjectTypes(badUi, person).WithSingularName("PersonMany").WithPluralName("PersonsMany").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("9ebbb9d1-2ca7-4a7f-9f18-f25c05fd28c1"), new Guid("37c64e26-a391-4c7b-98fb-53ccb5fbc795"), new Guid("4d2c7c20-b9c7-451b-b6b1-8552322ceddd")).WithObjectTypes(badUi, organisation).WithSingularName("CompanyOne").WithPluralName("CompanyOnes").WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("a4db0d75-3dff-45ac-9c1d-623bca046b4a"), new Guid("5ed577d8-f048-42b8-9fb4-38b88ebf35f1"), new Guid("c1b45f09-59fe-4484-8999-e2a3d9147919")).WithObjectTypes(badUi, person).WithSingularName("PersonOne").WithPluralName("PersonOnes").WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("a8621048-48b5-43c4-b10b-17225958d177"), new Guid("718eaf0b-1b62-43b2-b336-c9820d806b28"), new Guid("1663525b-5add-4a96-a596-5d736d466985")).WithObjectTypes(badUi, organisation).WithSingularName("CompanyMany").WithPluralName("CompanyManies").WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
            ...
            // Three
            new RelationTypeBuilder(domain, new Guid("1697f09c-0d3d-4e5e-9f3f-9d3ae0718fd3"), new Guid("dc813d9a-84e9-4995-8d2c-0ef449b12024"), new Guid("25737278-d039-47c5-8749-19f22ad7a4c3")).WithObjectTypes(three, four).WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("32fc21cc-4be7-4a0e-ac71-df135be95e68"), new Guid("e0006bdc-74e2-4067-871c-6f0b53eba5de"), new Guid("12824c37-d0d2-4cb9-9481-cad7f5f54976")).WithObjectTypes(i1, allorsDateTime).Build();
            new RelationTypeBuilder(domain, new Guid("39e28141-fd6b-4f49-8884-d5400f6c57ff"), new Guid("9118c09c-e8c2-4685-a464-9be9ece2e746"), new Guid("a4b456e2-b45f-4398-875b-4ba99ead49fe")).WithObjectTypes(i1, i2).WithSingularName("I2One2Many").WithPluralName("I2One2Manies").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("4506a14b-22f1-41fe-972b-40fab7c6dd31"), new Guid("54c659d3-98ff-45e6-b734-bc45f13428d8"), new Guid("d75a5613-4ed9-494f-accf-352d9e115ba9")).WithObjectTypes(i1, c2).WithSingularName("C2One2Many").WithPluralName("C2One2Manies").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("47f775ef-2fe1-475a-81d8-2267dfd01085"), new Guid("b46764be-27e2-4ee3-89f9-a4886fd86574"), new Guid("1adef5b4-234c-4837-8b09-230e25143468")).WithObjectTypes(i1, allorsDateTime).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("6199e5b4-133d-4d0e-9941-207316164ec8"), new Guid("75342efb-659c-43a9-8340-1e110087141c"), new Guid("920f26a7-971a-4771-81b1-af3972c997ff")).WithObjectTypes(i1, c2).WithSingularName("C2Many2Many").WithPluralName("C2Many2Manies").WithCardinality(Cardinalities.ManyToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("670c753e-8ea0-40b1-bfc9-7388074191d3"), new Guid("b1c6c329-09e3-4b07-8ddf-e6a4fd8d0285"), new Guid("6d36c9f9-1426-46a5-8d4f-7275a51c9c17")).WithObjectTypes(i1, i1).WithSingularName("I1One2Many").WithPluralName("I1One2Manies").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("6bb3ba6d-ffc7-4700-9723-c323b9b2d233"), new Guid("86623fe9-c7cc-4328-85d9-b0dfce2b9a59"), new Guid("9c64a761-136a-43aa-bef9-6bcd1259d591")).WithObjectTypes(i1, i1).WithSingularName("I1Many2Many").WithPluralName("I1Many2Manies").WithCardinality(Cardinalities.ManyToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("75fb2012-0b49-4442-a9b4-8239cffb1d37"), new Guid("1c1d99ce-9ce4-4eea-abc6-65deb9af72b8"), new Guid("9719d12f-8a1c-4870-8585-86b9ada1645a")).WithObjectTypes(i1, allorsLong).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("b89092f1-8775-4b6a-99ef-f8626bc770bd"), new Guid("d0b99a68-2104-4c4d-ba4c-73d725e406e9"), new Guid("6303d423-6cc4-4933-9546-4b6b39fa0ae4")).WithObjectTypes(i1, c1).WithSingularName("C1One2Many").WithPluralName("C1One2Manies").WithCardinality(Cardinalities.OneToMany).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("bcc9eee6-fa07-4d37-be84-b691bfce24be"), new Guid("b6c7354a-4997-4764-826a-0c9989431d3b"), new Guid("7da3b7ea-2e1a-400c-adbf-436d35720ae9")).WithObjectTypes(i1, c1).WithSingularName("C1Many2Many").WithPluralName("C1Many2Manies").WithCardinality(Cardinalities.ManyToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("cdb758bf-ecaf-4d99-88fb-58df9258c13c"), new Guid("62961c44-f0ab-4edf-9aa7-63312643e6b4"), new Guid("e33e809e-bbd3-4ecc-b46e-e233c5c93ce6")).WithObjectTypes(i1, allorsDouble).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("e3126228-342a-4415-a2e8-d52eceaeaf89"), new Guid("202575b6-aaff-46ce-9e8a-e976a8a9d263"), new Guid("2598d7df-a764-4b6e-bf91-5234404b97c2")).WithObjectTypes(i1, c1).WithSingularName("C1Many2One").WithPluralName("C1Many2Ones").WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("ef1a0a5e-1794-4478-9d0a-517182355206"), new Guid("7b80b14e-dd35-4e7c-ba85-ac7860a5dc28"), new Guid("1d51d303-f68b-4dca-9299-a6376e13c90e")).WithObjectTypes(i1, c2).WithSingularName("C2Many2One").WithPluralName("C2Many2Ones").WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
            ...
            // Person
            new RelationTypeBuilder(domain, new Guid("0375a3d3-1a1b-4cbb-b735-1fe508bcc672"), new Guid("ebaedf39-1af9-42b7-83dc-8945450cebf2"), new Guid("86685c44-5196-46dd-9260-e40a434e9a52")).WithObjectTypes(person, address).WithSingularName("MainAddress").WithPluralName("MainAddresses").WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("6340de2a-c3b1-4893-a7f3-cb924b82fa0e"), new Guid("b6ea4ac5-088a-4773-8410-6813d0185d7c"), new Guid("5a472c98-481f-407c-b53e-eaaa7e7a5340")).WithObjectTypes(person, mailboxAddress).WithSingularName("MailboxAddress").WithPluralName("MailboxAddresses").WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("654f6c84-62f2-4c0a-9d68-532ed3f39447"), new Guid("5ec6caf4-4752-4a89-92ec-13fd69b444f2"), new Guid("34704a90-d513-4fe2-a1ed-ad6d89399c73")).WithObjectTypes(person, gender).WithSingularName("Gender").WithPluralName("Genders").WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
            ...
            new RelationTypeBuilder(domain, new Guid("adf83a86-878d-4148-a9fc-152f56697136"), new Guid("b9da077d-bfc7-4b4e-be62-03aded6da22e"), new Guid("0ffd9c62-efc6-4438-aaa3-755e4c637c21")).WithObjectTypes(person, allorsDateTime).WithSingularName("BirthDate").WithPluralName("BirthDates").Build();
            ...
            new RelationTypeBuilder(domain, new Guid("b3ddd2df-8a5a-4747-bd4f-1f1eb37386b3"), new Guid("912b48f5-215e-4cc0-a83b-56b74d986608"), new Guid("f6624fac-db8e-4fb2-9e86-18021b59d31d")).WithObjectTypes(person, media).WithSingularName("Photo").WithPluralName("Photos").WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("e9e7c874-4d94-42ff-a4c9-414d05ff9533"), new Guid("da5e0427-79f7-4259-8a68-0071aa4c6273"), new Guid("c922b44f-6c6f-4e8b-901d-6558e79bb558")).WithObjectTypes(person, address).WithSingularName("Address").WithPluralName("Addresses").WithCardinality(Cardinalities.ManyToMany).WithIsIndexed(true).Build();
            new RelationTypeBuilder(domain, new Guid("9ce2ef9b-2376-474d-9aa2-d23fbe1ed236"), new Guid("04bc6904-bd6e-4401-9720-088ebf1fb392"), new Guid("7ab62a77-c098-4ad6-836d-53ae820df951")).WithObjectTypes(person, stringTemplate).WithSingularName("PersonTemplate").WithPluralName("PersonTemplates").WithCardinality(Cardinalities.ManyToOne).WithIsIndexed(true).Build();
